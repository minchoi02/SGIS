...
public class EgovSampleController {
	...
	public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		...
		//http://localhost:8080/view/totSurv/proxy?
		String url = "https://kosis.kr/openapi/statisticsList.do?method=getList&vwCd=MT_OTITLE&parentListId=101_2016_10&format=json&jsonVD=Y&apiKey=NWU2NjUxODYzMWQyMTM0MGQ5NWRhMTE3ZjZjZGE0ODc%3D";
