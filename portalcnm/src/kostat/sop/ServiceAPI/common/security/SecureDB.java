...
public class SecureDB {
	...
	* @exception Exception
	*/
	public static SDBCrypto dbConfig() throws SDBException, IOException, NullPointerException {
	...
	* @exception Exception
	*/
	public static String encryptAria256(String param) throws SDBException, IOException, NullPointerException {
		String encData = "";
		try {
	...
	* @exception Exception
	*/
	public static String decryptAria256(String param) throws SDBException, IOException, NullPointerException {
		String decData = "";
		try {
			SDBCrypto crypto = dbConfig();
	...
	* @exception Exception
	*/
	public static String encryptSha256(String param) throws SDBException, IOException, NullPointerException {
		String encData = "";
		try {
			SDBCrypto crypto = dbConfig();
