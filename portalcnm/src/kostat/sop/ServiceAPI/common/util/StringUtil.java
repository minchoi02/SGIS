...
public class StringUtil {
	...
	public static String checkHtmlView(String strString) {
		...
		try {
			if (strString.equals(null)) {
				throw new ApiException("입력된 String이 없습니다.");
			}
	 ...
	 * @see
	 */
	public static String getRandomStr(char startChr, char endChr) throws NullPointerException, AbsAPIException, IOException {
		...
		try {
			if (startChr == '\u0000') {
				throw new ApiException("startChr 파라미터 null입니다.");
			}
			if (endChr == '\u0000') {
				throw new ApiException("startChr 파라미터 null입니다.");
			}
			...
			try {
				...
				while (i >= 0) {
					...
					if(randomInt < startInt) { // 입력받은 문자 'A'(65)보다 작으면 다시 랜덤 숫자 발생
...
/**
     ...
     * @see
     */
	public static String getSpclStrCnvr(String srcString) throws NullPointerException, AbsAPIException, IOException {
		...
		try {
			...
			char chrBuff;
			if (srcString.equals(null)) {
				throw new ApiException("입력된 문자열이 없습니다.");
			} else {
	 ...
	 * @see
	 */
	public static String getHtmlStrCnvr(String srcString) throws NullPointerException, AbsAPIException, IOException {
	 ...
	 * 숫자인지 체크하기(소수 포함)
	 */
	public static boolean DecimalChk(String str) {
