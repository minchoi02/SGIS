 ...
 *
 * @author xuliguo   
 * @date：2014年10月16日 下午8:09:06    
 * @version V1.0      
 *   
 */
public class SearchAPI extends AbsAuth<Map> {
	/**
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			RequestUtil.transPagging(getParameterMap(req));
			return apiStatDao.searchAPI(getParameterMap(req));
	...
	private enum MustParam{
		API_B_CLASS_CD,NM,SRV_TYPE,SRV_ATTR,PAGEINDEX
	}
	@Override
