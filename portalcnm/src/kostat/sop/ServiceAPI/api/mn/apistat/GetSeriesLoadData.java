 ...
 *   
 */
public class GetSeriesLoadData extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(GetSeriesLoadData.class);
...
//			List B_M_List = session.selectList("Common.getAPIMClassList",paramMap);
			List B_M_List = session.selectList("APIStat.getAPICD",paramMap);
	...
	private enum MustParam{
		TIMETYPE,STARTDATE,ENDDATE,APINAME
	}
