 ...
 * 
 */
public class DevUpdateFAQ extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevUpdateFAQ.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			devFAQManageDao.updateFAQ(paramMap);
