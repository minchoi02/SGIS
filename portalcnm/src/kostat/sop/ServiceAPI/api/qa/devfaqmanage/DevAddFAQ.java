 ...
 *    
 */
public class DevAddFAQ extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevAddFAQ.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			paramMap.put("POST_NO", devFAQManageDao.getFAQPostNO());
			...
			devFAQManageDao.addFAQ(paramMap);
