 ...
 *   
 */
public class DevGetFAQ extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevGetFAQ.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return devFAQManageDao.getFAQ(req.getParameter(MustParam.POST_NO.name()));
