 ...
 *   
 */
public class DevGetBoard extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevGetBoard.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return boardManageDao.DevgetBoard(req.getParameter(MustParam.POST_NO.name()));
