 ...
 *    
 */
public class DelMediaIntro extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelMediaIntro.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return boardManageDao.deleteMediaIntro(req.getParameter(MustParam.POST_NO_List.name()).toString().split(","));
