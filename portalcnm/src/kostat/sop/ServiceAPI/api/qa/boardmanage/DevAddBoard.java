 ...
 *    
 */
public class DevAddBoard extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevAddBoard.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			paramMap.put("POST_NO", boardManageDao.DevgetPostNO());
            ...
            boardManageDao.DevaddBoard(paramMap);
