 ...
 * 
 */
public class SearchFAQ extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchFAQ.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			return boardManageDao.searchFAQ(paramMap);
