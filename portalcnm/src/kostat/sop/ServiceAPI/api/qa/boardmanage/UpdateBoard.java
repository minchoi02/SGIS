 ...
 * 
 */
public class UpdateBoard extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(UpdateBoard.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			boardManageDao.updateBoard(paramMap);
	...
	private enum OptionParam {
		DELETE_FILE_YN, FILE_ID, FILE_PATH, FILE_NM, FILE_EXTENSION, FILE_CONTENT_TYPE, BOARD_CD
	}
	@Override
