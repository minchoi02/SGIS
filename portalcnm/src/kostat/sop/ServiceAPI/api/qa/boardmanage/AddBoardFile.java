 ...
 * 
 */
public class AddBoardFile extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AddBoardFile.class);
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (!file.isFormField() && "FILE".equals(file.getFieldName()) && file.getSize() > 0) {
					...
					String FILE_ID = FILE_NM + "_" + Long.toString(curTime);
