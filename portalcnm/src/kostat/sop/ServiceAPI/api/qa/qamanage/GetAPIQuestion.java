 ...
 *   
 */
public class GetAPIQuestion extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(GetAPIQuestion.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return qaManageDao.getAPIQuestion(getParameterMap(req));
