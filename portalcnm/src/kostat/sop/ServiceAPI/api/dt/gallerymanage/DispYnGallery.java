 ...
 *     
 */
public class DispYnGallery extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DispYnGallery.class);
	@Resource
	private GalleryManageDao galleryManageDao;
	@Override
	public String getApiId() {
		return "updateGalleryDispYn";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			paramMap.put("SRV_TYPE", req.getParameter(MustParam.SRV_TYPE.name()));
			return  galleryManageDao.dispYnGallery(paramMap);
