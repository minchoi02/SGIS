 ...
 *     
 */
public class SearchAccess extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchAccess.class);
	@Resource
	private AccessManageDao accessManageDao;
	@Override
	public String getApiId() {
		return "accessmanage_search";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {	
			...
			return accessManageDao.searchAccess(paramMap);
