 ...
 *     
 */
public class SearchManagerInfo extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchManagerInfo.class);
	@Resource
	private AccessManageDao accessManageDao;
	@Override
	public String getApiId() {
		return "accessmanage_searchManager";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {	
			...
			return accessManageDao.SearchManagerInfo(paramMap);
