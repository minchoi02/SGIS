...
public class RegUpdateThemaChange extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(RegUpdateThemaChange.class);
	...
	public String getApiId() {
		return "themamapmanage_regupdatethemachange";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return pubDataManageDao.getRegThemaChID(paramMap);
