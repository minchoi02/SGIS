...
public class RegThemaID extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(RegThemaID.class);
	...
	public String getApiId() {
		return "themamapmanage_reggetthemamapparam";
	}
...
//			if(SEARCH_WORD != null && SEARCH_WORD.length() >10)
//				throw new ApiException("입력값을 체크 해 주세요");
			...
			return pubDataManageDao.getThemaID(paramMap);
