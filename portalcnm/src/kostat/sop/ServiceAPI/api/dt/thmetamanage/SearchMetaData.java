 ...
 *     
 */
public class SearchMetaData extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchMetaData.class);
	@Resource
	private ThMetaManageDao thMetaManageDao;
	@Override
	public String getApiId() {
		return "thmetamanage_search";
	}
...
//			return pubDataManageDao.searchPubData(paramMap);
			...
			return thMetaManageDao.searchMetaData(paramMap);
