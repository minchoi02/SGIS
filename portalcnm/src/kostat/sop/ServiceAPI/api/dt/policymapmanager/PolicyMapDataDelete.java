 ...
 *     
 */
public class PolicyMapDataDelete extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(PolicyMapDataDelete.class);
	@Resource
	private PolicyDataManageDao policydatamanagedao;
	@Override
	public String getApiId() {
		return "policymapdatadelete_del";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  policydatamanagedao.deletePOlicyData(req.getParameter(MustParam.DATA_List.name()).split(","));
