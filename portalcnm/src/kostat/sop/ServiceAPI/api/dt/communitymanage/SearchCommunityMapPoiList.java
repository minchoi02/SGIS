...
/**   
 *
 * @ClassName: SearchCommunityMapPoiList
 * @Description： 
 *
 * @author kwangheum   
 * @date：2015年11月23日    
 ...
 *     
 */
public class SearchCommunityMapPoiList extends AbsGridQuery<Map<?,?>> {
	/**
	...
	public String getApiId() {
		return "communitymanage_searchcommunitymappoilist";
	}
	...
	public Map<?,?> executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return communityManageDao.searchCommunityMapPoiList(paramMap);
