...
public class GetThemaList extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(GetThemaList.class);
	...
	public String getApiId() {
		return "themamapmanage_GetThemaList";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return themaMapManageDao.getThemaList(paramMap);
