...
public class GetPOICODE extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(GetPOICODE.class);
...
//				throw new ApiException("입력값을 체크 해 주세요");
			...
			return themaMapManageDao.getPOICODE(paramMap);
