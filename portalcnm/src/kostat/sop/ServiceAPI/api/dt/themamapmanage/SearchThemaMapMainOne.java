 ...
 *   
 */
public class SearchThemaMapMainOne extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchThemaMapMainOne.class);
	@Resource
	private ThemaMapManageDao themaMapManageDao;
	@Override
	public String getApiId() {
		return "ttipmanage_getboard";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			logger.debug("시작-------------------------------------------------");
			return themaMapManageDao.searchThemaMapOne(paramMap);
