...
/**   
 * 
 * @ClassName: AddWorkRoadStatsInfoSm
 * @Description：일자리 통계정보 집계 등록
 * 
 * @author 김남민
 * @date：2019.07.31    
 * @version V1.0      
 * 
 */
public class AddWorkRoadStatsInfoSm extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AddWorkRoadStatsInfoSm.class);
	...
	public String getApiId() {
		return "workroadstatsinfosm_add";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			//오늘날짜 (YYYYMMDD)
			paramMap.put("CREATE_DT", DateUtil.getToday());
			
			//관리자 ID
			String manager_id = StringUtil.isNullToString(req.getSession().getAttribute("manager_id"));
			paramMap.put("REG_MANAGER_ID", manager_id);
			
			return workRoadStatsInfoSmDao.addSearchWorkRoadStatsInfoSm(paramMap);
