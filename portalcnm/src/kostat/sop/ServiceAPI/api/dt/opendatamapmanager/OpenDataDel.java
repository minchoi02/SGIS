 ...
 *     
 */
public class OpenDataDel extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(OpenDataDel.class);
	@Resource
	private OpenDataManageDao OpenDatamanageDao;

	@Override
	public String getApiId() {
		return "opendatamanagedao_opendatadel";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  OpenDatamanageDao.deleteOpenData(req.getParameter(MustParam.DATA_List.name()).split(","));
