	...
	<div class="wrapper">
		...
		<div class="contents">
			...
			<div class="acticle">
				...
				<form id="resetForm">
					<input type="hidden" id="TOT_SURV_YN" name = "TOT_SURV_YN" value="Y" />
					<table class="apiTable02" summary="조회조건">
						...
						<tbody>
							<tr>
								<th class="right">통계구분</th>
								<td>
									<select class="input_use29" id="STATTB_DIV" name="STATTB_DIV">
										<option value="">전체</option>
									</select>
								</td>
								<th class="right">통계시기</th>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" id="STATTB_SOURC" name="STATTB_SOURC" class="input_use03 validatebox-text"  style="width:200px"/>
								</td>
							</tr>
						</tbody>
					</table>
