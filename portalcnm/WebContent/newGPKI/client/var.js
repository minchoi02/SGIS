...
var ServiceStartPageURL = '/GPKISecureWebHTML/gpkisecureweb/index.html';		// * 설치완료후 이동할 페이지
...
document.write("<link rel='shortcut icon' href='" + "/GPKISecureWebHTML/" + gpkiScriptBase + "/image/install/favicon.ico'	type='image/x-icon' />");
