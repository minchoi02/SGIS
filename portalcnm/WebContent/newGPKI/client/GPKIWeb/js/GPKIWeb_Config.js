var ML_Default_Set = {
	...
	mlDirPath 					: "/GPKISecureWebHTML/gpkisecureweb/client/GPKIWeb/",
...
var ConfigObject = {
	...
	embeddedHtml 				: "/GPKISecureWebHTML/gpkisecureweb/jsp/createSecureSession_1_3.jsp",
	...
	CS_DOWNLOAD_WIN				: ML_Default_Set.protocolType + "//" + ML_Default_Set.mlMainUrl + "/GPKISecureWebHTML/gpkisecureweb/client/setup/GPKISecureWebSetup.exe",		//윈도우용 CS 설치 파일 주소
	...
	targetSrc    				: "/GPKISecureWebHTML/gpkisecureweb/certstr/gpkiapi.html", //실 사용하는 공동저장소 주소로 변경

	// 공동저장소 URL 설정
	StorageCertURL				: "/GPKISecureWebHTML/gpkisecureweb/client/gpkicert.js",
