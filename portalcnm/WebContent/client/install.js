...
// 		var installVersion;
// 		try{
// 			installVersion = GPKISecureWeb.GetAPIVersion();
// 		}catch(err){
// 			return false;
// 		}
// 		var deployVersion = '1,0,0,8';
// 	
// 		var deployDot = deployVersion.split(',');
// 		alert(deployDot);
// 		var tmpVersion = '';
// 		for(var i=0; i<deployDot.length; i++){
// 			tmpVersion += deployDot[i];
// 			alert(deployDot[i]);
// 		}
// 		alert(tmpVersion);
// 		alert(installVersion);
// 		if(installVersion<parseInt(tmpVersion))
// 			return false;
// 		
// 		return true;
	}
