						...
						<div class="apiPFont01">
							<table class="useTable" summary="자료 신청">
								...
								<tr>
									...
									<td>http://sgis.kostat.go.kr/SGisService/getstaticsxml</td>
								</tr> 
								<tr>
...
public class StaticsXml {
	...
	public String sgisApiStaticsXml(String requestXml) {
		final String apiurl = "http://sgis.kostat.go.kr/SGisService/getstaticsxml";
...
&lt;head&gt;
  ...
  &lt;script type="text/javascript"&gt;
	function aaaaopen(){
		var url = "http://sgis.kostat.go.kr/SGisService/getstaticsxml";
                        //요청문서 작성 시작
