...
%>
	...
	<select name="sgis_census_year_id" id="sgis_census_year1" class="w40" title="년도"  onchange="sido('sgis_census_id1','sgis_census_data_id1', this.value,'inUse1','years1'); selectSameVal();" >
