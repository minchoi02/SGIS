...
(function(W, D) {
	...
	$(document).ready(function(){
		...
		if(type == 'reply'){
			//request Question
			$DevQAReply.reqQuestion();
		} else if(type == 'update'){
			//request Answer
			$DevQAReply.reqAnswer();
		}
		//click the contant button
		$('#toContantButton').click(function(){
			location.href = './../QA/DevQASearch.html?BOARD_CD=' + BOARD_CD_RETURN + '&S_CLASS_CD_NM=' + S_CLASS_CD_NM 
			+ '&keywordSelect=' + keywordSelect + '&keywordInput=' + keywordInput + '&pageNumber=' + pageNumber;
		});
