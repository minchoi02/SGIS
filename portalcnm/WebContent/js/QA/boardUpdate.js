...
(function(W, D) {
	...
	$boardUpdate = {
		...
		reqBoard : function() {
			...
			sopOpenApiReqBoardObj.addParam('BOARD_CD', BOARD_CD);
			sopOpenApiReqBoardObj.addParam('POST_NO', POST_NO);
			sopOpenApiReqBoardObj.request({
				method : "POST",
				async : false,
				url : contextPath + "/ServiceAPI/QA/BoardManage/getBoard.json"
			});
		},
		...
		updateBoardAfterFile : function(POST_NO, POST_TITLE, PRIORITY_DISP_YN, POST_CONTENT, DELETE_FILE_YN, FILE_YN, FILE_EXTENSION, FILE_ID, FILE_NM,
			...
			sopOpenApiUpdateBoardAfterFileObj.addParam('BOARD_CD', BOARD_CD);
			...
			sopOpenApiUpdateBoardAfterFileObj.request({
				method : "POST",
				async : false,
				url : contextPath + "/ServiceAPI/QA/BoardManage/updateBoard.json"
			});
		},
		updateBoardInner : function(POST_NO, POST_TITLE, PRIORITY_DISP_YN, POST_CONTENT, DELETE_FILE_YN, FILE_YN) {
			...
			sopOpenApiupdateBoardInnerObj.addParam('BOARD_CD', BOARD_CD);
