...
public class OpenDataList extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(OpenDataList.class);
	...
	public String getApiId() {
		return "opendatamanagedao_opendata";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return OpenDatamanageDao.getopenDataMapList(paramMap);
