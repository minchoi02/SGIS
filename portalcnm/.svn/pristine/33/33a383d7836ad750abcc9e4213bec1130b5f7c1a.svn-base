 ...
 *
 * @author xuliguo   
 * @date：2015年12月21日 下午4:57:25    
 * @version V1.0      
 *   
 */
public class DevGetBanner extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevGetBanner.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return devFAQManageDao.getBanner(req.getParameter(MustParam.POST_NO.name()));
