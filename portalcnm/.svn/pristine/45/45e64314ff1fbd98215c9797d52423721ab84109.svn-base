...
(function(W, D) {
	...
	$(document).ready(
			function() {
				...
				$('#modifyButton').click(
						function() {
							srvLogWrite("L0", "05", "01", "05", "", "");
							getConfirmPopup('확인', '수정하시겠습니까?', 'confirm');
							$('#ok_confirmPopup').click(
									function() {
										location.href = './../QA/boardUpdate.html?BOARD_CD='+BOARD_CD+'&POST_NO=' + POST_NO + "&searchWordType=" + searchWordType + "&searchWord="
