 ...
 *
 * @author xuliguo   
 * @date：2014年10月28日 下午4:47:33    
 * @version V1.0      
 *    
 */
public class DelMember extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelMember.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return memberDao.deleteMember(paramMap, accessIp);
