		...
		<div class="ML_content" style="width:418px;float:left;"><%-- ML_content : S --%>
			<div class="ML_content-area" id="GPKISecureWeb" style="padding-top:5px;"><%-- ML_content-area : S --%>
				...
				<span id="ML_dp_03" class="btn_row_s">
					...
					<span class="btn_cell_right">
						<p class="whtgrey_btn">
							<button type="button" id="btn_pwChgCert">
								<span><img src="images/icon_pw_chg.png" alt="인증서 암호변경"><span class="MSG_cls" id="MSG_TS007">인증서 암호변경</span></span>
							</button>
						</p>
					</span> --%>
					<span class="w_space8"></span>
					<span class="btn_cell_right">
						...
						<%-- <p class="whtgrey_ws_btn">
							<button type="button" id="btn_viewCert">
								<span><img src="images/icon_detail.png" alt="인증서 보기"><span class="MSG_cls" id="MSG_TS017">인증서 보기</span></span>
							</button>
						</p> --%>
					</span>
					<span class="w_space8"></span>
					...
					<span class="btn_cell_right">
						<%-- <p id="flip" class="whtgrey_ws_btn2"><button type="button" id="btn_PFX"><span><img src="images/icon_search.png" alt="pfx 찾기">PFX 인증서 가져오기</span></button></p> --%>
					</span>
				</span>
				<%-- BTN : E --%>
				<%-- Certificate list : E --%>
	...
	<div class="ML_container">
		<div class="ML_content">
			<div class="ML_content-area">
				<img src="images/browser_menual3.png" alt="브라우저 인증서 사용방법" class="MLjqui-window-close-button MLjqui-icon-close">
			</div>
		</div>
	</div>
</div> --%>
