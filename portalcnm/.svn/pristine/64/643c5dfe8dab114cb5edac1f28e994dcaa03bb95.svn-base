 ...
 *     
 */
public class UpdateMetaData extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(UpdateMetaData.class);
	@Resource
	private ThMetaManageDao thMetaManageDao;
	@Override
	public String getApiId() {
		return "thmetamanage_update";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			cleanXssDATA_ID = Security.cleanXss((String) paramMap.get("META_DATA_ID"));
			paramMap.put("META_DATA_ID", cleanXssDATA_ID);	
			...
			return  thMetaManageDao.updateMetaData(paramMap);
