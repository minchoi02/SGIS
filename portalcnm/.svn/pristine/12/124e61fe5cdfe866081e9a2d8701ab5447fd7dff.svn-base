...
/**   
 *
 * @ClassName: AddWorkRoadStatsItemManage
 * @Description： 일자리 통계항목 관리 신규 추가
 *
 * @author 한광희
 * @date：2019.08.02    
 * @version V1.0      
 *     
 */
public class AddWorkRoadStatsItemManage extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AddWorkRoadStatsItemManage.class);
	@Resource
	private WorkRoadStatsItemManageDao workRoadStatsItemManageDao;
	@Override
	public String getApiId() {
		return "workroadstatsitemmanage_addWorkRoadStatsItemManage";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			return workRoadStatsItemManageDao.addWorkRoadStatsItemManage(paramMap);
