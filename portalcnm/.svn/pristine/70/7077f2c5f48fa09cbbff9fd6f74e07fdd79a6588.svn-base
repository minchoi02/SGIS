...
function nowYearMonth(){
	...
	// mng_s 2021. 01. 04 j.h.Seok 하드코딩 부분 동적 생성 변경
...
//	jQuery("#yearSel").append("<option value='2020'>2020</option>")
	...
	var tempYear = '2015';
	for(var i = tempYear; i <= nowYear; i++) {
		var str = "<option value = '" + i + "'>" + i + "</option>";
		jQuery("#yearSel").append(str);
		jQuery("#yearSel2").append(str);
	}
...
function makeLeftMenu(topM, leftBigM, leftSmallM){
	...
	if(topM == "1"){		//서비스 현황
		...
		//mng_s 20210112 이진호
		//현재 운영되고 있는 서비스 메뉴명과 불일치 하여 변경
		//jQuery(".leftMenu ul").append("<li id='lm1'><a id='lm1a' href='./../MN/totUseStat.html'>통계포탈</a></li>");
		jQuery(".leftMenu ul").append("<li id='lm1'><a id='lm1a' href='./../MN/totUseStat.html'>총괄이용현황</a></li>");
		//mng_e 20210112 이진호
		...
		// 2020년 SGIS고도화 3차 시작
		jQuery(".leftMenu ul").append("<li id='lm12'><a id='lm12a' href='/s-portalcnm/ststistics/ststisticsUSTotalStblMng.do'>시각화관리</a></li>");
		jQuery(".leftMenu ul").append("<li id='lm13'><a id='lm13a' href='/s-portalcnm/srvAreaMng/srvAreaSetInfoMng.do'>생활권역 통계지도</a></li>");
		// 2020년 SGIS고도화 3차 끝
		//2021년 SGIS4 도시화 시작
		jQuery(".leftMenu ul").append("<li id='lm14'><a id='lm14a' href='/s-portalcnm/urban/urbanServiceManage.do'>도시화 분석 지도</a></li>");
		//2021년 SGIS4 도시화 끝
		if(leftBigM == "1"){	//정책통계지도
			document.title = "SGIS-정책통계지도 서비스 관리";
			...
			jQuery("#lm1 ul").append("<li id='ls3'><a id='ls3a' href='./../DT/openDataMapManager.html'>지자체 데이터 관리</a></li>");
			
		}else if(leftBigM == "2"){	//업로드 데이터 현황
			document.title = "SGIS-주제도 서비스 관리";
			jQuery("#lm2").append("<ul class='sub'>");
			...
			document.title = "SGIS-지역현안 소통지도 서비스 관리";
			jQuery("#lm3").append("<ul class='sub'>");
			...
			//jQuery("#lm7 ul").append("<li id='ls2'><a id='ls2a' href='/s-portalcnm/contents/gsks/gsks_01_04_01.jsp'>자료제공</a></li>"); //mng_s 20220324 사용하지 않는기능
			...
			jQuery("#lm7 ul").append("<li id='ls5'><a id='ls5a' href='/s-portalcnm/ststistics/ststisticsUSProvideDataMng.do'>자료제공서비스 자동화</a></li>"); //SGIS_4 자료제공서비스 자동화 추가
			jQuery("#lm7 ul").append("<li id='ls6'><a id='ls6a' href='/s-portalcnm/ststistics/ststisticsUSGridInfo.do'>격자자료 제공서비스 자동화</a></li>");
		}else if(leftBigM == "8"){	//통계갤러리
			document.title = "SGIS-통계갤러리 서비스 관리";
			jQuery("#lm8").append("<ul class='sub'>");
		}else if(leftBigM == "9"){	//모바일 서비스 관리
			document.title = "SGIS-모바일 서비스 관리";
			jQuery("#lm9").append("<ul class='sub'>");
		}
		// 19년반영 시작
		else if(leftBigM == "10"){
			document.title = "SGIS-My통계로 서비스 관리";
			...
			jQuery("#lm10 ul").append("<li id='ls2'><a id='ls2a' href='/s-portalcnm/ststistics/ststisticsUSInterestsMng.do'>관심분야관리</a></li>");//20201127 2020년 SGIS고도화 3차 수정
...
//			jQuery("#lm10 ul").append("<li id='ls4'><a id='ls4a' href='/s-portalcnm/ststistics/ststisticsUSSubKeyWordMng.do'>유사키워드관리</a></li>");
			...
			jQuery("#lm10 ul").append("<li id='ls4'><a id='ls4a' href='/s-portalcnm/ststistics/ststisticsUSAccumulateKeyWordMng.do'>누적키워드관리</a></li>");
			jQuery("#lm10 ul").append("<li id='ls5'><a id='ls5a' href='/s-portalcnm/ststistics/ststisticsUSDataMng.do'>서비스관리</a></li>");
			jQuery("#lm10 ul").append("<li id='ls6'><a id='ls6a' href='/s-portalcnm/ststistics/ststisticsUSRecmdKwrdMng.do'>추천키워드관리</a></li>");
			jQuery("#lm10 ul").append("<li id='ls7'><a id='ls7a' href='/s-portalcnm/ststistics/ststisticsUSKwrdContentMng.do'>키워드 콘텐츠 현황</a></li>");
			jQuery("#lm10 ul").append("<li id='ls8'><a id='ls8a' href='/s-portalcnm/ststistics/ststisticsUSInterestingTopicMng.do'>관심주제 이용현황</a></li>");
            jQuery("#lm10 ul").append("<li id='ls9'><a id='ls9a' href='/s-portalcnm/ststistics/ststisticsUSAccessAreaMng.do'>접속지역별 이용현황</a></li>");
            jQuery("#lm10 ul").append("<li id='ls10'><a id='ls10a' href='/s-portalcnm/ststistics/ststisticsUSInterestSelectPatternMng.do'>관심주제 선택패턴 현황</a></li>");
            jQuery("#lm10 ul").append("<li id='ls11'><a id='ls11a' href='/s-portalcnm/ststistics/ststisticsUSTrendKwrdMng.do'>트렌드키워드관리</a></li>");
            jQuery("#lm10 ul").append("<li id='ls12'><a id='ls12a' href='/s-portalcnm/ststistics/ststisticsUSSynonymBasedMainKeywordMng.do'>유의어 기반 메인키워드 관리</a></li>"); // 2020년 SGIS고도화 유의어 기반 메인키워드 등록 - 좌측 소메뉴 추가 (pse) 
			//2020년 SGIS고도화 3차 끝
		} 
		// 19년반영 끝
		//2019-07-30 [김남민] 관리자 > 서비스 관리 > 일자리 맵 > 일자리 통계정보 집계. START
		else if(leftBigM == "11"){	//일자리 맵
			document.title = "SGIS-일자리 맵 서비스 관리";
			...
			//2021.06.22[hjh] 관리자 > 서비스 관리 > 일자리 맵 > 일자리 경계 현행화 관련 메뉴 추가. START
			jQuery("#lm11 ul").append("<li id='ls4'><a id='ls4a' href='/s-portalcnm/html/DT/WorkRoadMnbyStatsResve.html'>일자리 경계 현행화 관리</a></li>");
			jQuery("#lm11 ul").append("<li id='ls5' style='line-height: 20px;'><a id='ls5a' href='/s-portalcnm/html/DT/WorkRoadMnbyStats.html' style='height: auto;'>일자리 월별 집계 및<br/>경계 현행화 조회</a></li>");
			//2021.06.22[hjh] 관리자 > 서비스 관리 > 일자리 맵 > 일자리 경계 현행화 관련 메뉴 추가. END
		}
		//2019-07-30 [김남민] 관리자 > 서비스 관리 > 일자리 맵 > 일자리 통계정보 집계. END
		// 2021년 SGIS고도화 4차 이영호
		else if(leftBigM == "12"){
			document.title = "SGIS-총조사시각화 서비스 관리";
			jQuery("#lm12").append("<ul class='sub'>");
			/* 2022.03.10 [이영호] 관리자 > 서비스 관리 > 총조사시각화. START */
			jQuery("#lm12 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/ststistics/ststisticsUSTotalStblMng.do'>통계표 관리</a></li>");
			jQuery("#lm12 ul").append("<li id='ls2'><a id='ls2a' href='/s-portalcnm/ststistics/ststisticsUSTotalStblDetailMng.do'>통계표 상세 관리</a></li>");
			/* 2022.03.10 [이영호] 관리자 > 서비스 관리 > 총조사시각화. START */
			/*jQuery("#lm12 ul").append("<li id='ls3'><a id='ls3a' href='/s-portalcnm/ststistics/ststisticsStblDashBoardMng.do'>대쉬보드 차트 관리</a></li>");*/
			//jQuery("#lm12 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/ststistics/ststisticsUSTotalSurveyDataMng.do'>총조사시각화 데이터 관리</a></li>"); //210308 메뉴없음!! 주석처리 요망!
		}
		/*else if(leftBigM == "14"){
			document.title = "SGIS-행정통계 서비스 관리";
			jQuery("#lm14").append("<ul class='sub'>");
			jQuery("#lm14 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/ststistics/ststisticsUSAdministStatsStblMng.do'>통계표 관리</a></li>");
			jQuery("#lm14 ul").append("<li id='ls2'><a id='ls2a' href='/s-portalcnm/ststistics/ststisticsUSAdministStatsStblDetailMng.do'>통계표 상세 관리</a></li>");
			//jQuery("#lm12 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/ststistics/ststisticsUSTotalSurveyDataMng.do'>총조사시각화 데이터 관리</a></li>"); //210308 메뉴없음!! 주석처리 요망!
		}*/
		// 2021년 SGIS고도화 4차 이영호
		else if(leftBigM == "13"){
			document.title = "SGIS-생활권역 서비스 관리";
			jQuery("#lm13").append("<ul class='sub'>");
			jQuery("#lm13 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/srvAreaMng/srvAreaSetInfoMng.do'>서비스 관리</a></li>");
			jQuery("#lm13 ul").append("<li id='ls1'><a id='ls2a' href='/s-portalcnm/srvAreaMng/srvAreaFacilityTypeMng.do'>시설유형 관리</a></li>");
		}
		// 2020년 SGIS고도화 3차 끝
		//2021년 SGIS4 도시화 시작
		else if(leftBigM == "14"){
			jQuery("#lm14").append("<ul class='sub'>");
			jQuery("#lm14 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/urban/urbanServiceManage.do'>권역 관리</a></li>");
			jQuery("#lm14 ul").append("<li id='ls1'><a id='ls1a' href='/s-portalcnm/urban/urbanIdManage.do'>대표ID 관리</a></li>");
		}
		//2021년 SGIS4 도시화 끝
	}else if(topM == "4"){		//정보관리
		...
		jQuery(".leftMenu ul").append("<li id='lm3'><a id='lm3a' href='./../QA/eduBoardManage.html'>에듀</a></li>");
		jQuery(".leftMenu ul").append("<li id='lm4'><a id='lm4a' href='./../QA/reqBoardList.html'>운영이력관리</a></li>");
		...
		if(leftBigM == "3"){ //에듀
			jQuery("#lm3").append("<ul class='sub'>");
			jQuery("#lm3 ul").append("<li id='ls1'><a id='ls1a' href='./../QA/eduBoardManage.html'>에듀소식</a></li>");
			jQuery("#lm3 ul").append("<li id='ls2'><a id='ls2a' href='./../QA/eduFaqManage.html'>궁금해요</a></li>");
			jQuery("#lm3 ul").append("<li id='ls3'><a id='ls3a' href='./../QA/eduQASearch.html'>질문하기</a></li>");
		}
		//왼쪽 스몰메뉴 추가
		if(leftBigM == "4"){ //운영이력관리
			jQuery("#lm4").append("<ul class='sub'>");
			jQuery("#lm4 ul").append("<li id='ls1'><a id='ls1a' href='./../QA/reqBoardList.html'>운영이력관리</a></li>");
		}
