...
/**   
 *
 * @ClassName: USESRVStat
 * @Description： 
 *
 * @author xuliguo   
 * @date：2014年10月19日 下午3:43:02    
 * @version V1.0      
 *     
 */
public class USESRVStat extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(USESRVStat.class);
	@Resource
	private USESRVStatDao usesrvStatDao;
	@Override
	public String getApiId() {
		return "usersrvstat_usesrvstat";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return usesrvStatDao.getUSESRVStat(paramMap);
