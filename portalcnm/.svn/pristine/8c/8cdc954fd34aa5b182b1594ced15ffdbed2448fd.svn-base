 ...
 *    
 */
public class DelCommunityNotice extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelCommunityNotice.class);
	@Resource
	private CommunityNoticeManageDao communityNoticeManageDao;
	@Override
	public String getApiId() {
		return "communitymanage_deleteboard";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return communityNoticeManageDao.deleteBoard(req.getParameter(MustParam.POST_NO_List.name()).toString().split(","));
