 ...
 *    
 */
public class SearchPolicyCategory extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchPolicyCategory.class);
	@Resource
	private PolicyCategoryManageDao policycategorymanagedao;
	@Override
	public String getApiId() {
		return "policycategorymanagedao";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return policycategorymanagedao.searchThemaMap(paramMap);
