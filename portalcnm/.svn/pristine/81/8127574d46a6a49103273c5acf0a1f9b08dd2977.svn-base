...
public class GetThemaICON extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(GetThemaICON.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return themaMapManageDao.getThemaICON(paramMap);
