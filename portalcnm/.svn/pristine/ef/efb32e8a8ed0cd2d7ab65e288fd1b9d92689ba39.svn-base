 ...
 *    
 */
public class AddBoard extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AddBoard.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			paramMap.put("POST_NO", boardManageDao.getPostNO( BOARD_CD ));
            ...
            boardManageDao.addBoard(paramMap);
...
//	}
	...
	private enum OptionParam{
		FILE_ID,FILE_PATH,FILE_NM,FILE_EXTENSION,FILE_CONTENT_TYPE,BOARD_CD
	}
	@Override
