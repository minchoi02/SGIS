 ...
 *   
 */
public class GetCateDIV extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(GetCateDIV.class);
	@Resource
	private PolicyCategoryManageDao policycategorymanagedao;
	@Override
	public String getApiId() {
		return "policycategorymanage_getcatediv";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			logger.debug("시작-------------------------------------------------");
			return policycategorymanagedao.getTipDiv(paramMap);
