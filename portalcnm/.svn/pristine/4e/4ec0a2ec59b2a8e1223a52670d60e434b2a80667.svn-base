 ...
 *     
 */
public class DelMetaData extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelMetaData.class);
	@Resource
	private ThMetaManageDao thMetaManageDao;
	@Override
	public String getApiId() {
		return "thmetamanage_del";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  thMetaManageDao.deleteMetaData(req.getParameter(MustParam.DATA_List.name()).split(","));
