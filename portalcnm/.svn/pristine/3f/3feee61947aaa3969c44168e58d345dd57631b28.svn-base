 ...
 * 
 */
public class DevAddBannerFile extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevAddBannerFile.class);

	@Override
	public String getApiId() {
		return "boardmanage_addbannerfile";
	}
