 ...
 *     
 */
public class SidoKosis extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SidoKosis.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return kosisManageDao.searchSIDO(paramMap);
