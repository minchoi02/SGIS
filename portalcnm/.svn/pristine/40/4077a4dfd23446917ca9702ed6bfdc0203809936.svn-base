 ...
 *     
 */ 
public class deleteUserData extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(deleteUserData.class);
	@Resource
	private UPLOADDataDao upLoadDataDao;
	@Override
	public String getApiId() {
		return "uploaddata_del";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  upLoadDataDao.deleteUserData(req.getParameter(MustParam.delList.name()).split(","));
