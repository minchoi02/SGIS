 ...
 *     
 */
public class RegDelPubData extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(RegDelPubData.class);
	@Resource
	private PubDataManageDao pubDataManageDao;
	@Override
	public String getApiId() {
		return "regpubdatamanage_del";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  pubDataManageDao.deleteRegPubData(req.getParameter(MustParam.DATA_List.name()).split(","));
