...
public class ApiFormat extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> map, HttpServletRequest req,	HttpServletResponse res) throws AbsHttpException, IOException, RuntimeException, NullPointerException {
