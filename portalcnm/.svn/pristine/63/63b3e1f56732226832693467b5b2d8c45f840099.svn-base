...
/**
 *
 * @ClassName: GetAPIMClass @Description：
 *
 * @author KSY @date：2018.08.06
 * @version V1.0
 * 
 */
public class AllMakeZipFile extends AbsAuth<Success> {

	private static final Logger logger = Logger.getLogger(AllMakeZipFile.class);
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		 ...
		 * 
		 * sgis_census_data_id 0-집계구별통계(인구) : in_01(교육정도별인구) in_02(성연령별인구)
		 * in_03(성_혼인상태별인구) in_04(인구총괄(총인구)) in_05(인구총괄(평균나이)) in_06(인구총괄(인구밀도))
		 * in_07(인구총괄(노령화지수)) in_08(인구총괄(노년부양비)) in_09(인구총괄(유년부양비))
		 * 
		 * 1-집계구별통계(가구) ga_01(점유형태별가구) ga_02(세대구성별가구) ga_03(가구총괄)
		 * 
		 * 2-집계구별통계(주택) ho_01(건축년도별주택) ho_03(주택유형별주택) ho_04(연건평별주택) ho_05(주택총괄_총주택(거처)수)
		 * 
		 * 3-집계구별통계(사업체) cp_02(산업분류별(9차_대분류)_종사자수) cp_04(산업분류별(9차_대분류)_사업체수)
		 * cp_06(산업분류별(9차_대분류)_총괄사업체수) cp_01(산업분류별(8차_대분류)_종사자수)
		 * cp_03(산업분류별(8차_대분류)_사업체수) cp_05(산업분류별(8차_대분류)_총괄사업체수)
		 */
		...
		try {
			...
			mapParameter.put("sgis_census_id", sgis_census_id);
			mapParameter.put("sgis_census_data_id", sgis_census_data_id);
			mapParameter.put("census_output_area_year", census_output_area_year);
			// mapParameter.put("baseYear", baseYear);
			mapParameter.put("ouputYear", census_output_area_year);
			if (sgis_census_data_id.equals("0")) {
				data_id = "in";
			} else if (sgis_census_data_id.equals("1")) {
				data_id = "ga";
			} else if (sgis_census_data_id.equals("2")) {
				data_id = "ho";
			} else if (sgis_census_data_id.equals("3")) {
				data_id = "cp";
			}
			mapParameter.put("data_id", data_id);
			List<HashMap<String, Object>> sidosigunguyear = commonDao.sidosigunguyear(mapParameter);
			for (HashMap<String, Object> map : sidosigunguyear) {
				for (String key : map.keySet()) {
					if (key.toString().equals("SGIS_CENSUS_YEAR")) {
						baseYear = (String) map.get(key);
						mapParameter.put("baseYear", baseYear);
					}
				}
				System.out.println(baseYear);
				List<HashMap<String, Object>> detaildataid = commonDao.detaildataid(mapParameter);
				sgis_census_detail_data_id = "";
				for (HashMap<String, Object> map1 : detaildataid) {
					for (String key : map1.keySet()) {
						if (key.toString().equals("SGIS_CENSUS_DETAIL_DATA_ID")) {
							data_id2 = (String) map1.get(key);
							sgis_census_detail_data_id += data_id2;
						}
					}
				}
				List<HashMap<String, Object>> sidosigungucode = commonDao.sidosigungucode(mapParameter);
				for (HashMap<String, Object> map2 : sidosigungucode) {
					for (String key : map2.keySet()) {
						if (key.toString().equals("SGIS_CENSUS_SIDO")) {
							sgis_census_sido = (String) map2.get(key);
							mapParameter.put("sgis_census_sido_id", sgis_census_sido);
						} else if (key.toString().equals("SGIS_CENSUS_SIGUNGU")) {
							sgis_census_sigungu = (String) map2.get(key);
							mapParameter.put("sgis_census_sigungu_id", sgis_census_sigungu);
						}
					}
					// List result_sigungu = commonDao.sigungu(mapParameter);
					// String sigunguCd = (String)
					// data_sigungu.get("SGIS_CENSUS_SIGUNGU");//sgis_census_sigungu
					String sigunguCd = sgis_census_sigungu;
					// String sigungu_nm = (String) data_sigungu.get("sigungu_nm");
					// String sido_nm = (String) data_sigungu.get("sido_nm");
					String sigunguNm = "";
					String sigunguCd1 = sgis_census_sigungu;
					if (!"00000".equals(sigunguCd)) {
						mapParameter.put("totRegCd", sigunguCd);
						// if(sigungu_nm != null && sigungu_nm != "") sigunguNm = "(" + sido_nm + " " +
						// sigungu_nm + ")";
						// else sigunguNm = "(" + sido_nm + ")";
						sigunguCd += "_";
					} else {
						if (sgis_census_sido.equals("00")) {
							sigunguCd = "";
							mapParameter.put("totRegCd", sigunguCd);
						}	
						else {
							mapParameter.put("totRegCd", sgis_census_sido);
							sigunguCd = sgis_census_sido + "_";
						}
						sigunguCd1 = sgis_census_sido;
					}
					...
					String txt = "";
					String txt2 = "";
					String cdId = sgis_census_detail_data_id;
					if (Integer.parseInt(baseYear) < 2006)
						txt = "8차_대분류";
					else if (Integer.parseInt(baseYear) == 2016) {
						if (cdId.indexOf("cp_02") > -1 && cdId.indexOf("cp_07") > -1 || cdId.indexOf("cp_08") > -1
								|| cdId.indexOf("cp_09") > -1) {// 2016 전체 선택시 예외처리
							txt2 = "10차_대분류";
							txt = "9차_대분류";
						} else if (cdId.indexOf("cp_04") > -1 && cdId.indexOf("cp_07") > -1
								|| cdId.indexOf("cp_08") > -1 || cdId.indexOf("cp_09") > -1) {// 2016 전체 선택시 예외처리
							txt2 = "10차_대분류";
							txt = "9차_대분류";
						} else if (cdId.indexOf("cp_06") > -1 && cdId.indexOf("cp_07") > -1
								|| cdId.indexOf("cp_08") > -1 || cdId.indexOf("cp_09") > -1) {// 2016 전체 선택시 예외처리
							txt2 = "10차_대분류";
							txt = "9차_대분류";
						} else if (cdId.indexOf("cp_07") > -1 || cdId.indexOf("cp_08") > -1
								|| cdId.indexOf("cp_09") > -1) {
							txt2 = "10차_대분류";
						} else
							txt = "9차_대분류";
					} else if (Integer.parseInt(baseYear) < 2016)
					...
					//		+ census_output_area_year + "\\oa_cp\\oa_cp_" + sigunguCd1 + "_" + baseYear + "_"
					//		+ census_output_area_year;// 2000 ~ 2016
					String cpDir = "/DATA/docs/statsPotal/upload" + "/census/new_txt_data_" +
					census_output_area_year + "/oa_cp/oa_cp_" + sigunguCd1 + "_" + baseYear + "_"
					+ census_output_area_year;//2000 ~ 2016
					String cpBemFileName10 = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt2 + ")_종사자수" + sigunguNm
							+ ".txt";// 2016 10차(16년도 전체를 선택할시 예외처리)
					String cpBnuFileName10 = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt2 + ")_사업체수" + sigunguNm
							+ ".txt";// 2016 10차(16년도 전체를 선택할시 예외처리)
					String toFaFileName10 = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt2 + ")_총괄사업체수" + sigunguNm
							+ ".txt";// 2016 10차(16년도 전체를 선택할시 예외처리)
					String cpBem10 = cpDir + "/" + cpBemFileName10;
					String cpBnu10 = cpDir + "/" + cpBnuFileName10;
					String toFa10 = cpDir + "/" + toFaFileName10;
					
					// String cpBemDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_cp\\oa_cp_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 ~ 2016
					// String cpBnuDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_cp\\oa_cp_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 ~ 2016
					// String toFaDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_cp\\oa_cp_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 ~ 2016

					File createCpBemDir = new File(cpDir);
					if (!createCpBemDir.isDirectory() && sgis_census_data_id.equals("3"))
						createCpBemDir.mkdirs();/** 2019-05-09 김성연 자료대상에서 선택했을경우에만 디렉토리 생성 */
					...
					String cpBemFileName = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt + ")_종사자수" + sigunguNm
							+ ".txt";// 2000 ~ 2016
					String cpBnuFileName = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt + ")_사업체수" + sigunguNm
							+ ".txt";// 2000 ~ 2016
					String toFaFileName = txt1 + sigunguCd + baseYear + "년_산업분류별(" + txt + ")_총괄사업체수" + sigunguNm
							+ ".txt";// 2000 ~ 2016

					/*
					 * String cpBem = cpDir + "\\" + cpBemFileName; String cpBnu = cpDir + "\\" +
					 * cpBnuFileName; String toFa = cpDir + "\\" + toFaFileName;
					 */
					...
					//		+ census_output_area_year + "\\oa_ho\\oa_ho_" + sigunguCd1 + "_" + baseYear + "_"
					//		+ census_output_area_year;// 2000 2005 2010
					String gunYyyyDir = "/DATA/docs/statsPotal/upload" + "/census/new_txt_data_"
					+ census_output_area_year + "/oa_ho/oa_ho_" + sigunguCd1 + "_" + baseYear +
					"_" + census_output_area_year;//2000 2005 2010

					// String juYuDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_ho\\oa_ho_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String sizeDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_ho\\oa_ho_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toHoDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_ho\\oa_ho_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016

					File createGunYyyyDir = new File(gunYyyyDir);
					if (!createGunYyyyDir.isDirectory() && sgis_census_data_id.equals("2"))
						createGunYyyyDir.mkdirs();/** 2019-05-09 김성연 자료대상에서 선택했을경우에만 디렉토리 생성 */
					...
					if (Integer.parseInt(baseYear) >= 2015)
						gunYyyyFileName = txt1 + sigunguCd + baseYear + "년_노후년수별주택" + sigunguNm + ".txt";// 2015
																											// 2016
					else
						gunYyyyFileName = txt1 + sigunguCd + baseYear + "년_건축년도별주택" + sigunguNm + ".txt";// 2000
																											// 2005
																											// 2010
					String juYuFileName = txt1 + sigunguCd + baseYear + "년_주택유형별주택" + sigunguNm + ".txt";// 2000
																											// 2005
																											// 2010
																											// 2015
																											// 2016
					String sizeFileName = txt1 + sigunguCd + baseYear + "년_연건평별주택" + sigunguNm + ".txt";// 2000 2005
																										// 2010 2015
																										// 2016
					String toHoFileName = txt1 + sigunguCd + baseYear + "년_주택총괄_총주택(거처)수" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					...
					/*
					 * String gunYyyy = gunYyyyDir + "\\" + gunYyyyFileName; String juYu =
					 * gunYyyyDir + "\\" + juYuFileName; String size = gunYyyyDir + "\\" +
					 * sizeFileName; String toHo = gunYyyyDir + "\\" + toHoFileName;
					 */
					...
					//		+ census_output_area_year + "\\oa_ga\\oa_ga_" + sigunguCd1 + "_" + baseYear + "_"
					//		+ census_output_area_year;// 2000 2005 2010
					String gabuJumDir = "/DATA/docs/statsPotal/upload" + "/census/new_txt_data_"
					+ census_output_area_year + "/oa_ga/oa_ga_" + sigunguCd1 + "_" + baseYear +
					"_" + census_output_area_year;//2000 2005 2010

					// String gabuSedaDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_ga\\oa_ga_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toGaDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_ga\\oa_ga_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016

					File createGabuJumDir = new File(gabuJumDir);
					if (!createGabuJumDir.isDirectory() && sgis_census_data_id.equals("1"))
						createGabuJumDir.mkdirs();/** 2019-05-09 김성연 자료대상에서 선택했을경우에만 디렉토리 생성 */
					...
					String gabuJumFileName = txt1 + sigunguCd + baseYear + "년_점유형태별가구" + sigunguNm + ".txt";// 2000
																											// 2005
																											// 2010
					String gabuSedaFileName = txt1 + sigunguCd + baseYear + "년_세대구성별가구" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toGaFileName = txt1 + sigunguCd + baseYear + "년_가구총괄" + sigunguNm + ".txt";// 2000 2005
																										// 2010 2015
																										// 2016

					/*
					 * String gabuJum = gabuJumDir + "\\" + gabuJumFileName; String gabuSeda =
					 * gabuJumDir + "\\" + gabuSedaFileName; String toGa = gabuJumDir + "\\" +
					 * toGaFileName;
					 */
					...
					//		+ census_output_area_year + "\\oa_in\\oa_in_" + sigunguCd1 + "_" + baseYear + "_"
					//		+ census_output_area_year;// 2000 2005 2010
					String eduDir = "/DATA/docs/statsPotal/upload" + "/census/new_txt_data_" +
					census_output_area_year + "/oa_in/oa_in_" + sigunguCd1 + "_" + baseYear + "_"
					+ census_output_area_year;//2000 2005 2010

					// String inguDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String marryDir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// String toIn001Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toIn002Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toIn003Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toIn004Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toIn005Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016
					// String toIn006Dir = "C:\\DATA\\docs\\statsPotal\\upload" +
					// "\\census\\new_txt_data_" + census_output_area_year + "\\oa_in\\oa_in_" +
					// sigunguCd1 + "_" + baseYear + "_" + census_output_area_year;//2000 2005 2010
					// 2015 2016

					File createEduDir = new File(eduDir);
					if (!createEduDir.isDirectory() && sgis_census_data_id.equals("0"))
						createEduDir.mkdirs();/** 20190509 김성연 자료대상에서 선택했을경우에만 디렉토리 생성 */
					...
					String eduFileName = txt1 + sigunguCd + baseYear + "년_교육정도별인구" + sigunguNm + ".txt";// 2000 2005
																										// 2010
					String inguFileName = txt1 + sigunguCd + baseYear + "년_성연령별인구" + sigunguNm + ".txt";// 2000 2005
																										// 2010 2015
																										// 2016
					String marryFileName = txt1 + sigunguCd + baseYear + "년_성_혼인상태별인구" + sigunguNm + ".txt";// 2000
																											// 2005
																											// 2010
					String toIn001FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(총인구)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toIn002FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(평균나이)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toIn003FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(인구밀도)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toIn004FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(노령화지수)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toIn005FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(노년부양비)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					String toIn006FileName = txt1 + sigunguCd + baseYear + "년_인구총괄(유년부양비)" + sigunguNm + ".txt";// 2000
																												// 2005
																												// 2010
																												// 2015
																												// 2016
					...
					/*
					 * String edu = eduDir + "\\" + eduFileName; String ingu = eduDir + "\\" +
					 * inguFileName; String marry = eduDir + "\\" + marryFileName; String toIn001 =
					 * eduDir + "\\" + toIn001FileName; String toIn002 = eduDir + "\\" +
					 * toIn002FileName; String toIn003 = eduDir + "\\" + toIn003FileName; String
					 * toIn004 = eduDir + "\\" + toIn004FileName; String toIn005 = eduDir + "\\" +
					 * toIn005FileName; String toIn006 = eduDir + "\\" + toIn006FileName;
					 */
					...
					// ********************************************************************
					/** 2000 ~ 2016 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_01") > -1
							|| sgis_census_detail_data_id.indexOf("cp_02") > -1)) {
					...
					/** 2016 2017 10차 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_07") > -1)) {
						BufferedWriter fw_cpBem = new BufferedWriter(new FileWriter(cpBem10, false));
						StringBuilder str_cpBem = null;
						if (Integer.parseInt(baseYear) == 2016)
							mapParameter.put("baseYear", "9016");
						mapParameter.put("type", "cp_bem");
						List result_cpBem = commonDao.cpFile(mapParameter);
						str_cpBem = new StringBuilder();
						str_cpBem.append("base_year^tot_oa_cd^item^value");
						...
						for (int i = 0; i < result_cpBem.size(); i++) {
							...
							if (base_year.equals("9016"))
								base_year = "2016";
							str_cpBem.append(base_year);
							str_cpBem.append("^");
							str_cpBem.append(data.get("TOT_REG_CD"));
							str_cpBem.append("^");
							str_cpBem.append(data.get("GBN"));
					...
					// ********************************************************************
					/** 2000 ~ 2016 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_03") > -1
							|| sgis_census_detail_data_id.indexOf("cp_04") > -1)) {
					...
					/** 2016 10차 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_08") > -1)) {
						BufferedWriter fw_cpBnu = new BufferedWriter(new FileWriter(cpBnu10, false));
						StringBuilder str_cpBnu = null;
						if (Integer.parseInt(baseYear) == 2016)
							mapParameter.put("baseYear", "9016");
						mapParameter.put("type", "cp_bnu");
					...
					// ********************************************************************
					/** 2000 ~ 2016 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_05") > -1
							|| sgis_census_detail_data_id.indexOf("cp_06") > -1)) {
					...
					/** 2016 10차 */
					if (sgis_census_data_id.equals("3") && (sgis_census_detail_data_id.indexOf("cp_09") > -1)) {
						BufferedWriter fw_toFa = new BufferedWriter(new FileWriter(toFa10, false));
						StringBuilder str_toFa = null;
						if (Integer.parseInt(baseYear) == 2016)
							mapParameter.put("baseYear", "9016");
						List result_toFa = commonDao.toFaFile(mapParameter);
					...
					// **** 노후년수별주택 ************************************************
					// ********************************************************************
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
							|| Integer.parseInt(baseYear) > 2016)) { /** 2000 2005 2010 2015 2016 */
						if (sgis_census_data_id.equals("2") && sgis_census_detail_data_id.indexOf("ho_01") > -1
								|| sgis_census_detail_data_id.indexOf("ho_02") > -1) {
							BufferedWriter fw_gunYyyy = new BufferedWriter(new FileWriter(gunYyyy, false));
							StringBuilder str_gunYyyy = null;

							if (Integer.parseInt(baseYear) < 2015)
								mapParameter.put("type", "ho_yr");
							else
								mapParameter.put("type", "ho_pr");
							...
							for (int i = 0; i < result_gunYyyy.size(); i++) {
								...
								str_gunYyyy.append("^");
								if (Integer.parseInt(baseYear) < 2015)
									str_gunYyyy.append(data.get("NA"));
								else
					...
					if (baseYear.length() == 4 && ("2000*2005*2010").indexOf(baseYear) > -1) { /** 2000 2005 2010 */
						if (sgis_census_data_id.equals("1") && sgis_census_detail_data_id.indexOf("ga_01") > -1) {
							...
							for (int i = 0; i < result_gabuJum.size(); i++) {
								...
								str_gabuJum.append("^");
								str_gabuJum.append(data.get("NA"));
								fw_gabuJum.write(str_gabuJum.toString());
								fw_gabuJum.newLine();
								fw_gabuJum.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("1") && sgis_census_detail_data_id.indexOf("ga_02") > -1) {
							...
							for (int i = 0; i < result_gabuSeda.size(); i++) {
								...
								str_gabuSeda.append("^");
								str_gabuSeda.append(data.get("NA"));
								fw_gabuSeda.write(str_gabuSeda.toString());
								fw_gabuSeda.newLine();
								fw_gabuSeda.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("0") && sgis_census_detail_data_id.indexOf("in_05") > -1) {
							...
							for (int i = 0; i < result_toIn002.size(); i++) {
								...
								str_toIn002.append("^");
								str_toIn002.append(data.get("AVG_AGE"));
								fw_toIn002.write(str_toIn002.toString());
								fw_toIn002.newLine();
								fw_toIn002.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("0") && sgis_census_detail_data_id.indexOf("in_06") > -1) {
							...
							for (int i = 0; i < result_toIn003.size(); i++) {
								...
								str_toIn003.append("^");
								str_toIn003.append(data.get("PPLTN_DNSTY"));
								fw_toIn003.write(str_toIn003.toString());
								fw_toIn003.newLine();
								fw_toIn003.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("0") && sgis_census_detail_data_id.indexOf("in_07") > -1) {
							...
							for (int i = 0; i < result_toIn004.size(); i++) {
								...
								str_toIn004.append("^");
								str_toIn004.append(data.get("AGED_CHILD_IDX"));
								fw_toIn004.write(str_toIn004.toString());
								fw_toIn004.newLine();
								fw_toIn004.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("0") && sgis_census_detail_data_id.indexOf("in_08") > -1) {
							...
							for (int i = 0; i < result_toIn005.size(); i++) {
								...
								str_toIn005.append("^");
								str_toIn005.append(data.get("OLDAGE_SUPRT_PER"));
								fw_toIn005.write(str_toIn005.toString());
								fw_toIn005.newLine();
								fw_toIn005.flush();
							}
					...
					if (baseYear.length() == 4 && (("2000*2005*2010*2015*2016").indexOf(baseYear) > -1
						...
						if (sgis_census_data_id.equals("0") && sgis_census_detail_data_id.indexOf("in_09") > -1) {
							...
							for (int i = 0; i < result_toIn006.size(); i++) {
								...
								str_toIn006.append("^");
								str_toIn006.append("to_in_006");
								str_toIn006.append("^");
								str_toIn006.append(data.get("JUV_SUPRT_PER"));
								fw_toIn006.write(str_toIn006.toString());
								fw_toIn006.newLine();
								fw_toIn006.flush();
							}
	...
	private enum OptionParam {
		CENSUS_OUTPUT_AREA_YEAR, SGIS_CENSUS_ID, SGIS_CENSUS_DATA_ID
	}
