...
(function(W, D) {
	...
	$(document).ready(
			function() {
				...
				$DevfaqDetail.requestDetail();
				$('#modifyButton').click(
						function() {
							srvLogWrite("L0", "05", "02", "15", "", "");
							getConfirmPopup('확인', '수정하시겠습니까?', 'confirm');
							$('#ok_confirmPopup').click(
									function() {
										location.href = './../QA/DevfaqUpdate.html?POST_NO=' + POST_NO + "&searchWordType=" + searchWordType + "&searchWord="
