...
GPKISecureWeb.InstallPageURL = location.protocol +'//'+ location.host+ "/s-portalcnm/newGPKI/install.html";
...
GPKISecureWeb.DownloadURL = location.protocol +'//'+ location.host+ "/s-portalcnm/client/setup/";
GPKISecureWeb.DownloadWinFileName ="GPKISecureWebSetup"+".exe";
GPKISecureWeb.UrlSchemeServerURL = location.protocol +'//'+ location.host+ "/s-portalcnm/client/";
var isEmbedded = false;
var sessionid="";
var returnIndexPage = '/s-portalcnm/index.html';
