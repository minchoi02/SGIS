 ...
 *    
 */
public class DelTHBook extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelTHBook.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  relManageDao.deleteREL(req.getParameter(MustParam.SEARCH_WORD_List.name()).split(","));
