 ...
 *     
 */
public class DelPubData extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelPubData.class);
	@Resource
	private PubDataManageDao pubDataManageDao;
	@Override
	public String getApiId() {
		return "pubdatamanage_del";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  pubDataManageDao.deletePubData(req.getParameter(MustParam.DATA_List.name()).split(","));
