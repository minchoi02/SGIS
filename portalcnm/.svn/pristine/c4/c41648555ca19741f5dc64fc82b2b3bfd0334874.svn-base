...
/**   
 *
 * @ClassName: CheckLINKID
 * @Description： 일자리 통계항목 연계 ID 중복 체크
 *
 * @author 한광희
 * @date：2019.08.02    
 * @version V1.0      
 *     
 */
public class CheckLINKID extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(CheckLINKID.class);
	@Resource
	private WorkRoadStatsItemManageDao workRoadStatsItemManageDao;
	@Override
	public String getApiId() {
		return "workroadstatsitemmanage_checkLINKID";
	}
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return workRoadStatsItemManageDao.checkLINKID(paramMap);
