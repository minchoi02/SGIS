...
function engPopOpen() {
	window.open('http://sgis.kostat.go.kr/statistics_eng/html/index.jsp','eng','width=1024, height=698, toolbars=1, menubars=1, location=1, status=1, toolbar=1, scrollbars=1, resizable=1');
}
