...
public class GetReqBoardChart extends AbsAuth<Map>{
	/**
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			String searchYear = req.getParameter("searchYear");
			...
			resultMap.put("line", reqBoardDao.getLineChartData( searchYear ));
			resultMap.put("pie", reqBoardDao.getPieChartData( searchYear ));
