 ...
 * 
 */
public class SearchCommunityNotice extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchCommunityNotice.class);
	@Resource
	private CommunityNoticeManageDao communityNoticeManageDao;

	@Override
	public String getApiId() {
		return "communitymanage_search";
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			return communityNoticeManageDao.searchBoard(paramMap);
