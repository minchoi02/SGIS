 ...
 * 
 */
public class SearchBoard extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchBoard.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			return boardManageDao.searchBoard(paramMap);
	...
	private enum OptionParam {
		POST_TITLE, POST_CONTENT, REG_MEMBER_ID, PRIORITY_DISP_YN,MANAGER_NM, BOARD_CD
	}
