...
/*start*/
//liudandan
var _b5=(Math.ceil(_b3.pageNumber/_b3.links)-1)*_b3.links+1;
/*end*/
if(_b5<1){
_b5=1;
}
...
/*start*/
//liudandan
bb.first.linkbutton({disabled:((!_b3.total)||_b3.pageNumber<=_b3.links)});
/*end*/
}
if(bb.prev){
...
/*start*/
//liudandan
bb.last.linkbutton({disabled:(_b3.pageNumber>=(Math.ceil(_b4/_b3.links)-1)*_b3.links+1)});
/*end*/
}
_b8(_b0,_b3.loading);
};
...
/*start*/
//liudandan
if(_cb.pageNumber>_cb.links){
$(this).pagination("select",(Math.ceil(_cb.pageNumber/_cb.links)-2)*_cb.links+1);
}
/*endt*/
}
...
/*start*/
//liudandan
if(_cf.pageNumber<(Math.ceil(_d0/_cf.links)-1)*_cf.links+1){
$(this).pagination("select",Math.ceil(_cf.pageNumber/_cf.links)*_cf.links+1);
}
/*endt*/
}
