...
//			plainText = Disk.read("./Sample/CRYPT/Asymmetric/Message.dat");
			plainText = (new String("0000111122223333444455556666777788889999!!!!****")).getBytes();
	...
	public void AsymmetricKey() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert("./Sample/CRYPT/Asymmetric/rsa.der");
			priKey = Disk.readPriKey("./Sample/CRYPT/Asymmetric/rsa.key", "12345678");
			...
			cert = Disk.readCert("./Sample/CRYPT/Sign/kcdsa.der");
			priKey = Disk.readPriKey("./Sample/CRYPT/Sign/kcdsa.key", "12345678");
