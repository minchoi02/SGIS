 ...
 *   
 */
public class GetGridQuestion extends AbsAuth<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(GetGridQuestion.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return boardManageDao.getGridQuestion(getParameterMap(req));
