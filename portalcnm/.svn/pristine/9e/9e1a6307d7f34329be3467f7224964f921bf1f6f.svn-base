 ...
 *    
 */
public class DevDelBoard extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevDelBoard.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return boardManageDao.DevdeleteBoard(req.getParameter(MustParam.POST_NO_List.name()).toString().split(","));
