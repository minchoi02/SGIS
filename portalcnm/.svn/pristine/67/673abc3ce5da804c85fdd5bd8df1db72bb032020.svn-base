 ...
 *    
 */
public class DevDelBanner extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DevDelBanner.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return devFAQManageDao.deleteBanner(req.getParameter(MustParam.POST_NO_List.name()).toString().split(","));
