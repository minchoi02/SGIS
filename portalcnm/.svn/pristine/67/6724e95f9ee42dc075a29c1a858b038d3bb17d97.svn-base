						...
						<div class="apiPFont01">
							<table class="useTable" summary="자료 신청">
								...
								<tr>
									...
									<td>http://sgis.kostat.go.kr/SGisService/coordconversion	</td>
								</tr> 
								<tr>
...
&lt;xls:PortrayMapResponse&gt;
    &lt;xls:Map&gt;
      &lt;xls:Content format="image/png" width="640" height="480"&gt;
        &lt;xls:URL&gt;http://sgis.kostat.go.kr/SGisService/data/2011/08/10/20110810104911529008.png&lt;/xls:URL&gt;
      &lt;/xls:Content&gt;
    &lt;/xls:Map&gt;
  &lt;/xls:PortrayMapResponse&gt;
...
public class StaticsXml {
	...
	public String sgisApiStaticsXml(String requestXml) {
		final String apiurl = "http://sgis.kostat.go.kr/SGisService/getportraymap";
...
&lt;head&gt;
  ...
  &lt;script type="text/javascript"&gt;
	function aaaaopen(){
		var url = "http://sgis.kostat.go.kr/SGisService/getportraymap";
//요청문서 작성 시작
