 ...
 *   
 */
public class SearchGrid extends AbsGridQuery<Map> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(SearchGrid.class);
	@Resource
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			return boardManageDao.searchGrid(paramMap);
