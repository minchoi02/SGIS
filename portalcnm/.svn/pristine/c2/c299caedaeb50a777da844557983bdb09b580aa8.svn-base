...
function checkLogin(url){
      ...
      if(loginYn == 'Y')
        ...
        pop_login = window.open('https://sgis.kostat.go.kr/contents/member/pop_login.jsp?login_url='+url,'','width=355,height=255');
        pop_login.focus();
...
function menuOverOut(id){
     ...
     for(i=0; i<subMenu.length; i++){
       ...
       function topLogin(){
    	 pop_login = window.open('https://sgis.kostat.go.kr/contents/member/pop_login.jsp','','width=350,height=250,toobar=0,status=0,fullscreen=0,menubar=0,scrollbars=0,resizable=0');
       }
  ...
  <h1><a href="/" ><img style="border: 0px; width: 178px; height: 38px;"  src="/contents/inc/img/logo.gif"  alt="통계지리정보서비스" /></a></h1>
   <table style="border: 0px; width: 970px; height: 85px;" cellpadding="0" cellspacing="0" id="table1">
	<tr>
		...
		<img  style="width: 3px; height: 13px;border: 0px;"  src="/contents/inc/img/line_01.gif"  alt="" />&nbsp;
		<!--
		<a href="http://sgis.kostat.go.kr/statistics_eng/html/index.jsp"><img border="0" src="/contents/inc/img/button_4.gif" alt="ENGLISH" /></a>&nbsp;
		<img  style="width: 3px; height: 13px;border: 0px;"  src="/contents/inc/img/line_01.gif"  alt="" />&nbsp;
		-->
