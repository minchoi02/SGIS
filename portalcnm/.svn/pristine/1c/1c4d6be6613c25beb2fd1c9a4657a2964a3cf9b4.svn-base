 ...
 * 
 */
public class DelThemaMap extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelThemaMap.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		try {
			...
			if (STAT_THEMA_MAP_ID_List != null) {
				success = themaMapManageDao.deleteThemaMap(STAT_THEMA_MAP_ID_List.split(","));
			}
			return success;
