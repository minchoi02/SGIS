var GPKISecureWebJS = (function(context) {
	...
	GPKISecureWebJS.prototype.Init = function(callback) {
		var scriptList = [["/s-portalcnm/client/gpkijs_1.2.1.3.min.js",	"gpkijs"],
						  ["/s-portalcnm/client/GPKIJS_Crypto.js",		"GPKIJS_Crypto"],
						  ["/s-portalcnm/client/GenerateContent.js",		"GenInterface"]];
