...
public class GetPOICorpClassCODE extends AbsGridQuery<Map>{

	private static final Logger logger = Logger.getLogger(GetPOICorpClassCODE.class);
...
//			if(SEARCH_WORD != null && SEARCH_WORD.getBytes().length >10)
//				throw new ApiException("입력값을 체크 해 주세요");
			...
			return themaMapManageDao.getPOICorpClassCODE(paramMap);
