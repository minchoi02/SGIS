 ...
 *    
 */
public class DelMobileManage extends AbsAuth<Success> {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(DelMobileManage.class);
	@Resource
	...
	public Success executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			return  mobileManageDao.deleteMobileManage(req.getParameter(MustParam.MOBILE_ID_List.name()).split(","));
