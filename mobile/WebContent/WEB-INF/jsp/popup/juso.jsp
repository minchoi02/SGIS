...
<% 
	...
	String confmKey = "U01TX0FVVEgyMDIwMDYyOTE3MjU0ODEwOTkxMTg="; // 검색API 승인키
...
<script type="text/javascript" src="/mobile/resources/plugins/jquery/jquery-1.12.0.min.js"></script>
<script type="text/javascript" src="/js/util/addrlink.js"></script>
