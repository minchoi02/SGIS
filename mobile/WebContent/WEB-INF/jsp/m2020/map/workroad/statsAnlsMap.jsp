...
<body>
	<div class="contentBox">
		<!-- 지도 영역 START -->
		<div class="MapArea">
			<div class="Map" style="overflow: hidden; position: fixed; top: 100px; width: 100%; height:calc(100% - 100px)">
				<div id="map"></div>
			</div>
		</div>
		<!-- 지도 영역 END -->
		...
		<div class="nav-layer"> <!--2022-11-04 z-index 추가-->
			<ul>
				...
				<li class="on3"><a href="${ctx }/m2020/map/workroad/statsAnlsMap.sgis">일자리통계정보</a></li> <!-- 2022-11-24 class 추가  -->
			</ul>
		</div>
	...
	<%-- 
		...
		<!-- 2020.09.08[한광희] 통계정보 하위 스와이프 변경 START -->
		<div class="swiper-container01 nav_h_type statsMenuWrap3" id="touchFlow" style=" position: relative; width : 100%; margin-top: 60px;"> <!--2022-11-04 z-index 추가-->
	    ...
	    <!-- 업종 대분류 값 START -->
	    <div class="statsSelect" style="position: relative; " id="statsSelectDiv"> <!--2022-11-04 z-index 추가-->
	    ...
	    <!-- 업종 중분류 값 START -->
		<div class="statsSelect" style="position: relative; " id="statsSelectDiv2"> <!--2022-11-04 z-index 추가-->
		...
		<!-- 업종 중분류 값 END -->
		<!-- 종사자 규모 값 START -->
		<div class="statsSelect" style="position: relative; " id="statsSelectDiv3"> <!--2022-11-04 z-index 추가-->
		...
		<div class="statsSelect" style="position: relative; display: none; " id="statsSelectDiv4"></div>	<!-- 2020.09.15[한광희] 일자리만족도  --> <!--2022-11-04 z-index 추가-->
        	...
        	<ul class="tab">
		    	<li class="depth" id="3">
	          	...
	          	<li class="depth" id="4">
	            	...
	            	<div id="statsAnalsChartMain2" style="position: absolute; z-index:900; top: 140px;"></div>
	          	</li>
	    	</ul>
	    </div>
...
<!--         	<div class="statsGraopTitle" id="statsGraopTitle">통계그래프</div> --> <!--2022-11-15 수정-->
        	...
        	<div id="statsAnalsChartMain3" style="position: absolute; z-index:900; padding-top: 10px;"></div>
        </div>
        <!-- 일자리추이, 일자리만족도 차트 영역 END -->
        
        <!-- 일자리추이 설명팝업 추가. START -->
        <!-- 2020.09.25[한광희] 일자리추이 설명 팝업 수정 START -->
        <div class="popWrap" id="alertBox" style="display: none;">
        	<div class="popBox">
				<div class="popHeader">
