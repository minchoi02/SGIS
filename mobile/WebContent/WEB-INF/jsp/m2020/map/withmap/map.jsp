...
<html lang="ko">
	...
	<body>
		...
		<div id="map-container" class="ContArea Community_Insert" style="padding:0;">
			<div class="Community_cont">
				<div id="community-info" class="MaptitArea">
					<div class="Maintit">
						...
						<p class="">${community.usr_id }</p> <!-- 개설자 -->
						<div class="titInfo">
			...
			<div id="map" style="position: absolute; top:101px; left: 0; width: 100%; height: calc(100vh - 200px); z-index: 100;">
			<!-- 생활환경 정보 START -->
			...
			<div class="Community_map" style="width:100%; bottom:0px; position:absolute; z-index:999;">
				...
				<div class="Btnarea" id="statsMeCatalogBtn" style="">
					...
					<button class="" type="button" onclick="javascript:srvLogWrite('O0', '20', '02', '05', '', '');location.href='${ctx }/m2020/map/withmap/communityMap.sgis'"><img src="/mobile/resources/m2021/images/map/i_result--arrow.png" alt="이전" width="20" /></button>
					...
					<div id="all-community" class="" style="height: 0px;">	<!-- 2020.09.09[신예리] 이전 버튼 추가로 인한 사이즈 수정 --> 
						<form id="community-poiList" class="search-result" style="position:relative; z-index:19999; margin:0 !important;"> 
