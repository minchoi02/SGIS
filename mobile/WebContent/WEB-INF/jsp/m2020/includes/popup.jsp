...
<div id="common_popup_alert" class="popWrap" style="top: 100px; width: 240px; display: none;"> <!--2022-11-04 left값 삭제-->
	...
	<div class="popBox">
		<div class="popHeader">
			<!-- 2020.12.07 close 버튼 삭제 -->
			<button id="common_popup_alert_close" class="btn_popClose" type="button" title="닫기" style="display:none;"></button> <!-- 2020.09.08 [신예리] 대체텍스트 추가 -->
		</div>
...
<div id="common_popup_confirm" class="popWrap" style="width: 240px; display: none;">
	<div class="i_pop pAlert"></div>
	<div class="popBox">
		<div class="popHeader" style="display: none;">
		...
		<div class="popContentBox">
			...
			<div class="popBtnBoxCurrent">
					...
					<button id="common_popup_confirm_ok" class="btn_popType3" type="button">확인</button>
				</div>
		</div>
	</div>
</div>
...
<div id="common_popup_location" class="popWrap" style="display:none;">
	...
	<div class="popBox">
		...
		<div class="popBtnBoxLocation" style="height:35px">
				<button id="common_popup_location_ok" class="btn_popType3" type="button">허용</button>
				<button id="common_popup_location_cancel" class="btn_reset" type="button" style="margin:0 0 0 5px">허용 안함</button>
		</div> 
	</div>
</div>
<!--위치동의 팝업 END -->
...
<div id="todayStatusPopup" class="popWrap" style="width: 315px; display: none;">
	...
	<div class="popBox" style="padding-bottom: 10px;">
		<div class="popHeader">
		<span class="popTitle" style="">오늘의 구인현황</span><span class="popTitleSpan" id="todayStatusPopup_adm_nm">(전국)</span> 
