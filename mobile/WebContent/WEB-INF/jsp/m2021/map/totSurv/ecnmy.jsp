...
<body>
<style>
.dashboard__statistics > ul > li:nth-child(1) { border:1px solid #e0e0e0; border-radius:5px 5px 0 0 ;  width:100%;}
...
.dashboard__statistics > ul > li:nth-child(4) { border:1px solid #e0e0e0; border-top:0px; border-radius:0 0 5px 5px; width:100%;}
</style>
	<div id="summary-container" class="dashboard__statistics">
		<!-- <h3 class="dashboard__statistics__title dashOpen"><span data-id="ecnmy-name">9차 산업분류</span> 사업체 총괄</h3> -->
		<ul>
