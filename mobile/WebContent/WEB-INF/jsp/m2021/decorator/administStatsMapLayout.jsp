...
<html lang="ko">
<head>
	<title>[행정통계시각화지도] SGIS plus mobile</title>
...
$(document).ready(function(){
	...
	if(theme == newly){
		$(".nav-layer li:nth-child(1)").addClass("on3");
	}
})
</script> -->
	...
	<div class="container">
		...
		<%-- 	<div class="map__above d-flex" style="justify-content:flex-end;">	
			...
			<div class="nav-layer" style="width:140px !important;">
				<ul>
					<li id="newly"><a href="/mobile/m2021/map/administStats.sgis?theme=newly" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-신혼부부통계', '')">신혼부부통계</a></li>
					<li id="house"><a href="/mobile/m2021/map/administStats.sgis?theme=house" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-주택소유통계', '')">주택소유통계</a></li>
					<li id="middl"><a href="/mobile/m2021/map/administStats.sgis?theme=middl" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-중·장년층행정통계', '')">중·장년층행정통계</a></li>
					<li id="retun"><a href="/mobile/m2021/map/administStats.sgis?theme=retun" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-귀농어·귀촌인통계', '')">귀농어·귀촌인통계</a></li>
					<li id="more1"><a href="/mobile/m2021/administStats.sgis?theme=more1" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-일자리행정통계', '')">일자리행정통계</a></li>
					<li id="more2"><a href="/mobile/m2021/administStats.sgis?theme=more2" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-퇴직연금통계', '')">퇴직연금통계</a></li>
					<li id="more3"><a href="/mobile/m2021/administStats.sgis?theme=more3" onclick="javascript:srvLogWrite('O0', '51', '01', '08', '행정통계 시각화 지도-임금근로 일자리 동향', '')">임금근로 일자리 동향</a></li>
				</ul>
			</div>
			<div id="administStatsRegionPop" class="popWrap region" style="display:none;">
				<div class="popBox">
					<div class="popHeader">
			...
			<div id="year-container" class="option__container" style="display:none;">
				<div class="popBox">
					<div class="popHeader">
						...
						<button id="common_popup_year_close" class="btn_popClose" type="button">
<!-- 							<svg width="15" height="15" viewBox="0 0 15 15" fill="#000" xmlns="http://www.w3.org/2000/svg">
								<path d="M1 1L13 13" stroke="black" stroke-linecap="round" stroke-linejoin="round"></path>
								<path d="M13 1L1 13" stroke="black" stroke-linecap="round" stroke-linejoin="round"></path>
							</svg> -->
	...
	<!-- 				<div id="map-navigator-sido"></div> -->
			...
			<!--[2022-10-17] 지도 저장 수정  -->
			<div style="position:absolute; z-index:300; right:0px; bottom:68px">
