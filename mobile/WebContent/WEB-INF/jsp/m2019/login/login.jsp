...
<meta name="title" content="로그인">
	...
	<!-- 기본 js -->
	<script src="${ctx }/resources/m2019/js/login/login.js"></script>
</head>
<body>
	<div class="loginWrap">
		<button id="loginIdBack" class="btn_forward" type="button">이전</button>
		<div class="loginTitle">
			LOGIN
			<p>(통합회원)</p>
		</div>
		<div class="loginDesc">
			회원님, 로그인을 하시면<br> 맞춤형 채용공고정보 서비스를 이용하실 수 있습니다.
		</div>
		<div class="loginBox">
		...
		<div class="loginDesc" style="text-align: center;">
			아직 회원이 아니시면 통합회원 가입 후 이용해주세요.<br> (통합회원 가입은 PC버전에서만 가능합니다.)
		</div>
		<div class="goPcv">
			<button id="loginPcVerMovement" class="btn_goPCV" type="button">PC 버전 이동</button>
		</div>
