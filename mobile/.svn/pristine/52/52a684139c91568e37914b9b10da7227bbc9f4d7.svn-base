...
<script src="${ctx }/resources/m2020/js/common/map/statsMe/legendInfo.js"></script>
<script src="${ctx }/resources/m2020/js/common/map/statsMe/map.js"></script>--%>
<script src="${ctx }/resources/m2020/js/common/catchmentArea/common.js"></script>

<script src="${ctx }/resources/js/common/censusApi.js"></script>

<script src="${ctx }/resources/js/common/mapNavigation.js"></script>
<script src="${ctx }/resources/js/common/chart.js"></script>
<script src="${ctx }/resources/js/common/catchmentArea/poi.js"></script>
