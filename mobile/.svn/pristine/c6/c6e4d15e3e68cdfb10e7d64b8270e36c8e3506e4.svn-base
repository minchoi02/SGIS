...
<body>
	...
	<div class="nav-layer">
		<ul>
			...
			<li class="on3"><a href="${ctx }/m2020/map/biz/bizMap.sgis">우리동네 생활업종</a></li> <!-- 2022-11-24 class 추가  -->
	...
	<!-- 메뉴 버튼 Swiper END -->
	<style>
	.nav-layer2 { width:56px; position:absolute; z-index:500; top:4px; left:142px; background-color:#fff; border:1px solid #757678; box-sizing:border-box; font-size:13px; color:#3d3d3d; display:none; }
	.nav-layer2 #biztab div { box-sizing:border-box; padding:5px 10px;}
	.nav-layer2 #biztab div.on {background-color: #F2F2F2; color: #2277F2;} <!-- 2022-11-24 css 추가 -->
	<!-- 2022-11-29 css 수정 -->
	...
	.nav-layer3 { }
	.nav-layer3 .bizItemBox {display:none; position: absolute; z-index: 500; top: 4px; left: 203px; background-color: #fff; border: 1px solid #757678; box-sizing: border-box; font-size: 13px; color: #3d3d3d; }
	.nav-layer3 .bizItemBox div { box-sizing:border-box; padding:5px 10px;}
	.nav-layer3 .bizItemBox div.on {background-color: #F2F2F2; color: #2277F2;} <!-- 2022-11-24 css 추가 -->
	</style>
		...
		<div class="MapArea" style="min-height:500px;">
			...
			<div class="nav-layer2" style="">
				<div class="" id="biztab">
					...
					<!-- 2022-11-24 class 추가 -->
<!-- 					<div class="on" data-index="1">음식</div> 
					...
					<!-- 2022-12-07 목록명 변경 -->
					<div class="on" data-index="1">음식</div>
					<div class="" data-index="2">소매</div>
					<div class="" data-index="3">생활</div>
					<div class="" data-index="4">숙박</div>
					<div class="" data-index="5">여가</div>
					<div class="" data-index="6">교육</div>
					<div class="" data-index="7">의료</div>
					<div class="" data-index="8">공공</div>
		    ...
		    <div class="nav-layer3" id="bizItem">
		    	...
		    	<div style="display: block;" id="bizItem_1">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_5001" name="theme_cd" data-id="5001">한식</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_2">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_1001" name="theme_cd" data-id="1001">인테리어</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_3">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_1002" name="theme_cd" data-id="1002">목욕탕</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_4">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_4001" name="theme_cd" data-id="4001">호텔</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_5">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_1010" name="theme_cd" data-id="1010">PC방</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_6">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_1003" name="theme_cd" data-id="1003">교습학원</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_7">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_9003" name="theme_cd" data-id="9003">병원</div> <!-- 2022-11-24 class 추가 -->
				...
				<div style="display: none;" id="bizItem_8">
					<div class="bizItemBox">
						<div class="on" id="theme_cd_6001" name="theme_cd" data-id="6001">우체국</div> <!-- 2022-11-24 class 추가 -->
