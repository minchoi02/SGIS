...
<body>
	...
	<div class="nav-layer">
		<ul>
			...
			<li class="on3"><a href="${ctx }/m2020/map/house/houseSearchMap.sgis">간편동네찾기</a></li> <!-- 2022-11-24 class 추가  -->
	...
	<div class="contentBox" id="houseSearchMapArea">
		<div class="MapArea">
			<!-- 지도 영역 START -->
			<div class="Map" style="overflow: hidden; position: fixed; top: 101px; width: 100%;z-index:10; ">
				<div id="map"></div>
			</div>
			<!-- 지도 영역 END -->
...
<!-- 			<div id="lifeEnvironmentToggle" class="btn_infoView infoOff" style="z-index: 990"></div> -->
			...
			<div class="resultWrap">
				...
				<div class="result_list2" id="result_list2" style="bottom: 0 !important;">
					...
					<div class="gridWrap" id=house_list_div style="height: 250px;">
						 <!-- <ul>
	...
	<div class="houseWrap" style="background-color: #fff; position: fixed; top: 100px; width: 100%; height: calc(100vh - 100px); z-index: 490; overflow: hidden; box-sizing:border-box; padding:10px; border-top:3px solid #112B48;"  id="search-item-box">
