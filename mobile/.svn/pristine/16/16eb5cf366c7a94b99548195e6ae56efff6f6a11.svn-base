...
<head>
	...
	<%@include file="/WEB-INF/jsp/m2020/includes/includeStatsMapHeaderFile.jsp" %>
...
<body>
	...
	<div class="Wrap">
		<!-- <div class="Header"> -->
			<%@include file="/WEB-INF/jsp/m2020/includes/header.jsp" %>
		<!-- </div> -->
		<div class="Content">
			<sitemesh:write property='body'/>
		</div>
	</div>
	<%@include file="/WEB-INF/jsp/m2020/includes/popup.jsp" %>
</body>
</html>