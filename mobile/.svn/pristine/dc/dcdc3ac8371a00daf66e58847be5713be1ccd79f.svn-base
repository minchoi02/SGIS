...
<body>
	<div class="contentBox">
		<!-- 지도 영역 START -->
		<div class="MapArea">
			<div class="Map" style="overflow: hidden; position: fixed; top: 100px; width: 100%; height:calc(100% - 230px)">
				<div id="map"></div>
			</div>
		</div>
		<!-- 지도 영역 END -->
		...
		<div class="nav-layer">
			<ul>
				...
				<li class="on3"><a href="${ctx }/m2020/map/workroad/todayStatusMap.sgis">오늘의구인현황</a></li> <!-- 2022-11-24 class 추가  -->
