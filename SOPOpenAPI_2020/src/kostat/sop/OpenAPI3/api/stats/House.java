...
* 김현태, 1.1, 2016/08/31 SRV_DT_HOUSESGG_2015, SRV_DT_HOUSEREG_2015 테이블 컬럼 변경에 따른 API 수정.
* 나재웅, 1.2, 2016/09/09 house_area_cd 파라미터의 값이 다중으로 들어올 수 있도록 API 수정 
* </pre>
* 
* @author 심홍헌
...
public class House extends AbsAuthAPI< List >
{
		...
		try
		{
			...
			if( year > 2010 && strAreaType.equals( "0" ))
			{
				...
				if(zoom != null && !"".equals(zoom) && !"bnd_grid".equals(bnd_grid)) { //mng_s 그리드이면
					...
					result = session.selectList( "stats.house2015", mapParameter );
				}
