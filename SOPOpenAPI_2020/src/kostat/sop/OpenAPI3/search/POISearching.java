...
public class POISearching extends AbsSearchingInMultipleIndexSearcher
{
	//private static String strIndexPath = "D:/project/kostate_dev/test/index";
	private String strIndexPath;//"D:/project/kostate_dev/test/poiindex";
//	@Override
...
//	}
	...
	public POISearching(String path){
		this.strIndexPath = path;
		/*try
		{
...
//	};
	...
	@Override
	public void initIndexSearcherMap() throws IOException
	{
