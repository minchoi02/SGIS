...
public class GeoIndexingFromDBHandler extends AbsEnumBaseIndexHandler< Map<String, Object> > 
{
	private final Log logger = LogFactory.getLog( GeoIndexingFromDBHandler.class );
