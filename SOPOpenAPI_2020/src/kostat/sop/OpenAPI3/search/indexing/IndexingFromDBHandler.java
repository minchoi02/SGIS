...
public class IndexingFromDBHandler extends AbsEnumBaseIndexHandler< Map<String, Object> > 
{
	private final Log logger = LogFactory.getLog( IndexingFromDBHandler.class );
