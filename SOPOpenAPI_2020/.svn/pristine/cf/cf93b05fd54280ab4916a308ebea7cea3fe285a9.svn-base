...
public class ApiException extends AbsAPIException {
	...
	public ApiException(Throwable t) {
		super("서버에서 처리 중 에러가 발생하였습니다.\n현상이 반복될 경우 고객센터(1899-0627)로 문의하시기 바랍니다.", COMM_ERR_CODE.ERR_DEFAULT.getErrCode(), t);
	}	

	public ApiException(COMM_ERR_CODE parmErrCd, Throwable t) {
		super("서버에서 처리 중 에러가 발생하였습니다.\n현상이 반복될 경우 고객센터(1899-0627)로 문의하시기 바랍니다.", parmErrCd.getErrCode(), t);
	}
	...
	public enum COMM_ERR_CODE
	{
		...
		, REDIS_TIME_OUT	(-402)	// REDIS TIME OUT.
