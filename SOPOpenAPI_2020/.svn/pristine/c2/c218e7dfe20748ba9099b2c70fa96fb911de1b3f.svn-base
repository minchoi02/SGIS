 ...
 *
 */
public enum GeocodeIndexFieldDefineEnum implements IIndexFieldDefine
{	
	pnu	            			(0, TextField.class),  
	bd_mgt_sn					(1, TextField.class), 
	...
	pcl		    				(24, StringField.class),
	x		    				(25, TextField.class),
	y		    				(26, TextField.class),
	origin_xy					(27, StringField.class),
	master_db_update			(28, TextField.class);
	...
	private GeocodeIndexFieldDefineEnum( int index )
	{
		this(index, Field.Store.YES, StringField.class, String.class);
	}
	
	private GeocodeIndexFieldDefineEnum( int index, Class<? extends Field> clz)
	{
		this(index, Field.Store.YES, clz, String.class);
	}
	
	private GeocodeIndexFieldDefineEnum( int index, Store store, Class<? extends Field> clz, Class valueType )
	{
