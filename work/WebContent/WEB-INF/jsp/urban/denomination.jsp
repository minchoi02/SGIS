...
$(document).ready(function(){
	let api_url = "/api/urban/getDnmtList.do"
...
<div class="container">
    <div class="content_new">
		<!-- @@block content -->
		<div class="sub-title">
<!-- 			<strong class="home">도시/준도시명 관리</strong> -->
			<h2>도시/준도시명 관리</h2>
<!-- 			<h3>도시/준도시명 관리</h3> -->
		</div>
		<div class="srch-form">
					...
					<div class="col col-sm12">
						<table cellpadding="0" cellspacing="0" border="0" width="100%" class="searchTable">
							<tr>
								...
								<td colspan="2">
									<span class=""><input type="date" name="startDay" id="startDay" ></span> ~
									<span class=""><input type="date" name="endDay" id="endDay" ></span>
								</td>
								<td>
			...
			<div class="row">
				<div class="cols">
					...
					<div class="col col-sm12 newCreate" style="display: none">
						...
						<button class="btn lager line cancelBtn">취소</button>
						</div>
					</div>
				</div>
					</div>
