	...
	<div class="row">
		<div class="cols">
			<div class="col col-sm11">
				<div class="in-box">
					<span class="inputs"><input type="text" name="searchText" id="metaWordSearchText" placeholder="검색어를 입력해주세요"></span>
				</div>
			</div>
			...
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									<button type="button" id="deleteBtn">일괄등록</button>
									<button type="button" id="deleteBtn">엑셀다운로드</button>
									<button type="button" onclick="location.href='metaWordNew'">+ 용어등록</button>
								</div>
								<span class="select"> 
						...
						<table id="metaWorTable">
							<tbody>
							</tbody>
						</table>
					</div>
					<div class="pageArea"><span id="metaWordPage"  class="pages paging"></span></div>
				</div>
			</div>
		</div>
	</div>
