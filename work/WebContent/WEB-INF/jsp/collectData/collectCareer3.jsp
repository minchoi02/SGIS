...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/work/collectCareer3.js"></script>
	
	<!-- mng_s 2019. 06. 04 j.h.Seok -->
	<script>
		$(document).ready(
			function() {
				$collectCareer3.request.doReqcollectCareerList(0);	
...
<div class="sub-title">
  ...
  <h2>이력관리 현황</h2>
  <h3>변동되는 법정동코드와 주소사전에 대한 이력관리 현황을 알 수 있습니다</h3>
</div>
<div class="tabs">
  <ul>
  	<!-- <li><a href="collectCareer">품질점검 이력관리</a></li> -->
  	<li><a href="collectCareer2">법정동 이력관리</a></li>
  	<li class="is-active"><a href="collectCareer3">주소사전 이력관리</a></li>
  </ul>
</div>
    ...
    <div class="cols">
      <div class="col col-1">
        <div class="in-box">
          <div class="tbs1">
            <div class="tb-tit">
            	주소사전 데이터 목록 : <em id="cnt-page" class="total"></em>
              <div class="tit-utils">
