						...
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									...
									<button id="btnExec" type="button">즉시실행</button>
									<button id="btnStop" type="button">작업정지</button>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td colspan="3">
										<span class="inputs"><input type="text" id="prj_name" placeholder="업무명"  value="자료제공 총괄"></span>
									</td>
								</tr>				
								<tr>
									<th>작업예약</th>
