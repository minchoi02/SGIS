...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/work/collectCareer2.js"></script>
	
	<!-- mng_s 2019. 06. 04 j.h.Seok -->
	<script>
		$(document).ready(
			function() {
				$collectCareer2.request.doReqcollectCareerList(0);	
...
<div class="tabs">
  <ul>
  	...
  	<li class="is-active"><a href="collectCareer2">법정동 이력관리</a></li>
    ...
    <div class="cols">
      <div class="col col-1">
        <div class="in-box">
          <div class="tbs1">
            <div class="tb-tit">
            	법정동 데이터 목록 : <em id="cnt-page" class="total"></em>
              <div class="tit-utils">
