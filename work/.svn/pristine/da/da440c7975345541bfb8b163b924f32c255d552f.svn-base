...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/work/prjUnitModify.js"></script>
						...
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnPrev" type="button"><< 이전 작업</button>
									<button id="btnNext" type="button">다음 작업 >></button>
									<button id="btnPreview" type="button">데이터 미리보기</button>
