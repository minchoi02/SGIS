...
<script>
	$(document).ready(function(){
		...
		let apiUrl = "/api/urban/getTimeSeriesDetail.do";
		$urbar.request.doReqPrjSetDetailInfo(prKey,apiUrl,3);
	})
</script>
</head>
<body>
				...
				<div class="cols">
					<div class="col col-1">
						<div class="in-box">
									...
									<tbody>
										<tr id="sIdx_0">
											...
											<td>
												...
												<button class="cBlue">상세내역</button>
											</td>
										</tr>
									</tbody>
								</table>
							...
							<div class="tfBtnBox">
								<button class="btnStyle bgGray" id="tsListBtn">목록</button>
							</div>
