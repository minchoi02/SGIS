...
<head>
  ...
  <script src="/js/lvs/rSlider.min.js"></script>
   ...
   <script src="/js/lvs/lvsPageFunc1.js"></script>
   <script src="/js/lvs/lvsPageFunc2.js"></script>
    ...
    <div class="extend_data_wrap active exBoard" id="extendBoard">
        ...
        <div class="extend_data_header" data-attr="header">
            ...
            <div class="extend_panel">
                <button class="data_player play" type="button" name="button" data-status="play"
                    onclick="sliderTimerStart()">
                    <i class="icon controller"></i>
                </button>
                <button class="data_player pause" type="button" name="button" data-status="pause"
                    onclick="sliderTimerPause()">
                    <i class="icon controller"></i>
                </button>
