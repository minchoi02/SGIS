...
<html lang="ko">
	<head>
	    ...
	    <!-- <link rel="stylesheet" type="text/css" href="/css/tutorial/common.css"> 리디자인에 따른 주석처리 - 2019.01.22	ywKim	변경 -->
        ...
        <!-- 2018-12-21 정책통계지도 > 툴박스 지역컨텐츠 위치. -->
        ...
        <style>
        	...
        	.containerBox{top:105px;}
    	   	...
    	   	/* #quickBox-01 {width: 280px; top: 70px; border-right: 1px solid #dcdcdc;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-01 .subj{background: #f5f5f5; border-bottom: 1px solid #dcdcdc;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-01 .scrollBox{height:calc( 100% - 90px );} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-01 #bottomService{position: static; float: right; margin-right: 10px;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	#view1 .sceneRela .interactiveBar {padding: 0;}
    	   	#companyClassListDiv {top: 70px;}
    	   	#kosisDetailDiv {top: 70px;}
    	   	#quickBox_2depth {top: 69px; border-right: 1px solid #dcdcdc;}
    	   	#quickBox_2depth .subj{background: #f5f5f5; height: 37px;}
    	   	#quickBox_2depth .mCustomScrollbar .mCSB_container{width: 279px;}
    	   	#quickBox_2depth .scrollBox{height:calc( 100% - 90px );}
    	   	#quickBox_2depth .stepBox ul > li .ar{margin-right: 10px;}
    	   	/* 2018-12-26 데이터통계 작성화면 UI 맞추기 (2019-01-02 추가) */
    	   	/* #quickBox-02 {width: 280px; top: 70px; border-right: 1px solid #dcdcdc;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-02 .subj{background: #f5f5f5; border-bottom: 1px solid #dcdcdc; line-height: 35px; height: auto;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-02 .scrollBox{height:calc( 100% - 90px );} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	/* #quickBox-02 #bottomService{position: static; float: right; margin-right: 10px;} 리디자인에 따른 주석처리 - 2019.01.22	ywKim */
    	   	#view2 .sceneRela .interactiveBar {padding: 0;}
    	   	#quickBox2_2depth {top: 70px; border-right: 1px solid #dcdcdc;}
    	   	#quickBox2_2depth .subj{background: #f5f5f5; height: 35px;}
    	   	#quickBox2_2depth .normalBox2{height: calc( 100% - 90px );}
    	   	#quickBox2_2depth #mCSB_8_container{width:280px !important;}
    	   	#quickBox2_3depth {top: 70px; border-right: 1px solid #dcdcdc;}
    	   	#quickBox2_3depth .subj{background: #f5f5f5; height: 35px;}
    	   	#quickBox2_3depth .scrollBox{height:calc( 100% - 90px );}
    	   	
    	   	/* 2019-01-02 전국사업체조사 - 테마업종 선택시 제대로 된 목록 이름이 나오지 않음. */
    	   	#poiBtnList .poiBtn a.ellipsis{width: 100%;}
    	   	#poiBtnList .poiBtn a.sqdel{right: 6px; top: 6px;}
    	   	
    	   	/* 2019-01-02 연도 및 메뉴선택 항목에서 화살표가 없어서 선택 가능한지에 대한 인식이 힘듦. */
    	   	#policyMapUploadForm select{-webkit-appearance: menulist;}
        </style>
	</head>
					...
					<div class="sceneBox on" id="view1" style="width:50%">
						<div class="sceneRela">
							<div class="toolBar">
								<h2>정책통계지도</h2>
								<!-- 2018-12-21 정책통계지도 > 툴박스 지역컨텐츠 위치. -->
								<div class="navi_title" id="naviTitle" style="margin-left: 140px;"></div>
