...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '09', '00', '', '서비스 소개');
        });
    </script>   
		...
		<div class="container">
			...
			<div class="leftWrap">
				...
				<div class="leftmenu">
					<ul>
						...
						<!-- mng_s 20200402 이진호 / 도움말 현행화 및 중복 컨텐츠 정비-->
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h1>화면 구성</h1>
					<img src="/img/newhelp/img_community_1_01_001.png"	style="margin-left: 0px;" alt="지역현안 소통지도 화면구성">
					<ol>
						<li>1) 소통지도 검색 : 제목 또는 태그로 검색합니다.</li>
						<li>2) 정렬 : 우선정렬과 정렬 방법으로 통계 소통지도의 목록을 재조회할 수 있습니다.</li>
						<li>3) 소통지도 만들기 : 개설자가 운영목적에 부합한 통계자료를 배경지도로 선택한 후 소통지도를 만들어 운영하며, 소통지도의 운영성격에 따라서 참여자는 개설자의 승인을 얻은 후 참여가 가능합니다.</li>
						<li>4) 소통지도 목록 : 소통지도 목록은 전체, 개설, 가입 소통지도 목록을 조회하여 보여주며 의견등록한 소통지도를 선택하면 해당 소통지도의 상세정보와 의견등록하기, 댓글쓰기, 신고하기 등의 기능을 사용하실 수 있습니다.</li>
						<li>5) 튜토리얼 : 통계 소통지도의 사용방법에 대한 튜토리얼을 진행합니다.</li>
						<li>6) 핫소통지도 : 참여인원과 등록의견이 많은 순으로 4개의 소통지도를 핫소통지도로 선정 및 조회합니다.</li>
						<li>7) 최신소통지도 : 최근 등록된 소통지도를 보여줍니다.</li>
						<li>8) 공지사항 : 지역현안 소통지도 전체 공지사항을 조회할 수 있습니다.</li>
						<li>9) 지역현안 소통지도 소개 : 지역현안 소통지도 소개 및 이용안내 등의 정보를 조회할 수 있고, 모바일로 QR코드를 스캔하면 모바일페이지로 접근이 가능합니다.</li>
					</ol>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
