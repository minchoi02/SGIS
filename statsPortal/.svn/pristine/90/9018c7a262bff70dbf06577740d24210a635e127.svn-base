...
public class GetStatsAnlsJobGrowthMain extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(GetStatsAnlsJobGrowthMain.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			...
			result = session.selectList("wrStatsAnls.selectSsaJobGrowthMain", mapParameter);
