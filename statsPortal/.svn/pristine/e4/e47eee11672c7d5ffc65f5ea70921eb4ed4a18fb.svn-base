...
<!-- mng_s 20210616 이진호, 웹 접근성 검사 오류 수정 / lang ='ko' 추가  -->
<html lang="ko"> 
<!-- mng_e 20210616 이진호 -->
...
<body>      
	<div class="header" id="header">
		...
		<ul class="gnb">
			...
			<li><a id="tit03" href="/edu/jsp/board/edu_board_list.jsp"  style="color:#ff8e70">자유게시판</a></li>
			<li><a id="tit04" href="/edu/jsp/game01.jsp">카드뒤집기</a></li>
			<li><a id="tit05" href="/edu/jsp/game02.jsp">OX퀴즈</a></li>
		</ul>
	</div>
	<div class="container">
		<div class="noticWrap">
			<div class="notic">
				...
				<!-- mng_s 20210616 이진호, 웹 접근성 검사 오류 수정 / caption 추가 -->
				<table class="table03 mt40">
				<caption style="font-size: 0px;"> SGIS 에듀 자유게시판 게시글 VIEW</caption>
				<!-- mng_e 20210616 이진호 -->
				...
				<!-- mng_s 20210616 이진호, 웹 접근성 검사 오류 수정 / thead, tfoot 추가 -->
				<thead></thead>
				<tbody>
					<tr>
					...
					<tr  style="height:450px;">					
						<td colspan="2">
							<!-- mng_s 20201016 김건민 (스크롤바 추가) -->
							<div style="height:400px; overflow-y: scroll;" id="post_content">
