...
public class GetStatusAnlsEducationLevel extends AbsQuery<List> {
	
	private static final Log logger = LogFactory.getLog(GetStatusAnlsEducationLevel.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result = session.selectList("wrStatusAnls.getStatusAnlsEducationLevel", mapParameter);
