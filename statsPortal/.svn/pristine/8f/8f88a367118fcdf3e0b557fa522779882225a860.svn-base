...
public class Ceaa00DAO extends GeneralDAO{
    ...
    public String getListSql(LData lData) {
		...
		/*******************************/
			...
			String census_output_area_year = lData.getString("census_output_area_year");
			...
			//mng_s 20190613 과거집계구 자료신청시 집계구 기준년도가 2016년의 경우 사업체의 10차가 존재하지 않아서 예외처리함
			if ("2016".equals(census_output_area_year)) {
				sql.append(" and sgis_census_detail_data_id not in ('cp_10','cp_11','cp_12')	\n");
			}

			//-- 2019년 집계구기준 건축년도별주택은 2000~2018(ho_06)
			//-- 소스 로직단에서 집계구기준 년도가 2019년 미만이면  and sgis_census_detail_data_id not in ('ho_06') 을 추가하고,
			//-- 2019년 이상이면 and sgis_census_detail_data_id not in ('ho_01', 'ho_02')  을 추가하면 될듯하다.

			//****************************** mng_s 20201028 4분기가 추가될 때마다 여기에 기술해 주어야 한다. *********************************
			if( ! "2018_4".equals(census_output_area_year) && ! "2019_4".equals(census_output_area_year)) {
				if( Integer.parseInt(census_output_area_year) < 2019   ) {
					sql.append(" and sgis_census_detail_data_id not in ('ho_06')	        \n");
				}
				if( Integer.parseInt(census_output_area_year) >= 2019   ) {
					//sgisCensusYear는 int 타입이다. 아래 if문에서 스트링하고 혼동하면 않됨
					if(2013 == sgisCensusYear) { //세종시만 2013이 존재하는데 건축년도별주택은 존재하지 않으므로 예외처리한다. mng_s 20191122
						sql.append(" and sgis_census_detail_data_id not in ('ho_01', 'ho_02', 'ho_06')	\n");
					} else {
						sql.append(" and sgis_census_detail_data_id not in ('ho_01', 'ho_02')	\n");
					}
				}
			}
		...
		*/
		...
		/*******************************/
			...
			*/
			...
			//mng_s 20180807 김준하 수정
			sql.append("	select * from (																																																					\n");
			sql.append("	select count(sgis_census_req_id) cnt_req_id, sgis_census_req_id                                                                                                                                                                 \n");
			sql.append("	from (                                                                                                                                                                                                                          \n");
			sql.append("		select A.*, B.*, C.* from (                                                                                                                                                                                                 \n");
			sql.append("		 select distinct a.sgis_census_data_id, (select  d.sgis_census_name from sgis_census_data d where a.sgis_census_id = d.sgis_census_id and a.sgis_census_data_id = d.sgis_census_data_id) sgis_census_data_name ,            \n");
			sql.append("				a.sgis_census_id, (select  c.sgis_census_code_name from sgis_census_code c where a.sgis_census_id = c.sgis_census_id ) sgis_census_code_name ,                                                                      \n");
			...
			sql.append("		 and trunc(sysdate) between to_date(b.sgis_census_req_y_s_d) and to_date(b.sgis_census_req_y_e_d)                                                                                                                           \n");
			//sql.append("		 and (a.census_output_area_year - e.census_output_area_year) =0                                                                                                                                                             \n");
			sql.append("		 and a.census_output_area_year = e.census_output_area_year                                                                                                                                                             \n");
			sql.append("		 order by  a.sgis_census_req_id desc, a.sgis_census_id,  a.sgis_census_data_id, b.sgis_census_req_year                                                                                                                      \n");
			sql.append("		 ) A                                                                                                                                                                                                                        \n");
			sql.append("		 left outer join                                                                                                                                                                                                            \n");
			sql.append("		 (                                                                                                                                                                                                                          \n");
			sql.append("		 select sgis_census_req_id as zipfile_req_id, sgis_census_file_path as zipfile_path, sgis_census_file_name as zipfile_name                                                                                                  \n");
			sql.append("		 from sgis_census_dynamic_zipfile ) B on A.sgis_census_req_id = B.zipfile_req_id                                                                                                                                            \n");
			sql.append("		 left outer join                                                                                                                                                                                                            \n");
			sql.append("		(                                                                                                                                                                                                                           \n");
			sql.append("		 select sgis_census_detail_data_id, sgis_census_detail_data_nm                                                                                                                                                              \n");
			sql.append("		 from sgis_census_detail_data_code                                                                                                                                                                                          \n");
			...
			sql.append("	)AAA, (	select A.*, B.*, C.* from (                                                                                                                                                                                             \n");
			sql.append("		 select distinct a.sgis_census_data_id, (select  d.sgis_census_name from sgis_census_data d where a.sgis_census_id = d.sgis_census_id and a.sgis_census_data_id = d.sgis_census_data_id) sgis_census_data_name ,            \n");
			sql.append("				a.sgis_census_id, (select  c.sgis_census_code_name from sgis_census_code c where a.sgis_census_id = c.sgis_census_id ) sgis_census_code_name ,                                                                      \n");
			sql.append("				a.sgis_census_req_file,                                                                                                                                                                                             \n");
			sql.append("				a.sgis_census_req_id,                                                                                                                                                                                               \n");
			...
			sql.append("		 ) C on A.sgis_census_detail_data_id = C.sgis_census_detail_data_id                                                                                                                                                         \n");
			sql.append("	) BBB                                                                                                                                                                                                                           \n");
			sql.append("	where AAA.sgis_census_req_id=BBB.sgis_census_req_id                                                                                                                                                                             \n");

			// 2017.11.09 [개발팀] 수정 END
		/*******************************/
		/* 센서스 라운로드 리스트 재개발(아이티밴드 2022-06-20 */
		/*******************************/
		}  else if(lData.getString("PARAM").equals("CENSUS_DOWN_DATA2")){
				String sc_userkey = lData.getString("sc_userkey");
				sql.append("				select  to_char(a.cnt) as cnt , b.* from (                                                                                                                                                             \n"); 
				sql.append("						select                                                                                                                                                                                         \n");
				sql.append("						    sgis_census_req_id                                                                                                                                                                         \n");
				sql.append("						  , sgis_census_file_name                                                                                                                                                                      \n");
				sql.append("						  , count(*) as cnt                                                                                                                                                                            \n");
				sql.append("						from (                                                                                                                                                                                         \n");
				sql.append("								select                                                                                                                                                                                 \n");
				sql.append("									   a.sgis_census_req_id,                                                                                                                                                           \n");
				sql.append("									       case when  a.sgis_census_id = '2' and a.sgis_census_data_id ='7' then                                                                                                       \n");
				sql.append("									     			concat(concat(concat(concat('기초단위구_',a.sgis_census_req_sido),'_'),a.sgis_census_req_year),'.zip')                                                             \n");
				sql.append("												when   a.sgis_census_id = '2'  then                                                                                                                                    \n");
				sql.append("													c.sgis_census_file                                                                                                                                                 \n");
				sql.append("												when   a.sgis_census_id = '8' and a.sgis_census_data_id ='0' then                                                                                                      \n");
				sql.append("													concat(concat('grid_',substr(a.sgis_census_detail_data_id,1,2)),'.zip')                                                                                            \n");
				sql.append("												when   a.sgis_census_id = '8' and a.sgis_census_data_id ='1' then                                                                                                      \n");
				sql.append("													concat(concat('도시화경계_',a.sgis_census_req_year),'.zip')                                                                                                        \n");
				sql.append("											    else                                                                                                                                                                   \n");
				sql.append("											    	d.sgis_census_file_name                                                                                                                                            \n");
				sql.append("											   	end as sgis_census_file_name                                                                                                                                           \n");
				sql.append("									  from  ( 	                                                                                                                                                                       \n");
				sql.append("									       select                                                                                                                                                                      \n");
				sql.append("									          a.sgis_census_req_id                                                                                                                                                     \n");
				...
				sql.append("									       	  , b.sgis_census_req_sido                                                                                                                                                 \n");
				sql.append("									       	  , b.sgis_census_req_sigungu                                                                                                                                              \n");
				sql.append("									       	  , b.census_output_area_dts_year                                                                                                                                          \n");
				sql.append("									       	  , b.sgis_census_req_y_s_d                                                                                                                                                \n");
				sql.append("									       	  , b.sgis_census_req_y_e_d                                                                                                                                                \n");
				sql.append("									       	  , b.sgis_census_detail_data_id                                                                                                                                           \n");
				sql.append("								           from sgis_census_req a inner join sgis_census_req_year_code b                                                                                                               \n");
				sql.append("								            	on  a.sgis_census_req_id = b.sgis_census_req_id                                                                                                                        \n");
				sql.append("									        	  and a.sgis_census_id= b.sgis_census_id                                                                                                                               \n");
				sql.append("									        	  and a.sgis_census_data_id = b.sgis_census_data_id                                                                                                                    \n");
				sql.append("									        	  and a.detail_data_seq = b.detail_data_seq                                                                                                                            \n");
				sql.append("										          and a.sgis_census_req_status= 'A'                                                                                                                                    \n");
				sql.append("						 				          and a.sgis_member_key = '" + sc_userkey + "'                                                                                                                                   \n");
				sql.append("										          and trunc(sysdate) between to_date(b.sgis_census_req_y_s_d) and to_date(b.sgis_census_req_y_e_d)                                                                     \n");
				sql.append("										    ) a   left join  sgis_census_sigungu_data c                                                                                                                                \n");
				sql.append("									        	on c.sgis_census_id 			= a.sgis_census_id                                                                                                                     \n");
				sql.append("									        	  and c.sgis_census_data_id 	= a.sgis_census_data_id                                                                                                                \n");
				sql.append("									        	  and c.sgis_census_year  	=     a.sgis_census_req_year                                                                                                               \n");
				sql.append("									        	  and c.sgis_census_sido 		= a.sgis_census_req_sido                                                                                                               \n");
				sql.append("									        	  and c.sgis_census_sigungu 	= a.sgis_census_req_sigungu                                                                                                            \n");
				sql.append("									        	  and c.census_output_area_year = a.census_output_area_dts_year                                                                                                        \n");
				sql.append("											left join sgis_census_dynamic_zipfile d                                                                                                                                    \n");
				sql.append("										   		 on d.sgis_census_req_id = a.sgis_census_req_id                                                                                                                        \n");
				sql.append("									  where 1=1                                                                                                                                                                        \n");
				sql.append("							) a group by sgis_census_req_id, sgis_census_file_name                                                                                                                                     \n");
				sql.append("				) a inner join (                                                                                                                                                                                       \n");
				sql.append("					 select                                                                                                                                                                                            \n");
				sql.append("					 	  a.sgis_census_req_id                                                                                                                                                                         \n");
				sql.append("					 	  ,case when a.sgis_census_id = '2' or a.sgis_census_id = '8'  then '경계' else '통계' end data_kind                                                                                           \n");
				sql.append("					     , a.sgis_census_id                                                                                                                                                                            \n");
				sql.append("					     , a.sgis_census_data_id                                                                                                                                                                       \n");
				sql.append("					     , a.sgis_census_detail_data_id                                                                                                                                                                \n");
				sql.append("					     , case  when  a.sgis_census_id = '2' or a.sgis_census_id = '7'   then                                                                                                                         \n");
				sql.append("								    concat(concat(a.sgis_census_req_year ,'년 ') , f.sgis_census_name)                                                                                                                 \n");
				sql.append("								when   a.sgis_census_id = '8' and a.sgis_census_data_id ='0' then                                                                                                                      \n");
				sql.append("								    concat(substr(a.sgis_census_detail_data_id,1,2)  ,'(100K,10K,1K,500M,100M)') 	                                                                                                   \n");
				sql.append("								when   a.sgis_census_id = '8' and a.sgis_census_data_id ='1' then                                                                                                                      \n");
				sql.append("							    	concat(concat(a.sgis_census_req_year ,'년 ') ,f.sgis_census_name)			                                                                                                       \n");
				sql.append("							    else                                                                                                                                                                                   \n");
				sql.append("							    	concat(concat(a.sgis_census_req_year ,'년 ') ,e.sgis_census_detail_data_nm)                                                                                                        \n");
				sql.append("							   	end as data_nm                                                                                                                                                                         \n");
				sql.append("					     ,  case  when  a.sgis_census_id = '2' and a.sgis_census_data_id ='7' then                                                                                                                     \n");
				sql.append("								    concat(concat(concat(concat(concat(concat('/census/base_border_', a.sgis_census_req_year),'/기초단위구_'),a.sgis_census_req_sido),'_'),a.sgis_census_req_year),'/')                \n");
				sql.append("								when   a.sgis_census_id = '2'  then                                                                                                                                                    \n");
				sql.append("									concat(c.sgis_census_dir,'/')                                                                                                                                                      \n");
				sql.append("								when   a.sgis_census_id = '8' and a.sgis_census_data_id ='0' then                                                                                                                      \n");
				sql.append("								    concat(concat(concat(concat('/grid_border/grid_',a.sgis_census_req_year),'/grid_'),substr(a.sgis_census_detail_data_id,1,2)) ,'/')                                                 \n");
				sql.append("								when   a.sgis_census_id = '8' and a.sgis_census_data_id ='1' then                                                                                                                      \n");
				sql.append("									concat(concat('/grid_border/urban/도시화경계_',a.sgis_census_req_year),'/')                                                                                                        \n");
				sql.append("							    else                                                                                                                                                                                   \n");
				sql.append("							    	d.sgis_census_file_path                                                                                                                                                            \n");
				sql.append("							   	end as sgis_census_file_path                                                                                                                                                           \n");
				sql.append("					     ,  case when  a.sgis_census_id = '2' and a.sgis_census_data_id ='7' then                                                                                                                      \n");
				sql.append("					     			concat(concat(concat(concat('기초단위구_',a.sgis_census_req_sido),'_'),a.sgis_census_req_year),'.zip')                                                                             \n");
				sql.append("								when   a.sgis_census_id = '2'  then                                                                                                                                                    \n");
				sql.append("									c.sgis_census_file                                                                                                                                                                 \n");
				...
				sql.append("							    	d.sgis_census_file_name                                                                                                                                                            \n");
				sql.append("							   	end as sgis_census_file_name                                                                                                                                                           \n");
				sql.append("					     , a.sgis_census_req_y_s_d                                                                                                                                                                     \n");
				sql.append("					     , a.sgis_census_req_y_e_d                                                                                                                                                                     \n");
				sql.append("					     , a.sgis_census_req_sido                                                                                                                                                                      \n");
				sql.append("					     , a.sgis_census_req_sigungu                                                                                                                                                                   \n");
				sql.append("					     , a.sgis_census_req_year                                                                                                                                                                      \n");
				sql.append("					  from  ( 	                                                                                                                                                                                       \n");
				sql.append("						       select                                                                                                                                                                                  \n");
				sql.append("						          a.sgis_census_req_id                                                                                                                                                                 \n");
				...
				sql.append("							left join sgis_census_dynamic_zipfile d                                                                                                                                                    \n");
				sql.append("						   		 on d.sgis_census_req_id = a.sgis_census_req_id                                                                                                                                        \n");
				sql.append("							left join sgis_census_detail_data_code e                                                                                                                                                   \n");
				sql.append("						   		 on e.sgis_census_detail_data_id = a.sgis_census_detail_data_id                                                                                                                        \n");
				sql.append("							left join sgis_census_data f                                                                                                                                                               \n");
				sql.append("						   		 on f.sgis_census_id = a.sgis_census_id                                                                                                                                                \n");
				sql.append("						   		 	and f.sgis_census_data_id = a.sgis_census_data_id                                                                                                                                  \n");
				sql.append("					  where 1=1                                                                                                                                                                                        \n");
				sql.append("				) b on a.sgis_census_req_id = b.sgis_census_req_id and a.sgis_census_file_name = b.sgis_census_file_name                                                                                               \n");
				sql.append("				order by a.sgis_census_req_id	asc                                                                                                                                                                    \n");
		}
		/*******************************/
		/* 센서스 개인 신청 상세정보 */
		/*******************************/
		...
		// 2022.06.29 아이티밴드 수정
			...
			*/
			...
			sql.append("		    , d.sgis_census_detail_data_id 	\n");
			sql.append("		    , d.census_output_area_dts_year 	\n");
			...
			sql.append("						decode(it.sgis_census_req_sido, '00', '전국', (Select top 1 sido_nm from sgis_census_sigungu_data where sgis_census_year= it.sgis_census_req_year and sgis_census_sido=it.sgis_census_req_sido ) ) sido_nm			                   \n");
			sql.append("						,decode(it.sgis_census_req_sigungu, '00000', '전체',(Select top 1 sigungu_nm from sgis_census_sigungu_data where sgis_census_year= it.sgis_census_req_year and sgis_census_sigungu=it.sgis_census_req_sigungu ) ) sigungu_nm		       \n");
			sql.append("				from (			                                                                                                                                                                                                                               \n");
			sql.append("						select a.sgis_census_id	                                                                                                                                                                                                               \n");
			sql.append("						    , a.sgis_census_data_id 	                                                                                                                                                                                                       \n");
			sql.append("						    , a.sgis_census_req_company 	                                                                                                                                                                                                   \n");
			...
			sql.append("							, b.sgis_census_req_sido as sgis_census_req_sido                                                                                                                                                                                   \n");
			sql.append("							, b.sgis_census_req_sigungu as sgis_census_req_sigungu 	                                                                                                                                                                           \n");
			sql.append("						    , b.sgis_census_detail_data_id 	                                                                                                                                                                                                   \n");
			sql.append("						    , b.census_output_area_dts_year 	                                                                                                                                                                                               \n");
			sql.append("						    , c.sgis_census_code_name 							                                                                                                                                                                               \n");
			sql.append("						    , d.sgis_census_name sgis_census_data_name 							                                                                                                                                                               \n");
			sql.append("							, d.sgis_census_location								                                                                                                                                                                           \n");
			sql.append("						from sgis_census_req a                                                                                                                                                                                                                 \n");
			...
			sql.append("								 	and a.detail_data_seq = b.detail_data_seq  						                                                                                                                                                           \n");
			sql.append("								 	                                                                                                                                                                                                                           \n");
			sql.append("								left join sgis_census_code c                                                                                                                                                                                                   \n");
			sql.append("									on  a.sgis_census_id = c.sgis_census_id                                                                                                                                                                                    \n");
			sql.append("								 	                                                                                                                                                                                                                           \n");
			sql.append("								left join sgis_census_data d                                                                                                                                                                                                   \n");
			sql.append("									on  a.sgis_census_id = d.sgis_census_id                                                                                                                                                                                    \n");
			sql.append("									   and a.sgis_census_data_id = d.sgis_census_data_id                                                                                                                                                                       \n");
			sql.append("				  ) it		                                                                                                                                                                                                                                   \n");
			sql.append("			) A		                                                                                                                                                                                                                                           \n");
			sql.append("			left outer join sgis_census_detail_data_code B		                                                                                                                                                                                               \n");
		...
		/*******************************/
		/* sgis_member_key 가져오기 */
		/*******************************/
		} else if(lData.getString("PARAM").equals("SGIS_MEMBER_KEY")) {
			sql.append(" select sgis_member_key 	\n");
    ...
    public int insert(LData lData) throws Exception {
    	...
    	try {
    		...
    		if(lData.getString("PARAM").equals("CENSUS_APPLY")) {
    			...
    			isql.append("				    , :sgis_census_req_sosok 		\n");
    			isql.append("				    , :sgis_census_req_mokjuk 		\n");
    			isql.append("				    , substr(nvl(:census_output_area_year,''),1,4) 		\n");
    			isql.append("				    , :sgis_census_req_kwaje 		\n");
    			isql.append("				    , :sgis_census_req_email 		\n");
    		...
    		/* 센서스 신청 년도 등록 */
    		/*******************************/
    		}else if(lData.getString("PARAM").equals("CENSUS_APPLY_COMPLE")) {
    			
    			isql.append(" update sgis_census_req set 	\n");
    			isql.append("		 sgis_census_req_status = 'S' 	\n");
    			isql.append(" WHERE  sgis_census_req_id = :sgis_census_req_id \n");
    			dbmgr.prepareStatement(isql.toString(), lData);
    			resultFlag = dbmgr.executeUpdate();
    		
    		}else if(lData.getString("PARAM").equals("CENSUS_APPLY_YEAR_CODE")) {
    			...
    			// 2022 06. 21 컬럼추가
    			isql.append("		, census_output_area_dts_year 		\n");
    			...
    			// 2018. 01. 04 mng_s
    			isql.append("		, nvl(:census_output_area_dts_year,'')		\n");
