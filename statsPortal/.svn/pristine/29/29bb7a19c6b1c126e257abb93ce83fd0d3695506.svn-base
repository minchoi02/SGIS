 ...
 */
(function(W, D) {
	W.$tsMapApi = W.$tsMapApi || {};
	
	//$tsMapApi.grid_legend_new = [[]]; //그리드의 범례 데이터 세팅 mng_s
	...
	$tsMapApi.request = {
			...
			// 일자리맵 추가
			API_WORK_URL : "/ServiceAPI/workRoad/todayStatus/getTodayStatusSidoDataBoard.json",
			...
			mask : {
				show : function () {
					$workRoad.ui.addFnc01List("$tsMapApi.request.mask.show");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				close : function () {
					$workRoad.ui.addFnc01List("$tsMapApi.request.mask.close");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			openApiWorkData : function(params) {// used
				$workRoad.ui.log("$tsMapApi.request.openApiWorkData - begin");

				var sopOpenApiWorkDataObj = new sop.openApi.ts.workData.api();
				...
				// 구인현황 조회 필수 파라메터 설정
				//sopOpenApiWorkDataObj.addParam("today", params.today);
				...
				//2018-01-03 지도 화면에 마우스 오버시 "2018"로 뜨고 있음 (YYYY.MM.DD)로 변경 필요.
				for(var i = 0; i < params.param.length; i++) {
					var lvKey = params.param[i].key
					var lvValue = params.param[i].value;
					if (lvKey == "today") {
						$wrmTodayStatus.ui.selected_today = lvValue;
					} else if (lvKey == "search_type") {		// 카테고리 데이터 유형 글로벌 변수에 저장 - 2019.01.15	ywKim	추가
						$wrmTodayStatus.ui.selected_search_type = lvValue;
					}
				}
				
				console.log("[tsMapApi.js] params.param.push ");
				sopOpenApiWorkDataObj.request({
					method : "POST",
					async : async,	//9월 서비스
					//url : openApiPath + this.API_WORK_URL,
					url : contextPath + this.API_WORK_URL,					
					options : {
						params : params,
						url : this.API_WORK_URL,
					}
				});
			},
			...
			openApiTotalPopulation : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiTotalPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[tsMapApi.js] openApiTotalPopulation() 호출");
				
				var sopOpenApiTotalPopulationObj = new sop.openApi.ts.totalPopulation.api();
				...
				console.log("[tsMapApi.js] openApiTotalPopulation() params.map.isInnerMapShow2 [" + params.map.isInnerMapShow2);
				console.log("[tsMapApi.js] openApiTotalPopulation() params.map.isInnerMapShow3 [" + params.map.isInnerMapShow3);
				console.log("[tsMapApi.js] openApiTotalPopulation() zeroLevelYn [" + zeroLevelYn);
			...
			gridLegendTotalPopulation : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.gridLegendTotalPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[tsMapApi.js] gridLegendTotalPopulation() 호출");
				
				var gridLegendTotalPopulationObj = new sop.openApi.ts.gridLegendTotalPopulation.api();
			...
			openApiSearchPopulation : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiSearchPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiSearchPopulationObj = new sop.openApi.ts.searchPopulation.api();
			...
			openApiHouseHold : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseHoldObj = new sop.openApi.ts.houseHold.api();
			...
			openApiHouseHoldMember : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiHouseHoldMember");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseHoldMemberObj = new sop.openApi.ts.houseHoldMember.api();
			...
			openApiFarmHouseHold : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiFarmHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiFarmHouseHoldObj = new sop.openApi.ts.FarmHouseHold.api();
			...
			openApiForestryHouseHold : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiForestryHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiForestryHouseHoldObj = new sop.openApi.ts.ForestryHouseHold.api();
			...
			openApiFisheryHouseHold : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiFisheryHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiFisheryHouseHoldObj = new sop.openApi.ts.FisheryHouseHold.api();
			...
			openApiInterstryCode : function(depth, class_deg, class_cd) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiInterstryCode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiInderstryCodeObj = new sop.openApi.ts.InderstryCode.api();
			...
			openApiCompany : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiCompany");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[todayStatusMap.js] openApiCompany() 호출");
				
				var sopOpenApiCompanyObj = new sop.openApi.ts.Company.api();
			...
			openApiHouse : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiHouse");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseObj = new sop.openApi.ts.House.api();
			...
			openApiMainRecentParamInfo : function (hist_id) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiMainRecentParamInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiMainRecentParamInfoObj = new sop.openApi.ts.mainRecentParamInfo.api();
			...
			openApiShareForStats : function(params, adm_cd) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiShareForStats");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiShareForStatsObj = new sop.openApi.ts.shareForStats.api();
				...
				if(params.param_info.isKosis) {
					todayStatusMapEtc.org_id = paramInfo.org_id;
					todayStatusMapEtc.tbl_id = paramInfo.tbl_id;
//					todayStatusMapEtc.gis_se = paramInfo.gis_se;
					todayStatusMapEtc.gis_se = params.param_info.gis_se_bak;
					todayStatusMapEtc.kosis_data_item = paramInfo.kosis_data_item;
					todayStatusMapEtc.kosis_data_period = paramInfo.kosis_data_period;
					todayStatusMapEtc.kosis_data_year = paramInfo.kosis_data_year;
					todayStatusMapEtc.kosis_data_item_detail = paramInfo.kosis_data_item_detail;
					todayStatusMapEtc.pAdmCd = paramInfo.gis_se;
					
					todayStatusMapEtc.kosis_obj_var_id = paramInfo.obj_var_id;
					todayStatusMapEtc.kosis_field_id = paramInfo.field_id;
			...
			openApiUserDrawForStats : function(params, area, layer) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiUserDrawForStats");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var url = "";
				var method = "GET";

				var sopOpenApiUserDrawForStatsObj = new sop.openApi.ts.userDrawForStats.api();
				for (var i = 0; i < params.param.length; i++) {
			...
			openApiLoginProcess : function(id, pwd) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiLoginProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopLoginObj = new sop.portal.ts.login.api();
			...
			openApiDeveloperLoginProcess : function(id, pwd) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiDeveloperLoginProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopDeveloperLoginObj = new sop.portal.ts.developerLogin.api();
			...
			openApiStatBaseYearProcess : function() {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiStatBaseYearProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var searchbtnCnt = $todayStatusLeftMenu.ui.searchbtnCnt - 1;
				var sopStatBaseYearObj = new sop.portal.ts.statBaseYear.api();
				var param_info = new Array();
				param_info.push("low_search");
				for (var i = 0; i < $todayStatusLeftMenu.ui.arParamList.length; i++) {
					if($todayStatusLeftMenu.ui.arParamList[i].idx == $todayStatusLeftMenu.ui.searchbtnCnt-1) {
						for(var x = 0; x < $todayStatusLeftMenu.ui.arParamList[i].params.length; x ++) {
							var params = $todayStatusLeftMenu.ui.arParamList[i].params[x];
				...
				sopStatBaseYearObj.addParam("api_id", $todayStatusLeftMenu.ui.curSelectedDetailStatsType.substring(0,8));
			...
			openApiGeocode : function(address) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiGeocode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도			
				var sopOpenApiGeocodeObj = new sop.openApi.ts.geocode.api();
			...
			openApiSOP : function(searchword, pagenum) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiSOP");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiSOPObj = new sop.openApi.ts.sopsearch.api();
...
//				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiKOSIS");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
//				var sopOpenApiKOSISObj = new sop.openApi.ts.kosissearch.api();
...
//			},
			...
			openApiItemCombine : function(params) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.openApiItemCombine");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiItemCombineObj = new sop.openApi.ts.itemcombine.api();
				var api_url = contextPath + $tsMapApi.request.API_FUSION_URL;		//초기값은 기본 결합조건api주소
				var methodType = "POST";
					...
					if(params.noneParams[i].key == "fusion_query_type") {	
						if(params.noneParams[i].value == "population" || params.noneParams[i].value == "household" || params.noneParams[i].value == "house") {		//인구, 가구, 주택 조건
							if(params.noneParams[i].value == "population") {
								api_url = openApiPath + $tsMapApi.request.API_0302_URL;		//인구 OPENAPI 호출
							} else if(params.noneParams[i].value == "household") {
								api_url = openApiPath + $tsMapApi.request.API_0305_URL;		//가구 OPENAPI 호출
							} else if(params.noneParams[i].value == "house") {
								api_url = openApiPath + $tsMapApi.request.API_0306_URL;		//주택 OPENAPI 호출
							}
							methodType = "GET";
			...
			searchReverseGeoCode : function (division, url, title) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.searchReverseGeoCode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopSearchReverseGeoCodeObj = new sop.openApi.ts.searchReverseGeoCode.api();
				sopSearchReverseGeoCodeObj.addParam("accessToken", accessToken);
				sopSearchReverseGeoCodeObj.addParam("addr_type", "20");
				sopSearchReverseGeoCodeObj.addParam("x_coor", $tsMap.ui.x);
				sopSearchReverseGeoCodeObj.addParam("y_coor", $tsMap.ui.y);
			...
			userAreaBoundInfo : function (area, type, code, layer, map) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.userAreaBoundInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var userAreaBoundObj = new sop.openApi.ts.userAreaBoundObj.api();
			...
			setStatsData : function (res, options, isContry) {// used
				$workRoad.ui.log("$tsMapApi.request.setStatsData - begin");
				
				var result = res.result;
				var params = options.params;
				var map = params.map;
				var mapInfo = map.mapInfo;
				var dataBoard = $tsDataBoard.ui.mapData[$tsDataBoard.ui.map_id].dataBoard;	//9월 서비스
				...
				for (var i=0; i<result.length; i++) {
					console.log("[tsMapApi.js] params.filter : " + params.filter);
...
//					$("#noticeTextPopup0"+(parseInt(map.id)+1)).hide();
				...
				// 구인자료현황 조회 추가
				console.log("[tsMapApi.js] res.id / options.params.title / options.params.unit / map.id : " + res.id + " / " + options.params.title  + " / " +  options.params.unit  + " / " +  map.id);
				if (res.id == "API_WORK") {
				...
				// 일반검색 버튼일 경우,
				if ($tsMap.ui.searchBtnType == "normal") {	
					...
					//map.shareInfo.setShareInfo(options, "normal", map.id);	// 구인현황 주석처리
					$tsMap.ui.updateSearchTitle(options.params.title, options.params.unit, map.id);
					...
					if (dataBoard.isTimeSeriesPlay) {
						...
						$tsDataBoard.ui.doReqTimeSeries();
						...
						if (params.view_type == "TS") {
							...
							if(params.view_type == "NM"){	//2018.11.07 오늘의 구인현황 콤보박스 선택 시, 시도 레벨 조회 추가
								...
								var s_center = (map.xComboVal != 0 ? [map.xComboVal,map.yComboVal] : map.center); // 2020.12.02 [이금은]
								map.openApiReverseGeoCode(s_center, function() {
									if(gv_zoom != "" && gv_zoom_first_yn == "Y") {
										gv_zoom_first_yn = "N";
										//map.setZoom(gv_zoom);
										var lvMapCenter = map.center;
				                        var lvMapCenterX = lvMapCenter[0];
				                        var lvMapCenterY = lvMapCenter[1];
				                        map.mapMove([lvMapCenterX,lvMapCenterY],gv_zoom);
									}
								});
						...
						//데이터보드 업데이트
						$tsDataBoard.ui.updateDataBoard(res, options);
					}
					
				} else {
					
					//범례결합시, 하나라도 통신에러나 검색결과가 없을 경우, 초기화한다.
					if ($tsMapApi.request.combineFailCnt > 0) {
						map.clearDataOverlay();
						$tsMap.ui.shareUrlInfoList = [];
						return;
					}
...
//						$("#timeSeriesDiv").hide();
					...
					if (map.combineData.length == 2) {
						...
						$tsMap.ui.updateSearchTitle(combineTitle, map.id);
					}
			...
			setMultiStatsData : function (res, options, isContry) {
				$workRoad.ui.addFnc01List("$tsMapApi.request.setMultiStatsData");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var result = res.result;
				var params = options.params;
				var map = params.map;
			...
			checkContryData : function(res, options, map) {// used
				$workRoad.ui.log("$tsMapApi.request.checkContryData - begin");
	...
	if ($workRoad.ui.isSetCallback('tsMapApi')) return;
	
	/** ********* OpenAPI 구인자료 현황 조회 Start ********* */
	(function() {
		$class("sop.openApi.ts.workData.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						console.log("[tsMapApi.js] sop.openApi.ts.workData.api 호출");
						console.log("[tsMapApi.js] sop.openApi.ts.workData.api res.errCd [" + res.errCd);
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							case 0:
								var isContry = $tsMapApi.request.checkContryData(res, options, map);
								if (map.selectedBoundMode == "multi") {
									$tsMapApi.request.setMultiStatsData(res, options, isContry);		
								}else {
									$tsMapApi.request.setStatsData(res, options, isContry);		
								}
								break;
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiWorkData(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
									res["result"] = [];
									$tsMapApi.request.setMultiStatsData(res, options);	
								}else {
									messageAlert.open(
											"알림", 
								...
								break;
							default:
								$tsMapApi.request.combineFailCnt++;
								map.clearDataOverlay();
	...
	(function() {
		$class("sop.openApi.ts.totalPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						
						console.log("[tsMapApi.js] sop.openApi.ts.totalPopulation.api 호출");
						console.log("[tsMapApi.js] sop.openApi.ts.totalPopulation.api res.errCd [" + res.errCd);
						...
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiTotalPopulation(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
									...
									//시계열에서 검색값이 없을 경우
									$tsDataBoard.ui.emptyTimerBaseInsert(res, options);
								}
								break;
							default:
								$tsMapApi.request.combineFailCnt++;
					...
					onFail : function(status, options) {
						...
						console.log("[tsMapApi.js] sop.openApi.ts.totalPopulation.api onFail 호출");
						console.log("[tsMapApi.js] sop.openApi.ts.totalPopulation.api status [" + status);
	...
	(function() {
		$class("sop.openApi.ts.gridLegendTotalPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						
						console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api 호출");
						console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api res.errCd [" + res.errCd);
					...
					onFail : function(status, options) {
						...
						console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api onFail 호출");
						console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api status [" + status);
						...
						//console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api options.params.map.grid_legend_new [" + options.params.map.grid_legend_new);
						
						//console.log("[tsMapApi.js] sop.openApi.ts.gridLegendTotalPopulation.api click ");
						//$("#legendColor_"+options.params.map.legend.id+ " li>a").eq(0).click();
	...
	(function() {
		$class("sop.openApi.ts.searchPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiSearchPopulation(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ts.houseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ts.houseHoldMember.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiHouseHoldMember(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ts.FarmHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiFarmHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ts.ForestryHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiForestryHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ts.FisheryHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiFisheryHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* OpenAPI 산업체분류 Start ********* */
	(function() {
		$class("sop.openApi.ts.InderstryCode.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var result = res.result;
						if (res.errCd == "0") {
							...
							if ($todayStatusLeftMenu.ui.companyTree == null) {
								if (options.depth == 0) {
									...
									//=============================================================================================//
									//mng_e 20180412_김건민
									$todayStatusLeftMenu.ui.companyTree = $("#company_TreeBox").easytree({
										slidingTime:0,
							            building:$todayStatusLeftMenu.event.companyListTreeWidth,
							            stateChanged:$todayStatusLeftMenu.event.companyListTreeWidth,
							            toggled:$todayStatusLeftMenu.event.companyListTreeWidth,
										data : rootData,
										allowActivate: true,
							            disableIcons: true,
											...
											if (node.childCount == null) {
												if (node.children.length > 0 ) {
													if(node.children[0].id == node.id + "_progress") {
														if (node.isExpanded) {
															$tsMapApi.request.openApiInterstryCode(
																	node.depth,
																	options.class_deg,
																	node.cd);
														}
										...
										selected : function(node) {	
											$todayStatusLeftMenu.ui.curSelectedCompanyNode = node;
										},
									...
									$todayStatusLeftMenu.ui.companyTree.activateNode(tmpData[0].id);
									$todayStatusLeftMenu.ui.curSelectedCompanyNode = $todayStatusLeftMenu.ui.companyTree.getNode(tmpData[0].id);
									
									//=============================================================================================//
									for (var i=0; i<tmpData.length; i++) {
										$todayStatusLeftMenu.ui.companyTree.addNode(tmpData[i], "root");
									}
									$todayStatusLeftMenu.ui.companyTree.removeNode("root_progress");
									$todayStatusLeftMenu.ui.companyTree.rebuildTree();
									$todayStatusLeftMenu.ui.companyTree.activateNode("root");
									$todayStatusLeftMenu.ui.curSelectedCompanyNode = $todayStatusLeftMenu.ui.companyTree.getNode("root");
									//=============================================================================================//
								} 
							}else {
								for (var i=0; i<tmpData.length; i++) {
									$todayStatusLeftMenu.ui.companyTree.addNode(tmpData[i], options.class_cd + "_" +(options.depth-1));
								}
								$todayStatusLeftMenu.ui.companyTree.removeNode(options.class_cd + "_" + (options.depth-1) + "_progress");
								$todayStatusLeftMenu.ui.companyTree.rebuildTree();
								$todayStatusLeftMenu.ui.companyTree.activateNode(options.class_cd + "_" + (options.depth-1));
							}
	...
	/** ********* OpenAPI 사업체분류 Start ********* */
	(function() {
		$class("sop.openApi.ts.Company.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiCompany(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* OpenAPI 주택분류 Start ********* */
	(function() {
		$class("sop.openApi.ts.House.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {	
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$tsMapApi.request.openApiHouse(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* 메인예시 파라미터정보조회 시작 ********* */
	(function() {
		$class("sop.openApi.ts.mainRecentParamInfo.api").extend(sop.portal.absAPI).define(
				{
	...
	/** ********* 북마크/공유 통계정보조회 시작 ********* */
	(function() {
		$class("sop.openApi.ts.shareForStats.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var result = res.result;
						var mapId = getMapDivisionId();		//검색 시 적용 될 지도(맵 분할 시)
						var map = $tsMap.ui.mapList[mapId];
						var mapInfo = map.mapInfo;		
						...
						if (res.errCd == "0") {
							...
							if(kosisParams.isKosis) {
								map.clearDataOverlay();
								todayStatusMapEtc.tbl_id_linked = kosisParams.paramInfo.tbl_id;
								todayStatusMapEtc.map = map;
								
								var year = todayStatusMapEtc.kosis_data_year;
								if(year.length > 4) {
								...
								todayStatusMapEtc.kosis_result_data = [];
								todayStatusMapEtc.kosis_result_data = result;
								todayStatusMapEtc.kosis_select_menu_text = decodeURI(options.params.param_info.title);
								todayStatusMapEtc.curSelectedTitle = decodeURI(options.params.param_info.title);
								todayStatusMapEtc.setKosisStatsData(null, options);
								
								options["zoomlevel"] = map.zoom;
								options["center"] = map.center;
								options["dist_level"] = todayStatusMapEtc.gis_se;
							...
							if ($tsMap.ui.searchBtnType == "normal") {	
								...
								$tsMap.ui.updateSearchTitle(options.params.param_info.title, options.params.param_info.unit, map.id);
								...
								//시계열 초기값 세팅
								$tsDataBoard.ui.timeSeriesInit(tmpOptions.params);
								
								$tsDataBoard.ui.updateDataBoard(res, tmpOptions);	//데이터보드
							...
							accessTokenInfo(function() {
								$tsMapApi.request.openApiShareForStats(options.params, options.adm_cd);
							});
	...
	/** ********* 로그인 시작 ********* */
	(function() {
		$class("sop.portal.ts.login.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
							var result = res.result;
							...
							$tsMapApi.request.openApiRegBookmark(
									$tsMap.ui.shareUrlInfoList[parseInt($tsMap.ui.curMapId)], 
									$tsMap.ui.share_type,
									$tsMap.ui.curMapId+1);
							
							//개발자 로그인
							$tsMapApi.request.openApiDeveloperLoginProcess(options.id, options.pwd);
	...
	/** ********* 개발자 로그인 시작 ********* */
	(function() {
		$class("sop.portal.ts.developerLogin.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
						} else {
	...
	/** ********* 통계별최신년도정보 조회 시작 ********* */
	(function() {
		$class("sop.portal.ts.statBaseYear.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
							var result = res.result;
							if(result.base_year != null) {
								...
								for (var i = 0; i < $todayStatusLeftMenu.ui.arParamList.length; i++) {
									if($todayStatusLeftMenu.ui.arParamList[i].idx == searchbtnCnt) {
										tmpParamList = $todayStatusLeftMenu.ui.arParamList[i];
	...
	/** ********* 사용자지정영역검색 시작 ********* */
	(function() {
		$class("sop.openApi.ts.userDrawForStats.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
	...
	(function() {
	    $class("sop.openApi.ts.geocode.api").extend(sop.portal.absAPI).define({
	        onSuccess : function(status, res, options) {	        
	            if(res.errCd == "0") {
	            	var result = res.result;
	            	for(var  i = 0; i < result.resultdata.length; i ++) {
	            		...
	            		var arrayKey = $tsMap.ui.sKeyword.split(" ");
	            		if(arrayKey.length < 2) {
	            			$tsMap.ui.addressAdmCd = "";
	            			$tsMap.ui.x = "962202";
		            		$tsMap.ui.y = "1839421";
	            		} else {
	            			$tsMap.ui.addressAdmCd = dongCd;
	            			$tsMap.ui.x = result.resultdata[i].x;
		            		$tsMap.ui.y = result.resultdata[i].y;
	            		}
	            	...
	            	accessTokenInfo(function() {
	            		$tsMapApi.request.openApiGeocode(options.address);
	            	});
	            }  else if (res.errCd == "-100") {
	            	$tsMap.ui.addressAdmCd = "";
        			$tsMap.ui.x = "962202";
	            ...
	            var arrayKey = $tsMap.ui.sKeyword.split(" ");
	            if(arrayKey.length < 2) {
					$tsMapApi.request.openApiSOP($tsMap.ui.sKeyword, $tsMap.ui.sopCurrentPageIndex);
	            } else {
	            	$tsMapApi.request.openApiSOP($tsMap.ui.searchKeyword, $tsMap.ui.sopCurrentPageIndex);
	            }
	            //KOSIS 검색
//	            $tsMapApi.request.openApiKOSIS($tsMap.ui.sKeyword, $tsMap.ui.kosisCurrentPageIndex);
	        },
	        onFail : function(status) {
	        	//SOP 검색
	        	var arrayKey = $tsMap.ui.sKeyword.split(" ");
...
//	            $tsMapApi.request.openApiKOSIS($tsMap.ui.sKeyword, $tsMap.ui.kosisCurrentPageIndex);
	...
	(function() {
	    $class("sop.openApi.ts.sopsearch.api").extend(sop.portal.absAPI).define({
	        onSuccess : function(status, res, options) {
            	$("#sopListTable").empty();
	            ...
	            if(res.errCd == "0") {
	            	...
	            	for(var i = 0; i < result.resultdata.length; i++) {
	            		...
	            		html += "	<div style='cursor: pointer; margin-left: 20px; font-size: 11px;' onclick=\"javascript:$tsMapApi.request.searchReverseGeoCode('sop', '"+elem.url + "','"+elem.nm+"')\">" + elem.nm + "</div>";
	            		html += "</li>";
	            	}
	            	html += "</ul>";
	            	html += "</div>";	            		            
            		...
            		$tsMap.ui.sopPaging(result.totalcount, $tsMap.ui.sopCurrentPageIndex);
            		
	            } else if(res.errCd == "-401") {
	            	accessTokenInfo(function() {
	            		$tsMapApi.request.openApiSOP(options.searchword, options.pagenum);
	            	});
	            }
	        },
	        onFail : function(status) {
...
//	(function() {
//	    $class("sop.openApi.ts.kosissearch.api").extend(sop.portal.absAPI).define({
//	        onSuccess : function(status, res, options) {
//	        	$("#kosisListTable").empty();
//	        	$("#kosisListTablePage").empty();
//	            if(res.errCd == "0") {
//	            	var result = res.result;
//	            	$tsMap.ui.searchKosisParam = [];
//            		//KOSIS
...
//	            			elem["type"] = "kosis";
//	            			elem["adm_cd"] = $tsMap.ui.addressAdmCd;
//	            			elem["x"] = $tsMap.ui.x;
//	            			elem["y"] = $tsMap.ui.y;
//	            			
//	            			html += "<li style='line-height: 30px;'>";
//	            			html += 	"<div style='float: left; font-size: 5px;'>● </div>"	//리버스지오코딩 : 법정동->행정동
//	        	            html += "	<div style='cursor: pointer; margin-left: 20px; font-size: 11px;' onclick=\"javascript:$tsMapApi.request.searchReverseGeoCode('kosis', '"+x + "', '"+elem.stat_title+"')\">" /*+ elem.menu_level_nm1  + " > " */+ elem.stat_title + "</div>";
//	            			html += "</li>";
//	            			
//	            			$tsMap.ui.searchKosisParam.push(elem);
//	            		}
//	            		
//	            		html += "</ul>";
//	            		html += "</div>";
...
//	            		}
//	            		$tsMap.ui.kosisPaging(result.totalcount, $tsMap.ui.kosisCurrentPageIndex);
//	            	}
//	            	
//	            } else if(res.errCd == "-401") {
//	            	accessTokenInfo(function() {
//	            		$tsMapApi.request.openApiKOSIS(options.searchword, options.pagenum);
//	            	});
//	            }
//	        },
//	        onFail : function(status) {
...
//	}());
	...
	(function () {
		$class("sop.openApi.ts.searchReverseGeoCode.api").extend(sop.portal.absAPI).define({
			onSuccess : function (status, res, options) {
				var that = options.target;
				if (res.errCd == "0") {		
					var result = res.result[0];
					if ($tsMap.ui.addressAdmCd != "") {
						if (options.division == "sop") {		//SOP
							if($tsMap.ui.addressAdmCd.length == 2) {
								$tsMap.ui.addressAdmCd = result.sido_cd;
							}else if ($tsMap.ui.addressAdmCd.length == 5) {
								$tsMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd;
							}else if ($tsMap.ui.addressAdmCd.length == 7) {
								$tsMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd + result.emdong_cd;
							}else {
								$tsMap.ui.addressAdmCd = "00";
							}
						} else {	//KOSIS
							$tsMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd + result.emdong_cd;
						}
					...
					if(options.division == "sop") {
            			...
            			$tsMap.ui.searchSOPParam = [elem];
            			$tsMap.ui.analysisSearchInfo("sop", 0);
					} else if(options.division == "kosis") {
						var x = options.url;
						$tsMap.ui.searchKosisParam[x]["adm_cd"] = $tsMap.ui.addressAdmCd;
						$tsMap.ui.searchKosisParam[x]["x"] = $tsMap.ui.x;
						$tsMap.ui.searchKosisParam[x]["y"] = $tsMap.ui.y;
						$tsMap.ui.searchKosisParam[x]["title"] = options.title;
						$tsMap.ui.analysisSearchInfo("kosis", x);
					}
				}
				else if (res.errCd == "-401") {
					accessTokenInfo(function() {
	...
	/** ********* 조건결합통계 Start ********* */
	(function() {
		$class("sop.openApi.ts.itemcombine.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {	
						if (res.errCd == "0") {
							var params = options.params;
...
//							$tsMap.ui.setShareInfo(options, "normal", map.id);
							map.shareInfo.setShareInfo(options, "normal", map.id);

						} else if (res.errCd == "-401") {
							accessTokenInfo(function() {
								$tsMapApi.request.openApiItemCombine(options.params);
							});
						} else {
							var map = options.params.map;
							map.clearDataOverlay();
	...
	/** ********* 사용자영역 경계조회 Start ********* */
	(function() {
		$class("sop.openApi.ts.userAreaBoundObj.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var map = options.map;
