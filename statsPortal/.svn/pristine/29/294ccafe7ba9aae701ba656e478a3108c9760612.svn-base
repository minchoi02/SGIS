...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '12', '00', '', '서비스 이용방법');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 이용방법</h1>
					...
					<!-- mng_s 20200408 이진호 / 도움말 현행화 -->
					<!--<img src="/img/newhelp/Mn_010_01.png" style="width:700px;" alt="월간통계 화면구성"/> -->
					<img src="/img/newhelp/Mn_010_01_002.png" style="width:700px;" alt="월간통계 화면구성"/>
					<!-- mng_e 20200408 이진호 -->
					...
					<h2>4) 지도창에서 행정구역을 선택하기 위해 마우스 오른쪽 버튼으로 클릭합니다.</h2>
 					...
 					<h2>6) 데이터/그래프 조회 : 통계항목에 대한 데이터와 그래프 조회를 수행합니다.</h2>
					<br><br>
					...
					<h2>○ 전ㆍ후ㆍ월 선택하여 전월, 전년동월비 보기 : 해당(선택) 월의 전, 후 월을 클릭하면 선택한 월의 전월비 및 전년동월비를 통계지도로 볼 수 있습니다.</h2>
					<h2>○ 항목선택 : 통계 항목 리스트가 보이며 원하는 항목을 선택하면 해당 항목의 데이터가 적용된 통계지도를 볼 수 있습니다.</h2>
					<h2>○ 월별 수치 시계열 그래프로보기 : 통계지도에서 해당 행정구역(시,도)를 클릭하면 해당 지역의 월별 수치를 시계열 그래프로 볼 수 있으며 그래프를 마우스로 클릭하면 전국그래프를 볼 수 있습니다.</h2>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
