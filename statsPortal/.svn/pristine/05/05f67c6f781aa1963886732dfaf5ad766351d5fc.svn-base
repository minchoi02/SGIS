...
<title>메인 | 통계청SGIS 오픈플랫폼</title>
    ...
    <script type="text/javascript" src="/js/edu_gallery/useCaseModify.js"></script>
...
<body>
	<div id="wrap">
		...
		<!-- body -->
			...
			<p class="mpGuide">
				<a href="/view/index">활용서비스&nbsp;>&nbsp;</a>
				<a href="/view/edu_gallery/resultGallery">통계갤러리&nbsp;>&nbsp;</a>
				<a href="/view/edu_gallery/getUseCaseModifyPage?id=<%=data_id%>"><span class="path_el current">활용사례 수정</span></a>
			</p>
