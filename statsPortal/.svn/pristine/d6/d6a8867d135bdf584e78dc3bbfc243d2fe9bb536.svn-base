...
public class GetMyDataCoordinate extends AbsQuery<Map> {

	private static final Log logger = LogFactory.getLog( GetMyDataCoordinate.class );
	...
	public Map executeAPI( HttpServletRequest req, HttpServletResponse res, String trId ) throws AbsException
	{
		...
		try
		{
			...
			String data_id = (String) mapParameter.get("dataId");
			...
			result = mypageMapper.selectMyDataInfo(data_id);
