...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '기본조작 방법-지도창 조작 방법');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>지도창 조작 방법</h1>
					<h2>○ 지도이동은 마우스 드래그 방식으로 동작하고, 지도확대 및 축소는 마우스 휠 조작 또는 지도레벨 컨트롤 조작에 의해서 동작합니다.</h2>
					...
					<h2>○ 데이터시각화 창에서 “설정“ 버튼을 누르면 데이터시각화 설정창이 표출되고, 데이터시각화 설정창에서 표출색상, 분류방법 등을 수정해서 적용할 수 있습니다.</h2>
					...
					<!-- mng_s 20210412 이진호, 북마크를 사용하기 위한 로그인 알림 이미지 및 문구 추가 -->	
					<br><br>
					<h2>○ 북마크 기능을 사용하려면 로그인을 해야 합니다.</h2>
					<img src="/img/newhelp/In_020_15_new.png" style="margin-left: 58px; width:314px; height:auto;" border=0 alt="로그인"/>
					<!-- mng_e 20210412 이진호 -->
						
					<br><br>
					<h1>공유 설정</h1>
					<h2>○ 지도화면에 표출되고 있는 통계정보를 블로그, 페이스북 등 SNS에 링크시켜서 공유할 수 있도록 하는 기능입니다.</h2>
					<h2>○ 지도화면에 통계정보가 표출된 상태에서 공유 버튼을 누르면 공유 안내창이 표출되고, 클립보드 복사를 통해서 원하는 곳에 링크 시킬 수 있습니다.</h2>
					<img src="/img/newhelp/In_020_14_new.png" style="margin-left: 58px; width:300px; height:32px" border=0 alt="공유 설정"/>	
					<br><br>
					
					<!-- mng_s 20210412 이진호, 공유는 로그인이 URL 공유기능은 로그인이 필요 없기 때문에 주석처리 -->					
