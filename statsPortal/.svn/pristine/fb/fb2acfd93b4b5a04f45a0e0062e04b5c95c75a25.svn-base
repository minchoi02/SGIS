	...
	<div class="myDataDivSub" id="myDataNormalDiv">
		...
		<div class="dbRangeBox">
			<ul class="dbTypeList" id="searchMethodBox">
				<li style="display:none; width:33%;" class="searchMethod01">
				...
				<li class="searchMethod02" style="display:none; width:33%;"><!-- id 삭제함. -->
				...
				<li class="searchMethod05" style="display:none; width:34%;"><!-- id 삭제함. -->
					<div class="dbTypeSubj">버블지도</div>
					<div class="dbTypeCk">
						<input type="radio" name="dbTypeCk" id="dbTypeCk05" value="pbubble" />
	                  	<label for="dbTypeCk05">선택</label>
					</div>
					<div class="dbTypeContents">
						<ul class="dbRingList">
							<li></li>
		...
		<div class="mydata_dbTypeSubj01" style="height:32px;line-height:32px;">데이터 표출 정보 설정
		...
		<ul class="dbTypeList" id="dataSelectZone" style="margin-left:5px;margin-bottom:20px;">
				...
				<li id="searchMethod03" class="weightSelDiv">
					<div class="dbTypeSubj"><span id="weightTxt">열지도</span> 가중치 컬럼 선택</div>
					<div class="dbTypeCk">
					<select id="weightSel" style="width:90%;padding:3px 3px 3px 3px;">
					</select>
					</div>
				</li>
		</ul>
