...
public class CommunityMapper extends EgovAbstractMapper {
	...
	public List<HashMap<String, Object>> selectOpenHistList(Map<String,Object> mapParameter) throws SQLException {
		return selectList("communityEtc.selectOpenHistList", mapParameter );
	}
	
	public List<HashMap<String, Object>> selectPointDataList(Map<String,Object> mapParameter) throws SQLException {
		return selectList("communityEtc.selectPointDataList",mapParameter);
	}
	
	public void updateCmmntyHits(Map<String,Object> mapParameter) throws SQLException {
		update("communityMap.updateCmmntyHits",mapParameter);
	}
