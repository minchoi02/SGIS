...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '08', '00', '', '서비스 이용방법-(생활)시도별 생활업종 현황');
        });
    </script> 
		...
		<div class="container">
				...
				<div class="leftmenu">
					<ul>
						...
						<li><a href="/view/newhelp/so_help_30_0">서비스 이용방법</a>
							<ul class="sub">
							<!--  190308 방민정수정 시작 -->
								<li><a href="/view/newhelp/so_help_30_0" class="on">ㆍ(생활)시도별 생활업종 현황</a></li>
								...
								<li><a href="/view/newhelp/so_help_30_5">ㆍ(생활)업종별 뜨는 지역</a></li><!-- mng_s 20190320 박찬성 주무관님 요청으로 현행화 전까지 하이드 -->
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h1>시도별 생활업종현황</h1>
					<h2>○ 17개 주요 시도별, 71종의 생활업종에 대한 다양한 통계정보를 조회하실 수 있습니다.</h2>
					...
					<img src="/img/newhelp/So_030_15_001.png" style="" border=0 alt="시도별 생활업종현황 - 종합현황"/>
					<!-- mng_e 20200331 이진호 -->
					
					<h2 style="text-align:center;">[시도별 생활업종현황 - 종합현황]</h2><br>
					
					<!-- mng_s 20200331 이진호 / 도움말 현행화 -->
					<!-- <img src="/img/newhelp/So_030_16.png" style="width:713px; height:373px" border=0 alt="시도별 생활업종현황 – 업종별 현황"/> -->
					<img src="/img/newhelp/So_030_16_001.png" style="" border=0 alt="시도별 생활업종현황 – 업종별 현황"/>
					<!-- mng_e 20200331 이진호 -->
						
					<h2 style="text-align:center;">[시도별 생활업종현황 – 업종별 현황]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
