		...
		<div class="container">
				...
				<div class="leftmenu">
					<ul>
						...
						<li><a href="/view/newhelp/mystatslo_help_30_0" class="on">서비스 이용방법</a>
							<ul class="sub">
								<li><a href="/view/newhelp/mystatslo_help_30_0" class="on">ㆍ나의</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>나의</h1>
					<!-- 2020-02-19 [김남민] 통계로-39 : 서비스 설명자료 수정. -->
					<h2>○ 관심지역과 생애주기를 선택하는 기능을 제공합니다.</h2>
					<img src="/img/newhelp/mystatslo_help_30_0_01.png" border=0 alt="나의 화면"/>
					<h2 style="text-align:center;">[나의 화면]</h2><br>
					<!-- 2020-02-19 [김남민] 통계로-39 : 서비스 설명자료 수정. -->
					<h2>1) 관심 생애주기 : 7가지 생애주기 중 최대 2개까지 선택가능 합니다.</h2>
					<h2>2) 생애주기 선택항목 : 선택한 생애주기 항목이 표시됩니다. 2개 이상 선택 시 최초 선택한 항목이 삭제되고, 최종선택한 항목이 추가됩니다.</h2> 
					<h2>3) 현재 관심지역 : 위치동의 및 관심지역 변경에 따라 현재 관심지역이 표시됩니다. : 관심지역 변경하기를 클릭하여 지역을 변경합니다.</h2>
					<h2>4) ‘&gt;’ 이미지 : ‘관심분야를’ 화면으로 이동합니다.</h2>
					<h2>5) SGIS : SGIS 클릭 시 ‘SGIS 통계지리정보시스템’으로 이동합니다.</h2>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
