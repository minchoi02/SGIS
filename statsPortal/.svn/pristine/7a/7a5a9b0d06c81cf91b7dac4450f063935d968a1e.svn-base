	...
	<div class="detail_box">
		<div style="padding-right:15px;">
			...
			<div class="btn_detail_group">
				...
				<button id="${popupId }-report-button" class="register" type="button" 
				onclick="javascript:$communityLeftMenu.ui.reportBtnClick( false );">
				<img src="${pageContext.request.contextPath}/img/community/icon_report.png" alt="">신고하기</button>
				<c:choose>
				...
				<div id="${popupId }-report-layer-popup" class="register_layer" data-layer="true">
					...
					<form id="${popupId }-report-form">
						...
						<div class="btn">
							...
							<button type="button" onclick="javascript:$communityLeftMenu.ui.reportBtnClick( true );">취소</button>
						</div>
