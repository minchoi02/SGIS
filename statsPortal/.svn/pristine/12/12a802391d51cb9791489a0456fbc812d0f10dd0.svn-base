...
<!-- 							<li>
							...
							<li>
								<a href="javascript:$myData.fileDownLoad('sample.zip')" class="spbox type02">TXT예제보기</a>
							</li>
							<li>
								<a href="javascript:$myData.fileDownLoad('sample_kml.zip')" class="spbox type02">KML예제보기</a>
							</li>
							<li>
				...
				<div class="btnbox">
					<div class="fl">
						...
						<a id="saveModify" href="javascript:$myData.popGio(8);" class="spbox type01" style="display:none; width: auto !important;">저장후 데이터편집</a>
					</div>
		...
		<div class="popBox dragbox" id="newSavePop" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:2147483647;display:none;">
				<div class="topbar closebtn1">
					<span>새 이름으로 저장</span> 
					<a href="javascript:void(0)">닫기</a>
				</div>
