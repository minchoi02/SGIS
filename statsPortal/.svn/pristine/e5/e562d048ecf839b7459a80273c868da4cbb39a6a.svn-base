 ...
 * 
 * history : 
 * 		2018.10.02	ywKim	대화형통계지도 소스 복사
 * 
 * author : ywKim
 * version : 1.0
 * see : 
 ...
 */
(function(W, D) {
	W.$ssaMapBtn = W.$ssaMapBtn || {};
	
	ssaMapBtnInfo = {
		btnInfo	: function(map, delegate) {// used
			$workRoad.ui.log("ssaMapBtnInfo.btnInfo - begin");
			 ...
			 * @history 	 :
			 */
			this.createUI = function(options) {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo.createUI - begin");
				...
				if (options != null) {
					...
					if (options.intrZoomControl != undefined && options.intrZoomControl) {
						//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가.
						this.createMapTypeBtn();
			...
			this.createPOIBtn = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createPOIBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var poiUI = sop.control({position: 'topright'});
				poiUI.onAdd = function (map) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createPOIBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				poiUI.update = function (props) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createPOIBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
			...
			this.createTechPOIBtn = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createTechPOIBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var poiUI = sop.control({position: 'topright'});
				poiUI.onAdd = function (map) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createTechPOIBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				    $(this._div).attr("id", 'poi_' +that.id);
				...
				poiUI.update = function (props) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createTechPOIBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
					html += "<a class='rightQuick rq01'><span>GPS</span></a>";
			...
			this.createSettingBtn = function(type) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createSettingBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var setUI = sop.control({position: 'topright'});
				setUI.onAdd = function (map) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createSettingBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				...
				setUI.update = function (props) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createSettingBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
			...
			this.createMapTypeBtn = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createMapTypeBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var mapUI = sop.control({position: 'topright'});
				mapUI.onAdd = function (map) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createMapTypeBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				...
				mapUI.update = function (props) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createMapTypeBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
					html += "<a class='rightQuick rq06'><span>GPS</span></a>";
					//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가. START
					html += "<ul class='rqListBox rq06' style='width: 80px;'>";
...
//					html += 	"<li id='backMap'><a name='white' class='ico_side_gps02'><span>백지도</span></a></li>"; //2020.02.19 iq250snail
//					html += 	"<li id='white_child' style='margin-left: 78px;margin-top: 10px; display:none;'><a name='white_child' class='ico_side_gps02'><span>숨기기</span></a></li>";
					html += "</ul>";
					//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가. END
					html += "</div>";
					this._div.innerHTML = html;
			 ...
			 * @history 	 :
			 */
			this.createZoomControl = function(type) {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo.createZoomControl - begin");
				
				var zoomUI = sop.control({position: 'topright'});
				zoomUI.onAdd = function (map) {// used
					$workRoad.ui.log("ssaMapBtnInfo.btnInfo.createZoomControl.[zoomUI.onAdd] - begin");
				...
				zoomUI.update = function (props) {// used
					$workRoad.ui.log("ssaMapBtnInfo.btnInfo.createZoomControl.[zoomUI.update] - begin");
			...
			this.createEasyZoomControl = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createEasyZoomControl");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var zoomUI = sop.control({position: 'topright'});
				zoomUI.onAdd = function (map) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createEasyZoomControl.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				    $(this._div).attr("id", 'zoom_' +that.id);
				...
				zoomUI.update = function (props) {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createEasyZoomControl.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
			...
			this.addLifePoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addLifePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='1001'><img src='/images/workRoad/ico/ico_1001.png' alt='인테리어'/><span style='cursor:pointer;'>인테리어</span></a></li>";	
				html += "<li><a name='1002'><img src='/images/workRoad/ico/ico_1002.png' alt='목욕탕'/><span style='cursor:pointer;'>목욕탕</span></a></li>";
				html += "<li><a name='1003'><img src='/images/workRoad/ico/ico_1003.png' alt='교습학원'/><span style='cursor:pointer;'>교습학원</span></a></li>";
				html += "<li><a name='1004'><img src='/images/workRoad/ico/ico_1004.png' alt='어학원'/><span style='cursor:pointer;'>어학원</span></a></li>";
				html += "<li><a name='1005'><img src='/images/workRoad/ico/ico_1005.png' alt='예체능학원'/><span style='cursor:pointer;'>예체능학원</span></a></li>";
				html += "<li><a name='1006'><img src='/images/workRoad/ico/ico_1006.png' alt='부동산중개업'/><span style='cursor:pointer;'>부동산중개업</span></a></li>";
				html += "<li><a name='1007'><img src='/images/workRoad/ico/ico_1007.png' alt='이발소'/><span style='cursor:pointer;'>이발소</span></a></li>";    		
				html += "<li><a name='1008'><img src='/images/workRoad/ico/ico_1008.png' alt='미용실'/><span style='cursor:pointer;'>미용실</span></a></li>";     			
				html += "<li><a name='1009'><img src='/images/workRoad/ico/ico_1009.png' alt='세탁소'/><span style='cursor:pointer;'>세탁소</span></a></li>";    				
				html += "<li><a name='1010'><img src='/images/workRoad/ico/ico_1010.png' alt='PC방'/><span style='cursor:pointer;'>PC방</span></a></li>";    				
				html += "<li><a name='1011'><img src='/images/workRoad/ico/ico_1011.png' alt='노래방'/><span style='cursor:pointer;'>노래방</span></a></li>";     								
			...
			this.addShopPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addShopPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='2001'><img src='/images/workRoad/ico/ico_2001.png' alt='문구점'/><span style='cursor:pointer;'>문구점</span></a></li>";        				
				html += "<li><a name='2002'><img src='/images/workRoad/ico/ico_2002.png' alt='서점'/><span style='cursor:pointer;'>서점</span></a></li>";    				
				html += "<li><a name='2003'><img src='/images/workRoad/ico/ico_2003.png' alt='편의점'/><span style='cursor:pointer;'>편의점</span></a></li>";    				
				html += "<li><a name='2004'><img src='/images/workRoad/ico/ico_2004.png' alt='식료품점'/><span style='cursor:pointer;'>식료품점</span></a></li>";    				
				html += "<li><a name='2005'><img src='/images/workRoad/ico/ico_2005.png' alt='휴대폰점'/><span style='cursor:pointer;'>휴대폰점</span></a></li>";  
				html += "<li><a name='2006'><img src='/images/workRoad/ico/ico_2006.png' alt='의류'/><span style='cursor:pointer;'>의류</span></a></li>";
				html += "<li><a name='2007'><img src='/images/workRoad/ico/ico_2007.png' alt='화장품/방향제'/><span style='cursor:pointer;'>화장품/방향제</span></a></li>";
				html += "<li><a name='2008'><img src='/images/workRoad/ico/ico_2008.png' alt='철물점'/><span style='cursor:pointer;'>철물점</span></a></li>";
				html += "<li><a name='2009'><img src='/images/workRoad/ico/ico_2009.png' alt='주유소'/><span style='cursor:pointer;'>주유소</span></a></li>";
				html += "<li><a name='2010'><img src='/images/workRoad/ico/ico_2010.png' alt='꽃집'/><span style='cursor:pointer;'>꽃집</span></a></li>";
				html += "<li><a name='2011'><img src='/images/workRoad/ico/ico_2011.png' alt='슈퍼마켓'/><span style='cursor:pointer;'>슈퍼마켓</span></a></li>";
			...
			this.addTrafficPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addTrafficPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='3001'><img src='/images/workRoad/ico/ico_3001.png' alt='지하철역'/><span style='cursor:pointer;'>지하철역</span></a></li>";    				
				html += "<li><a name='3002'><img src='/images/workRoad/ico/ico_3002.png' alt='터미널'/><span style='cursor:pointer;'>터미널</span></a></li>";    						
			...
			this.addLodgePoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addLodgePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='4001'><img src='/images/workRoad/ico/ico_4001.png' alt='호텔'/><span style='cursor:pointer;'>호텔</span></a></li>";
				html += "<li><a name='4002'><img src='/images/workRoad/ico/ico_4002.png' alt='여관'/><span style='cursor:pointer;'>여관</span></a></li>"; 	
				html += "<li><a name='4003'><img src='/images/workRoad/ico/ico_4003.png' alt='펜션'/><span style='cursor:pointer;'>펜션</span></a></li>";
			...
			this.addRestaurantPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addRestaurantPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='5001'><img src='/images/workRoad/ico/ico_5001.png' alt='한식'/><span style='cursor:pointer;'>한식</span></a></li>";
				html += "<li><a name='5002'><img src='/images/workRoad/ico/ico_5002.png' alt='중식'/><span style='cursor:pointer;'>중식</span></a></li>";
				html += "<li><a name='5003'><img src='/images/workRoad/ico/ico_5003.png' alt='일식'/><span style='cursor:pointer;'>일식</span></a></li>";
				html += "<li><a name='5004'><img src='/images/workRoad/ico/ico_5004.png' alt='분식'/><span style='cursor:pointer;'>분식</span></a></li>";
				html += "<li><a name='5005'><img src='/images/workRoad/ico/ico_5005.png' alt='서양식'/><span style='cursor:pointer;'>서양식</span></a></li>";
				html += "<li><a name='5006'><img src='/images/workRoad/ico/ico_5006.png' alt='제과점'/><span style='cursor:pointer;'>제과점</span></a></li>";
				html += "<li><a name='5007'><img src='/images/workRoad/ico/ico_5007.png' alt='패스트푸드'/><span style='cursor:pointer;'>패스트푸드</span></a></li>";
				html += "<li><a name='5008'><img src='/images/workRoad/ico/ico_5008.png' alt='치킨'/><span style='cursor:pointer;'>치킨</span></a></li>";
				html += "<li><a name='5009'><img src='/images/workRoad/ico/ico_5009.png' alt='호프/간이주점'/><span style='cursor:pointer;'>호프/간이주점</span></a></li>";
				html += "<li><a name='5010'><img src='/images/workRoad/ico/ico_5010.png' alt='카페'/><span style='cursor:pointer;'>카페</span></a></li>";
				html += "<li><a name='5011'><img src='/images/workRoad/ico/ico_5011.png' alt='기타 외국식'/><span style='cursor:pointer;'>기타 외국식</span></a></li>"; 
			...
			this.addPublicPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addPublicPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='6001'><img src='/images/workRoad/ico/ico_6001.png' alt='우체국'/><span style='cursor:pointer;'>우체국</span></a></li>";
				html += "<li><a name='6002'><img src='/images/workRoad/ico/ico_6002.png' alt='행정기관'/><span style='cursor:pointer;'>행정기관</span></a></li>";
				html += "<li><a name='6003'><img src='/images/workRoad/ico/ico_6003.png' alt='경찰/지구대'/><span style='cursor:pointer;'>경찰/지구대</span></a></li>";
				html += "<li><a name='6004'><img src='/images/workRoad/ico/ico_6004.png' alt='소방서'/><span style='cursor:pointer;'>소방서</span></a></li>"; 
			...
			this.addEduPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addEduPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='7001'><img src='/images/workRoad/ico/ico_7001.png' alt='초등학교'/><span style='cursor:pointer;'>초등학교</span></a></li>";
				html += "<li><a name='7002'><img src='/images/workRoad/ico/ico_7001.png' alt='중학교'/><span style='cursor:pointer;'>중학교</span></a></li>";
				html += "<li><a name='7003'><img src='/images/workRoad/ico/ico_7001.png' alt='고등학교'/><span style='cursor:pointer;'>고등학교</span></a></li>";
				html += "<li><a name='7004'><img src='/images/workRoad/ico/ico_7001.png' alt='전문대학'/><span style='cursor:pointer;'>전문대학</span></a></li>";
				html += "<li><a name='7005'><img src='/images/workRoad/ico/ico_7001.png' alt='대학교'/><span style='cursor:pointer;'>대학교</span></a></li>";
				html += "<li><a name='7006'><img src='/images/workRoad/ico/ico_7001.png' alt='대학원'/><span style='cursor:pointer;'>대학원</span></a></li>";
				html += "<li><a name='7007'><img src='/images/workRoad/ico/ico_7001.png' alt='어린이보육업'/><span style='cursor:pointer;'>어린이보육업</span></a></li>";
			...
			this.addCompanyPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addCompanyPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='8001'><img src='/images/workRoad/ico/ico_8001.png' alt='제조/화학'/><span style='cursor:pointer;'>제조/화학</span></a></li>";
				html += "<li><a name='8002'><img src='/images/workRoad/ico/ico_8002.png' alt='서비스'/><span style='cursor:pointer;'>서비스</span></a></li>";
				html += "<li><a name='8003'><img src='/images/workRoad/ico/ico_8003.png' alt='통신/IT'/><span style='cursor:pointer;'>통신/IT</span></a></li>";
				html += "<li><a name='8004'><img src='/images/workRoad/ico/ico_8004.png' alt='건설'/><span style='cursor:pointer;'>건설</span></a></li>";
				html += "<li><a name='8005'><img src='/images/workRoad/ico/ico_8005.png' alt='판매/유통'/><span style='cursor:pointer;'>판매/유통</span></a></li>";
				html += "<li><a name='8006'><img src='/images/workRoad/ico/ico_8006.png' alt='기타금융업'/><span style='cursor:pointer;'>기타금융업</span></a></li>";
				html += "<li><a name='8007'><img src='/images/workRoad/ico/ico_8007.png' alt='기타의료업'/><span style='cursor:pointer;'>기타의료업</span></a></li>";
				html += "<li><a name='8008'><img src='/images/workRoad/ico/ico_8008.png' alt='문화/체육'/><span style='cursor:pointer;'>문화/체육</span></a></li>";
			...
			this.addCulturePoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addCulturePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html += "<li><a name='9001'><img src='/images/workRoad/ico/ico_9001.png' alt='백화점/중대형마트'/><span style='cursor:pointer;'>백화점/중대형마트</span></a></li>";
				html += "<li><a name='9002'><img src='/images/workRoad/ico/ico_9002.png' alt='은행'/><span>은행</span style='cursor:pointer;'></a></li>";
				html += "<li><a name='9003'><img src='/images/workRoad/ico/ico_9003.png' alt='병원'/><span>병원</span style='cursor:pointer;'></a></li>";
				html += "<li><a name='9004'><img src='/images/workRoad/ico/ico_9004.png' alt='극장/영화관'/><span style='cursor:pointer;'>극장/영화관</span></a></li>";
				html += "<li><a name='9005'><img src='/images/workRoad/ico/ico_9005.png' alt='도서관/박물관'/><span style='cursor:pointer;'>도서관/박물관</span></a></li>";
			...
			this.addTechPoiList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addTechPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addBoundaryLevelList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addBoundaryLevelList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>"
			...
			this.addMultiSelectList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addMultiSelectList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>";
			...
			this.addMeasureList = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.addMeasureList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>";
			 ...
			 * @history 	 :
			 */
			this.changeZoomLevelTitle = function(title) {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo. - begin");
			...
			this.closeMenu = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.closeMenu");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.initTree = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.initTree");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				this.curSelectedCompanyNode = null;
			...
			this.clearPOI = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.clearPOI");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				this.closeMenu();
			...
			this.controlHide = function(name) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.controlHide");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				if (name == "poi") {
					$(this.poiObj).hide();
			...
			this.controlShow = function(name) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.controlShow");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				if (name == "poi") {
					$(this.poiObj).show();
				}else if (name == "setting") {
					$(this.setObj).show();
			...
			this.createSatelliteCRS = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createSatelliteCRS");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.createSatelliteTileLayer = function() {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createSatelliteTileLayer");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.createTileLayer = function(map, crs, baseLayer, targetLayer, zoomMargin) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.createTileLayer");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			 ...
			 * @history 	 :
			 */
			this.doClearSelectedBound = function() {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo. - begin");
			 ...
			 * @history 	 :
			 */
			this.setFixedBoundBtn = function(bool) {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo. - begin");
			 ...
			 * @history 	 :
			 */
			this.eventHandler = function() {// used
				$workRoad.ui.log("ssaMapBtnInfo.btnInfo.eventHandler - begin");
				
				//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가. START
				var timer = null;
				
				$("body").on('mouseenter' , '#backMap' , function(){
					if(that.map.mapMode == 'white'){
						$("#white_child").show();
				...
				$("#poi_" + that.id).find(".rightQuick.rq01").click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[1]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					...
					$("#poi_" + that.id).find(".rqListBox").stop().animate({"right":"-650px"},0);//20200424 수정 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
					if(!on){
						that.closeMenu();
						$(this).next(".rqListBox").stop().animate({"right":"45px"},0);//20200424 수정 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
						$(this).addClass("on");
					}else{
						$(this).next(".rqListBox").stop().animate({"right":"-650px"},0);//20200424 수정 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
						$(this).removeClass("on");
					}
				});
				
				$("#set_" + that.id).find(".rightQuick.rq02").click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[2]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on");
					...
					$("#set_" + that.id).find(".rqListBox").stop().animate({"right":"-650px"},0);//20200424 수정 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
					if(!on){
						that.closeMenu();
						$(this).next(".rqListBox").stop().animate({"right":"45px"},0);//20200424 수정 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
						$(this).addClass("on");
				...
				$("#map_" + that.id).find(".rightQuick.rq06").click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[3]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on");
				...
				$("#poi_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[4]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on"); 
					if(!on){
						$("#poi_" + that.id).find(".rqListBox>li>a").removeClass("on");
						$("#poi_" + that.id).find(".rqListBox>li>ul, .rqListBox>li>ol").hide();
				...
				$("#set_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[5]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					//경계가 고정이고,
				...
				$("#map_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[6]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on"); 
					if(!on){
						that.isOpenPOI = false;
				...
				$(settingList).mouseover(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[7]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					$(this).addClass("over");
				});
				
				$(settingList).mouseout(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[8]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$(optionList).click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[9]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var val = $(this).html();
				...
				$("#poi_" + that.id).find("#industry").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[10]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				});
				//세부POI 선택
				$("#poi_" + that.id).find(".rqListBox>li>ol>li").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[11]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$("#set_" + that.id).find(".rqListBox>li>ul>li").click(function(e){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[12]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					...
					switch(typeList[type]) {
						...
						case 2:	//오버레이 초기화
							...
							if (that.map.drawControl != null) {				// 예외처리 - 2019.01.07	ywKim	변경
				...
				$("#map_" + that.id).find(".rqListBox>li").click(function(){
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[13]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var type = $(this).find("a").attr("name");
					var zoomMargin, crs;
					//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가. START
					if (type == "settlite") {
						...
						that.map.mapMode =  sop.mapMode = "settlite"; // 2019년반영 시작 djlee
				...
				$("#set_" + that.id).find(".ico_side_reset").click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[14]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					$("#set_" + that.id).find(".map_measure").find("span").html("지도<br/>측정");
				...
				//zoom-in
				$("#zoom_" + that.id).find(".rightQuick.rq03").click(function() {// used
					$workRoad.ui.log('ssaMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq03").click] - begin');
				...
				//zoom-out
				$("#zoom_" + that.id).find(".rightQuick.rq05").click(function() {// used
					$workRoad.ui.log('ssaMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq05").click] - begin');
				...
				$("#zoom_" + that.id).find(".rightQuick.rq07").click(function(){// used
					$workRoad.ui.log('ssaMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq07").click] - begin');
					
					var on = $(this).hasClass("on");
					if(!on){
						$(this).addClass("on");
						$(this).css("background-image","url(/images/workRoad/ico/ico_moveType02.png)");
						...
						$(this).removeClass("on");
						$(this).css("background-image","url(/images/workRoad/ico/ico_moveType01.png)");
				...
				$("#poiInit_"+that.id).click(function() {
					$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.eventHandler.[18]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					that.isOpenPOI = false;
					that.map.markers.clearLayers();
			...
			this.reqThemePoiInfo = function(themeCd, pageNum) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.reqThemePoiInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				var sopOpenApiCompanySearchObj = new sop.openApi.ssa.companySearch.api();
			...
			this.reqCompanyPoiInfo = function(class_cd, class_deg, pageNum) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.reqCompanyPoiInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				var sopOpenApiCompanySearchObj = new sop.openApi.ssa.companyPoiSearch.api();
				sopOpenApiCompanySearchObj.addParam("accessToken", accessToken);
				sopOpenApiCompanySearchObj.addParam("bnd_year", this.bndYear);
				sopOpenApiCompanySearchObj.addParam("year", this.year);
				sopOpenApiCompanySearchObj.addParam("area_type", "1");
			...
			this.reqInterstryList = function(depth, class_deg, class_cd) {
				$workRoad.ui.addFnc04List("ssaMapBtnInfo.btnInfo.reqInterstryList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiInderstryCodeObj = new sop.openApi.ssa.InderstryList.api();
	...
	if ($workRoad.ui.isSetCallback('ssaMapBtn')) return;	
	
	/** ********* 테마사업체 POI 조회 START ********* */
	(function () {
		$class("sop.openApi.ssa.companySearch.api").extend(sop.portal.absAPI).define({
	...
	/** ********* 사업체 POI 조회 START ********* */
	(function () {
		$class("sop.openApi.ssa.companyPoiSearch.api").extend(sop.portal.absAPI).define({
			onSuccess : function (status, res, options) {
				var that = options.target;
				if (res.errCd == "0") {
	...
	/** ********* OpenAPI 산업체분류 Start ********* */
	(function() {
		$class("sop.openApi.ssa.InderstryList.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
