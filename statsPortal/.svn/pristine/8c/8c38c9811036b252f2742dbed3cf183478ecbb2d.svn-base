...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '07', '00', '', '서비스 이용방법-주거현황 보기');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>주거현황 보기 </h1>
					<img src="/img/newhelp/img_house_4_00.png" style="width:90px; margin-top:-52px; margin-left:130px;" alt="주거현황 보기" />
					...
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_4_02_1.png" style="margin-left: 0px;" alt="지역 선택 과 지표 선택">
					...
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_4_03_1.png" style="margin-left: 0px;" alt="지역 별 종합정보 조회 – 지역 선택">
						<figcaption>[지역 별 종합정보 조회 – 지역 선택]</figcaption>
					</figure>
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_4_04_1.png" style="margin-left: 0px;" alt="지역 별 종합정보 조회 – 지표 정보 조회">
...
<!-- 								<li>시군구별 지표의 색상지도를 전국으로 볼려면 <img src="/img/newhelp/img_house_4_06.png" style="width:24px; vertical-align: middle; margin: -5px 0 0 0;">버튼을 클릭하면 된다.</li> -->
					...
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_4_05_1.png" style="margin-left: 0px;" alt="">
