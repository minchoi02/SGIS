...
public class GetStatsRegion extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(GetStatsRegion.class);
	...
	public List<Map<String, Object>> executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			resultLust = session.selectList("statsMeMap.selectListMapRegion", mapParameter);
