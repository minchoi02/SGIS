...
<div class="dataBoardDiv" id="publicDataDiv">
	<dl class="dscList"> 
		...
		<dd class="publicDataDD" id="publicMetroDiv">
			...
			<!-- mng_s 20210525 이진호, 데이터 출처년도 수정 -->
			<p class="origin_txt_2" style="margin-right: 20px;">출처 : 철도 노선별 관리기관, 지하철 이용현황 (2020)</p>
			<!-- mng_e 20210525 이진호 -->
		...
		<dd class="publicDataDD" id="publicBusStopDiv">
			...
			<!-- mng_s 20211028 이진호, 버스정류장 위치정보 2020년 들어옴에 따른 출처문구 수정 -->
			<p class="origin_txt_2" style="margin-right: 20px;">출처 : 교통안전공단, 버스정류장 위치정보 (2020)</p>
			<!-- mng_e 20211028 이진호 -->
		...
		<dd id="userAreaDiv"> 	<!-- 2017.06.26 [개발팀] 공공데이터 추가 -->
			...
			<!-- 2017.07.24 [개발팀] 출처표출-->
			<!-- mng_s 20201029 이진호 / 2020 센서스 반영 출처 변경 -->
			<!-- <p class="origin_txt_2" style="padding-right:10px;">통계청 , 인구주택총조사, 2018 / 통계청, 전국사업체조사, 2018</p> -->
			<p class="origin_txt_2" style="margin-right: 20px;">통계청 , 인구주택총조사, 2019 / 통계청, 전국사업체조사, 2018</p>
			<!-- mng_e 20201029 이진호 -->			
		</dd>
	</dl>
</div>