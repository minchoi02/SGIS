...
<link rel="stylesheet" type="text/css" href="/sample2/include/css/gallery_pop.css"  property="" />
				<!-- gallery pop 2 start-->
				...
				<!-- jsp/common/gallaryDialog.jsp gallery pop 2 end-->
				<!-- jsp/common/gallaryDialog.jsp gallery pop 3 start-->
