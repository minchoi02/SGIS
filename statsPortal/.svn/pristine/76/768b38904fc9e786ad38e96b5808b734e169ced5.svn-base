...
(function(W, D) {
	...
	saMapBtnInfo = {
		btnInfo	: function(map, delegate) {// used
			$workRoad.ui.log("saMapBtnInfo.btnInfo - begin");
			...
			this.createUI = function(options) {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.createUI - begin");
			...
			this.createPOIBtn = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createPOIBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var poiUI = sop.control({position: 'topright'});
				poiUI.onAdd = function (map) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createPOIBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				poiUI.update = function (props) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createPOIBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
			...
			this.createTechPOIBtn = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createTechPOIBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var poiUI = sop.control({position: 'topright'});
				poiUI.onAdd = function (map) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createTechPOIBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				    $(this._div).attr("id", 'poi_' +that.id);
				...
				poiUI.update = function (props) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createTechPOIBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
					html += "<a class='rightQuick rq01'><span>GPS</span></a>";
			...
			this.createSettingBtn = function(type) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createSettingBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var setUI = sop.control({position: 'topright'});
				setUI.onAdd = function (map) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createSettingBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				...
				setUI.update = function (props) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createSettingBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
			...
			this.createMapTypeBtn = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createMapTypeBtn");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var mapUI = sop.control({position: 'topright'});
				mapUI.onAdd = function (map) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createMapTypeBtn.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				...
				mapUI.update = function (props) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createMapTypeBtn.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
					html += "<div class='mapBtnWrapper' data-html2canvas-ignore=true>";
...
//					html += 	"<li id='white_child' style='margin-left: 78px;margin-top: 10px; display:none;'><a name='white_child' class='ico_side_gps02'><span>숨기기</span></a></li>";
			...
			this.createZoomControl = function(type) {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.createZoomControl - begin");
				
				var zoomUI = sop.control({position: 'topright'});
				zoomUI.onAdd = function (map) {// used
					$workRoad.ui.log("saMapBtnInfo.btnInfo.createZoomControl.[zoomUI.onAdd] - begin");
				...
				zoomUI.update = function (props) {// used
					$workRoad.ui.log("saMapBtnInfo.btnInfo.createZoomControl.[zoomUI.update] - begin");
			...
			this.createEasyZoomControl = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createEasyZoomControl");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var zoomUI = sop.control({position: 'topright'});
				zoomUI.onAdd = function (map) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createEasyZoomControl.onAdd");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				    this._div = sop.DomUtil.create('div', 'info');
				    sop.DomEvent.disableClickPropagation(this._div);
				    this.update();
				    $(this._div).attr("id", 'zoom_' +that.id);
				...
				zoomUI.update = function (props) {
					$workRoad.ui.addFnc03List("saMapBtnInfo.createEasyZoomControl.update");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var html = "";
			...
			this.addLifePoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addLifePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addShopPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addShopPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addTrafficPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addTrafficPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addLodgePoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addLodgePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addRestaurantPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addRestaurantPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addPublicPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addPublicPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addEduPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addEduPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addCompanyPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addCompanyPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addCulturePoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addCulturePoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addTechPoiList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addTechPoiList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
			...
			this.addBoundaryLevelList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addBoundaryLevelList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>"
			...
			this.addMultiSelectList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addMultiSelectList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>";
			...
			this.addMeasureList = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.addMeasureList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var html = "";
				html +=	"<ul>";
			...
			this.changeZoomLevelTitle = function(title) {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.changeZoomLevelTitle - begin");
			...
			this.closeMenu = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.closeMenu");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				//20200424 수정 시작 (10번. 아이콘 우측에서 날라옴, 200ms ==> 0ms)
				$("#poi_" + that.id).find(".rightQuick.rq01").next(".rqListBox").stop().animate({"right":"-650px"},0);
				$("#poi_" + that.id).find(".rightQuick.rq01").removeClass("on");
				$("#set_" + that.id).find(".rightQuick.rq02").next(".rqListBox").stop().animate({"right":"-650px"},0);
				$("#set_" + that.id).find(".rightQuick.rq02").removeClass("on");
				$("#map_" + that.id).find(".rightQuick.rq06").next(".rqListBox").stop().animate({"right":"-650px"},0);
			...
			this.initTree = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.initTree");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				this.curSelectedCompanyNode = null;
			...
			this.clearPOI = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.clearPOI");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				this.closeMenu();
			...
			this.controlHide = function(name) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.controlHide");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				if (name == "poi") {
					$(this.poiObj).hide();
			...
			this.controlShow = function(name) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.controlShow");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				if (name == "poi") {
					$(this.poiObj).show();
				}else if (name == "setting") {
					$(this.setObj).show();
			...
			this.createSatelliteCRS = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createSatelliteCRS");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.createSatelliteTileLayer = function() {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createSatelliteTileLayer");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.createTileLayer = function(map, crs, baseLayer, targetLayer, zoomMargin) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.createTileLayer");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			this.doClearSelectedBound = function() {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.doClearSelectedBound - begin");
			...
			this.setFixedBoundBtn = function(bool) {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.setFixedBoundBtn - begin");
			...
			this.eventHandler = function() {// used
				$workRoad.ui.log("saMapBtnInfo.btnInfo.eventHandler - begin");
				...
				$("#poi_" + that.id).find(".rightQuick.rq01").click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[1]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$("#set_" + that.id).find(".rightQuick.rq02").click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[2]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on");
				...
				$("#map_" + that.id).find(".rightQuick.rq06").click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[3]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on");
				...
				$("#poi_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[4]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on"); 
					if(!on){
						$("#poi_" + that.id).find(".rqListBox>li>a").removeClass("on");
						$("#poi_" + that.id).find(".rqListBox>li>ul, .rqListBox>li>ol").hide();
				...
				$("#set_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[5]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					//경계가 고정이고,
				...
				$("#map_" + that.id).find(".rqListBox>li>a").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[6]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var on = $(this).hasClass("on"); 
					if(!on){
						that.isOpenPOI = false;
				...
				$(settingList).mouseover(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[7]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					$(this).addClass("over");
				});
				
				$(settingList).mouseout(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[8]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$(optionList).click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[9]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var val = $(this).html();
				...
				$("#poi_" + that.id).find("#industry").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[10]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				});
				//세부POI 선택
				$("#poi_" + that.id).find(".rqListBox>li>ol>li").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[11]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$("#set_" + that.id).find(".rqListBox>li>ul>li").click(function(e){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[12]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				$("#map_" + that.id).find(".rqListBox>li").click(function(){
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[13]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					var type = $(this).find("a").attr("name");
					var zoomMargin, crs;
					//2019-12-26 [김남민] 일자리 맵 > 위성지도, 백지도 추가. START
					if (type == "settlite") {
				...
				$("#set_" + that.id).find(".ico_side_reset").click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[14]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					$("#set_" + that.id).find(".map_measure").find("span").html("지도<br/>측정");
				...
				$("#zoom_" + that.id).find(".rightQuick.rq03").click(function() {// used
					$workRoad.ui.log('saMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq03").click] - begin');
				...
				$("#zoom_" + that.id).find(".rightQuick.rq05").click(function() {// used
					$workRoad.ui.log('saMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq05").click] - begin');
					if (!that.map.isFixedBound) {
				...
				$("#zoom_" + that.id).find(".rightQuick.rq07").click(function(){// used
					$workRoad.ui.log('saMapBtnInfo.btnInfo.eventHandler.[$("#zoom_" + that.id).find(".rightQuick.rq07").click] - begin');
					var on = $(this).hasClass("on");
					if(!on){
						$(this).addClass("on");
				...
				$("#poiInit_"+that.id).click(function() {
					$workRoad.ui.addFnc03List("saMapBtnInfo.eventHandler.[18]");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
					that.isOpenPOI = false;
					that.map.markers.clearLayers();
			...
			this.reqThemePoiInfo = function(themeCd, pageNum) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.reqThemePoiInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				var sopOpenApiCompanySearchObj = new sop.openApi.sa.companySearch.api();
			...
			this.reqCompanyPoiInfo = function(class_cd, class_deg, pageNum) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.reqCompanyPoiInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				var sopOpenApiCompanySearchObj = new sop.openApi.sa.companyPoiSearch.api();
				sopOpenApiCompanySearchObj.addParam("accessToken", accessToken);
				sopOpenApiCompanySearchObj.addParam("bnd_year", this.bndYear);
				sopOpenApiCompanySearchObj.addParam("year", this.year);
				sopOpenApiCompanySearchObj.addParam("area_type", "1");
			...
			this.reqInterstryList = function(depth, class_deg, class_cd) {
				$workRoad.ui.addFnc03List("saMapBtnInfo.reqInterstryList");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiInderstryCodeObj = new sop.openApi.sa.InderstryList.api();
	...
	if ($workRoad.ui.isSetCallback('saMapBtn')) return;
	
	/** ********* 테마사업체 POI 조회 START ********* */
	(function () {
		$class("sop.openApi.sa.companySearch.api").extend(sop.portal.absAPI).define({
	...
	/** ********* 사업체 POI 조회 START ********* */
	(function () {
		$class("sop.openApi.sa.companyPoiSearch.api").extend(sop.portal.absAPI).define({
			onSuccess : function (status, res, options) {
				var that = options.target;
				if (res.errCd == "0") {
	...
	/** ********* OpenAPI 산업체분류 Start ********* */
	(function() {
		$class("sop.openApi.sa.InderstryList.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
