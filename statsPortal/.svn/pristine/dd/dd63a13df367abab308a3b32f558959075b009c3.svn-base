    ...
    <script type="text/javascript">       
		...
		$(document).ready(function(){
			...
			$('input').focusin(function(){
				...
				$(this).closest("p").find("button").attr("class","num select");
			});
   		...
   		<div class="cont_wrap">
			<div class="cont">
				...
				<div id="srv11" class="answer_wrap layout_style01">
				    ...
				    <p class="answer"><label><button class="num" onclick="setVal(11,8,8,this)">8</button>기타&nbsp;</label><input type="text" id="etc11" maxlength="100"></p>
				</div>     
                ...
                <div id="srv3" class="answer_wrap">
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(3,5,5)">5</button>기타&nbsp;</label><input type="text" id="etc3" maxlength="100"></p>
                </div>
                ...
                <div id="srv31" class="answer_wrap">
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(31,5,5)">5</button>기타 </label><input type="text" id="etc31" maxlength="100"></p>
                </div>
                ...
                <div id="srv4" class="answer_wrap layout_style01">
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(4,9,9)">9</button>기타&nbsp;</label><input type="text" id="etc4" maxlength="100"></p>
                </div>
                ...
                <div id="srv41" class="answer_wrap layout_style01"> 
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(41,5,5)">5</button>기타&nbsp;</label><input type="text" id="etc41" maxlength="100"></p>
                </div>
                ...
                <div id="srv5" class="answer_wrap layout_style01">  
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(5,15,15,this)">15</button>개발지원센터(Open API)</label></p>
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(5,20,20,this)">20</button>기타&nbsp;</label><input type="text" id="etc5" maxlength="100"></p>
                </div>
                ...
                <div id="srv61" class="answer_wrap srv61" style="display:none;">
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(61,5,5)">5</button>기타&nbsp;</label><input type="text" id="etc61" maxlength="100"></p>
                </div>
                ...
                <div id="srv62" class="answer_wrap srv62" style="display:none;">
                    ...
                    <p class="answer"><label><button class="num" onclick="setVal(62,5,5)">5</button>기타&nbsp;</label><input type="text" id="etc62" maxlength="100"></p>
                </div>

                <h5>7. SGIS 서비스 향상을 위해 바라시는 점 또는 개선의견을 자유롭게 작성하여 주시기 바랍니다.</h5>
                <div class="answer_wrap">
                    <textarea id="srv7" name="name" rows="8" cols="80"></textarea>
                </div>
