...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '05', '00', '', '서비스 이용방법-수요변화형지표');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<!--<h2 style="text-align:center;">[수요변화형지표]</h2><br> -->
					...
					<!--<h2>5) 경계레벨설정 : 현재 선택한 지역을 기준으로 최대 2레벨까지 통계조회를 할 수 있습니다.(통계청 등록일 경우) (통계청이 등록한 정책통계지도의 경우)</h2> -->
					<br><br>
					
					<img src="/img/newhelp/Ps_030_04.png" width=600 height=auto border=0 alt="수요변화형지표-데이터보드"/>
					<h2 style="text-align:center;">[수요변화형지표 - 데이터보드]</h2><br>
					<h2>1) 데이터 보드 : 표출된 통계의 기본정보 및 그래프,표정보를 제공합니다.</h2>	
					<br><br>
					<img src="/img/newhelp/Ps_030_02.png" width=600 height=auto border=0 alt="통계연산형지표-융합결과"/>
					<h2 style="text-align:center;">[수요변화지표 - 융합결과]</h2><br>	
					<h2>2) 융합통계 : 기준/추가 데이터의 융합정보를 제공합니다.</h2>	
					<h2>3) 융합상세정보 : 융합된 통계의 상세정보(정책내용, 그래프, 표 등)를 제공합니다.</h2>	
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
