...
<script type="text/javascript">
	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="contents">
				<ul class="location">
					<li><a href="/jsp/english/index.jsp"><img src="/images/common/location_home.gif" alt="홈"></a></li>
					<li><a href="/jsp/english/application.jsp">Applications</a></li>
				</ul>
				<div id="content_2">
					<!-- 게시판 전체 영역// -->
					<div id="article-wrap">
						...
						<div class="tab_contents"">
							<div class="article-list"">
								<div id="content">
									<div class="pl20 pr20">
										<!-- 일자리맵 -->
										<h2 id="application1" style="float:left">The Job Map</h2>&nbsp;&nbsp;&nbsp;
										<a href="/view/workRoad/main"><img src="/jsp/english/img/btn_service.png" alt="서비스 바로가기" /></a><hr>
										<h4 class="itit">Service Overview</h4>
										<p class="para mb25">
											○ The Job Map is a service that provides job information and status that meet the user's conditions, such as today's job status, job view, and job status analysis using job information collected from Worknet, Saramin and Incruit.<br>
											○ In addition, the job statistics analysis is a service that allows you to search indicators such as job status, job increase or decrease, job quality, economic situation and the quality of life.<br/>
											○ Main function<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;- Today's Job Status<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;: Today's Job Status is a service that allows you to search the current status and daily increase or decrease of all, new and terminated jobs registered in Worknet, Saramin and Incruit.<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;- Job View<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;: Job View is a service that allows you to search job information under various conditions.<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;- Job Status Analysis<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;: Job Status Analysis is a service that allows you to search by region and target for the job status you want to know by supporting various job topics using job information of Worknet, Incruit and Saramin.<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;- Job Statistics Analysis<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;: Job Statistics Analysis is a service that allows you to inquire about job status/increase or decrease/quality, economic status and the quality of life<br/>
										</p>
										<h4 class="itit">Screen Layout</h4>
										<p><img src="/img/newhelp/img_workroad_1_01.png" alt="일자리맵 안내" style="width:850px;"/></p>
										<p class="para mb25">
											1) Menu selection: Runs today's job status, job view, job status analysis and job statistics analysis.<br/>
											2) Today's Job Status: You can select the region of your interesting for Today's Job Status.<br/>
											3) Data board: Provides inquired statistical data information in the form of graphs, etc.<br/>
											4) Map Zoom In/Out: Zoom in and out of the map.<br/>
											5) Legend window: Displays the legend of the displayed statistics and the legend settings can be changed.<br/>
										</p><br><br><br><br>
										
										<!-- My통계로 -->
										<h2 id="application2" style="float:left">My Statistics Road</h2>&nbsp;&nbsp;&nbsp;
										<a href="/view/statsMe/statsMeMain"><img src="/jsp/english/img/btn_service.png" alt="서비스 바로가기" /></a><hr>
										<h4 class="itit">Service Overview</h4>
										<p class="para mb25">
											○ Provides spatial statistical information for personal interesting topics.<br/>
											○ You can use all the pages of SGIS (Statistical and Geographic Information Service) on one interface.<br/>
											○ We provide personalized services in a user-oriented environment through the language of people's lives.<br/>
											○ It is an effective information delivery-oriented service through a concise interface.<br/>
											○ Keyword search type service is provided for information search convenience.<br/>
											○ You can intuitively check statistics through the catalog service.<br/>
											○ Main function<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;-My: Provides a function to recommend statistical information according to the region of interest and life cycle selection<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;-Interest field: Provides a function to recommend statistical information according to the region of interest and the field of interest<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;-By selecting from the catalog: Provides a list of statistical geographic information according to life cycle, distance selection and keywords and provides a link to the relevant SGIS content of the list of retrieved statistical geographic information<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;-Check on the map: Provides a function to display the information selected from the list of statistical geographic information on the map<br/>
											&nbsp;&nbsp;&nbsp;&nbsp;-Check detailed information: Provides detailed information from the list of statistical and geographic information<br/>
										</p>
										<h4 class="itit">Screen Layout</h4>
										<p><img src="/img/newhelp/mystatslo_help_10_0_01.png" alt="My통계로 안내" style="width:850px;"/></p>
										<p class="para mb25">
											1) Navigation: Moves the screen and manages the selected items (life cycle, interests, catalog).<br/>
											2) Contents: Each content is displayed, such as my, interest field, catalog, check on the map and check detailed information.<br/>
										</p><br><br><br><br>
										
										
										<!-- 정책 통계지도 -->
										<h2 id="application3" style="float:left">Policy Statistical Map</h2>&nbsp;&nbsp;&nbsp;
										...
										<!-- 기술업종 통계지도 -->
										<h2 id="application4" style="float:left">Technical Industry Statistics Map</h2>&nbsp;&nbsp;&nbsp;
										...
										<!-- 살고싶은 우리동네 -->
										<h2 id="application5" style="float:left">Where We Want To Live In</h2>&nbsp;&nbsp;&nbsp;
										...
										<!-- 우리동네 생활업종 박길섭 수정-->
										<h2 id="application6" style="float:left">Our Town’s Industry</h2>&nbsp;&nbsp;&nbsp;
										<a href="/view/bizStats/bizStatsMap?biz=0"><img src="/jsp/english/img/btn_service.png" alt="서비스 바로가기" /></a><hr>
										<h4 class="itit">Service Overview</h4>
										<p class="para mb25">
										...
										<!-- 지역현안 소통지도-->
										<h2 id="application7" style="float:left">Regional Issues Communication Map</h2>&nbsp;&nbsp;&nbsp;
										...
										<!-- 통계지도체험-->
										<h2 id="application8" style="float:left">Statistics Map Experience</h2>&nbsp;&nbsp;&nbsp;
										...
										<!-- 통계갤러리-->
										<h2 id="application9" style="float:left">Statistics Gallery</h2>&nbsp;&nbsp;&nbsp;
