	   		...
	   		<div class="policywContents">
	   			...
	   			<div class="policyFormArea">
	   				<div class="pcGuide">
	   					...
	   					<a id="delete_bt" style="display:none; top:80px; background:#666; cursor:pointer;">삭제</a>
	   				</div>
	   				<ul class="pcTabs">
	   				...
	   				<div class="pcTabArea" id="policyStoryArea">
	   					<form id="policyMapUploadForm" name="policyMapUploadForm" method="post">
		   					...
		   					<dl class="dscList extraRankArea" id="gongDataArea" style="display:none;">
				   				<dt class="mt15" style="height:70px;">
			    					<span style="font-size:11px; color:blue;">※ 본 자료는 공공데이터포탈(data.go.kr)에 각 지자체가 업로드 한 표준데이터를 활용하였기에, 자료가 누락된 지역이 있을 수도 있으며, 지자체 별로 갱신주기가 다릅니다. 이점 활용에 유의하시기 바랍니다</span> 
			    				</dt>
			    				<dd>
			    				</dd>
		    				</dl>
	    			...
	    			<div class="pcTabArea" id="policyCombineDataArea" style="display:none;padding:0 5px 30px 20px;"> <!-- 2018.01.03 [개발팀] -->
	    				...
	    				<div class="compareBox" id="combineBox">
	    					<div class="typeBox" id="combineTypeBox" style="margin-top:14px"><!-- 2018.06.12 ywKim 변경: 엑셀버튼의 상단여백 주기  [v180611] - 엑셀다운/정렬 기능 추가 -->
							...
							<!-- 2018.06.12 ywKim 추가: 엑셀버튼 추가 [v180611] - 엑셀다운/정렬 기능 추가 -->
							<div>	    						
	    						<a href="javascript:void(0)" class="btn_excelDownload" id="btn_excelDownload" style="position: relative; display:none;margin:5px 50px 5px auto;width:41px;height:41px;overflow:hidden;text-indent:-2000px;background:url(/img/ico/ico_excel.png)">
	    						엑셀다운로드
	    						</a>
	    					</div>
