...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '03', '00', '', '통계항목 선택방법');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>통계주제도 목록 조회</h1><br>
					...
					<h2>○ 통계주제도 목록 화면에서는 인구와 가구, 주거와 교통, 복지와 문화, 노동과 경제, 건강과 안전, 환경과 기후등 6가지 카테고리로 분류되어 있고, 각각의 카테고리별로 최근에 등록된 6개의 통계주제도 항목이 표출됩니다.</h2>
					<!-- 2016.03.18 수정, 이미지 높이 수정 -->
					<img src="/img/newhelp/Su_010_02_1.png"  alt="통계주제도"/><!-- 190315 방민정 수정 -->
					<h2 style="text-align:center;">[통계주제도]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
