...
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=1" />
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '02', '00', '', '서비스 소개-자료신청');
        });
    </script>   
		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/us_help_20_0">서비스 소개</a>
							<ul class="sub">
								...
								<!-- mng_s 20200727 이진호, 자료신청이 자료제공으로 변경 -->
								<!-- <li><a href="/view/newhelp/us_help_20_10" class="on">ㆍ자료신청</a></li> -->
								<li><a href="/view/newhelp/us_help_20_10" class="on">ㆍ자료제공</a></li>
								<!-- mng_e 20200727 이진호 -->
			...
			<div class="contentsWrap">
				<div class="contents">
				  ...
				  <!-- mng_s 20200727 이진호, 기존 자료신청이 자료제공으로 변경되어 수정 -->
				  <!-- <h1>자료신청</h1> -->
				  <h1>자료제공</h1>
				  <!-- mng_e 20200727 이진호 -->
				  
					<h2>● 센서스 공간통계 자료를 제공하는 서비스입니다.</h2>
					<h2>● 통계청에서 자체 생산한 통계지리정보자료를 정부기관 및 민간에서 활용하여 더 큰 부가가치를 창출할 수 있도록 자료를 제공하는 것으로 현재 센서스 공간통계 자료를 파일형태로 서비스하고 있습니다. </h2>
					<br>
				  <h1>서비스 목적</h1>
...
<!-- 					<h2><a href="http://sgis.kostat.go.kr/contents/include/download.jsp?filename=sgis_data_request_guide.hwp&path=/board/"> [다운로드]</h2> -->
					...
					<h2>문의사항연락처: ☏042-481-2438, kingstars@korea.kr</h2>
					
					
					<!-- mng_s 20200728 이진호 / 기존 자료신청이 자료제공으로 변경됨에 따른 수정 -->
					...
					<h2><a href="http://sgis.kostat.go.kr/contents/shortcut/shortcut_05_02.jsp"><img src="/img/newhelp/Dd_blue.png" style="margin-left: 0px; width:238px; height:25px" border=0 alt="자료제공 바로가기"/></a></h2>
					<!-- mng_e 20200728 이진호 -->
