 ...
 * <p/>
 */
public class GetRecmdKwrdList extends AbsQuery<HashMap<String,Object>> {
	private static final Log logger = LogFactory.getLog(GetRecmdKwrdList.class);
	...
	public HashMap<String,Object> executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			...
			result.put("recmdKwrdList", session.selectList("statsMeCatalog.selectRecmdKwrdList", mapParameter));	
