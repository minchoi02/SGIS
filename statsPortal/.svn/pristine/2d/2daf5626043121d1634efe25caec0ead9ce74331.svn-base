...
public class GetMyDataList extends AbsQuery< List > {

	private static final Log logger = LogFactory.getLog( GetMyDataList.class );
	...
	public List executeAPI( HttpServletRequest req, HttpServletResponse res, String trId ) throws AbsException
	{
		...
		try
		{
			...
			String userId = (String) mapParameter.get("userId");
			...
			result = mypageMapper.selectListMyDataPure(userId);
