...
<!-- 			<div class="dataMenuBox mt20">
			...
			<div class="btnbox">
				<div class="fl">
					...
					<a href="javascript:srvLogWrite('A0', '11', '03', '06', '', '');$myDataModify.popMapGisSetting()" class="spbox type01">지도표출설정</a>
				</div> 
				<div class="fr">
					<a href="javascript:$myDataModify.moveList();" class="spbox type01">목록보기</a>
				</div>
			</div> 
		</div>
			<!-- popBox start -->
			
		 	<div class="popBox dragbox" id="gioPop1" style="position:absolute;margin-top:150px;margin-left:-400px;z-index:1000;display:none;">
			...
			<div class="popBox dragbox" id="gioPop2" style="position:absolute;margin-top:150px;margin-left:30px;z-index:1000;display:none;">
				<div class="topbar closebtn1">
					<span>연산</span> 
					<a href="javascript:void(0)">닫기</a>
				</div>
		...
		<div class="popBox dragbox" id="gioCodingPop1" style="display: none;z-index:214748364;">
			<div class="topbar closebtn1">
				<span>지오코딩 선택 - 1</span> 
				<a href="javascript:void(0)">닫기</a>
			</div>
		...
		<div class="popBox dragbox" id="gioCodingPop2" style="display: none;z-index:1200;">
			<div class="topbar closebtn1">
		...
		<div class="popBox dragbox" id="gioCodingPop3" style="display: none;z-index:1200;">
			<div class="topbar closebtn1">
		...
		<!--  2017.08.01 [개발팀] 수정  -->
		<div class="popBox dragbox" id="yearListAddPop" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:1200;display:none;">
			<div class="topbar closebtn1">
		...
		<div class="popBox dragbox" id="gioPop3" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:2147483647;display:none;">
			<div class="topbar closebtn1">
				<span>새 이름으로 저장</span> 
				<a href="javascript:void(0)">닫기</a>
			</div>
			<div class="popContents" style="height:150px">
				...
				<div class="btnBox"> 
					<a href="javascript:$myDataModify.saveConfirm(true);" class="btnType01">저장</a>
				</div>
				...
				<div class="popContents">
					<div class="pfl">
						<dl>
							...
							<dd>
								<ul id="mapSettingTooltip" class="ckbox" style="height:80px;">
