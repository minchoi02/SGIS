...
<a href="javascript:void(0)" class="interactiveDataBoard" style="z-index:10000;">데이터보드</a><!--20년수정반영 (z-index="99999" ==> "10000")-->
<div class="dataSideBox" style="z-index:9999;"><!--20년수정반영-->
<div class="dataSideBox" style="top:0px;"><!--20년수정반영-->
	<div class="bar">
						...
						<div class="compareBox">
							...
							<div class="tables"><!-- 표영역 -->
								<table style="table-layout: fixed;">
									...
									<thead>
										<tr id="db_normal_tb">
											<th class="grid_cd_th_hide" scope="col">항목</th>
											<th class="adm_cd_th" scope="col" style="display: none;">집계구번호</th>
											<th class="grid_cd_th_show" scope="col" style="display: none;">격자번호</th>
											<th scope="col">순위</th>
<!-- 										<th scope="col" id="th_result" class="th_result"> <span id=th_result_val>값</span></th> -->
											<th scope="col" id="th_result" class="th_result">값</th>
											<th scope="col" id="th_Ratio">비율(%)</th>
										</tr>
										<!-- 
										<tr id="db_grid_tb" style="display: none;">
											<th scope="col">격자번호</th>
											<th scope="col">순위</th>
											<th scope="col">값</th>
											<th scope="col">비율(%)</th>
										</tr>
					...
					<dd id="viewTimeSeriesData_dd_area">
						<div class="clockTypeBox">
							...
							<a href="javascript:void(0)" class="btn_clockTypeMts" id="multiTimeSeries">다중시계열보기</a><!-- SGIS_4 추가-->
