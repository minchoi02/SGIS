...
private static final Log logger = LogFactory.getLog(NewSaveData.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			if( req.getParameter("ratiofield") != null && !("null").equals( req.getParameter("ratiofield") ) ){
				mapParameter.put("ratiofield", req.getParameter("ratiofield"));
			} else {
				mapParameter.put("ratiofield", "");
			}
