	...
	<head>
		...
		<script type="text/javascript">
			var reqMemberUnRegister = function() {
				var t = document.getElementById("unRegisterForm");
				t.target = "_parent";
				t.CUR_URL.value = window.location.protocol+"//"+window.location.host + "/view/index";
				t.SYS_URL.value = window.location.protocol+"//"+window.location.host + "/view/authorization/unregister";
				t.submit();
			} 
		</script>
	</head>
