...
<!--  테스트 추가 배천규  20221214  -->
<script src="/js/administStats/more4Dash.js"></script>
<script src="/js/administStats/more5Dash.js"></script>
<script src="/js/administStats/more6Dash.js"></script>
<!--  테스트 추가 배천규  20221214  -->
<!-- fontawesome[S] -->
...
<script src="/js/administStats/administStatsMain.js"></script>
...
<header class="header" id="header">
	<div class="header-wrap">
                        <!--  구조변경으로 인한 추가 배천규  20221214  -->
		<div class="header-left">
			<div class="header_tit">행정통계 시각화지도</div>
		...
		<div class="header-right">
                                    <!--  배천규 수정  20221214  -->
			<a href="#" class="btn-icon btn-outline btn-guide btn" title="사용 가이드" data-mode="${mode}" onclick="javascript: return false;">사용가이드</a>
			...
			<a href="#" class="btn-icon btn-share btn" title="공유" onclick="javascript: return false;">공유하기</a>
		</div>
	</div>
</header>