...
//		"<a href='/edu/jsp/main.jsp'><img src='/edu/include/img/etc/edu_home.png' alt='SGIS' style='margin-left:-10px;'/></a></h1>");
		"<a href='/edu/jsp/main.jsp'><img src='/edu/include/img/etc/ed_logo.png' alt='SGIS' style='margin-left:17px;width:100px;margin-bottom:10px;'/></a></h1>");
...
document.write("<li><a id='tit01' href='/edu/jsp/submain01.jsp'>SGIS에듀가 알려주는 사회변화</a></li>");
document.write("<li><a id='tit02' href='/edu/jsp/submain02.jsp'>생활에 유익한 SGIS에듀 체험</a></li>");
...
function titHighLight(){
	...
	if(pageName == "game01"){
		$("#tit04").addClass("on");
		srvLogWrite('A0', '08', '04', '00', '', '');
	} else if(pageName == "game02"){
		$("#tit05").addClass("on");
		srvLogWrite('A0', '08', '05', '00', '', '');
