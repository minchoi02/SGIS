...
<div id="history-menu-box" class="Add_bookmark">
	...
	<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/historyMenu/major"/>
	<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/historyMenu/population"/>
	<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/historyMenu/3fFish"/>
	<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/historyMenu/company"/>
	<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/historyMenu/kosis"/>
</div>
