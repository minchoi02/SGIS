...
//							$('.qmIcon01').append(html);
							var html = '<li><a href="javascript:$thematicMapFrame04.getCategoryList.getMenuList(\''+categoryList[i].thema_map_category+'\');">'+categoryList[i].category_nm+'</a></li>';
							$('.themul').append(html);
							
							html = '<li><a href="javascript:$thematicMapFrame04.getCategoryList.getMenuList(\''+categoryList[i].thema_map_category+'\');" title="'+categoryList[i].category_nm+'"><span>'+categoryList[i].category_nm+'</span></a></li>';
...
//								html += "<li><input type='radio' name='' id='' value='' />";
								html += '<a href="/view/thematicMap/thematicMapMainOld?stat_thema_map_id=' + list[i].stat_thema_map_id + '&theme=' + list[i].category + '&mapType=' + list[i].thema_map_type + '" target="_top">'+list[i].title+'</a></li>';
							}else{
								...
								html += "<li>";
//								html += "<li><input type='radio' name='' id='' value='' />";
								html += '<a href="/view/thematicMap/thematicMapMain?stat_thema_map_id=' + list[i].stat_thema_map_id + '&theme=' + list[i].category + '&mapType=' + list[i].thema_map_type + '" target="_top">'+list[i].title+"</a></li>";
							}
						}
//						linkTooltip();
