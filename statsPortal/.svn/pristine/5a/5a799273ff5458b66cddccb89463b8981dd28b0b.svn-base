...
public class MainFacilityList extends AbsQuery<Map> {
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			//String base_year = (String) Collections.max(Properties.getCompany_year_list());
			// mng_s 20190502 김건민
			List company_yearList = Properties.getCompany_year_list();
			String base_year = (String) company_yearList.get(company_yearList.size() - 1);
			// mng_e 20190502 김건민
