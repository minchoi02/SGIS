...
<head>
	...
	<title>함께하는지도 공지사항 | 통계지리정보서비스</title>
	...
	<script src="${pageContext.request.contextPath}/sgis_edu/resource/js/communityMap/notice/view.js"></script>
	...
	<div id="wrap">
		...
		<div id="container">
			<c:set var="appendPath" scope="request">
				<c:url var="noticeListUrl" value="/view/edu/${ss_school_level}/community/notice/list">
			...
			<h2 class="ctit">함께하는지도 공지사항</h2>
			<p class="smr">
				SGIS 플러스의 함께하는지도의 전체 공지사항을 볼 수 있습니다.
			</p>
			<div id="contents">
				<div id="content">
					<div id="article-wrap">
