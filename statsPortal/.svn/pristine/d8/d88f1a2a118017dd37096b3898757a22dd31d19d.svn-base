					...
					<div class="popUseCasesRela">
						<div class="popUseCases">
							<div class="usecLeft">
								...
								<ul class="ulIconList">
									<li class="b01" onclick="javascript:srvLogWrite('J0','03','01','00','',''); $galleryAdd.writeGalleryPopOpen();">
										<p class="t01">갤러리 등록</p>
										<p class="t02">갤러리를 등록할 수 있는 페이지로 이동합니다.</p>
									</li>
									<li class="b02" onclick="javascript:srvLogWrite('J0','03','02','00','',''); location.href='/view/mypage/bookmark'">
								...
								<ul class="utIconList">
									<li><a href="javascript:srvLogWrite('J0','03','03','01','기술업종 통계지도',''); location.href='/view/technicalBiz/technicalBizMap'"><img
											src="/img/ico/ico_utIconList01.png" alt="기술업종 통계지도" /></a></li>
									<li><a href="javascript:srvLogWrite('J0','03','03','02','대화형 통계지도',''); location.href='/view/map/interactiveMap'"><img
											src="/img/ico/ico_utIconList02.png" alt="대화형 통계지도" /></a></li>
									<li><a href="javascript:srvLogWrite('J0','03','03','03','살고싶은 우리동네',''); location.href='/view/house/houseAnalysisMap'"><img
											src="/img/ico/ico_utIconList03.png" alt="살고싶은 우리동네" /></a></li>
									<li><a href="javascript:srvLogWrite('J0','03','03','04','우리동네 생활업종',''); location.href='/view/bizStats/bizStatsMap'"><img
											src="/img/ico/ico_utIconList04.png" alt="우리동네 생활업종" /></a></li>
									<li><a href="javascript:srvLogWrite('J0','03','03','05','통계주제도',''); location.href='/view/thematicMap/categoryList'"><img
											src="/img/ico/ico_utIconList05.png" alt="통계주제도" /></a></li>
								</ul>
							</div>
							<div class="usecRight">
								...
								<ul class="ulIconList01">
									<li class="b01" onclick="javascript:srvLogWrite('J0','03','04','00','',''); $galleryAdd.writeGalleryUseCase();">
								...
								<ul class="utIconList01">
									<li><a onclick="javascript:srvLogWrite('J0','03','05','00','',''); $galleryAdd.goApplyData();"><img
											src="/img/ico/ico_utIconList06.png" alt="자료신청" /></a></li>
									<li><a onclick="javascript:srvLogWrite('J0','03','06','00','',''); $galleryAdd.goApplyOpenApi();"><img
