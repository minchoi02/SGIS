...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '기본조작 방법-시계열 통계 조회');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h2>○ 지도화면에 통계정보가 표출된 상태에서 데이터보드창 하단의 시계열정보창을 활성화시키고, 통계 기준년도를 선택하면 해당년도의 통계정보가 조회됩니다. 그리고, 애니매이션 버튼을 누르면 
					조회 가능한 기준년도의 통계정보가 일정 간격으로 연속해서 표출됩니다.</h2>
					...
					<img src="/img/newhelp/In_020_19_new_001.png"  style="margin-left: 10px; width:700px; height:380px" alt="시계열 통계 조회"/>
					<!-- mng_e 20200407 이진호 -->
