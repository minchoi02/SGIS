...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '기본조작 방법-데이터 업로드 이용방법');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<!-- mng_s 20200402 이진호 -->
					<!--<img src="/img/newhelp/In_020_23_1.png"  style="margin-left: 55px; width:47%;" alt="데이터 업로드 파일선택"/> --><!-- 190315 방민정수정 -->
					<!-- mng_s 20210412 이진호, 나의 데이터 LeftMenu 이미지 현행화 -->
					<img src="/img/newhelp/In_020_23_1_001.png"  style="margin-left: 55px; width:47%;" alt="데이터 업로드 파일선택"/>
					<!-- mng_e 20200402 이진호 -->
					
					<br><br>
					<h2>○ 데이터 업로드는 지정된 양식의 문서만 업로드가 가능한데, 양식파일은 데이터업로드 설정창에서 다운로드가 가능합니다.</h2>
					<h2>○ 지정된 양식의 데이터 파일을 업로드하면 사용자데이터 리스트창이 표출되어, 문서 내의 항목리스트가 표출됩니다.</h2>
					<h2>○ 위치정보조회 버튼을 누르면 좌표값이 생성되고, 지도에서 위치보기 체크를 통해서 지도화면에서 마커 형태로 표출되는 것을 확인할 수 있습니다.</h2>
					<img src="/img/newhelp/In_020_25_new.png" style="margin-left: 35px;" alt="마커표출"/>	
					<br><br>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;○ 마커표출 설정</h2>
