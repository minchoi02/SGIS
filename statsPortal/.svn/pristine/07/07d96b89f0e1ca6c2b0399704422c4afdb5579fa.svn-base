...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '사례별 이용법1');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<img src="/img/newhelp/In_060_01_new.png" style="margin-left: 0px;" border=0 alt="지역선택"/>
					<h2>○ 통계조회를 위해 지도 레벨 설정 : 보고 싶은 통계(시도, 시군구, 읍면동, 집계구)의 상위단계 경계가 보이도록 지도 레벨을 조절합니다.</h2>
					...
					<!-- <img src="/img/newhelp/interactiveMap/In_060_03_1.png" style="margin-left: 0px;" border=0 alt="지도 레벨 설정"/> --><!-- 190315 방민정 수정 -->
					<img src="/img/newhelp/In_060_03_1_001.png" style="margin-left: 0px;" border=0 alt="지도 레벨 설정"/>
					<!-- mng_e 20200403 이진호 -->
					...
					<img src="/img/newhelp/In_060_04_new_001.png" style="margin-left: 0px;" border=0 alt="검색 결과"/>
					<!-- mng_e 20200403 이진호 -->
					...
					<img src="/img/newhelp/In_060_05_new_001.png" style="margin-left: 0px;" border=0 alt="검색 결과"/>
					<!-- mng_e 20200403 이진호 -->
