...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '서비스 구분별 이용방법-인구통계 조회');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>인구통계 조회</h1>
					<h2>○ 총인구, 평균나이, 인구밀도 등 인구총괄 검색조건 설정 및 해당 통계조회가 가능하고, 성별, 나이, 교육정도, 혼인상태 등의 세부검색조건을 설정해서 인구통계를 조회할 수 있습니다.</h2>
					<h2>○ 검색조건을 설정하고, 인구조건 버튼생성을 클릭하면 해당 검색조건의 통계버튼이 생성됩니다.</h2>
					
					<!-- mng_s 20200402 이진호 / 도움말 현행화 -->
					<!-- <img src="/img/newhelp/In_050_1_1.png" style="margin-left: 119px; width:48%;" alt="검색조건 설정"/>	 --><!-- 190315 방민정 수정 -->
					<img src="/img/newhelp/In_050_1_1_001.png" style="margin-left: 119px; width:48%;" alt="검색조건 설정"/>
					<!--mng_e 20200402 이진호 -->
					
					<h2 style="/* margin-left: 250px; */text-align:center;">[검색조건 설정]</h2><br>
					<h2>○ 생성된 통계버튼을 더블클릭하거나, 지도화면의 임의의 행정구역에 드래그앤드롭 하면 선택된 행정구역의 세부행정구역 단위로 인구통계정보가 생성되어 지도화면에 표출됩니다.</h2>
					...
					<img src="/img/newhelp/In_050_2_new_001.png"  border=0 alt="상세정보 표시"/>
					<!--mng_e 20200402 이진호 -->
					
					<h2 style="text-align:center;">[상세정보 표시]</h2><br>
					<h2>○ 요약데이터창에는 선택된 통계조건에 대해서 해당 행정구역의 상대적 통계정보가 선택된 행정구역의 레벨에 맞게 표출됩니다.</h2>
					<h2>○ 선택된 행정구역의 해당 시군구 내의 통계비율, 해당 시군구의 시도 내의 통계비율, 해당 시도의 전국 내에서 통계비율이 원형그래프형태로 시각화되어 표출됩니다.</h2>
					<h2>○ 상세데이터창에서는 해당 행정구역의 세부 행정구역단위로 통계값 계산 후 막대그래프 형태로 시각화되어 표출됩니다.</h2>
					<img src="/img/newhelp/In_050_3_new.png"  alt="상세정보 그래프"/>
					<h2 style="text-align:center;">[상세정보 그래프]</h2>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
