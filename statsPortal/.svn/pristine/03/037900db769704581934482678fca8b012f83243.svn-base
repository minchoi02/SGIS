				...
				*/
				this.setPolyLayerHighlight = function (admCd) {
					if(this.dataGeojson != null) {
						...
						var color = "#0086c6";
						var weight = 5;
						//var tempColor = $inMoreDetailMap.ui.mapTempColor;
						var tempColor = "";
						...
						this.dataGeojson.eachLayer(function(layer) {
							...
							if($inMoreDetailMap.ui.mapToggleId == admCd){
								...
								if(layer.feature.properties.adm_cd == admCd){
									$inMoreDetailMap.ui.mapTempColor = fillColor;
									if($inMoreDetailMap.ui.mapToggleId == ""){
										tempColor = $inMoreDetailMap.ui.mapTempColor; 
									}
									layer.setStyle({
										weight : weight,
										color : color,
									...
									if(layer.feature.properties.adm_cd == $inMoreDetailMap.ui.mapToggleId){
										layer.setStyle({
											weight : 1,
											color : "white",
											dashArray : dashArray,
						...
						this.dataGeojson.eachLayer(function(layer) {
							...
							if(layer.feature.properties.adm_cd == admCd){
								if($inMoreDetailMap.ui.mapToggleId == admCd){									
									...
									$inMoreDetailMap.ui.mapToggleId = admCd;
								}
							} else {
								for(var j=0; j<$totSurvMain.ui.tilePerColor.length; j++) {
									if(layer.feature.properties.adm_cd == $totSurvMain.ui.tilePerColor[j].adm_cd) {
								...
								if (feature.info[x].showData) {
									for (param in feature.info[x]) {
										if (param == feature.info[x].showData) {
											...
											if($inMoreDetailMap.ui.selectedObj==""||$inMoreDetailMap.ui.selectedObj[0]==""){
...
//												this.checkShowCaption();
				...
				this.setPolygonDataGeojson = function (geoData) {
					...
					if($totSurvMain.ui.selectedArea != "00" && $totSurvMain.ui.selectedArea != "")
						that.setPolyLayerHighlight($totSurvMain.ui.selectedArea);
				};
