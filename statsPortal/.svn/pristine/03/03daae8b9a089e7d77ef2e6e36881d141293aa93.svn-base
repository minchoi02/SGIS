...
public class GetIntroDataNewDetail extends AbsQuery<Map>{

	private static final Log logger = LogFactory.getLog(GetIntroDataNewDetail.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String arg2) throws AbsException {
		...
		try {
			...
			result.put("introData", workRoadTodayStatusService.getIntroDataNewDetail(mapParameter));
