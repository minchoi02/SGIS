...
<!-- 							<a href="javascript:$thematicMapFrame03.ui.mapList[0].mapNavigation.getLocation();" class="interactiveIco"><img src="/img/ico/ico_gps01.gif" alt="위치검색" /></a>  -->
							...
							<div class="tb_right"> 
								...
								<!--20년수정반영 시작 (1) ~ (4)-->
								<ul class="tbr01">
									<li><a onclick="javascript:$thematicMapFrame03.ui.doMaxSize();" id="fullScreen" style="cursor: pointer;" title="전체 화면 확대" ><img src="/img/ico/ico_toolbars01.png" alt="전체 화면 확대" /></a></li><!--(1)-->   
									<!-- <li><a onclick="javascript:$thematicMapFrame03.ui.doClearMap(1);" style="cursor:pointer;" title="초기화"><img src="/img/ico/ico_toolbars02.png" alt="초기화"></a></li> --><!--(2)-->
									<li><a onclick="javascript:$thematicMapFrame03.ui.doShare(1);" class="tb_share" style="cursor:pointer;" title="URL 공유하기" ><img src="/img/ico/ico_toolbars04.png" alt="URL 공유하기"/></a></li><!--(3)-->
									<li><a onclick="javascript:$thematicMapFrame03.ui.mapImageDown();" style="cursor:pointer;" title="지도 이미지 다운로드"><img src="/img/ico/ico_toolbars13.png" alt="지도 이미지 다운로드" /></a></li>
									...
									<li><a onclick="javascript:$thematicMapFrame03.ui.reportDataSet(1); javascript:srvLogWrite('B0','03','09','00',$('.helperText span').text(),'');" style="cursor:pointer;" title="보고서 보기"><img src="/img/ico/ico_toolbars09.png" alt="보고서 보기" /></a></li>
...
<!-- 							<a href="javascript:void(0)" class="interactiveDataBoard" style="right:335px;">데이터보드</a> -->
							<div class="dataSideBox"  style="width:400px;height:500px">
								<div class="bar">
									<div style="position:relative;width:50px;float:left;left:240px;top:2px;"><a onclick="javascript:$thematicMapFrame03.ui.chartImageDown();" style="cursor:pointer;" title="데이터보드 이미지 다운로드"><img src="/img/ico/ico_toolbars13.png" alt="데이터보드 이미지 다운로드" /></a></div>
									<div id="dataSlider" class="dataSlider"></div>
...
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    				...
		    				<li id="select_dataType" style="display: none;">
		    					<span>기준시간</span>
<!-- 		    					<select id="select_dataType" onchange="javascript:$thematicMapFrame03.Popup.show(); setTimeout(function() {$thematicMapFrame03.ui.mapList[0].changeRegionBound()}, 1000);"> -->
		    					<select id="select_dataType" onchange="javascript:srvLogWrite('B0','10','03','00',$('.helperText span').text(),$('#select_dataType option:selected').val());$thematicMapFrame03.Popup.show(); $thematicMapFrame03.ui.mapList[0].changeRegionBound();">
		    						<option>5분</option>
		    						<option>10분</option>
		    						<option>30분</option>
    							</select>
		    				...
		    				<li id="region_boundary">		
		    					...
		    					<a onclick="javascript:srvLogWrite('B0','03','04','01',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame03.Popup.show(); $thematicMapFrame03.ui.mapList[0].changeRegionBound();" class="first" id="autoRegion">자동</a><!--2019-03-13 박길섭 -->
		    					<a onclick="javascript:srvLogWrite('B0','03','04','02',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame03.Popup.show(); $thematicMapFrame03.ui.mapList[0].changeRegionBound();" id="sido" >시도</a><!--2019-03-13 박길섭  -->
		    					<a onclick="javascript:srvLogWrite('B0','03','04','03',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame03.Popup.show(); $thematicMapFrame03.ui.mapList[0].changeRegionBound();" id="sigungu" >시군구</a><!-- 2019-03-13 박길섭 -->
		    					<a onclick="javascript:srvLogWrite('B0','03','04','04',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame03.Popup.show(); $thematicMapFrame03.ui.mapList[0].changeRegionBound();" id="eupmyundong" class="last">읍면동</a><!--2019-03-13 박길섭  -->
		    				...
		    				<li id="top_bottom_li" style="display: none;"> <!-- style="display: none;" -->
		    					<span>선택보기</span>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].showTopBottomDataOnly('ON', false);" class="first" id="top_bottom_on">ON</a>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].showTopBottomDataOnly('OFF', false);" class="last" id="top_bottom_off">OFF</a>
		    				</li>
		    				
		    				<li id="top_bottom_type" style="display: none;">
		    					<span>&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;</span>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].setTopBottomType('top');" class="first" id="top_bottom_type_top">상위</a>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].setTopBottomType('both');" id="top_bottom_type_both">상/하위</a>
		    					<a href="javascript:$thematicMapFrame03.ui.mapList[0].setTopBottomType('bottom');" class="last" id="top_bottom_type_bottom">하위</a>
		    				</li>
		    				
		    				<li id="top_bottom_select" style="display: none;">
		    					<span>&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;</span>
		    					<select id="top_bottom_select_count" onchange="javascript:$thematicMapFrame03.ui.mapList[0].setTopBottomCount(this.value);">
		    				...
		    				<li id="map_type">
		    					<span>지도유형</span>
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" data-subj="색상지도" title="색상지도색상지도색상지도" class="first on" id="color">색상</a> -->
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" data-subj="버블지도" title="버블지도버블지도버블지도" class="last" id="bubble">버블</a> -->
		    					<a onclick="javascript:srvLogWrite('B0','03','05','01',$('.helperText span').text(),'');$('.thematicTopText').show();" href="javascript:$thematicMapFrame03.ui.changeDataMode();" class="first on" id="color">색상</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','05','02',$('.helperText span').text(),'');$('.thematicTopText').hide();" href="javascript:$thematicMapFrame03.ui.changeDataMode();" class="last" id="bubble">버블</a>
		    				...
		    				<li id="heritage_type" style="display: none;">
		    					<span>지도유형</span>
		    					<a href="javascript:srvLogWrite('B0','08','01','01',$('.helperText span').text(),'');$thematicMapFrame03.ui.mapList[0].changeRegionBound();" style="width: 130px;" class="first" id="heritage0">국가지정문화재 지정구역</a>
		    					<a href="javascript:srvLogWrite('B0','08','01','02',$('.helperText span').text(),'');$thematicMapFrame03.ui.mapList[0].changeRegionBound();" class="last">등록문화재</a>
		    					<input type="hidden" id="heritageMode" value="0"/>
		    				</li>
		    				<li id="data_type">
		    					<span>통계표출</span>
		    					<a onclick="javascript:srvLogWrite('B0','03','06','00',$('.helperText span').text(),'ON');" href="javascript:$thematicMapFrame03.ui.changeDataMode2();" class="first">ON</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','06','00',$('.helperText span').text(),'OFF');" href="javascript:$thematicMapFrame03.ui.changeDataMode2();" class="last" id="default_switch">OFF</a>
					...
					<div class="quickBox step01">
						...
						<div class="normalBox">
							...
							<ol class="stat-infor">
		                        ...
		                        <li><a href="javascript:$thematicMapFrame03.ui.doMaxSize();" id="fullScreen">전체 화면 확대</a></li>  
							</ol>
		...
		<!-- 공유팝업  -->
		    	<div id="sharedlg" class="galleryPopBox" style="display:none; z-index:20001;">
					<div class="topbar">
						...
						<a onclick="javascript:$thematicMapFrame03.ui.doCancel('sharedlg');">닫기</a>
					</div>
					<div class="popContents">
								...
								<div style="width:100%;margin:auto 0">
									<table style="margin:auto;width:270px;height:30px;margin-top:10px" summary="URL공유하기 SNS 목록">
										<tr style="height:30px;line-height:1px;">
											<td valign="middle">
												<a href="javascript:$thematicMapFrame03.ui.shareToKakaoStory();" style="margin-left:10px;"><img src="/img/im/kakao.png" alt="카카오스토리"></a>
											</td>
											<td valign="middle">
						...
						<div class="btnBox">
							<a onclick="javascript:$thematicMapFrame03.ui.doDone('sharedlg');" class="btnStyle01">URL 복사하기</a>
							<a onclick="javascript:$thematicMapFrame03.ui.doCancel('sharedlg');" class="btnStyle01">닫기</a>
						</div>
					</div>
				</div>
		<!--20년수정반영 끝 (공유팝업) -->
