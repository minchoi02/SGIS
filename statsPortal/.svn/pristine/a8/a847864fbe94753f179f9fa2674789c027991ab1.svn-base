...
public class GetTodayStatusSggDataBoard extends AbsQuery<Map> {
	
	private static final Log logger = LogFactory.getLog(GetTodayStatusSggDataBoard.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("todayStatusList", workRoadTodayStatusService.getTodayStatusSggDataBoard(mapParameter));
