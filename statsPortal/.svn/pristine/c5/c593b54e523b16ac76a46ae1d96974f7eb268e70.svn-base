...
<head>
	...
	<script src="/js/gallery/galleryApi.js"></script>
...
<body>   
	<div id="wrap">
		...
		<div class="containerBox">  
			<p class="mpGuide">
				<a href="/view/index"><span class="path_el">활용서비스&nbsp;>&nbsp;</span></a>
				<a href="/view/gallery/resultGallery"><span class="path_el current">통계갤러리</span></a>
			</p>
			...
			<div class="gallerySearchBox">
				...
				<div class="form"> 
					...
					<a class="inputSearchKeyboard" href="javascript:openKeyboard('searchWord','gallerySearchBtn');" style="position:absolute; margin-left:-25px; margin-top:10px;">
					...
					<a id="gallerySearchBtn" onclick="javascript:srvLogWrite('J0','01','02','00','','');$resultGallery.gallerySearch();"><img src="/img/ico/ico_search01.png" alt="검색" /></a>
				</div>
			...
			<div class="galleryCategory">
				<a name="orderSelectList" onclick="javascript:srvLogWrite('J0','01','03','00','최신순','');$resultGallery.galleryOrderList(this,'dt')" class="on">최신순</a>
				<a name="orderSelectList" onclick="javascript:srvLogWrite('J0','01','03','00','조회순','');$resultGallery.galleryOrderList(this,'hits')" >조회순</a>
				<a name="orderSelectList" onclick="javascript:srvLogWrite('J0','01','03','00','추천순','');$resultGallery.galleryOrderList(this,'like')">추천순</a>
