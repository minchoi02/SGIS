		...
		<div class="noticWrap">
			<div class="notic">
				...
				<div class="search">
					...
					<!-- mng_s 20210616 이진호, 웹 접근성 검사 오류 수정 label 추가 -->
					<label>
				...
				<!-- mng_s 20210616 이진호, 웹 접근성 검사 오류 수정 /  cation 추가 -->
				<table class="table01 mt10" id="eduTbl">
				<caption style="font-size: 0px;"> SGIS 에듀 자유게시판</caption>
				<!-- mng_e 20210616 이진호 -->
				...
				<!-- mng_s 20210616 이진호, 웹 접근성 점검 오류 수정 / thead, tfoot 추가 -->
				<thead></thead>
				<tbody id="eduTblBody">
					<tr>
						<th>글번호</th>
