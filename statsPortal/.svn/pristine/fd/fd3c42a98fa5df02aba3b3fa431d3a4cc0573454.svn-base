...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            srvLogWrite('A0', '12', '10', '00', '', '서비스 이용방법');
        });
    </script>   
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>통계지도 체험의 구성</h1>
					<img src="/img/newhelp/Ex_020_01_1.png" style="width:100%;" alt="통계지도 체험의 구성"/><!-- 190319 방민정 -->
				...
				<div class="contents">
				  <h1>지도화면 설정하기</h1>
					<img src="/img/newhelp/Ex_020_02_1.png" style="width:100%;" alt="지도화면 설정하기"/><!-- 190319 방민정 -->
				...
				<div class="contents">
				  <h1>통계값 입력하기</h1>
					<img src="/img/newhelp/Ex_020_03_1.png" style="width:100%;" alt="지도화면 설정하기"/><!-- 190319 방민정 -->
					<h2>1) 통계값 입력 : 통계로 표시하고자 하는 정보를 빈 난에 입력합니다.</h2>
				...
				<div class="contents">
				  <h1>통계값을 막대/원 그래프로 보기</h1>
					<img src="/img/newhelp/Ex_020_04_1.png" style="width:100%;" alt="지도화면 설정하기"/><!-- 190319 방민정 -->
