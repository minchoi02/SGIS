...
<script src="/js/administStats/lodash.js"></script><!-- 경제 대쉬보드 -->
...
<script src="/js/totSurv/inMoreDetail/inMoreDetailMain.js"></script>
...
<script src="/js/totSurv/inMoreDetail/inMoreDetail.js"></script>

<!-- 2020-10-19 [주형식 ]공통 차트 추가 -->
<script src="/js/totSurv/inMoreDetail/commonChart.js"></script>
...
<script type="text/javascript" src="/js/totSurv/inMoreDetail/legendInfo.js"></script>
...
<script type="text/javascript" src="/js/administStatsDetail/highcharts/offline-exporting.js"></script>
...
<c:if test="${type == 'locgov' or type == 'totFarmLocgov' or type == 'totPeopleLocgov'}"> <!-- 2020-11-03 [곽제욱] 인구가구주택, 농림어업임업 가르기 -->
	<div class="con_Top MenuHidden" style="z-index:502">
    	...
    	<button class="totSurvBI" type="button" onclick="location.href='/view/totSurv/inMoreDetail'"></button>
		...
		<!-- 2020.10.21[신예리] 상단 pdf,프린트,공유 버튼 button으로 변경 START -->
  		<div class="TopRightBtn" style="display:block; margin: 0px -221px 0px 0px;">
