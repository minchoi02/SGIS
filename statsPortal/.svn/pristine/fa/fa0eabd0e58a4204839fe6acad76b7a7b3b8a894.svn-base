...
<div class="container sub04"> 
	...
	<div id="sbox01" class="mboxArea sbox01 subtop04"> 
		...
		<ul class="topMenuList">
			...
			<li><a href="#sbox03">지역 간 남녀 비율 및 인구 분포의 불균형</a></li>
	...
	<div id="sbox03" class="mboxArea sbox04">
		<div class="cont">
			...
			<p class="tit">
				...
				<span>지역 간 남녀 비율 및 인구 분포의 불균형</span>
			</p>
	...
	<div id="sbox04" class="mboxArea sbox02 first">
		<div class="cont">
			<p class="subj"><img alt="이미지" src="/edu/include/img/etc/etc_subtxt04.png" /></p>
			<p class="tit">
	...
	<div class="sbox03"> 
		 ...
		 -->
		 <p class="imgCenter"><img alt="이미지"  src="/edu/include/img/etc/edu13.png" style="width:1200px" /></p>
		 <!-- 190306 방민정수정 끝 -->
		 <br>
