...
public class GetStatsAnlsJobQualityMain extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(GetStatsAnlsJobQualityMain.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			...
			result = session.selectList("wrStatsAnls.getStatsAnlsJobQualityMain", mapParameter);
