<%
/**************************************************************************************************************************
* Program Name	: 더보기 Main
* File Name		: inMoreDetail.jsp
* Comment		: 
* History		: 
*	2021.10.10	이영호	신규
*
...
<script src="${pageContext.request.contextPath}/js/totSurv/inMoreDetail/inMoreDetailMap.js"></script>
<script src="${pageContext.request.contextPath}/js/totSurv/inMoreDetail/inMoreDetailMapApi.js"></script>
<script>
	var totLastYear = '<c:out value="${totLastYear}"/>';
	$inMoreDetail.ui.totLastYear = totLastYear;
</script>
<div id="inMoreDetailDataDiv" style="width: calc(100% - 500px); display: inline-block; float: right;">
	<!-- 선택한 조사표 표출 영역 --> 
</div>
