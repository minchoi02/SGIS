...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '05', '00', '', '서비스 개요');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1><br>
					<h2 style="line-height:25px !important;">○ 정책통계지도는 인구, 가구, 주택, 사업체 등 주요 통계지표에 대해서 과거와 현재의 통계 변화를 보여주고, 이를 통해 지역사회의 정책 결정에 도움을 주도록 하기 위한 서비스입니다.</h2>
					<h2>○ 주요기능</h2>
				    ...
				    <h2>&nbsp;&nbsp;&nbsp;- 융합 : 선택한 지표의 변화된 통계정보를 하나의 지도에 융합하여 보여줌으로써 지역별 통계 변화를 한 눈에 알아볼 수 있습니다.</h2>
					<h2>○ 주요 통계지표</h2>
