...
(function(W, D) {
	...
	$(window).load(function() {
		if (window.opener.$statsMeDetailInfo != undefined) {
			window.opener.$statsMeDetailInfo.ui.reportLoad();
		}
		/*setTimeout(function() {
...
//								adm_cd = info.adm_cd;
				...
				onOffDiv : function(value) {
					if($("#" + value).css("display") == "none"){
						$("#" + value + "_show").hide();
						$("#" + value).show();
						$("#" + value).parents("#gridDiv").show(); //20200811 박은식 background-color가 남는 문제 해결하기 위함
					}else{
						$("#" + value).hide();
						$("#" + value + "_show").show();
						$("#" + value).parents("#gridDiv").hide(); //20200811 박은식 background-color가 남는 문제 해결하기 위함
					}
				},
