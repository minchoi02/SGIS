	     ...
	     <div id="container">
			...
			<div class="containerBox">  
				<div class="mpSubTitle">
					...
					<a href="javascript:logWriteAndMove('A0', '11', '05', '00', '', '', '/view/mypage/mysubpage', false);" class="btnType02">회원정보관리</a> 
				</div>  
			...
			<ul class="latest">
				<li>
					<h4><a href="javascript:logWriteAndMove('A0', '11', '02', '00', '', '', '/view/mypage/bookmark', false);">즐겨찾기</a></h4>
					<p>SGIS+plus를 이용하면서 저장한 서비스 조회  이력으로 조회결과를 재조회하거나 저장된 목록을 관리할 수 있습니다.</p>
				</li>
				<li>
					<h4><a href="javascript:logWriteAndMove('A0', '11', '03', '01', '', '', '/view/mypage/myData/dataList', false);">나의 데이터</a></h4>
				...
				<li>
					...
					<h4><a href="javascript:logWriteAndMove('A0', '11', '04', '00', '', '', '/view/mypage/community', false);">나의 소통지도</a></h4>
	   	...
	   	<!-- footer// -->
	    <footer id="footer" style="margin-top:16%;"><!-- 190311 방민정 수정 -->
	    	<!-- Bottom Include -->
