...
/**************************************************************************************************************************
* Program Name  :   
* File Name     : ssaJobGrowthDataBoard.jsp
* Comment       : 
* History       : 
*
**************************************************************************************************************************/
...
<style>
	#ssaJobGrowthDataBoard {/* 데이터보드를 지도컨트롤 버튼 위에 위치시키기 */
		z-index: 1001;
	}
	
   	#ssaJobGrowthDataBoard .popBox {/* 팝업용도가 아닌 데이터보드에 끼워넣기하는 경우 처리될 사항 - 테두리제거, 사이즈 Full */
   	    left: 0px;
	    top: 0px;
	    margin-left: 0px;
	    width: 100%;
    ...
    #ssaJobGrowthDataBoard .today-data {width: 100%;}/* 정보테이블 */
    /* .today-data dl dt {width: 100px;} *//* 정보테이블의 제목 */
    #ssaJobGrowthDataBoard .today-data dl dd {width: 652px;}/* 정보테이블의 설명 */
    #ssaJobGrowthDataBoard .dscList {width: 100%;}/* 표/그리드 영역 */
    #ssaJobGrowthDataBoard .combineGrid {width: 100%;}/* 엑셀 다운 버튼 영역 */
    #ssaJobGrowthDataBoard .workRoad .job-offer-graph {height:500px;}
    #ssaJobGrowthDataBoard #ssaJobStatusDataBoardChart {width:760px;height:530px;}
    #ssaJobGrowthDataBoard .tables{width:760px;height:530px;}
	#ssaJobGrowthDataBoard .compareBox .tables table {width:730px;}
</style>
	...
	<div class="dataSideBox">
		...
		<div class="dataSideContents">
			<div class="workRoad" id="ssaJobGrowthDataBoard">
				<div class="popBox today-data-popup-view wrmScrollable">
				 	<div class="cont-box">
				 		<article>
				 			<h3>일자리 현황 > 비경제활동인구</h3>
				 			<div class="today-data view">
				 				<dl> 
				 					<dt>통계명</dt>
				 					<dd id="tsTitle"> 경제 활동 인구 조사</dd>
				 				</dl>
				 				<dl> 
				 					<dt>출  처</dt>
				 					<dd id="tsOrigin"> 통계청 사회통계국 고용통계과</dd>
				 				</dl>
				 				<dl> 
				 					<dt>자료갱신일</dt>
				 					<dd id="tsArea"> 2018-11-06 </dd>
				 				</dl>
				 			</div>
						 	...
						 	<div class="dscList">
								...
								<div class="compareBox">
									...
									<div id="wrapperChartScroll" class="censusChart" style="width:730px;height:540px;">
										<div class="charts" id="ssaJobGrowthDataBoardChart"></div>
									</div>
