...
public class getSrvareaScopeList extends AbsQuery< List > {
	
	private static final Log logger = LogFactory.getLog( getSrvareaScopeList.class );
	...
	{
		return "catchmentArea.selectSrvareaScopeList";
	}
