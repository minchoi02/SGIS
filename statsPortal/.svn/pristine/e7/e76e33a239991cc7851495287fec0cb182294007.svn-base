        ...
        <script>
    		...
    		function callTutorial(){
    			if(confirm("<정책 통계지도> \n처음 사용자를 위한 튜토리얼이 준비되어 있습니다.\n진행하시겠습니까?")) 
    				window.open('/view/map/policyStaticMap?tutorial_mode', '_blank'); 
    		}
        </script>
        <style>
        	.sop-tooltip.sop-zoom-animated.sop-tooltip-right { width: 200px} /* 2018.12.05	ywKim	신규: 디자인 리뉴얼 이후 맵 툴팁 배경이 줄어들어서 강제로 늘림 */
        	
        	/* 2018-12-20 정책통계지도메뉴 우측("왼쪽 통계메뉴 버튼을 클릭하여 지표를 선택하고 조회해보세요.") 에 이용법 표출 */
        	#view1 .interactiveBar a{cursor: pointer;font-size: 12px;background: #1778cc;border-radius: 5px;color: #fff;padding: 5px 10px; margin: 5px 5px; margin-left: 40px; left:auto; top:auto; position: static; line-height: normal;}
        	
        	/* 2018-12-20 연도 및 메뉴선택 항목에서 화살표가 없어서 선택 가능 한지에 대한 인식이 힘듦 */
        	#view1 .select, #view2 .select, #depth_1_menu .select{-webkit-appearance: menulist;}
        	...
        	.BtnAdmin .bnd_grid_radio{vertical-align:middle;float: left; margin-right: 10px;}
			.BtnAdmin .bnd_grid_radio{margin-top:2px;display:inline-block;width:84px;height:26px;overflow:hidden;background: #213967;border-radius:1000px;}
			.BtnAdmin .bnd_grid_radio span{font-family: '나눔고딕B';color:#ffffff;text-align:center; width:40px;height:22px;margin:2px;overflow:hidden;background: #213967;border-radius:1000px;line-height: 22px;}
			.BtnAdmin .bnd_grid_radio .fl{float:left; margin-right: 0px;}
			.BtnAdmin .bnd_grid_radio .fr{float:right; margin-left: 0px;}
			.BtnAdmin .bnd_grid_radio .on{background: #1dab8f;}
        </style>
	</head>
			...
			<div class="containerBox">
				<div class="rela">
					...
					<div class="BtnAdmin">
						...
						<a onclick="javascript:$policyStaticMap.ui.doMaxSize(1);" class="tb_sizing" style="float: left;cursor: pointer;" title="전체 화면 확대" ><img src="/img/ico/ico_toolbars01.png" alt="전체 화면 확대" /></a><!--2019-06-26 박길섭-->
	            		...
	            		<!-- mng_s 20180412_김건민  -->
						 <div> 
							...
							<button type="button" id="tuto_start_btn" style="   border-radius: 1000px;	background-color: #1dab8f; font-size: 12px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 26px; width: 95px; right: 350px; top: -2px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;" onclick="callTutorial();" title="사용법 따라하기">튜토리얼</button>
						 </div> 
						<!-- mng_e 20180412_김건민 -->
					...
					<div class="sceneBox on" id="view1" style="width:50%">
						<div class="sceneRela">
							...
							<!-- 2018-12-20 정책통계지도메뉴 우측("왼쪽 통계메뉴 버튼을 클릭하여 지표를 선택하고 조회해보세요.") 표출명 크기 및 위치 대화형통계지도와 일치 -->
							<div class="interactiveBar"><!-- map topbar -->
					    		<p class="helperText" id="sTitle" style="margin-left: 168px;">왼쪽 통계메뉴 버튼을 클릭하여 지표를 선택하고 조회해보세요.</p>
...
<!-- 			    	</a> -->
		...
		<div class="tutorialWrapper" style= "display: none" draggable="false">
			...
			<img id="btn_03" src="/img/tutorial/policyStatic/btn_03.png" alt="대전광역시" draggable="false" style="display:none; position:absolute; top:368px; left:15px; cursor:pointer;  border: 3px outset red;">
			<img id="btn_04" src="/img/tutorial/policyStatic/btn_04.png" alt="인구·가구·주택" draggable="false" style="display:none; position:absolute; top:339px; left:1px; cursor:pointer;  border: 3px outset red;">
			...
			<img id="btn_15" src="/img/tutorial/policyStatic/btn_15.png" alt="전체" draggable="false" style="display:none; position:absolute; top:290px; left:10px; cursor:pointer;  border: 3px outset red;">
			<img id="btn_16" src="/img/tutorial/policyStatic/btn_16.png" alt="시도 리스트" draggable="false" style="display:none; position:absolute; top:290px; left:10px; cursor:pointer;">
			<img id="btn_17" src="/img/tutorial/policyStatic/btn_17.png" alt="서구" draggable="false" style="display:none; position:absolute; top:370px; left:15px; cursor:pointer;  border: 3px outset red;">
			...
			<img id="btn_21" src="/img/tutorial/policyStatic/btn_21.png" alt="서구" draggable="false" style="display:none; position:absolute; top:285px; left:5px; cursor:pointer;  border: 3px outset red;">
			<img id="btn_22" src="/img/tutorial/policyStatic/btn_22.png" alt="시군구 리스트" draggable="false" style="display:none; position:absolute; top:281px; left:10px; cursor:pointer;">
			<img id="btn_23" src="/img/tutorial/policyStatic/btn_23.png" alt="전체" draggable="false" style="display:none; position:absolute; top:319px; left:18px; cursor:pointer;  border: 3px outset red;">
			<img id="btn_24" src="/img/tutorial/policyStatic/btn_24.png" alt="교육·문화" draggable="false" style="display:none; position:absolute; top:415px; left:0px; cursor:pointer;  border: 3px outset red;">
			...
			<!-- mng_s 20200424 이진호 , 튜토리얼 현행화에 따른 이미지 추가-->
			<img id="click_map_1" src="/img/tutorial/policyStatic/click_map_1.png" alt="대전 서구 클릭" draggable="false" style="display: none; position:absolute; bottom:5px; left:10px; cursor:pointer; border: 3px outset red;">
			<img id="click_map_1_tooltip" src="/img/tutorial/policyStatic/click_map_1_tooltip.png" alt="대전 서구 클릭 툴팁" draggable="false" style="display: none; position:absolute; bottom:5px; left:10px; cursor:pointer;">
			<img id="dataBoard_graph" src="/img/tutorial/policyStatic/dataBoard_graph.png" alt="데이터보드 그래프" draggable="false" style="display: none; position:absolute; z-index:99999; bottom:95px; left:891px; cursor:pointer; border: 3px outset red;">
			<img id="dataBoard_graph_tooltip" src="/img/tutorial/policyStatic/dataBoard_graph_tooltip.png" alt="데이터보드 그래프 툴팁" draggable="false" style="display: none; z-index:99999; position:absolute; cursor:pointer;">
			<!-- mng_e 20200424 이진호 -->
