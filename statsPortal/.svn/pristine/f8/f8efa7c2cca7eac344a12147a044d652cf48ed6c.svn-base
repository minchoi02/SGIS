...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            srvLogWrite('A0', '12', '10', '00', '', '엑셀활용 방법');
        });
    </script>   
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>통계값을 엑셀을 활용하여 불러오기</h1>
					<img src="/img/newhelp/Ex_030_01_1.png" style="width:100%;" alt="통계값을 엑셀을 활용하여 불러오기"/><!-- 190319 방민정 -->
				...
				<div class="contents">
				  <h1>엑셀에 통계값을 입력하기</h1>
					<img src="/img/newhelp/Ex_030_02_1.png" style="width:42%;" alt="엑셀에 통계값을 입력하기"/><!-- 190319 방민정 -->
				...
				<div class="contents">
				  <h1>엑셀자료를 불러오기</h1>
					<img src="/img/newhelp/Ex_030_03_1.png" style="width:100%;" alt="지도화면 설정하기"/><!-- 190319 방민정 -->
