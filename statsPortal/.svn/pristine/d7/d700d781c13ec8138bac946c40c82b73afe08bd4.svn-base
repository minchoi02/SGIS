...
//		},
		...
		addGallery : function () {
			if(AuthInfo.authStatus == true){
				...
				$("#dialogDiv").show();
				/*var nDate = new Date();*/
				/*$('#dialogDiv').load(window.location.protocol+"//"+window.location.host+"/view/edu_gallery/insertGallaryDialog.jsp",{"dataIdList" : dataIdList},function(){
				...
				var linkUrl = "/view/edu_gallery/bookMarkGallery";
				messageConfirm.open(
		    			 "알림", 
		    			 shareMessage,
		    			 btns = [
