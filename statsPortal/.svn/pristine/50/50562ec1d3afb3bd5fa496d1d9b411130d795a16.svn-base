...
public class SbrStatsController {
	...
	public ModelAndView main(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		String[] years2 = {"2020","2019","2018","2017","2016","2015","2010","2005","2000"};
		model.put("years2", years2);
		
		String[] years3 = {"2020","2015","2010","2005","2000"};
		model.put("years3", years3);
		
		model.put("bannerList", sbrStatsService.getBannerList());
	...
	public Map sbrRegionSignalDataList(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		Map resData = sbrStatsService.getRegionSignalDataList(sbrVo);
		return resData;
	}
	...
	// 기업검색
	@ResponseBody
	@RequestMapping(value = "/sbrSearchComPanyInfoList", produces="application/json;charset=UTF-8")
	public List getSearchComPanyInfoList(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		List resData = sbrStatsService.getSearchComPanyInfoList(sbrVo);
		return resData;
	}
	...
	public Map<String, String> getSbrYouthCount(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrYouthCountSignal(sbrVo);
	}
	
	//지역시그널 기업랭킹 정보
	@ResponseBody
	@RequestMapping(value = "/sbrCompayRankList", produces="application/json;charset=UTF-8")
	public List getCompayRankList(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrCompayRankList(sbrVo);
	}
	
	//면적측정
	//지역시그널 기업랭킹 정보
	@ResponseBody
	@RequestMapping(value = "/sbrArearDataInfo", produces="application/json;charset=UTF-8")
	public List getSbrArearDataInfo(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrArearDataInfo(sbrVo);
	}
	
	// 지역시그널 대세업종
	@ResponseBody
	@RequestMapping(value = "/sbrSignalTrendBiz", produces="application/json;charset=UTF-8")
	public Map<String, Object> getSbrSignalTrendBiz(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrSignalTrendBiz(sbrVo);
	}
	
	//기업위치찾기
	@ResponseBody
	@RequestMapping(value = "/sbrBizDataList", produces="application/json;charset=UTF-8")
	public List getSbrBizDataList(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrBizDataList(sbrVo);
	}
	
	//전통시장정보
	@ResponseBody
	@RequestMapping(value = "/sbrMaketInfo", produces="application/json;charset=UTF-8")
	public Map getSbrMaketInfo(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrMaketInfo(sbrVo);
	}
	
	//지역시그널 3.개폐업
	@ResponseBody
	@RequestMapping(value = "/sbrBizOpenClose", produces="application/json;charset=UTF-8")
	public List<Map<String, Object>> getSbrBizOpenClose(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrBizOpenClose(sbrVo);
	}
	
	@ResponseBody
	@RequestMapping(value = "/sbrSignalYouthCount", produces="application/json;charset=UTF-8")
	public Map<String, String> getSbrSignalYouthCount(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrSignalYouthCount(sbrVo);
	}
	
	//토지 시그널
	@ResponseBody
	@RequestMapping(value = "/getSbrSignalLandPrice", produces="application/json;charset=UTF-8")
	public Map<String, String> getSbrSignalLandPrice(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrSignalLandPrice(sbrVo);
	}
	
	//토지 시그널
	@ResponseBody
	@RequestMapping(value = "/getSbrInfoBizeCodeList", produces="application/json;charset=UTF-8")
	public List getSbrInfoBizeCodeList(HttpServletRequest request, HttpServletResponse reponse, ModelMap model, SbrVo sbrVo) throws Exception {
		return sbrStatsService.getSbrInfoBizeCodeList(sbrVo);
	}
