...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '15', '00', '', '서비스 개요');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1>
					<h2>○ 성씨분포 서비스는 우리나라의 성씨와 주요 본관에 대해서 지역별로 인구비율 및 과거로부터의 변화를 비교해볼 수 있는 서비스입니다.</h2>
					<h2>○ 각각의 성씨, 본관에 대해서 전국의 시군구단위로 인구분포현황 및 과거로부터의 인구변화를 색상지도 형태로 보여줍니다.</h2>
				  ...
				  <h1>화면 구성</h1>
					...
					<img src="/img/newhelp/Nm_010_01.png"  alt="성씨분포 화면구성"/>
