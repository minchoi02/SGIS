...
public class getSufidCoordinate extends AbsQuery< List > {
	
	private static final Log logger = LogFactory.getLog( getSufidCoordinate.class );
	...
	{
		return "catchmentArea.selectSufidCoordinate";
	}
