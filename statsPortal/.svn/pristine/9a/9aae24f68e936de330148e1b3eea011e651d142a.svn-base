...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '02', '00', '', '서비스 소개-성씨분포');
        });
    </script>   
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>성씨분포</h1><br>
					...
					<br>
<!-- 190315 방민정수정 --><h2><a href="/statbd/family_01.vw"><img src="/img/newhelp/Nm_blue.png" style="margin-left: 0px; width:238px; height:25px" border=0 alt="성씨분포 바로가기"/></a></h2>

					<img src="/img/newhelp/Nm_go_01.png"  alt="성씨분포"/><!-- 190313 방민정 수정 -->
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
