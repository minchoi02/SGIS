            ...
            <div class="inner clearFix">
                ...
                <div class="serviceArea">
                    <div class="serviceBox">
						<div id="mystatslo_quizEvent" class="" style="z-index: 10; left:50%; transform:translateX(-50%); display:none;">
							<div class="pa_top_close" style="margin-left: 90%; margin-top: 0px;"><a href="javascript:void(0);"><span></span></a></div>
							<div style="margin-top:545px;width:100%;height:30px;">
								<input type="checkbox" id="mystatslo_quizEvent_c1" style="margin-left: 5px;"/>
								<label for="mystatslo_quizEvent_c1" style="color: #FFFFFF;"><span></span>오늘 하루 창 열지 않기</label>
							</div>
							<div class="pa_bottom_close" style="margin-left: 90%; margin-top: -32px;">
