...
<head>
	...
	<title>SGIS 에듀 > 고교 > 검색결과 > 함께하는 지도</title>
	...
	<script type="text/javascript" src="/sgis_edu/resource/js/search/searchWithMap.js"></script>
</head>
<body>
	<!--헤더삽입 -->
        ...
        <section class="sect sect01">
 			<div class="inner">
                    ...
                    <ul class="hashTagWrap">
                        <li><a href="/view/edu/high/searchWithMap?kwrd=다문화" class="hashTag">다문화</a></li>
                        <li><a href="/view/edu/high/searchWithMap?kwrd=1인가구" class="hashTag">1인가구</a></li>
                        <li><a href="/view/edu/high/searchWithMap?kwrd=노령화지수" class="hashTag">노령화지수</a></li>
                        <li><a href="/view/edu/high/searchWithMap?kwrd=인구피라미드" class="hashTag">인구피라미드</a></li>
                    </ul>
               </div>
        </section>
        <main>
            <div class="inner">
                <ul class="tab">
                    ...
                    <li class="on"><a href="javascript:$eduSearchApi.goSearch('WithMap')">함께하는 지도 <span class="withMapCnt"></span></a></li>
                </ul>
                <section class="result on">
                    <p class="sectTi"><strong>함께하는 지도</strong> 검색 결과 총 <i class="withMapCnt"></i>건</p>
