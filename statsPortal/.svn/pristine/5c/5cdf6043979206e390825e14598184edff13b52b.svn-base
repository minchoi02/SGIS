...
<script>
	$(document).ready(function() {
		...
		//배천규 추가
		if(gv_url == "house"){
			$("#divContent").css("min-height","910px")
		}
	});
</script>
...
<div id="maps">
	...
	<div class="list-panel bg-gray" style="z-index: 100;">
		...
		<div class="searchbox">
			<div class="search">
				<input type="text" value="" class="searchInput" onkeyup="if(window.event.keyCode==13){searchInputButton()}" placeholder="검색어를 입력하세요."/>
				<button onclick="searchInputButton();"><i class="fa fa-search"></i></button>
				<div class="searchLayer">
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:10px">
						<tr>
							<th colspan="2"><img src="/images/administStatsDetail/searchIcon2.png" alt="" /> 검색목록 <span id="searchCount">0건</span></th>
						</tr>
					</table>
					<div class="scrollBox">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<div class="chart-panel bg-gray" style="z-index: 101;">
		...
		<div class="panel-content overflow-y-scroll" id="chartPanelContent" style="display: block;">
			<div class="in-content" id="panel1">
				<div class="panel-tit2 panel_flex"> <!--div 클래스 추가-->
					<h4 class="pancon1h panel_txt_r" role="button" onclick="showhide($(this),'.pancon1')"></h4>
					<div class="">
						<button type="button" class="imgSaveBtn" name="imgSaveBtn" title="이미지 저장"><img src="/images/administStatsDetail/housedash_icon02.png"></button> <!--이미지 추가-->
			...
			<div class="in-content" id="panel4">
				<div class="panel-tit2 panel_flex">
					<h4 class="panel_txt_r pancon4h" role="button" onclick="showhide($(this),'.pancon4')">지역별 데이터 보기</h4>
					<div class="btnDiv">
						<button type="button" class="imgSaveBtn" name="imgSaveBtn" title="이미지 저장"><img src="/images/administStatsDetail/housedash_icon02.png"></button>
						<button type="button" class="toggleBtn on" name="toggleBtn" title="펼치기"><img src="/images/administStatsDetail/housedash_icon01.png"></button>
					</div>
