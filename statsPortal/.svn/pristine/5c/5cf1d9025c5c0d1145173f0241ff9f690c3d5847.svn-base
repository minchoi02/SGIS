...
<title>메인 | 통계청SGIS 오픈플랫폼</title>
    ...
    <script type="text/javascript" src="/js/edu_gallery/censusReqModify.js"></script>
	...
	<div id="wrap">
		...
		<!-- body -->
			...
			<p class="mpGuide">
				...
				<a href="/view/edu_gallery/getUseCaseModifyPage?id=<%=data_id%>"><span class="path_el current">자료수정</span></a>
			</p>
