...
<link rel="stylesheet" href="/sgis_edu/resource/css/main_ele.css">
...
<script type="text/javascript" src="/sgis_edu/resource/js/ele/classList.js"></script>
<script type="text/javascript" src="/sgis_edu/resource/js/slick.min.js"></script>
<script type="text/javascript" src="/sgis_edu/resource/js/jquery.paging.js"></script>
...
<body>
   ...
   <div class="sub list">
        ...
        <main>
            <h3 class="contTi">인문 환경과 인간 생활</h3>
