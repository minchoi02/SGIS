					...
					//생활업종지도
						...
						switch(this.menuType[data.dataType]) {
							case 0:
								...
								if(chart3==""){
									$("#extraChartRegion").hide();//입지계수로 인한 박길섭 추가
									}
							...
							case 1:
								...
								for (var i=0; i<options.chart.length; i++) {
									...
									html +=		"<div id='jobArea_"+i+"' style='margin:0 auto; height:300px;'>";
									if(data.param.type=="lq"){
										html +=			"<img src='"+chart.data+"' style='margin-left:100px;'/>";
									}
									html +=		"</div>";
									html += "</div>";
									$("#extraChartRegion"+(i+1)).append(html);
									if(data.param.type=="all"||data.param.type=="part"){
										$("#jobArea_"+i).append($(options.chart[i].data[0]).html());
										$(".typeCharts01").css("height","190px");
									}
							...
							case 10://박길섭 추가
								...
								for (var i=0; i<options.chart.length; i++) {
									...
									$("#extraChartRegion"+(i+1)).append(html);
									$("#jobArea_"+i).append($(options.chart[i].data[0]).html());
									$("#jobArea_"+i).css("height","400px");
									$("#jobArea_"+i).css("margin","0px 140px");
									$("#extraChartRegion"+(i+1)).show();
									$(".chtChkArea .ckbtn .ico").css("left","0"); 
									}
								break;	
							case 2:
								//2017.03.13 pdf저장 이슈
					...
					//생활업종지도
						...
						switch(this.menuType[data.dataType]) {
							case 0:
								...
								if(data.param.type=="worker"){
									var curRegionTitle = data.param.adm_nm + " " + "종사자 비율(%)";
								}
								else{
									curRegionTitle = data.param.adm_nm + " " + "사업체 비율(%)";
								}
								var tmpData = data.data;
								console.log(tmpData);
								for (var i=0; i<tmpData.length; i++) {
									if (tmpData[i].type == "sidoPieChart"||tmpData[i].type == "sidoPieChartWorker") {//박길섭 수정
										curRegionData = tmpData[i].data;
									}else if (tmpData[i].type == "contryPieChart"||tmpData[i].type == "contryPieChartWorker") {
								...
								var itemName = {
										...
										"srv_per"	   : "서비스",
										"whrtlsal_per" : "도소매",
										"lodgebiz_worker_per" : "숙박업",
										"rstrt_worker_per"	   : "음식점",
										"srv_worker_per"	   : "서비스",
										"whrtlsal_worker_per" : "도소매"
								};
								var html = "";
								...
								if (curRegionData != undefined && curRegionData != null) {
									if(data.param.type=="worker"){
										for (p in curRegionData) {
											if (p == "lodgebiz_worker_per" || 
												p == "rstrt_worker_per"    ||
												p == "srv_worker_per"		||
												p == "whrtlsal_worker_per") {
												html += "<tr>";
							...
							case 1://박길섭 수정
								...
								var html4 =  "";
								var html5 =  "";
								//var tmpData3 = data.data[1].data;
								
								for(var i=0;i<data.data.length;i++){
									if(data.data[i].type=="SigunguDetailPieChart"&&data.param.type=="part"){
										tmpData1=data.data[i].data;
										
									}
									else if(data.data[i].type=="SigunguAveragePieChart"&&data.param.type=="part"){
										tmpData2=data.data[i].data;
										
									}
									else if(data.data[i].type=="SigunguBarChart"||data.data[i].type=="sggTobRank"){
										tmpData3=data.data[i].data;
									}
									else if(data.data[i].type=="SigunguDetailPieChartAll"&&data.param.type=="all"){
										$("#extraTable1").hide();
										tmpData4=data.data[i].data;
										html4 += "<tr>";
										html4 += 	 "<td>음식점</td>";
										html4 +=	 "<td>"+tmpData4.rstrt_corp_cnt+"</td>";
										html4 += 	 "<td>"+tmpData4.rstrt_per+"</td>";
										html4 +=	 "<td>"+tmpData4.rstrt_worker_cnt+"</td>";
										html4 +=	 "<td>"+tmpData4.rstrt_worker_per+"</td>";
										html4 += "</tr>";
										html4 += "<tr>";
										html4 += 	 "<td>도소매</td>";
										html4 +=	 "<td>"+tmpData4.whrtlsal_corp_cnt+"</td>";
										html4 += 	 "<td>"+tmpData4.whrtlsal_per+"</td>";
										html4 +=	 "<td>"+tmpData4.whrtlsal_worker_cnt+"</td>";
										html4 +=	 "<td>"+tmpData4.whrtlsal_worker_per+"</td>";
										html4 += "</tr>";
										html4 += "<tr>";
										html4 += 	 "<td>서비스</td>";
										html4 +=	 "<td>"+tmpData4.srv_corp_cnt+"</td>";
										html4 += 	 "<td>"+tmpData4.srv_per+"</td>";
										html4 +=	 "<td>"+tmpData4.srv_worker_cnt+"</td>";
										html4 +=	 "<td>"+tmpData4.srv_worker_per+"</td>";
										html4 += "</tr>";
										html4 += "<tr>";
										html4 += 	 "<td>숙박</td>";
										html4 +=	 "<td>"+tmpData4.lodgebiz_corp_cnt+"</td>";
										html4 += 	 "<td>"+tmpData4.lodgebiz_per+"</td>";
										html4 +=	 "<td>"+tmpData4.lodgebiz_worker_cnt+"</td>";
										html4 +=	 "<td>"+tmpData4.lodgebiz_worker_per+"</td>";
										html4 += "</tr>";
										$("#extraTable3").find(".table_title").html(data.param.adm_nm);
										$("#extraTable3").find("tbody").append(html4);
										$("#extraTable3").show();
									}
									else if(data.data[i].type=="SigunguAveragePieChartAll"&&data.param.type=="all"){
										$("#extraTable2").hide();
										tmpData5=data.data[i].data;
										html5 += "<tr>";
										html5 += 	 "<td>음식점</td>";
										html5 +=	 "<td>"+tmpData5.rstrt_corp_cnt+"</td>";
										html5 += 	 "<td>"+tmpData5.rstrt_per+"</td>";
										html5 +=	 "<td>"+tmpData5.rstrt_worker_cnt+"</td>";
										html5 +=	 "<td>"+tmpData5.rstrt_worker_per+"</td>";
										html5 += "</tr>";
										html5 += "<tr>";
										html5 += 	 "<td>도소매</td>";
										html5 +=	 "<td>"+tmpData5.whrtlsal_corp_cnt+"</td>";
										html5 += 	 "<td>"+tmpData5.whrtlsal_per+"</td>";
										html5 +=	 "<td>"+tmpData5.whrtlsal_worker_cnt+"</td>";
										html5 +=	 "<td>"+tmpData5.whrtlsal_worker_per+"</td>";
										html5 += "</tr>";
										html5 += "<tr>";
										html5 += 	 "<td>서비스</td>";
										html5 +=	 "<td>"+tmpData5.srv_corp_cnt+"</td>";
										html5 += 	 "<td>"+tmpData5.srv_per+"</td>";
										html5 +=	 "<td>"+tmpData5.srv_worker_cnt+"</td>";
										html5 +=	 "<td>"+tmpData5.srv_worker_per+"</td>";
										html5 += "</tr>";
										html5 += "<tr>";
										html5 += 	 "<td>숙박</td>";
										html5 +=	 "<td>"+tmpData5.lodgebiz_corp_cnt+"</td>";
										html5 += 	 "<td>"+tmpData5.lodgebiz_per+"</td>";
										html5 +=	 "<td>"+tmpData5.lodgebiz_worker_cnt+"</td>";
										html5 +=	 "<td>"+tmpData5.lodgebiz_worker_per+"</td>";
										html5 += "</tr>";
										$("#extraTable4").find(".table_title").html(tmpData3[0].sido_nm);
										$("#extraTable4").find("tbody").append(html5);
										$("#extraTable4").show();
									}
								}
								...
								var html2 =  "";
								var html3 =  "";
								if(data.param.type=="part"){
									$("#extraTable3").hide();
									$("#extraTable4").hide();
									for (var k=0; k<tmpData1.length; k++) {
										html1 += "<tr>";
										html1 += 	 "<td>"+tmpData1[k].name+"</td>";
										html1 +=	 "<td>"+tmpData1[k].corp_cnt+"</td>";
										html1 += 	 "<td>"+tmpData1[k].corp_per+"</td>";
										html1 +=	 "<td>"+tmpData1[k].worker_cnt+"</td>";
										html1 +=	 "<td>"+tmpData1[k].worker_per+"</td>";
										html1 +=	 "<td>"+(k+1)+"</td>";
										html1 += "</tr>";
									}
									for (var k=0; k<tmpData2.length; k++) {
										html2 += "<tr>";
										html2 += 	"<td>"+tmpData2[k].name+"</td>";
										html2 +=	"<td>"+tmpData2[k].corp_cnt+"</td>";
										html2 += 	"<td>"+tmpData2[k].corp_per+"</td>";
										html2 +=	"<td>"+tmpData2[k].worker_cnt+"</td>";
										html2 +=	"<td>"+tmpData2[k].worker_per+"</td>";
										html2 +=	"<td>"+(k+1)+"</td>";
										html2 += "</tr>";
									}
									$("#extraTable1").find(".table_title").html(data.param.adm_nm);
									$("#extraTable1").find("tbody").append(html1);
									$("#extraTable1").show();
									$("#extraTable2").find(".table_title").html(tmpData3[0].sido_nm);
									$("#extraTable2").find("tbody").append(html2);
									$("#extraTable2").show();
									
								}
								for (var k=0; k<tmpData3.length; k++) {
									html3 += "<tr>";
									html3 += 	"<td>"+tmpData3[k].sgg_nm+"</td>";
									html3 +=	"<td>"+tmpData3[k].corp_cnt+"</td>";
									html3 += 	"<td>"+tmpData3[k].corp_cnt_rank+"</td>";
									html3 +=	"<td>"+tmpData3[k].corp_per+"</td>";
									html3 +=	"<td>"+tmpData3[k].corp_per_cnt_rank+"</td>";
									html3 += 	"<td>"+tmpData3[k].resid_ppltn_cnt+"</td>";
									html3 +=	"<td>"+tmpData3[k].resid_ppltn_cnt_rank+"</td>";
									html3 += 	"<td>"+tmpData3[k].work_population_cnt+"</td>";
									html3 +=	"<td>"+tmpData3[k].work_population_cnt_rank+"</td>";
									html3 +=	"<td>"+tmpData3[k].households_cnt+"</td>";
									html3 += 	"<td>"+tmpData3[k].households_cnt_rank+"</td>";
									html3 +=	"<td>"+tmpData3[k].worker_cnt+"</td>";
									html3 += 	"<td>"+tmpData3[k].worker_cnt_rank+"</td>";
									html3 +=	"<td>"+tmpData3[k].avg_worker_cnt+"</td>";
									html3 +=	"<td>"+tmpData3[k].avg_worker_cnt_rank+"</td>";
									html3 += "</tr>";
								}
								$("#extraTable5").find(".table_title").html(tmpData3[0].sido_nm+" "+"("+tmpData3[0].theme_nm+")");
								$("#extraTable5").find("tbody").append(html3);
								$("#extraTable5").show();
								//$("#extraTable1").find(".table_title").html(options.chart[i].title);
								
								/*for (var i=0; i<tmpRankData.data.length; i++) {
									var lData = tmpRankData.data[i];
									for (p in lData) {
										if (p == "corp_cnt") {
											for (var k=0; k<7; k++) {
							...
							case 10://박길섭 추가
								...
								for(var k =0;k<tmpData1.length;k++){
									...
									if(tmpData1[k].type=="countrySidoLq"&&data.param.depth==null){
										
										for(var i=0;i<tmpData1[k].data.length;i++){
											$("#extraTable7").hide();
											html1 += "<tr>";
											html1 += 	 "<td>"+tmpData1[k].data[i].sido_nm+"</td>";
											html1 +=	 "<td>"+tmpData1[k].data[i].corp_lq+"</td>";
											html1 += 	 "<td>"+tmpData1[k].data[i].worker_lq+"</td>";
											html1 += "</tr>";
											
										}
										$("#extraTable6").find(".table_title").html("업종별 입지계수");
										$("#extraTable6").find("tbody").append(html1);
										$("#extraTable6").show();
										$("#jobArea_0").css("height","300px");
										
									}
									else if(tmpData1[k].type=="sggLq"&&data.param.depth=="first"||tmpData1[k].type=="sggLq"&&data.param.depth=="second"){
										for(var i=0;i<tmpData1[k].data.length;i++){
											$("#extraTable6").hide();
											html2 += "<tr>";
											html2 += 	 "<td>"+tmpData1[k].data[i].sgg_nm+"</td>";
											html2 +=	 "<td>"+tmpData1[k].data[i].corp_lq+"</td>";
											html2 += 	 "<td>"+tmpData1[k].data[i].worker_lq+"</td>";
											html2 += "</tr>";
											
										}
										$("#extraTable7").find(".table_title").html("업종별 입지계수");
										$("#extraTable7").find("tbody").append(html2);
										$("#extraTable7").show();
										$("#jobArea_1").css("height","330px");
									}
