...
//					}
			...
			drawMapData : function(p_map_region, p_map_type) {
				...
				if($totSurvMain.ui.selectedArea!='00') 
					$("#dash_sido").val($totSurvMain.ui.selectedArea);
				//지역변수
				var lv_adm_cd = "00";
				var lv_adm_nm = "전국";
...
//							//params.region = "sgg";
			...
			setTotSurvData : function(p_map, p_region, p_type, p_sido_cd, p_sgg_cd, p_emdong_cd, p_surv_id, p_callback) {
				...
				$.ajax({
					...
					$.ajax({
						//url: lv_url,
						url: "/view/totSurv/getTblIdFromSurvId",
					    type: 'GET',
					    //data: lv_params
					    data: {
					    	survId: p_surv_id
						...
						param.tbl_id_list = res.tblId[0].tbl_id;
						$.ajax({
							//url: lv_url,
							url: sgis4thApiPath,
						    type: 'GET',
