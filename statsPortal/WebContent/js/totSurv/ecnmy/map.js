...
//					}
				...
				this.addPolygonGeoJson = function (obj, type, opt) {
					...
					if($totSurvMain.ui.originTilePerColor.length == 0) {
						$totSurvMain.ui.originTilePerColor = $totSurvMain.ui.tilePerColor.splice(0);
					}
					return geojson;
				};
				...
				*/
				this.setPolyLayerHighlight = function (admCd) {
					if(this.dataGeojson != null) {
						...
						var color = "#0086c6";
						var weight = 5;
						var tempColor = $ecnmyMap.ui.mapTempColor;
						...
						this.dataGeojson.eachLayer(function(layer) {
							...
							if(layer.feature.properties.adm_cd == admCd){
								if($ecnmyMap.ui.mapToggleId == admCd){									
									...
									if (feature.info[x].showData) {
										for (param in feature.info[x]) {
											if (param == feature.info[x].showData) {
												...
												//if($ecnmyMap.ui.selectedObj==""||$ecnmyMap.ui.selectedObj[0]==""){
													for(var i=0; i<$totSurvMain.ui.tilePerColor.length; i++) {
														if(data.adm_cd == $totSurvMain.ui.tilePerColor[i].adm_cd) {
															$totSurvMain.ui.tilePerColor.splice(i, 1);
														}
													}
