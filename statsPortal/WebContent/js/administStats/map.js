...
//					$('.sop-bottom.sop-left').css('margin-bottom', '50px');
...
//						console.log("[map.js] addPolygonGeoJson() 상위111 adm_cd.length[" + adm_cd.length);
				...
				this.setPolyLayerHighlight = function (admCd) {
					this.setPolyLayerHighlight3(admCd, "#0086c6");
				};
                 ...
                 * 2020-09-08
				*/
				this.setPolyLayerHighlight3 = function (admCd, color) {
					if(this.dataGeojson != null) {

						var color = color;
						var weight = 5;
						var tempColor = $administStatsMap.ui.mapTempColor;
						if(tempColor == "" && tempColor == null) tempColor = color;
								...
								if (feature.info[x].showData) {
									for (param in feature.info[x]) {
										if (param == feature.info[x].showData) {
											...
											if($administStatsMain.ui.selSliceId==""||$administStatsMain.ui.selSliceId==""){
					...
					if (this.legend != undefined && this.legend.selectType == "bubble") {
						...
						if (this.dataGeojson != null) {
							this.dataGeojson.eachLayer(function(layer) {
								...
								/* FIXME geo_sido*.js x,y좌표로 통계치 위치 지정하는데 2016~2017 통계치 겹쳐서 하드코딩 */
								switch (layer.feature.properties.adm_cd) {
									case "11":
										layer.feature.properties = {adm_cd: '11', adm_nm: '서울특별시', y: '1952053', x: '953932'};
										break;
									case "21":
										layer.feature.properties = {adm_cd: '21', adm_nm: '부산광역시', y: '1695144', x: '1144829'};
										break;
									case "22":
										layer.feature.properties = {adm_cd: '22', adm_nm: '대구광역시', y: '1759774', x: '1096217'};
										break;
									case "23":
										layer.feature.properties = {adm_cd: '23', adm_nm: '인천광역시', y: '1939946', x: '929709'};
										break;
									case "24":
										layer.feature.properties = {adm_cd: '24', adm_nm: '광주광역시', y: '1684701', x: '939473'};
										break;
									case "25":
										layer.feature.properties = {adm_cd: '25', adm_nm: '대전광역시', y: '1815829', x: '990493'};
										break;
									case "26":
										layer.feature.properties = {adm_cd: '26', adm_nm: '울산광역시', y: '1730025', x: '1157564'};
										break;
									case "29":
										layer.feature.properties = {adm_cd: '29', adm_nm: '세종특별자치시', y: '1840335', x: '978417'};
										break;
									case "31":
										layer.feature.properties = {adm_cd: '31', adm_nm: '경기도', y: '1920879', x: '978021'};
										break;
									case "32":
										layer.feature.properties = {adm_cd: '32', adm_nm: '강원도', y: '1987302', x: '1059213'};
										break;
									case "33":
										layer.feature.properties = {adm_cd: '33', adm_nm: '충청북도', y: '1860032', x: '1003504'};
										break;
									case "34":
										layer.feature.properties = {adm_cd: '34', adm_nm: '충청남도', y: '1853662', x: '930163'};
										break;
									case "35":
										layer.feature.properties = {adm_cd: '35', adm_nm: '전라북도', y: '1758283', x: '964651'};
										break;
									case "36":
										layer.feature.properties = {adm_cd: '36', adm_nm: '전라남도', y: '1647012', x: '924272'};
										break;
									case "37":
										layer.feature.properties = {adm_cd: '37', adm_nm: '경상북도', y: '1817430', x: '1112095'};
										break;
									case "38":
										layer.feature.properties = {adm_cd: '38', adm_nm: '경상남도', y: '1715022', x: '1060308'};
										break;
										layer.feature.properties = {adm_cd: '39', adm_nm: '제주특별자치도', y: '1490395', x: '905503'};
									case "39":
										break;
								}

								let x = layer.feature.properties.x;
								let y = layer.feature.properties.y;
