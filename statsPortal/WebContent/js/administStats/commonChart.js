...
(function(W, D) {
	...
	// 차트 유형
	$commonChart.chartType = "";	// 항목2일때 어떤차트인지 구분하기 위한 변수 (인구-행정통계인구 t1, 가구-성별연령별 가구의 주택 t2, 주택종류별 빈집 t3, 농업-농축산물 판매금액별 t4, 농업-인구와농가인기의 연령대별 분포 t5 , 임업-판매 금액별 임가 t4)
	...
	$commonChart.noDataHtml = "<div class='DataNone' style='text-align: center;'><img src='/images/administStats/ChartNone.png' alt='선택하신 차트 정보가 없습니다.' style='margin-top: 138px;'><p style='margin-top: 15px;'>선택하신 차트 정보가 없습니다.</p></div>";
	...
	$commonChart.ui = {
		...
		init : function(){
			...
			if($commonChart.dataType == "itm2" || $commonChart.dataType == "itm3"){
				...
				// 항목2일때 어떤차트인지 구분하기 위한 변수 (인구-행정통계인구 t1, 가구-성별연령별 가구의 주택 t2, 주택종류별 빈집 t3, 농업-농축산물 판매금액별 t4, 농업-인구와농가인기의 연령대별 분포 t5 , 임업 X)
...
//			console.log("$commonChart.event.setUIEvent() called.");
			...
			body.on("click", "#cmmChartSave", function(event){
				if($('.chartKind00').hasClass("on")){
					//$administStatsMain.ui.chartImageDown("#ageDiv", "연령분포"); //20201023 주형식 차트 명칭 추가
					//console.log("title = " + $('.chartKind00').prop("title"));
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind00').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind01').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind01').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind02').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind02').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind04').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind04').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind05').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind05').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				// 07, 10, 12
					...
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind07').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind10').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind10').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}
				else if($('.chartKind12').hasClass("on")){
					$administStatsMain.ui.chartImageDown('#chartDiv', $('.chartKind12').prop("title"));
					$('#commonAdministStats_popup_confirm').css('z-index','11000');
					// 백그라운드 없어져서 다시 검은색으로....
					$('#commonAdministStatsDetail_popup_back').show();
				}

				//$('#commonAdministStats_popup_confirm').css('z-index','5000');
			});
		...
		for(var i=0; i<data.length; i++){
		  ...
		  svg.append("g")
		      ...
		      .on("mouseover", function(d){
			    	...
			    	if("c1_nm" ==$commonChart.columnVal){
      	    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.c1_nm,"", numberFormat(d.dt), $commonChart.chartUnit, tool, -140, -80); // 2020-12-02 [곽제욱] 차트 변수 추가
      	    		}
      	    		else if("itm_nm" ==$commonChart.columnVal){
      	    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.itm_nm,"", numberFormat(d.dt), $commonChart.chartUnit, tool, -140, -80); // 2020-12-02 [곽제욱] 차트 변수 추가
      	    		}
      	    		else if("c2_nm" ==$commonChart.columnVal){
      	    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.c2_nm,"", numberFormat(d.dt), $commonChart.chartUnit, tool, -140, -80); // 2020-12-02 [곽제욱] 차트 변수 추가
      	    		}
      	    		else if("surv_year" ==$commonChart.columnVal){
			  ...
			  .on("click", function(d){
//				    $administStatsMain.ui.chartTarget = chartDiv
//		    		$administStatsMain.ui.chartIndex = $(this).index()
//		    		$administStatsMain.ui.chartData = d;
//		    		$administStatsMain.ui.chartColor = "#576574";
//		    		// 변경
//		    		//$administStatsMain.ui.chartTitle =  $administStatsMain.ui.selectedYear+"년 "+d.itm_nm
//		    		if("c1_nm" ==$commonChart.columnVal){
//      	    			$commonChart.ui.chartItmClick($(this), d, "#576574", $administStatsMain.ui.selectedYear+"년 "+d.c1_nm);
//      	    		}
//      	    		else if("itm_nm" ==$commonChart.columnVal){
//      	    			$commonChart.ui.chartItmClick($(this), d, "#576574", $administStatsMain.ui.selectedYear+"년 "+d.itm_nm);
//      	    		}
//      	    		else if("c2_nm" ==$commonChart.columnVal){
//      	    			$commonChart.ui.chartItmClick($(this), d, "#576574", $administStatsMain.ui.selectedYear+"년 "+d.c2_nm);
//      	    		}
//      	    		else if("surv_year" ==$commonChart.columnVal){
//      	    			$commonChart.ui.chartItmClick($(this), d, "#576574", $administStatsMain.ui.selectedYear+"년 "+d.surv_year);
//      	    		}
			   })
...
//		    	$administStatsMain.ui.chartTarget = target
//		    	$administStatsMain.ui.chartIndex = $(this).index()
//		    	$administStatsMain.ui.chartData = d;
//		    	$administStatsMain.ui.chartColor = "#576574";

		    	// 변경
		    	//$administStatsMain.ui.chartTitle = $administStatsMain.ui.selectedYear+"년 "+d.c1_nm+" "+d.itm_nm;
//		    	if("c1_nm" ==$commonChart.columnVal){
//  	    			$commonChart.ui.chartItmClick($(this), d, "#576574", $administStatsMain.ui.selectedYear+"년 "+ d.c1_nm);
//  	    		}
//  	    		else if("itm_nm" ==$commonChart.columnVal){
		...
		svg.append("g")
			...
			.join("rect")
			 .on("mouseover", function(d){
				...
				if("c1_nm" ==$commonChart.columnVal){
					 if("dt" ==$commonChart.dataVal){
						 $commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.c1_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 10, -30); // 2020-12-02 [곽제욱] 차트 변수 추가
					 }
  	    		}
  	    		else if("itm_nm" ==$commonChart.columnVal){
  	    			if("dt" ==$commonChart.dataVal){
  	    				$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.itm_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 10, -30); // 2020-12-02 [곽제욱] 차트 변수 추가
  	    			}
  	    		}
  	    		else if("c2_nm" ==$commonChart.columnVal){
  	    			if("dt" ==$commonChart.dataVal){
  	    				$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.c2_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 10, -30); // 2020-12-02 [곽제욱] 차트 변수 추가
  	    			}
  	    		}
  	    		else if("surv_year" ==$commonChart.columnVal){
  	    			if("dt" ==$commonChart.dataVal){
	...
	if($commonChart.dataType == "itm1"){
	    ...
	    blobCircleWrapper.selectAll(".radarInvisibleCircle")
	        ...
	        .on("mouseover", function(d,i) {
	        	...
	        	if("dt" ==$commonChart.dataVal){
	        		if("c1_nm" ==$commonChart.columnVal){
	        			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.c1_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 0, 0); //툴팁추가 // 2020-12-02 [곽제욱] 차트 변수 추가
		    		}
		    		else if("itm_nm" ==$commonChart.columnVal){
		    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.itm_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 0, 0); //툴팁추가 // 2020-12-02 [곽제욱] 차트 변수 추가
		    		}
		    		else if("c2_nm" ==$commonChart.columnVal){
		    			$commonChart.ui.createChartTool($administStatsMㄴain.ui.selectedYear, d.c2_nm, "", numberFormat(d.dt), $commonChart.chartUnit, tool, 0, 0); //툴팁추가 // 2020-12-02 [곽제욱] 차트 변수 추가
		    		}
		    		else if("surv_year" ==$commonChart.columnVal){
...
//	            	$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, "", "", d.dt, "", tool, 0, 0); //툴팁추가
	        	}
	        })
	        .on("mouseout", function(){
	            tool.css('display', 'none')
...
function pieChart(data, target, resizeYn, height, gubun){
	...
	if($commonChart.dataType == "itm1"){
		...
		g.append("path")
		    .on("mouseover", function(d, i){
		    	console.log("d = " + d);
		    	//20201202 박은식 상세일때와 대쉬보드일때 파라미터가 다르므로 분기처리 START
		    	if($administStatsMain.ui.pageIndex == 0){
		    		...
		    		if("c1_nm" ==$commonChart.columnVal){
		    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, data[i].c1_nm, " ", numberFormat(d.data), $commonChart.chartUnit, tool, 0, 0);
		    		}
		    		else if("itm_nm" ==$commonChart.columnVal){
		    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, data[i].itm_nm, " ", numberFormat(d.data), $commonChart.chartUnit, tool, 0, 0);
		    		}
		    		else if("c2_nm" ==$commonChart.columnVal){
		    			$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, data[i].c2_nm, " ", numberFormat(d.data), $commonChart.chartUnit, tool, 0, 0);
		    		}
		    		else if("surv_year" ==$commonChart.columnVal){
		    	...
		    	//20201202 박은식 상세일때와 대쉬보드일때 파라미터가 다르므로 분기처리 END
		    })
		...
		svg.append("text")
		    ...
		    .text("합계: " + $administStatsMain.util.addComma(d3.sum(graphData)));
...
function barBrokenLineChart(){
	...
	if($commonChart.dataType == "itm2"){
		...
		// 인구 - 행정통계 인구
		if($commonChart.chartType == "t1"){
			// [행정통계인구 차트] 넘어온 데이터 체크  START  2020-10-13  jhs
			var data = $commonChart.chartData;
			if(data.length == 0){
				return;
			}
			// [행정통계인구 차트] 넘어온 데이터 체크  END  2020-10-13  jhs
			...
			const svg = chart.append("svg")
				...
				.on('mouseover', function(d){
					$commonChart.ui.chartMouseOver($(this), "#576574"); // 2020.09.22[신예리] 행정통계 인구 차트 마우스 오버 컬러 변경
					$commonChart.ui.createChartTool(d.surv_year, "총인구","", numberFormat(d.dt), "명", tool, -20, -100); //20201117 박은식 number format 변경
				})
				.on('mouseout', function(){
					$commonChart.ui.chartMouseOut($(this), "#576574"); // 2020.09.22[신예리] 행정통계 인구 차트 마우스 오버 컬러 변경
					tool.css("display", "none"); /** 2020-10-07 [곽제욱] 툴팁 수정 */
				})
				...
				var path = svg.append("path")
					.datum(data)
					.attr("fill", "none")
					.attr("stroke", "#97BB03") // 2020.09.22[신예리] 행정통계 인구 stroke color 변경
					.attr("stroke-miterlimit", 2)
					.attr("stroke-width", 2) // 2020.09.22[신예리] 행정통계 인구 stroke width값 조정
					.attr("d", line)
			...
			svg.append("g")
				...
				.attr("fill", "#fff") // 2020.09.22[신예리] 행정통계 인구 circle fill color 변경
				.attr("stroke", "#97BB03") // 2020.09.22[신예리] 행정통계 인구 circle stroke 추가
				.attr("stroke-width", 2) // 2020.09.22[신예리] 행정통계 인구 circle stroke width 추가
		...
		// 농업 - 농축산물 판매 금액별
			...
			const svg = chart.append("svg")
				...
				.on('mouseover', function(d){
					$commonChart.ui.chartMouseOver($(this), "#576574"); // 2020.09.22[신예리] 행정통계 인구 차트 마우스 오버 컬러 변경
					$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, d.itm_nm,"", numberFormat(d.dt), $commonChart.chartUnit, tool, -20, -100); //20201117 박은식 number format 변경 // 2020-12-02 [곽제욱] 차트 변수 추가
				})
				.on('mouseout', function(){
					$commonChart.ui.chartMouseOut($(this), "#576574"); // 2020.09.22[신예리] 행정통계 인구 차트 마우스 오버 컬러 변경
					tool.css("display", "none");
				...
				var path = svg.append("path")
					.datum(data)
					.attr("fill", "none")
					.attr("stroke", "#FFA200") // 2020.09.22[신예리] 행정통계 인구 stroke color 변경
					.attr("stroke-miterlimit", 2)
					.attr("stroke-width", 2) // 2020.09.22[신예리] 행정통계 인구 stroke width값 조정
					.attr("d", line)
			...
			svg.append("g")
				...
				.attr("fill", "#fff") // 2020.09.22[신예리] 행정통계 인구 circle fill color 변경
				.attr("stroke", "#FFA200") // 2020.09.22[신예리] 행정통계 인구 circle stroke 추가
				.attr("stroke-width", 2) // 2020.09.22[신예리] 행정통계 인구 circle stroke width 추가
				.attr("style", "pointer-events: all;")
				//.attr("cx", function(d){ return x(d.surv_year) + x.bandwidth() / 2 })
...
//			}
	 ...
	 // male newly
	 // create a g element ('group element') into which we will place the bars for the male newly
		var gM = svg.append("g")
					.attr('class', 'male')
		...
		gM.selectAll('rect')
		  ...
		  .on("mouseout", function(){
			  tool.css("display", "none");
			  $commonChart.ui.chartMouseOut($(this), $administStatsMain.ui.tempColor)
		  })
		  .transition()
		  .duration(1000)
		  .delay(function (d, i) {
...
//				  $administStatsMain.ui.chartTarget = $(this).parent().parent().attr('id')
//				  $administStatsMain.ui.chartIndex = $(this).parent().index()
//				  $administStatsMain.ui.chartData = param;
//				  $administStatsMain.ui.chartColor = "#576574";
//				  $administStatsMain.ui.chartTitle = d.data.year+" 주택종류별 빈집 (" + d.c1_nm + ")";
	...
	if($commonChart.dataType == "itm1"){
		...
		const rects = gSvg.selectAll("g").data(series).enter()
			...
			.on("mouseover", function(d){
				...
				$commonChart.ui.createChartTool($administStatsMain.ui.selectedYear, title + " " + $(this).attr("title"),"", numberFormat(d[1]-d[0]), $commonChart.chartUnit, tool, -20, -100);
			})
...
//				$administStatsMain.ui.chartTarget = target
//				$administStatsMain.ui.chartIndex = $(this).index()
//				$administStatsMain.ui.chartData = data;
//				$administStatsMain.ui.chartColor = "#576574";
//				$administStatsMain.ui.chartTitle = $administStatsMain.ui.selectedYear+"년 "+d.itm_nm;
//		    	$houseHoldDash.ui.chartItmClick($(this).parent().find("rect").eq(i), data, "#576574", $administStatsMain.ui.selectedYear+"년 "+title);
			})
			.attr("height",function(d){
 ...
 *         인구-행정통계인구 t1, 가구-성별연령별 가구의 주택 t2, 주택종류별 빈집 t3, 농업-농축산물 판매금액별 t4, 농업-인구와농가인기의 연령대별 분포 t5 , 임업 X)
 */
function chartModal(data, dataType, columnVal, dataVal, chartType, titleSubNm , unit) { // 2020-12-02 [곽제욱] 공통차트 변수 추가
	...
	modal
        ...
        .on('click', function() {
            ...
            //bg.remove();
            modal.hide();
            $('#commonAdministStatsDetail_popup_back').hide();
        });
