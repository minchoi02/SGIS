 ...
 */
(function(W, D) {
	W.$ssaMapApi = W.$ssaMapApi || {};
	
	//$ssaMapApi.grid_legend_new = [[]]; //그리드의 범례 데이터 세팅 mng_s
	...
	$ssaMapApi.request = {
			...
			// 일자리맵 추가
			API_WORK_URL : "/ServiceAPI/workRoad/statsAnls/getStatsAnlsJobQualityMainDataBoard.json",
			...
			mask : {
				show : function () {
					$workRoad.ui.addFnc04List("$ssaMapApi.request.mask.show");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				...
				close : function () {
					$workRoad.ui.addFnc04List("$ssaMapApi.request.mask.close");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
			...
			openApiWorkData : function(params) {// used
				$workRoad.ui.log("$ssaMapApi.request.openApiWorkData - begin");

				var sopOpenApiWorkDataObj = new sop.openApi.ssa.workData.api.ssa();
				...
				console.log("[ssaMapApi.js] params.param.push ");
			...
			openApiTotalPopulation : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiTotalPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[ssaMapApi.js] openApiTotalPopulation() 호출");
				
				var sopOpenApiTotalPopulationObj = new sop.openApi.ssa.totalPopulation.api();
				...
				console.log("[ssaMapApi.js] openApiTotalPopulation() params.map.isInnerMapShow2 [" + params.map.isInnerMapShow2);
				console.log("[ssaMapApi.js] openApiTotalPopulation() params.map.isInnerMapShow3 [" + params.map.isInnerMapShow3);
				console.log("[ssaMapApi.js] openApiTotalPopulation() zeroLevelYn [" + zeroLevelYn);
			...
			gridLegendTotalPopulation : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.gridLegendTotalPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[ssaMapApi.js] gridLegendTotalPopulation() 호출");
				
				var gridLegendTotalPopulationObj = new sop.openApi.ssa.gridLegendTotalPopulation.api();
			...
			openApiSearchPopulation : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiSearchPopulation");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiSearchPopulationObj = new sop.openApi.ssa.searchPopulation.api();
			...
			openApiHouseHold : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseHoldObj = new sop.openApi.ssa.houseHold.api();
			...
			openApiHouseHoldMember : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiHouseHoldMember");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseHoldMemberObj = new sop.openApi.ssa.houseHoldMember.api();
			...
			openApiFarmHouseHold : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiFarmHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiFarmHouseHoldObj = new sop.openApi.ssa.FarmHouseHold.api();
			...
			openApiForestryHouseHold : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiForestryHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiForestryHouseHoldObj = new sop.openApi.ssa.ForestryHouseHold.api();
			...
			openApiFisheryHouseHold : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiFisheryHouseHold");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiFisheryHouseHoldObj = new sop.openApi.ssa.FisheryHouseHold.api();
			...
			openApiInterstryCode : function(depth, class_deg, class_cd) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiInterstryCode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiInderstryCodeObj = new sop.openApi.ssa.InderstryCode.api();
			...
			openApiCompany : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiCompany");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[todayStatusMap.js] openApiCompany() 호출");
				
				var sopOpenApiCompanyObj = new sop.openApi.ssa.Company.api();
			...
			openApiHouse : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiHouse");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiHouseObj = new sop.openApi.ssa.House.api();
			...
			openApiMainRecentParamInfo : function (hist_id) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiMainRecentParamInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiMainRecentParamInfoObj = new sop.openApi.ssa.mainRecentParamInfo.api();
			...
			openApiShareForStats : function(params, adm_cd) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiShareForStats");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiShareForStatsObj = new sop.openApi.ssa.shareForStats.api();
...
//					todayStatusMapEtc.gis_se = paramInfo.gis_se;
			...
			openApiUserDrawForStats : function(params, area, layer) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiUserDrawForStats");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var url = "";
				var method = "GET";

				var sopOpenApiUserDrawForStatsObj = new sop.openApi.ssa.userDrawForStats.api();
				for (var i = 0; i < params.param.length; i++) {
			...
			openApiLoginProcess : function(id, pwd) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiLoginProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopLoginObj = new sop.portal.ssa.login.api();
			...
			openApiDeveloperLoginProcess : function(id, pwd) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiDeveloperLoginProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopDeveloperLoginObj = new sop.portal.ssa.developerLogin.api();
			...
			openApiStatBaseYearProcess : function() {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiStatBaseYearProcess");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var searchbtnCnt = $todayStatusLeftMenu.ui.searchbtnCnt - 1;
				var sopStatBaseYearObj = new sop.portal.ssa.statBaseYear.api();
			...
			openApiGeocode : function(address) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiGeocode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도			
				var sopOpenApiGeocodeObj = new sop.openApi.ssa.geocode.api();
			...
			openApiSOP : function(searchword, pagenum) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiSOP");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiSOPObj = new sop.openApi.ssa.sopsearch.api();
			...
			openApiKOSIS : function(searchword, pagenum) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiKOSIS");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiKOSISObj = new sop.openApi.ssa.kosissearch.api();
			...
			openApiItemCombine : function(params) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.openApiItemCombine");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopOpenApiItemCombineObj = new sop.openApi.ssa.itemcombine.api();
				var api_url = contextPath + $ssaMapApi.request.API_FUSION_URL;		//초기값은 기본 결합조건api주소
				var methodType = "POST";
					...
					if(params.noneParams[i].key == "fusion_query_type") {	
						if(params.noneParams[i].value == "population" || params.noneParams[i].value == "household" || params.noneParams[i].value == "house") {		//인구, 가구, 주택 조건
							if(params.noneParams[i].value == "population") {
								api_url = openApiPath + $ssaMapApi.request.API_0302_URL;		//인구 OPENAPI 호출
							} else if(params.noneParams[i].value == "household") {
								api_url = openApiPath + $ssaMapApi.request.API_0305_URL;		//가구 OPENAPI 호출
							} else if(params.noneParams[i].value == "house") {
								api_url = openApiPath + $ssaMapApi.request.API_0306_URL;		//주택 OPENAPI 호출
							}
							methodType = "GET";
			...
			searchReverseGeoCode : function (division, url, title) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.searchReverseGeoCode");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var sopSearchReverseGeoCodeObj = new sop.openApi.ssa.searchReverseGeoCode.api();
				sopSearchReverseGeoCodeObj.addParam("accessToken", accessToken);
				sopSearchReverseGeoCodeObj.addParam("addr_type", "20");
				sopSearchReverseGeoCodeObj.addParam("x_coor", $ssaMap.ui.x);
				sopSearchReverseGeoCodeObj.addParam("y_coor", $ssaMap.ui.y);
			...
			userAreaBoundInfo : function (area, type, code, layer, map) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.userAreaBoundInfo");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var userAreaBoundObj = new sop.openApi.ssa.userAreaBoundObj.api();
			...
			setStatsData : function (res, options, isContry) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.setStatsData");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				
				console.log("[ssaMapApi.js] setStatsData() 호출");
				
				var result = res.result;
				var params = options.params;
				var map = params.map;
				var mapInfo = map.mapInfo;
				var dataBoard = $ssaDataBoard.ui.mapData[$ssaDataBoard.ui.map_id].dataBoard;	//9월 서비스
				...
				for (var i=0; i<result.length; i++) {
					console.log("[ssaMapApi.js] params.filter : " + params.filter);
...
//					$("#noticeTextPopup0"+(parseInt(map.id)+1)).hide();
				...
				// 구인자료현황 조회 추가
				console.log("[ssaMapApi.js] res.id / options.params.title / options.params.unit / map.id : " + res.id + " / " + options.params.title  + " / " +  options.params.unit  + " / " +  map.id);
				if (res.id == "API_WORK") {
				...
				// 일반검색 버튼일 경우,
				if ($ssaMap.ui.searchBtnType == "normal") {	
					...
					$ssaMap.ui.updateSearchTitle(options.params.title, options.params.unit, map.id);
					...
					if ($ssaMapApi.request.combineFailCnt > 0) {
						map.clearDataOverlay();
						$ssaMap.ui.shareUrlInfoList = [];
						return;
					}
...
//						$("#timeSeriesDiv").hide();
					...
					if (map.combineData.length == 2) {
						...
						$ssaMap.ui.updateSearchTitle(combineTitle, map.id);
					}
			...
			setMultiStatsData : function (res, options, isContry) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.setMultiStatsData");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var result = res.result;
				var params = options.params;
				var map = params.map;
			...
			checkContryData : function(res, options, map) {
				$workRoad.ui.addFnc04List("$ssaMapApi.request.checkContryData");	// 임시 - 2019.01.10	ywKim	추가: 사용 안하는 함수 찾는 용도
				var isContry = false;
	...
	if ($workRoad.ui.isSetCallback('ssaMapApi')) return;
	
	/** ********* OpenAPI 구인자료 현황 조회 Start ********* */
	(function() {
		$class("sop.openApi.ssa.workData.api.ssa").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						console.log("[ssaMapApi.js] sop.openApi.ssa.workData.api.ssa 호출");
						console.log("[ssaMapApi.js] sop.openApi.ssa.workData.api.ssa res.errCd [" + res.errCd);
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							case 0:
								var isContry = $ssaMapApi.request.checkContryData(res, options, map);
								if (map.selectedBoundMode == "multi") {
									$ssaMapApi.request.setMultiStatsData(res, options, isContry);		
								}else {
									$ssaMapApi.request.setStatsData(res, options, isContry);		
								}
								break;
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiWorkData(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
									res["result"] = [];
									$ssaMapApi.request.setMultiStatsData(res, options);	
								}else {
									messageAlert.open(
											"알림", 
								...
								break;
							default:
								$ssaMapApi.request.combineFailCnt++;
								map.clearDataOverlay();
	...
	(function() {
		$class("sop.openApi.ssa.totalPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						
						console.log("[ssaMapApi.js] sop.openApi.ssa.totalPopulation.api 호출");
						console.log("[ssaMapApi.js] sop.openApi.ssa.totalPopulation.api res.errCd [" + res.errCd);
						...
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiTotalPopulation(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
									...
									//시계열에서 검색값이 없을 경우
									$ssaDataBoard.ui.emptyTimerBaseInsert(res, options);
								}
								break;
							default:
								$ssaMapApi.request.combineFailCnt++;
					...
					onFail : function(status, options) {
						...
						console.log("[ssaMapApi.js] sop.openApi.ssa.totalPopulation.api onFail 호출");
						console.log("[ssaMapApi.js] sop.openApi.ssa.totalPopulation.api status [" + status);
	...
	(function() {
		$class("sop.openApi.ssa.gridLegendTotalPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						
						console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api 호출");
						console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api res.errCd [" + res.errCd);
					...
					onFail : function(status, options) {
						...
						console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api onFail 호출");
						console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api status [" + status);
						...
						//console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api options.params.map.grid_legend_new [" + options.params.map.grid_legend_new);
						
						//console.log("[ssaMapApi.js] sop.openApi.ssa.gridLegendTotalPopulation.api click ");
						//$("#legendColor_"+options.params.map.legend.id+ " li>a").eq(0).click();
	...
	(function() {
		$class("sop.openApi.ssa.searchPopulation.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiSearchPopulation(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ssa.houseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ssa.houseHoldMember.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiHouseHoldMember(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ssa.FarmHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiFarmHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ssa.ForestryHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiForestryHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	(function() {
		$class("sop.openApi.ssa.FisheryHouseHold.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiFisheryHouseHold(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* OpenAPI 산업체분류 Start ********* */
	(function() {
		$class("sop.openApi.ssa.InderstryCode.api").extend(sop.portal.absAPI)
		.define(
				{
					onSuccess : function(status, res, options) {
						var result = res.result;
											...
											if (node.childCount == null) {
												if (node.children.length > 0 ) {
													if(node.children[0].id == node.id + "_progress") {
														if (node.isExpanded) {
															$ssaMapApi.request.openApiInterstryCode(
																	node.depth,
																	options.class_deg,
																	node.cd);
														}
	...
	/** ********* OpenAPI 사업체분류 Start ********* */
	(function() {
		$class("sop.openApi.ssa.Company.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiCompany(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* OpenAPI 주택분류 Start ********* */
	(function() {
		$class("sop.openApi.ssa.House.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {	
						var map = options.params.map;
						switch (parseInt(res.errCd)) {
							...
							case -401:
								accessTokenInfo(function() {
									$ssaMapApi.request.openApiHouse(options.params);
								});
								break;
							case -100:
								if (map.selectedBoundMode == "multi") {
	...
	/** ********* 메인예시 파라미터정보조회 시작 ********* */
	(function() {
		$class("sop.openApi.ssa.mainRecentParamInfo.api").extend(sop.portal.absAPI).define(
				{
	...
	/** ********* 북마크/공유 통계정보조회 시작 ********* */
	(function() {
		$class("sop.openApi.ssa.shareForStats.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var result = res.result;
						var mapId = getMapDivisionId();		//검색 시 적용 될 지도(맵 분할 시)
						var map = $ssaMap.ui.mapList[mapId];
						var mapInfo = map.mapInfo;		
						...
						if (res.errCd == "0") {
							...
							if ($ssaMap.ui.searchBtnType == "normal") {	
								...
								$ssaMap.ui.updateSearchTitle(options.params.param_info.title, options.params.param_info.unit, map.id);
								...
								//시계열 초기값 세팅
								$ssaDataBoard.ui.timeSeriesInit(tmpOptions.params);
								
								$ssaDataBoard.ui.updateDataBoard(res, tmpOptions);	//데이터보드
							...
							accessTokenInfo(function() {
								$ssaMapApi.request.openApiShareForStats(options.params, options.adm_cd);
							});
	...
	/** ********* 로그인 시작 ********* */
	(function() {
		$class("sop.portal.ssa.login.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
							var result = res.result;
							...
							$ssaMapApi.request.openApiRegBookmark(
									$ssaMap.ui.shareUrlInfoList[parseInt($ssaMap.ui.curMapId)], 
									$ssaMap.ui.share_type,
									$ssaMap.ui.curMapId+1);
							
							//개발자 로그인
							$ssaMapApi.request.openApiDeveloperLoginProcess(options.id, options.pwd);
	...
	/** ********* 개발자 로그인 시작 ********* */
	(function() {
		$class("sop.portal.ssa.developerLogin.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
						} else {
	...
	/** ********* 통계별최신년도정보 조회 시작 ********* */
	(function() {
		$class("sop.portal.ssa.statBaseYear.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
							var result = res.result;
	...
	/** ********* 사용자지정영역검색 시작 ********* */
	(function() {
		$class("sop.openApi.ssa.userDrawForStats.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						if (res.errCd == "0") {
	...
	(function() {
	    $class("sop.openApi.ssa.geocode.api").extend(sop.portal.absAPI).define({
	        onSuccess : function(status, res, options) {	        
	            if(res.errCd == "0") {
	            	var result = res.result;
	            	for(var  i = 0; i < result.resultdata.length; i ++) {
	            		...
	            		var arrayKey = $ssaMap.ui.sKeyword.split(" ");
	            		if(arrayKey.length < 2) {
	            			$ssaMap.ui.addressAdmCd = "";
	            			$ssaMap.ui.x = "962202";
		            		$ssaMap.ui.y = "1839421";
	            		} else {
	            			$ssaMap.ui.addressAdmCd = dongCd;
	            			$ssaMap.ui.x = result.resultdata[i].x;
		            		$ssaMap.ui.y = result.resultdata[i].y;
	            		}
	            	...
	            	accessTokenInfo(function() {
	            		$ssaMapApi.request.openApiGeocode(options.address);
	            	});
	            }  else if (res.errCd == "-100") {
	            	$ssaMap.ui.addressAdmCd = "";
        			$ssaMap.ui.x = "962202";
	            ...
	            var arrayKey = $ssaMap.ui.sKeyword.split(" ");
	            if(arrayKey.length < 2) {
					$ssaMapApi.request.openApiSOP($ssaMap.ui.sKeyword, $ssaMap.ui.sopCurrentPageIndex);
	            } else {
	            	$ssaMapApi.request.openApiSOP($ssaMap.ui.searchKeyword, $ssaMap.ui.sopCurrentPageIndex);
	            }
	            //KOSIS 검색
	            $ssaMapApi.request.openApiKOSIS($ssaMap.ui.sKeyword, $ssaMap.ui.kosisCurrentPageIndex);
	        },
	        onFail : function(status) {
	        	//SOP 검색
	        	var arrayKey = $ssaMap.ui.sKeyword.split(" ");
	...
	(function() {
	    $class("sop.openApi.ssa.sopsearch.api").extend(sop.portal.absAPI).define({
	        onSuccess : function(status, res, options) {
            	$("#sopListTable").empty();
	            ...
	            if(res.errCd == "0") {
	            	...
	            	for(var i = 0; i < result.resultdata.length; i++) {
	            		...
	            		html += "	<div style='cursor: pointer; margin-left: 20px; font-size: 11px;' onclick=\"javascript:$ssaMapApi.request.searchReverseGeoCode('sop', '"+elem.url + "','"+elem.nm+"')\">" + elem.nm + "</div>";
	            		html += "</li>";
	            	}
	            	html += "</ul>";
	            	html += "</div>";	            		            
            		...
            		$ssaMap.ui.sopPaging(result.totalcount, $ssaMap.ui.sopCurrentPageIndex);
            		
	            } else if(res.errCd == "-401") {
	            	accessTokenInfo(function() {
	            		$ssaMapApi.request.openApiSOP(options.searchword, options.pagenum);
	            	});
	            }
	        },
	        onFail : function(status) {
	...
	(function() {
	    $class("sop.openApi.ssa.kosissearch.api").extend(sop.portal.absAPI).define({
	        onSuccess : function(status, res, options) {
	        	$("#kosisListTable").empty();
	        	$("#kosisListTablePage").empty();
	            if(res.errCd == "0") {
	            	var result = res.result;
	            	$ssaMap.ui.searchKosisParam = [];
            		//KOSIS
	            	if(result.resultdata != undefined) {
	            		...
	            		for(var x = 0; x < result.resultdata.length; x ++) {
	            			...
	            			elem["type"] = "kosis";
	            			elem["adm_cd"] = $ssaMap.ui.addressAdmCd;
	            			elem["x"] = $ssaMap.ui.x;
	            			elem["y"] = $ssaMap.ui.y;
	            			
	            			html += "<li style='line-height: 30px;'>";
	            			html += 	"<div style='float: left; font-size: 5px;'>● </div>"	//리버스지오코딩 : 법정동->행정동
	        	            html += "	<div style='cursor: pointer; margin-left: 20px; font-size: 11px;' onclick=\"javascript:$ssaMapApi.request.searchReverseGeoCode('kosis', '"+x + "', '"+elem.stat_title+"')\">" /*+ elem.menu_level_nm1  + " > " */+ elem.stat_title + "</div>";
	            			html += "</li>";
	            			
	            			$ssaMap.ui.searchKosisParam.push(elem);
	            		}
	            		...
	            		$ssaMap.ui.kosisPaging(result.totalcount, $ssaMap.ui.kosisCurrentPageIndex);
	            	}
	            	
	            } else if(res.errCd == "-401") {
	            	accessTokenInfo(function() {
	            		$ssaMapApi.request.openApiKOSIS(options.searchword, options.pagenum);
	            	});
	            }
	        },
	        onFail : function(status) {
	...
	(function () {
		$class("sop.openApi.ssa.searchReverseGeoCode.api").extend(sop.portal.absAPI).define({
			onSuccess : function (status, res, options) {
				var that = options.target;
				if (res.errCd == "0") {		
					var result = res.result[0];
					if ($ssaMap.ui.addressAdmCd != "") {
						if (options.division == "sop") {		//SOP
							if($ssaMap.ui.addressAdmCd.length == 2) {
								$ssaMap.ui.addressAdmCd = result.sido_cd;
							}else if ($ssaMap.ui.addressAdmCd.length == 5) {
								$ssaMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd;
							}else if ($ssaMap.ui.addressAdmCd.length == 7) {
								$ssaMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd + result.emdong_cd;
							}else {
								$ssaMap.ui.addressAdmCd = "00";
							}
						} else {	//KOSIS
							$ssaMap.ui.addressAdmCd = result.sido_cd + result.sgg_cd + result.emdong_cd;
						}
					...
					if(options.division == "sop") {
            			...
            			$ssaMap.ui.searchSOPParam = [elem];
            			$ssaMap.ui.analysisSearchInfo("sop", 0);
					} else if(options.division == "kosis") {
						var x = options.url;
						$ssaMap.ui.searchKosisParam[x]["adm_cd"] = $ssaMap.ui.addressAdmCd;
						$ssaMap.ui.searchKosisParam[x]["x"] = $ssaMap.ui.x;
						$ssaMap.ui.searchKosisParam[x]["y"] = $ssaMap.ui.y;
						$ssaMap.ui.searchKosisParam[x]["title"] = options.title;
						$ssaMap.ui.analysisSearchInfo("kosis", x);
					}
				}
				else if (res.errCd == "-401") {
					accessTokenInfo(function() {
	...
	/** ********* 조건결합통계 Start ********* */
	(function() {
		$class("sop.openApi.ssa.itemcombine.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {	
						if (res.errCd == "0") {
							var params = options.params;
...
//							$ssaMap.ui.setShareInfo(options, "normal", map.id);
							map.shareInfo.setShareInfo(options, "normal", map.id);

						} else if (res.errCd == "-401") {
							accessTokenInfo(function() {
								$ssaMapApi.request.openApiItemCombine(options.params);
							});
						} else {
							var map = options.params.map;
							map.clearDataOverlay();
	...
	/** ********* 사용자영역 경계조회 Start ********* */
	(function() {
		$class("sop.openApi.ssa.userAreaBoundObj.api").extend(sop.portal.absAPI).define(
				{
					onSuccess : function(status, res, options) {
						var map = options.map;
