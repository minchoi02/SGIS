...
//			console.log("selectDataBoardMap - result : " + JSON.stringify(result));
		...
		SearchPopupData : function(){
			...
			srvLogWrite('D0', '05', '02', '03', '', slwParams);
...
//						20190313 손원웅 추가_피보험자 증감으로 바뀌면서 단위(%) 변경으로 주석 처리함
...
//						if(this.DetailData[0].link_id == "E3224" || this.DetailData[0].link_id == "E3208" || this.DetailData[0].link_id == "I3207"){
						if(this.DetailData[0].link_id == "E3208" || this.DetailData[0].link_id == "I3207"){
							yLabel = '명';
							...
							yLabel = '개';
						}else if(this.DetailData[0].link_id == "E3224"){
							yLabel = '명'; // 2020-05-18 [곽제욱] KOSIS 데이터 연계로 단위 수정(%->명)
						}
...
//													    console.log("SearchPopupMap - DataInfo data : " + JSON.stringify(data));
												...
												// 2019.03.13 접근log 생성
												srvLogWrite('D0', '05', '02', '04', '', 'Link_id='+dataParams.Link_id);
						                    }
						                }
						            },					            				                    
						            marker: {
...
//								console.log("SearchPopupMap - DataInfo data : " + JSON.stringify(data));
								...
								// 2019.08.22 이금은 this_Mon 으로 변경
								var this_Mon = $workRoad.util.dateWithSign($ssaJobGrowthDetailPopup.ui.CurrentDate[0].max_prd_de, "."); //max데이터 월 또는 현재 월
								var title    = data.stat_nm + " (" + this_Mon + ")";
								$("#ssaDataBoard #ssaStatPath").html(data.stat_path);
								$("#ssaDataBoard #ssaTitle").html(title);					// 제목
								$("#ssaDataBoard #ssaOrigin").html(data.colct_source);		// 출처
...
//								20190318 손원웅 추가
								switch(this.DetailData[i].c1_nm){
									case "서울":
										this.DetailData[i].c1_nm = "서울특별시"
										break;
									case "부산":
										this.DetailData[i].c1_nm = "부산광역시"
										break;
									case "대구":
										this.DetailData[i].c1_nm = "대구광역시"
										break;
									case "인천":
										this.DetailData[i].c1_nm = "인천광역시"
										break;
									case "광주":
										this.DetailData[i].c1_nm = "광주광역시"
										break;
									case "대전":
										this.DetailData[i].c1_nm = "대전광역시"
										break;
									case "울산":
										this.DetailData[i].c1_nm = "울산광역시"
										break;
									case "세종":
										this.DetailData[i].c1_nm = "세종특별자치시"
										break;
									case "경기":
										this.DetailData[i].c1_nm = "경기도"
										break;
									case "강원":
										this.DetailData[i].c1_nm = "강원도"
										break;
									case "충북":
										this.DetailData[i].c1_nm = "충청북도"
										break;
									case "충남":
										this.DetailData[i].c1_nm = "충청남도"
										break;
									case "전북":
										this.DetailData[i].c1_nm = "전라북도"
										break;
									case "전남":
										this.DetailData[i].c1_nm = "전라남도"
										break;
									case "경북":
										this.DetailData[i].c1_nm = "경상북도"
										break;
									case "경남":
										this.DetailData[i].c1_nm = "경상남도"
										break;
									case "제주":
										this.DetailData[i].c1_nm = "제주특별자치도"
										break;
								}
