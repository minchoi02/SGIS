			...
			$.ajax({
				...
				success: function(res) {
					if(res.errCd == 0){
						...
						//데이터에 따른 카테고리 설정
						if(this.DetailData[0].link_id == "I3401" || this.DetailData[0].link_id == "I3402"){
...
//												} else if(dataParams.Link_id == "I3404"){
												} else if(dataParams.Link_id == "I3403" || dataParams.Link_id == "I3404"){
						                    		return;
						                    	}
...
//						if(this.DetailData[0].link_id == "I3404"){
						if(this.DetailData[0].link_id == "I3403" || this.DetailData[0].link_id == "I3404"){
