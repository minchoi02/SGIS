...
(function(W, D) {
	...
	$policyStaticMapDataManagement.ui = {
		...
		dataManagement : function(from, to, nm, pageNum, srvType){
			...
			srvLogWrite( "E0", "05", "02", "01", "", "" ); // jrj 로그 > LBDMS 활용하기 목록 조회
	...
	$policyStaticMapDataManagement.event = {
		setUIEvent : function() {
			$("#data_search").click(function(){
				...
				srvLogWrite( "E0", "05", "02", "02", "", "일자:"+$("#data_from").val()+"~"+$("#data_to").val()+",서비스명:"+$("#data_nm").val() ); // jrj 로그 > LBDMS 활용하기 목록 조회
			});
