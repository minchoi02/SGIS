...
//					gis_se : parseInt($("#history-menu-depth-kosis>input[name=gis_se]").val()),
	...
	function createSelectYear(){
		...
		var years = "<option value='2019'>2019년도</option><option value='2018'>2018년도</option><option value='2017'>2017년도</option><option value='2016'>2016년도</option>";
		$("#mainIndex_year").append( years );
		$("#population_year").append( years );
		$("#household_year").append( years );
		$("#house_year").append( years );
		$("#population_year_combine").append( years );
