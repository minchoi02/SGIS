...
(function(W,D){
	...
	$useCaseModify = {
			...
			makeFirstData : function(){
				...
				$useCaseModify.survey_surv_end_dt = ( $useCaseModify.mainData.survey_surv_end_dt ? $useCaseModify.mainData.survey_surv_end_dt.substr(0,10) : '' );
...
//				}
				...
				if($useCaseModify.galleryData.imgFileName !="" || $useCaseModify.galleryData.imgFileName !="."){
					...
					if( $useCaseModify.galleryData.preViewImg ){
						...
						//$('#target').attr('src',"/img/common/testimg01.png");
						obj.saveFileName = '';
						obj.imgFileName = '';

						$useCaseModify.galleryData.preViewImg = obj;
					}
		    			 ...
		    			 btns = [
							{
							    ...
							    func : function(opt) {
									...
									$("#fileForm").ajaxForm({
										async : false,
										type : "POST",
										url : "/view/edu_gallery/useCaseUpdate", //usecaseSave가 되면 되지용 용 ^^
