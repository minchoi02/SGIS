...
function supportImgText( code ){
	var returnStr = "";
	switch( code ){
		case 'A0' : 	returnStr = '대화형 통계지도';
			break;
		case 'B0' : 	returnStr = '생활업종';
			break;
		case 'C0' : 	returnStr = '통계주제도';
			break;
		case 'E0' :     returnStr = '활용사례';
			break;
		case 'J0' : 	returnStr = '살고싶은 우리동네';
			break;
		case 'T0' :     returnStr = '기술업종';
			break;
		default : 		returnStr = code; 
	}
	return returnStr;
}
