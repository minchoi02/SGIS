...
//	var btnClick = 1;
	...
	$("#tutorialText").append(
			...
			+ "</p></div>");
	$("#tt_introduce_btn_1").hide();
	$("#tt_introduce_btn_00").addClass("tutobtnOn").show();
	...
	$("#tt_introduce_btn_00").click(function(){
		$("#addPoint_1").clearQueue().stop();
		$("#addPoint_1").hide();
		$("#tt_introduce_1").show();
		$("#tt_introduce_btn_00").hide();
...
//		posiInfo(4);
	...
	$("#tt_density_btn_3").click(function( evt ){
		...
		var content = "<p>ICT업종 사업체의 증가 폭이 상당히 큰 것을 알 수 있습니다.<br>"
			...
			+ "<strong style=\"color:#ee7c1a;  font-weight:bold;\">반지름을 30까지 올려보세요.</strong>";
		clickEvent( evt, content );
		posiInfo(22);
	});	
