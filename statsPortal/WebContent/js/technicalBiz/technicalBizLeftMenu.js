...
(function(W, D) {
	...
	$technicalBizLeftMenu.ui = {
			...
			icon : null,//icon class on을 유지하기 위해 
			srvLogSigunguValue : null, // mng_s 20190402 김건민 (기술업종 시군구별 현황 변수)
			srvLogDensityValue : null, // mng_s 20190402 김건민 (기술업종 업종 밀지도 변화 변수)
			srvLogLeftMenuNm : null, // mng_s 20190403 김건민 
			srvLogLeftMenuValue : null, // mng_s 20190404 김건민
			...
			setDetailStatsPanel : function(type) {
				...
				// mng_s 20190404 김건민
				$technicalBizLeftMenu.ui.srvLogLeftMenuValue = type;
				// mng_e 20190404 김건민 
				...
				$(".step04 .bottom > a.stepClose").removeClass("on");
				// mng_e 20200722 김건민
				...
				$("#hideClose").show();
				$(".mid-nav-list").hide();
				$(".sideQuick.sq02").addClass("on");//박길섭 추가
				...
				$(".sensus10 a").each(function(i , elem){
					// mng_s 20210517 김건민  (2018년에서 2019년으로 변경)
					if($(this).html()== '2019'){
						$(this).addClass("on");
					}
					// mng_e 20210517 김건민
				...
				//$(".quickBox.step00").stop().animate({"left":"-300px"},200);
				//데이터보드 초기화
				...
				if(menuType[type] != 0 && menuType[type] != 5 && menuType[type] != 6  && menuType[type] != 4) {
					...
					$(".quickBox.step04").stop().animate({"left":"-1000px"},200);
				}else if(menuType[type] == 4){
					$(".step04 .stepClose").addClass("on");
					$(".step02 .stepClose").removeClass("on");
					//기존 창 닫고 새로운 창 열기
					...
					$(".quickBox.step00").stop().animate({left : "-240px"} , 200);
					//$(".expand").stop().animate({"left":"80px"},200);
					$(".quickBox.step02").stop().animate({"left":"-300px"},200);
					$(".quickBox.step03").stop().animate({"left":"-300px"},200);
					$(".quickBox.dubble.step04").stop().animate({"left":"80px"},200);
				} else {
					$(".quickBox.step00").stop().animate({left : "-240px"} , 200);
					if($(".menuAutoClose label").hasClass("on")){
						$(".nav-sidebar").stop().animate({"left":"-100px"},200);
					}
					$(".sideQuick.sq02").stop().animate({"left":"0"},200);
					$(".quickBox.step03").stop().animate({"left":"-300px"},200);
					$(".quickBox.step04").stop().animate({"left":"-1000px"},200);
				...
				switch(menuType[type]) {
					...
					case 0:
						...
						/*$(".menu5").find("ul>li").removeClass("on");*/
						$technicalBizLeftMenu.ui.icon=".icon10";
						$(".icon10").addClass("on");
						this.doSidoIntro();
						$technicalBizLeftMenu.event.stepCloseAnimate(1, "check");
					...
					case 1:
						...
						/*$(".menu5").find("ul>li").removeClass("on");*/
						$(".icon11").addClass("on");
						$technicalBizLeftMenu.ui.icon=".icon11";
						this.doSigunguIntro();
					...
					case 2:
						...
						$technicalBizLeftMenu.ui.icon=".icon12";
						$(".icon12").addClass("on");
					...
					case 3 :
						...
						$technicalBizLeftMenu.ui.icon=".icon15";
						$(".icon15").addClass("on");
						this.doNormalMapInit();
						$(".quickBox.step02 .radioType label").removeClass("on");
						$(".quickBox.step02 .radioType label").removeAttr("checked");
					...
					case 4 :
						...
						$technicalBizLeftMenu.ui.icon=".icon16";
						$(".icon16").addClass("on");
						this.doSigunguIntro();
						var dataBoard = $technicalBizDataBoard.ui;
						var viewId = parseInt($technicalBizMap.ui.curMapId)+1;
					...
					case 5:
						$("#attributeMenu3").show();
						$(".nav-list li").eq(5).find("a").addClass("on");
						$(".menu_left").hide();
						//$(".menu3").show();
						//$(".menu2").find("ul>li").removeClass("on");
						//$(".menu1").find("ul>li").removeClass("on");
						...
						$(".mid-nav-list li:nth-child(1) a").css("height","265px");
						$technicalBizLeftMenu.ui.icon=".icon13";
						$(".icon13").addClass("on");
						this.doNormalMapInit();
					...
					case 6:
						$("#attributeMenu3").show();
						$(".nav-list li").eq(6).find("a").addClass("on");
						$(".menu_left").hide();
						$(".menu5").show();
						//$(".menu2").find("ul>li").removeClass("on");
						//$(".menu3").find("ul>li").removeClass("on");
						$(".menu5").find("ul>li").removeClass("on");
						$technicalBizLeftMenu.ui.icon=".icon14";
						$(".mid-nav-list li:nth-child(1) a").css("height","265px");
			...
			lqStandardSearch : function(){
				...
				$("#mapDataStandard").hide();//2019-03-13 박길섭
				if($(".menuAutoClose label").hasClass("on")){
					$(".nav-sidebar").stop().animate({"left":"-240px"},200);//박길섭 추가
					//$(".expand").stop().animate({"left":"-240px"},200);//박길섭 추가
				}
				//선택된 업종
				//입지계수냐 증감률이냐
				//사업체 기준 || 종사자 기준
			...
			doReqDensityInfo : function(themeCd, themeNm, viewId) {
				...
				// mng_s 20190503 김건민
				if(dataBoard.mapData[dataBoard.map_id].options.etc == undefined){
					//최초조회 시 전국정보 팝업
					var options = {
							params : {
								adm_cd : adm_cd,
								...
								//year : dataBoard.mapData[dataBoard.map_id].options.etc.year
							},
							dataBoard : {
					...
					options.params.base_year = dataBoard.mapData[dataBoard.map_id].options.etc.year;
	...
	$technicalBizLeftMenu.event = {
			...
			setUIEvent : function() {
		    	...
		    	// mng_s 20190419 김건민(지원시설 조회 벤처창업입지114 이동)
		    	body.on("click", "#tmpDataUrl" , function(){
		    		srvLogWrite('G2', '13', '06', '00', '', '벤처창업입지114 이동');
		    	});
		    	// mng_e 20190419 김건민
		    	
		    	
		    	// mng_s 20190404 김건민 (마커 클릭 부분)
		    	body.on("click", ".sop-marker-pane", function(){
		    		
		    		switch($technicalBizLeftMenu.ui.srvLogLeftMenuValue){
		    			case "sido" :
		    				srvLogWrite('G2', '08', '03', '00', '', '시도 선택 팝업창 보기');
		    				break;
		    			case "supply" :
		    				apiLogWrite2("T0", "T04", "지원시설 조회", "지원시설 선택 팝업창 보기", "00", "전국");
		    				srvLogWrite('G2', '13', '05', '00', '', '지원시설 선택 팝업창 보기');
		    				break;
		    			case "industry" :
		    				apiLogWrite2("T0", "T05", "산업단지 조회", "산업단지 선택 팝업창 보기", "00", "전국");
		    				srvLogWrite('G2', '14', '05', '00', '', '산업단지 선택 팝업창 보기');
		    				break;
		    			default:
		    				break;
		    		}
		    	...
		    	body.on("click", ".heatRadiusSlider", function(){
		    		srvLogWrite('G2', '10', '08', '00', '', '열지도 설정');
		    	});
		    	
		    	body.on("click", "#company", function(){
		    		if($technicalBizLeftMenu.ui.srvLogLeftMenuValue == 'supply'){
		    			srvLogWrite('G2', '13', '02', '00', '', '지원시설 사업체');
		    		}else{
		    			srvLogWrite('G2', '14', '02', '00', '', '산업단지 사업체');
		    		}
		    	});
		    	
		    	body.on("click", "#worker", function(){
		    		if($technicalBizLeftMenu.ui.srvLogLeftMenuValue == 'supply'){
		    			srvLogWrite('G2', '13', '02', '00', '', '지원시설 종사자');
		    		}else{
		    			srvLogWrite('G2', '14', '02', '00', '', '산업단지 종사자');
		    		}
		    	});
				...
				body.on("click", ".sideQuick.sq02", function(){
					//$($technicalBizLeftMenu.ui.icon).addClass("on");//class on을 유지하기 위해
					//$(".nav-list li>a").removeClass("on");
					$(".technicalul.ul-area li").removeClass("on");
					if($(this).hasClass("on")){
						$technicalBizLeftMenu.event.stepCloseAnimate2(parseInt($(this).index(".stepClose")+1), "pass");
						//$(".expand").animate({"left":"-60px"},200);
						$(".nav-sidebar").animate({"left":"-80px"},200);
					}
					else{
						$(".sideQuick.sq02").addClass("on");
						if($(".icon13>a").hasClass("on")){
							$(".menu_left").hide();
							$(".nav-list li>a").removeClass("on");
							$(".nav-list li").eq(5).find("a").addClass("on");
						...
						else if($(".icon16>a").hasClass("on")){
							$(".nav-list li>a").removeClass("on");
							$(".nav-list li").eq(4).find("a").addClass("on");
							$(".nav-sidebar").stop().animate({left : "0px"} , 200);
							//$(".expand").stop().animate({left : "80px"} , 200);
							$(".step04").stop().animate({left : "80px"} , 200);
						}
						else{
				...
				body.on("click",".stepClose",function(){ 
					...
					if(!on){
						...
						}else if($(".step04 .stepClose").hasClass("on")){
							$(".sideQuick.sq02").addClass("on");
							$(".step04 .bottom > a.stepClose").addClass("on");
							$(".step04 .bottom > a.stepClose").css("right","-25px");
							$(".nav-sidebar").stop().animate({"left":"0px"},200);
							$(".quickBox.step04").stop().animate({"left":"80px"},200);
						}else{
						...
						if($(".step00 .stepClose").hasClass("on")){
					    	...
					    	if($(".step02 .stepClose").hasClass("on")){
					    		...
					    		$(".sideQuick.sq02").removeClass("on");
								$(".step02 .bottom > a.stepClose").removeClass("on");
								$(".step02 .bottom > a.stepClose").stop().animate({"right":"-47px"}, 200);
								//$(".step03 .bottom > a.stepClose").addClass("on");
								$(".nav-sidebar").stop().animate({"left":"-80px"},200);
								$(".quickBox.step04").stop().animate({"left":"-1000px"},200);
					    	}
				...
				body.on("click","a.roundTextBox",function(){
					...
					$technicalBizLeftMenu.ui.srvLogSigunguValue = $(this).text();
				...
				body.on("click",".quickBox.step02 .radioType label",function(){
					...
					if($technicalBizLeftMenu.ui.curSelectedStatsType == "sigungu") {
						if($(".menuAutoClose label").hasClass("on")){
							$(".nav-sidebar").stop().animate({"left":"-240px"},200);
							//$(".expand").stop().animate({"left":"-240px"},200);
						}
						$technicalBizDataBoard.ui.initDataBoard();
						var dataBoard = $technicalBizDataBoard.ui;
						...
						// mng_s 20190402 김건민
						if($technicalBizLeftMenu.ui.srvLogSigunguValue == '전체현황'){
							srvLogWrite('G2', '09', '03', '00', $technicalBizLeftMenu.ui.srvLogSigunguValue + "/" + themeNm, '');
						}else if($technicalBizLeftMenu.ui.srvLogSigunguValue == '기술혁신정도(4종)'){
							srvLogWrite('G2', '09', '04', '00', $technicalBizLeftMenu.ui.srvLogSigunguValue + "/" + themeNm, '');
						}else{
							srvLogWrite('G2', '09', '05', '00', $technicalBizLeftMenu.ui.srvLogSigunguValue + "/" + themeNm, '');
						}
						// mng_e 20190402 김건민
					...
					// 업종밀집도일 때
						...
						// mng_s 20190402 김건민
						$technicalBizLeftMenu.ui.srvLogDensityValue  = $(this).text();
						// mng_e 20190402 김건민
						...
						if (themeCd == "00") {
							var themeNm = "전체 기술업종";
							// mng_s 20190402 김건민
							srvLogWrite('G2', '10', '02', '00', '', themeNm);
							// mng_e 20190402 김건민
						...
						$(".step04 .stepClose").removeClass("on");
						// mng_e 20200723 김건민
						$(".sideQuick.sq02").stop().animate({"left":"0"},200);
						$(".quickBox.step03").stop().animate({"left":"360px"},200);
						//$("#densityBaseYearList > li > a").removeClass("on");
						// mng_s 20190503 김건민
						/*if($("#densityBaseYearList > li > a").hasClass("on")){
							$(this).addClass("on");
						}*/
						// mng_e 20190503 김건민
					...
					//업종별 입지계수 지도 일때
						...
						// mng_s 20190402 김건민
						if($technicalBizLeftMenu.ui.srvLogSigunguValue == '기술혁신정도(4종)'){
							apiLogWrite2("T0", "T07", "기술혁신정보 업종 현황 조회", themeNm , map.zoom, "전국");
							srvLogWrite('G2', '11', '03', '00', $technicalBizLeftMenu.ui.srvLogSigunguValue + "/" + themeNm, '');
						}else{
							apiLogWrite2("T0", "T07", "지식집약정보 업종 현황 조회", themeNm , map.zoom, "전국");
							srvLogWrite('G2', '11', '04', '00', $technicalBizLeftMenu.ui.srvLogSigunguValue + "/" + themeNm, '');
						}
						// mng_e 20190402 김건민
						...
						// mng_s 20200218 김건민 수정
						$("#lqInfoYearSettingList2 > li > a").removeClass("on");
						$("#lqInfoYearSettingList2 > li > a").last().addClass("on");
						// mng_e 20200218 김건민
						$("#standardButton").removeClass("off");
				...
				body.on("click",".quickBox.step03 .radioType label",function(e){
					...
					// mng_s 20190402 김건민
					if($technicalBizLeftMenu.ui.srvLogDensityValue == '첨단기술업종' || $technicalBizLeftMenu.ui.srvLogDensityValue == '고기술업종' || $technicalBizLeftMenu.ui.srvLogDensityValue == '중기술업종' || $technicalBizLeftMenu.ui.srvLogDensityValue == '저기술업종'){
						srvLogWrite('G2', '10', '03', '00', $technicalBizLeftMenu.ui.srvLogDensityValue + "/" + themeNm, '');
					}else {
						srvLogWrite('G2', '10', '04', '00', $technicalBizLeftMenu.ui.srvLogDensityValue + "/" + themeNm, '');
					}
					// mng_e 20190402 김건민
				...
				body.on("click","#company,#worker",function(){
					...
					case 0:
						var map = $technicalBizMap.ui.mapList[$technicalBizMap.ui.curMapId];
						// mng_s 20190514 김건민(기술업종 시도별 사업체 종사자  map.geojson = null 때문에 주석처리함)
						//$technicalBizMap.ui.clearIntroData(map);
						// mng_g 20190514 김건민
						map.mapMode = "intro";
						map.mapMove([1007770, 1855549], 2);
				...
				body.on("click",".list_btn",function(){
					...
					//$technicalBizLeftMenu.event.stepCloseAnimate2("","");
					$(".quickBox.step00").stop().animate({"left":"0px"},200);
					$(".sideQuick.sq02").addClass("on");
					$(".nav-list li").find("a").removeClass("on");
					$(".technicalul.ul-area>li").removeClass("on");
			...
			stepCloseAnimate : function(inx, type){  
			    ...
			    if($(".menuAutoClose label").hasClass("on")){
			        ...
			        $(fx+'.step03').animate({"left":"-1400px"}, time);
			        $(fx+'.step02').animate({"left":"-1120px"}, time);
			        //$(fx+'.step01').animate({"left":"-300px"}, time);
			        $(fx+'.step00').animate({"left":"-300px"}, time);
			        //$(btn).find("span").show();
			        $(".shadow").hide();
			        $('.nav-sidebar').animate({"left":"-300px"}, time);
			        $('.expand').animate({"left":"-300px"}, time);
			    }
			    else{
			    	if($(".title-list>li").eq(0).find("a").hasClass("on")||$(".title-list>li").eq(5).find("a").hasClass("on")||$(".title-list>li").eq(6).find("a").hasClass("on")){
			   ...
			   /* $(fx).queue("step04", function(){
			    	...
			    	$(fx+'.step04').animate({"left":"-580px"}, time);
			    ...
			    $(fx).queue("step01", function(){
			    	...
			    	$(fx+'.step03, '+fx+'.step02').css({"left":"-300px"});
			    	$(fx+'.step04').css({"left":"-580px"});
