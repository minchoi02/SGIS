...
(function(W, D) {
	...
	var setData1 = [];	//2022 SGIS5 추가
	var setData2 = [];	//2022 SGIS5 추가
	$urbanApi.request = {
			...
			API_220801_URL : "/ServiceAPI/OpenAPI3/urban/urbarsFacility.json",			//2022 SGIS5 추가
			API_220830_URL : "/ServiceAPI/OpenAPI3/urban/urbarsFacilitySearch.json",	//2022 SGIS5 추가
			combineFailCnt : 0,
			...
			getUrbarsFacilitySearch : function(params){
				...
				sopPortalUrbarsFacilitySearchObj.addParam("adm_cd", params.urbarInfo.adm_cd);
			...
			getUrbarsStatistics : function(params){
				...
				if(params.urbarInfo.main_urban_id !== undefined && params.urbarInfo.main_urban_id !== null && params.urbarInfo.main_urban_id !== ""){
					sopPortalUrbarsStatisticsObj.addParam("main_urban_id", params.urbarInfo.main_urban_id);
				}
			...
			getUrbarsIndexes : function(params){
				console.log(params.urbarInfo.main_urban_id);
							...
							case 0:
								if(options.params.comparison_gb == "CT1" ||options.params.comparison_gb == "CT2" ){
									if(options.params.comparison_gb == "CT1"){
											setData1.push(res.result)	// 2022 SGIS5 추가
									}else{
											setData2.push(res.result)	// 2022 SGIS5 추가
									}
									$urbanDataBoard.ui.setUrbarsStatistics2(setData1,setData2, options);
								}else{
									$urbanDataBoard.ui.setUrbarsStatistics(res, options);
									setData1 =[];	// 2022 SGIS5 추가
									setData2 =[];	// 2022 SGIS5 추가
								}
								break;
							case -401:
								accessTokenInfo(function() {
