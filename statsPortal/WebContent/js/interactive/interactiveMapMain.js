...
//						this.mapList[mapId].setZoom(zoom);
					...
					case 14:
						...
						if (data.id != undefined && data.id.length > 0) {
							...
							$(".tb_radio").hide();
							$("#rotationTip , #rotationTip1 , #rotationTip2, #rotationTip3").hide();
							$("#tuto_start_btn").hide();
							$(".helperText").hide();
				...
				if (type == "data") {
					if (data.info.length > 0) {
						...
						if (sop.isInnerMapShow2 || sop.isInnerMapShow3) { //그리드 이면
							...
							if($interactiveMap.ui.mapList[0].dataType == "kosis" && $interactiveMap.ui.mapList[0].dataForCombine[0].UNIT != undefined){
