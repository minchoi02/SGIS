...
(function(W, D) {
	...
	$houseAnalysisMap.report = {
		...
		setData : function() {
			...
			this.setChart();//차트생성
			$("#stand-location").text("비교지역 : "+W.opener.$houseAnalysisMap.search.getRecommendObject().now_name);
			$("#inter-location").text("살고싶은지역 : "+W.opener.$houseAnalysisMap.search.getRecommendObject().inter_name);
