...
function fn_layerLine (id, data) {
	...
	let datatemp = data ;
	let dataYearTemp = [];
	let fontSizeTemp = "12px";
	if(!data) return ;	
	
	
	dataYearTemp = data['yearData']['year'].map(function(dataName) {  return dataName.length; })
	fontSizeTemp = (Math.max(...dataYearTemp) > 4) ? "11px" : "12px";
