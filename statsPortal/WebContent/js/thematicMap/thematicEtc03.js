			...
			if(theme){
				$(".themul > li").each(function(index , elem){
					...
					if(theme == $(elem).find("a").data("id")){
						...
						$thematicMapFrame03.getCategoryList.getMenuList(theme);
						$(elem).find("a").click();
					}
				});
...
function initTopBottomButtons() {
	...
	$thematicMapFrame03.ui.mapList[0].topBottomState = "OFF";
	$thematicMapFrame03.ui.mapList[0].topBottomType = "both";
	$thematicMapFrame03.ui.mapList[0].topBottomCount = "10";
}
//mng_e 2019. 11. 21 j.h.Seok 이용자 중심 서비스 개편 - 상하위 10개 표출
