...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '13', '00', '', '서비스 개요');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1>
					<h2>○ 움직이는 인구피라미드는 과거 인구에 대한 확정인구와 향후 인구변동(출생, 사망, 국제이동)을 고려하여 작성된 장래추계 변화를 그래프로 보실 수 있습니다.</h2>

					<h2>○ 서비스 내용</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;- 1960~2067년 연도별, 전국 각세별 인구피라미드</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;- 1970~2047년 연도별, 전국 및 시도 5세별 인구피라미드</h2>
