...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '07', '00', '', '서비스 이용방법-간편동네 찾기');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>간편동네 찾기 </h1><img src="/img/newhelp/img_house_5_00.png" style="width:90px;margin-top:-51px;margin-left:130px;" alt="간편동네 찾기" />
