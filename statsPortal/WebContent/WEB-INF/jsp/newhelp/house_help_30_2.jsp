...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '07', '00', '', '서비스 이용방법-지표내용');
        });
    </script> 
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 환경과학원 미세먼지월별대기오염도(2018년), 이산화질소월별대기오염도(2018년)<br>
									※ 10등급에 가까울 수록 대기오염도가 낮습니다.
								</td>
								<td>환경과학원에서 제공하는 일부 지역만 이용 가능합니다.</td>
								<td>시도, <br> 시군구</td>
								
								<!-- mng_s 20210412 이진호, 출처년도 문구 현행화 -->
								<!-- <td>환경과학원 대기오염도(2016년)</td> -->
								<td>환경과학원 대기오염도(2018년)</td>
								<!-- mng_e 20210412 이진호 -->
							...
							<tr>
								...
								<td>
									...
									공동주택비율은 전체 주택 중에 공동주택에 해당하는 비율을 확인할 수 있는 지표입니다. 공동주택이란 하나의 건물에서 여러세대가 생활할 수 있는 주택으로 아파트, 연립주택, 다세대주택을 의미합니다. 2019 등록센서스 총 주택 대비 공동주택(아파트, 연립, 다세대)에 해당하는 주택 유형 비율을 행정구역 별로 보실 수 있습니다.
									<br><br>
									<!-- mng_s 20210412 이진호, 출처년도 현행화 -->
									<!-- ※ 출처 : 통계청 등록센서스(2016년) -->
									※ 출처 : 통계청 등록센서스(2019년)
							...
							<tr>
								...
								<td>
									...
									주거면적은 주택수준을 확인하기 위해 1인당 살고있는 주거 면적을 확인할 수 있는 지표입니다. 2019 인구주택총조사 총 인구 대비 주거 연면적을 행정구역 별로 보실 수 있습니다.
									<br><br>
									<!-- mng_s 20210412 이진호, 출처년도 현행화 -->
									<!-- ※ 출처 : 통계청 인구주택총조사(2016년) -->
									※ 출처 : 통계청 인구주택총조사(2019년)
									<!-- mng_e 20210412 이진호 -->
									<br>
									※ 산출식 : 주거 연면적 / 총 인구
								</td>
							...
							<tr>
								...
								<td>
									...
									노후주택비율은 주택의 노후화 수준을 확인할 수 있는 지표입니다. 노후주택은 건축된지 20년 이상 경과된 주택을 의미하며, 노후주택 비율은 전체 주택 중에 노후주택이 차지하는 비율로, 2019 등록센서스 총 주택 대비 20년도 이상 노후 주택 비율을 행정구역 별로 보실 수 있습니다.
									<br><br>
									<!-- mng_s 20210412 이진호, 출처년도 현행화  -->									
									※ 출처 : 통계청 등록센서스(2019년)
									<!-- mng_e 20210412 이진호 -->
							...
							<tr>
								<td>공지시가</td>
								<td>주거용 토지의 단위 면적(1㎡)당 가격</td>
								<td>
									공지시가를 확인할 수 있는 지표로써 면적(1㎡당) 대비 주거용(단독, 연립, 다세대, 아파트) 토지 가격을 행정구역 별로 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 통계청 등록센서스(2019년), 통계청 전국사업체조사(2018년)<br>
									※ 산출식 : (사업체 종사자 수 / 인구) * 100
								</td>
								<td>-</td>
								<td>읍면동</td>
								<td>통계청 등록센서스(2019년)<br>통계청 전국사업체조사(2018년)</td>
							</tr>
							<tr>
								<td>순유입인구 비율</td>
							...
							<tr>
								...
								<td>범죄 안전지수(등급)</td>
								<td>
									범죄 위험지역을 1~5등급으로 구분하여 발표한 행정안전부 범죄안전지수를 바탕으로 범죄안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 범죄안전 수준을 나타내는 범죄안전지수(등급)를 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>안전 사고지수(등급)</td>
								<td>
									안전사고 위험지역을 1~5등급으로 구분하여 발표한 행정안전부 안전사고지수를 바탕으로 안전사고에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 안전사고 수준을 나타내는 안전사고지수(등급)를 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>자살 안전지수(등급)</td>
								<td>
									자살 위험지역을 1~5등급으로 구분하여 발표한 행정안전부 자살안전지수를 바탕으로 자살안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 자살안전 수준을 나타내는 자살안전지수(등급)를 보실 수 있습니다.
									<br><br>

									※ 출처 : 행정안전부 자살 안전지수(2015년 기준)
									<br>
									※ 1등급(좋음) ~ 5등급(나쁨)
								</td>
								<td>-</td>
							...
							<tr>
								...
								<td>감염병 안전지수(등급)</td>
								<td>
									감염병 위험지역을 1~5등급으로 구분하여 발표한 행정안전부 감염병안전지수를 바탕으로 감염병안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 감염병안전 수준을 나타내는 감염병안전지수(등급)를 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>자연재해 안전지수(등급)</td>
								<td>
									자연재해 위험지역을 1~5등급으로 구분하여 발표한 행정안전부 자연재해안전지수를 바탕으로 자연재해 안전에 대한 수준을 확인할 수 있는 지표입니다. 행정구역 별(시군구) 자연재해 안전 수준을 나타내는 자연재해안전지수(등급)를 보실 수 있습니다.
									<br><br>
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 통계청 전국사업체조사(2018년)
									<br>
									※ 편의시설 : 행정기관(시청, 주민센터 등), 우체국, 경찰서, 소방서, 은행, 주차장
								</td>
								<td>-</td>
								<td>읍면동</td>
								<td>통계청 전국사업체조사(2018년)</td>
							</tr>
							<tr>
								<td>쇼핑시설 수</td>
...
<!-- 							</tr> -->
							...
							<tr>
								...
								<td>
									...
									※ 출처 : 통계청 등록센서스(2019년), 통계청 전국사업체조사(2018년)
									<br>
