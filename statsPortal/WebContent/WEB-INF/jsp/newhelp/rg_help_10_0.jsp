...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '11', '00', '', '서비스 개요');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1><br>
					<h2>○ 통계갤러리는 사용자가 SGIS를 이용해서 검색한 다양한 통계정보 또는 사용자가 생성한 통계정보를 공유하며 함께 소통할 수 있는 서비스입니다.</h2>
					<h2>주요 기능</h2>
					<h2>&nbsp;&nbsp;&nbsp;- 갤러리 등록 : 등록정보 설정, 이미지 등록, 기존 즐겨찾기 항목 선택 등을 이용해서 갤러리를 등록합니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;- 기존 서비스를 조회하여 갤러리 등록 : 대화형통계지도, 살고싶은 우리동네 등 주요서비스에 대한 조회결과를 갤러리로 등록합니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;- 활용사례 등록 : 이용자가 직접 통계정보를 수급하고 활용한 사례를 등록하고 공유합니다.</h2>
					<br><br>
				  <h1>통계갤러리 등록방법</h1><br>
					<h2>○ 로그인을 하고 SGIS 서비스에서 기존에 저장해둔 즐겨찾기한 지도 이미지를 활용하거나 직접 이미지를 업로드하여 등록합니다.</h2>
				  	<br><br>
				  <h1>통계갤러리 목록 화면</h1>
