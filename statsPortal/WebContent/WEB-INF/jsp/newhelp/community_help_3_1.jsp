...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '09', '00', '', '서비스 이용방법-소통지도 만들기');
        });
    </script>   
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<ol>
						...
						<li>8) 태그 : 해당 소통지도 검색 시 알 수 있는 키워드를 입력합니다.</li>
					</ol>
					...
					<ol>
						...
						<li>2) 통계리스트(색지도) : 대화형통계지도에서 저장된 즐겨찾기 통계정보 중에 개설하려는 소통지도와 관련된 통계를 선택합니다. 최대 5개까지 등록 가능합니다.</li>
