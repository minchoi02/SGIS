...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '13', '00', '', '서비스 이용방법');
        });
    </script> 
					...
					<h2 style="margin-left:35px">
						<table border='1' width="600" bordercolor="#A09D9D" summary="피라미드 그래프">
						  ...
						  <tr>
							   ...
							   <td>1960~2067년도까지의 전국 인구 추계를 나타낸 그래프 입니다.</td>
						  </tr>
<!-- 						  <tr> -->
...
<!-- 							   <td>클릭 시 1년 단위로 그래프 추이를 볼 수 있는 버튼입니다.</td> -->
<!-- 						  </tr> -->
					   </table>
					</h2>
					<br><br>
...
<!-- 						  </tr> -->
						  <tr>
							   ...
							   <td>클릭 시 전국 인구추계 피라미드 그래프가 1년씩 증감하면서 자동으로 변화합니다.</td>
						  </tr>
<!-- 						  <tr> -->
...
<!-- 							   <td>클릭 시 위 전국 인구추계 피라미드 그래프가 2배 속도로 1년씩 증감하면서 자동으로 변화합니다.</td> -->
<!-- 						  </tr> -->
<!-- 						  <tr> -->
