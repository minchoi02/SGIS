...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '08', '00', '', '서비스 이용방법-(기술)시군구별 기술업종 현황');
        });
    </script> 
		...
		<div class="container">
					...
					<ul>
						...
						190308 방민정수정 -->
							...
							<!--  190308 방민정수정 시작 -->
								...
								<li><a href="/view/newhelp/tc_help_30_1" class="on">ㆍ(기술)시군구별 기술업종 현황</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<img src="/img/newhelp/Tc_help_30_1_001.png" width=600 height=auto border=0 alt="시군구별 기술업종 현황"/>
					<!-- mng_e 20200401 이진호 -->
						
					<h2 style="text-align:center;">[시군구별 기술업종 현황]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
