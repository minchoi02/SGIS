...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '사례별 이용법2');
        });ww
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<img src="/img/newhelp/So_040_03_new.png" style="margin-left: 0px; border:0px; width:100%; " alt="지역선택"/>
					...
					<!-- <img src="/img/newhelp/So_040_04_1.png" style="margin-left: 0px; width:100%; border:0px;"  alt="숙박업통계 조회"/> --><!-- 190315 방민정 수정 -->
					<img src="/img/newhelp/So_040_04_1_001.png" style="margin-left: 0px; width:100%; border:0px;"  alt="숙박업통계 조회"/>
					<!-- mng_e 20200407 이진호 -->
					...
					<img src="/img/newhelp/So_040_05_new_001.png" style="margin-left: 0px; width:100%; border:0px;" alt="숙박업통계 결과"/>
					<!-- mng_e 20200407 이진호 -->


					<br><br>
					<h2>3. 숙박업 중 펜션 유사업종 사업체 통계를 검색합니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;①"사업체"버튼 선택 → ② 산업세세분류(숙박 및 음식점업> 숙박업> 숙박시설운영업> 관광숙박시설운영업> 기타관광숙박시설운영업)선택 → ③ 산업분류 도움말(i) 확인 → ④ "검색조건 담기"버튼 선택 → </h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;⑤ 제주도 경계 위로 통계버튼 끌어다 놓기 → ⑥ 펜션유사업종 통계지도 확인 →</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;⑦ 제주도의 펜션유사업종 사업체수 확인</h2>
					
					<!-- mng_s 20200407 이진호 / 도움말 현행화 -->
					<!-- <img src="/img/newhelp/So_040_06_1.png" style="margin-left: 0px; width:100%; border:0px;" alt="숙박업통계 조회"/> --><!-- 190315 방민정 수정 -->
					<img src="/img/newhelp/So_040_06_1_001.png" style="margin-left: 0px; width:100%; border:0px;" alt="숙박업통계 조회"/>
					<!-- mng_e 20200407 이진호 -->
					...
					<br><br>
					<h2>[결과]</h2>
					<img src="/img/newhelp/So_040_07_new.png" style="margin-left: 0px; width:100%; border:0px;" alt="숙박업통계 결과"/>

					<br><br>
					<h2>4. 사용자 데이터(제주도 유명해변 주소)를 통계지도에 올릴 수 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;○ 제주도 유명 해변주변에 펜션 창업을 위해 관광공사 웹페이지에서 해변 이름과 주소 정보를 찾아 펜션관련 사업체 통계지도 위에 올려 사용자 통계지도를 만들 수 있습니다.</h2>
					...
					<div style="height:35px;"></div>
					   ...
					   <!-- mng_e 20170810 이경현 -->
<!-- 190315 방민정  --><img src="/img/newhelp/So_040_08_1.png" style="margin-left: 0px; width:420px;" border=0 alt="위치정보 조회"/>
					<img src="/img/newhelp/So_040_12_new.png" style="margin-left: 0px; width:500px; height:auto;" border=0 alt="위치정보 조회"/>
					<img src="/img/newhelp/So_040_13_new.png" style="margin-left: 0px; width:500px; height:auto;" border=0 alt="위치정보 조회"/>
					<h2>[Tip]위치정보 조회 : 통계청이 가진 주소자료를 가지고 위치를 찾아주며, 위치를 찾지 못해 ‘변환 실패’ 된 경우는 사용자가 직접 위치를 지정해 줄 수 있습니다.</h2><br><br>
					<h2>[결과] 집계구 단위로 유명해수욕장 근처의 펜션유사업종 통계 확인합니다.</h2>
					<img src="/img/newhelp/So_040_09_new.png" style="margin-left: 0px; width : 100%" border=0 alt="결과"/>

					<br><br>
					<h2>5. 펜션(기타 관광숙박시설 운영업) 유사 업종의 사업체 위치를 조회할 수 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;①"사업체"버튼 선택 → ② 위치표시 설정 → ③산업세세분류(숙박 및 음식점업> 숙박업> 숙박시설운영업>관광숙박시설운영업>기타관광숙박시설운영업)선택 →</h2>
					
					<!-- mng_s 20210412 이진호, 오타수정 -->
					<!-- <h2>&nbsp;&nbsp;&nbsp;&nbsp;④ "검색조건 담기"버튼 선택 → ⑤ wleh 경계 위로 통계버튼 끌어다 놓기(읍면동 이하 축척으로 자동조절) →</h2> -->
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;④ "검색조건 담기"버튼 선택 → ⑤ 지도 경계 위로 통계버튼 끌어다 놓기(읍면동 이하 축척으로 자동조절) →</h2>
					<!-- mng_e 20210412 이진호 -->
					
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;⑥ 지도위에 통계지도 및 사업체 개별위치 확인 → ⑦ "시계열"버튼 선택 → </h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;⑧ 년도 설정 → 사업체의 위치 및 변화 추이 확인</h2>
					<img src="/img/newhelp/So_040_10_new.png" style="margin-left: 0px; width : 100%" border=0 alt="결과 확인"/>
					<h2>[결과] 집계구 단위로 유명해수욕장 근처의 펜션유사업종 통계 확인합니다.</h2>
					<img src="/img/newhelp/So_040_11_new.png" style="margin-left: 0px; width : 100%" border=0 alt="결과"/>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
