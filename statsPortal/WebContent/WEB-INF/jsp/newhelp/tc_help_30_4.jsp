...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '08', '00', '', '서비스 이용방법-(기술)산업단지 조회');
        });
    </script> 
...
<li><a href="/view/newhelp/so_help_30_5">ㆍ(생활)업종별 뜨는 지역</a></li>
								...
								<li><a href="/view/newhelp/tc_help_30_4" class="on">ㆍ(기술)산업단지 조회</a></li>
							<!-- 
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;- 지도상에서 축척을 변경(마우스 휠 조작) 및 카운트 POI차트를 클릭하시면 더 자세한 산업단지 현황을 확인할 수 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;- POI차트의 '해당지역 상세정보보기' 버튼을 클릭하시면, 데이터보드에서 해당 산업단지의 상세정보를 조회할 수 있습니다.</h2>
					...
					<h2 style="/* margin-left: 250px; */text-align:center;">[산업단지조회 - 상세]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
