	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>고령화 추세 분석</h1><br>
 					<h2>○ 인구센서스 데이터를 이용한 2000년~2019년간의 과거 추세 분석 및 인구추계 데이터를 이용한 미래의 추세분석, 도표 및 그래프를 이용하여 과거에서 현재, 미래의 고령화 추세를 시각적으로 보여주는 서비스입니다.</h2>
					<br><br>
				  <h1>시나리오</h1><br>
					<h2>○ L씨는 ‘고령화 추세분석’서비스를 통해 S시의 현 고령화 정도의 추세가 더욱 악화될 것이라는 사실을 인지하여 장기적인 관점에서의 S시 복지체계를 전반적으로 검토해야 할 필요성을 제기하였다.</h2>
					<h2>○ L씨는 ‘고령화 추세분석’ 서비스를 이용, S시의 고령화 추세와 S시 주변에 있는 M, N, K시의 고령화 추세를 비교한 리포트를 상부에 보고하여 S시의 노인복지의 중요성을 상부에 보고하였다.</h2>
				  ...
				  <h1>결과화면</h1><br>	
					<h2>○과거 인구구조 변화</h2>
					<h2>&nbsp;&nbsp;&nbsp; - 과거 인구구조변화 : 선택한 구군과 구군의 상위 행정구역(시도)의 인구 구조에 대한 인구수, 비율 등을 파악 할 수 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp; - 인구구성비란? 0-14세, 15-64세, 65세 이상의 인구가 전체 인구중에 차지하는 비율을 말합니다.</h2>
					<!--<img src="/img/newhelp/Ol_010_13.png" style="width:600px;" alt="과거 인구구조 변화"/> -->
					<img src="/img/newhelp/Ol_010_13_001.png"  alt="과거 인구구조 변화"/>
					<h2 align="center">&lt; 과거 인구구조 변화 검색 결과&gt; </h2>
					<br/><br/><br/>
					...
					<!-- <img src="/img/newhelp/Ol_010_14.png" style="width:610px;" alt="고령화 현황 화면구성"/> -->
					
					<!-- <h2>2000년부터 2015년 까지의 노인 인구 구조와 노년부양비, 노령화 지수를 그래프로 나타내고, 노인인구구성비를 대전광역시와 서구를 비교하여 그래프를 보실 수 있습니다.</h2> -->
					<!-- <br> -->
					<!-- <h2>○ 용어설명</h2> -->
					<!-- <h2 style="font-weight:bold">- 노년부양비(①)</h2> -->
					<!-- <h2>&nbsp;&nbsp;&nbsp;노년부양비=(65세이상인구)/(15~64세인구)*100, 생산능력(경제활동능력)이 없는 노년인구를 생산가능인구가 부양해야 하는 경제적 부담을 나타내는 지표</h2> -->
					...
					<!--<img src="/img/newhelp/Ol_010_15.png" style="width:700px;" alt="고령화 추세 분석"/> -->
					<h2>○고령화 추세진단</h2>
					<h2>&nbsp;&nbsp;&nbsp; - 고령화 추세진단 : 선택한 구군과 구군의 상위 행정구역(시도)의 인구 구조에 대한 인구수, 비율 등을 파악 할 수 있습니다.</h2>
					<h2>&nbsp;&nbsp;&nbsp; - 서구의 5년간 인구 증가율을  그래프로 보여주며, 그래프는 노령인구 인구 증가와 유년인구의 증가를 차트로 보여줍니다.</h2>
					<img src="/img/newhelp/Ol_010_15_001.png"  alt="고령화 추세 분석"/>
					<h2 align="center">&lt; 고령화 추세 분석 검색 결과&gt; </h2>
					<br/><br/><br/>
					<!-- mng_e 20170811 -->

					<!-- <h2>○ 서구의 5년간 인구 증가율을 왼쪽 그래프로 보여주며, 오른쪽 그래프는 노령인구 인구 증가와 유년인구의 증가를 차트로 보여줍니다.</h2> -->
					<!-- <br> -->
					<!-- <h2>○ 용어설명</h2> -->
					...
					<h2>○ 미래인구구조변화</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp;- 2005년부터 2045년까지 미래의 고령화진행을 볼 수 있으며, 선택한 행정구역(시도)이 전국에서 노인인구 구성비가 어느 정도인지 또는 전국의 노인인구 구성비를 그래프로 파악할 수 있습니다.</h2>
					<img src="/img/newhelp/Ol_010_16_001.png"  alt="고령화 현황 화면구성"/>
					<h2 align="center">&lt; 미래 인구구조 변화 검색 결과&gt; </h2>
					<br/><br/><br/>
					
					<!-- <h2>○ 용어설명</h2> -->
					<!-- <h2>&nbsp;&nbsp;&nbsp;&nbsp;- 인구구성비란? 0-14세, 15-64세, 65세 이상의 인구가 전체 인구중에 차지하는 비율을 말합니다.</h2> -->
					<!-- <img src="/img/newhelp/Ol_010_17.png" style="width:700px;" alt="고령화 현황 화면구성"/> -->
