	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1><br>
					<h2>○ 인구, 주택, 가구, 농림어업, 사업체 센서스 및 행정구역통계 등 다양한 통계정보를 지역단위로 자유롭게 조회할 수 있는 통계지리정보 서비스입니다.</h2>
					<h2>○ 다양한 통계항목을 조건별로 세분화하여 사용자 관심항목에 따라 조회할 수 있습니다.</h2>
					<h2>○ 원하는 통계 항목을 미리 설정하고 이를 지도상의 지역에 끌어서 놓기(drag&drop)하거나, 선택항목을 두번 연속 클릭(더블 클릭)하는 방식으로 통계 조회가 가능합니다.</h2>
				    ...
				    <h2>&nbsp;&nbsp;&nbsp;- 다중뷰 : 통계지도를 여러개 표출하여 동일 조건에 대한 지역별 차이를 비교하거나 동일 지역에 대한 서로 다른 통계조건 비교를 할 수 있음</h2>
					<br><br>
				  <h1>화면 구성</h1>
					<img src="/img/newhelp/In_010_new.png"  alt="설명"/>				
					...
					<h2 style="font-weight:bold">5) 데이터 보드 : 조회된 데이터에 대한 막대그래프, 원형그래프, 시계열조회 등 다양하게 데이터를 확인할 수 있습니다.</h2>
					<h2 style="font-weight:bold">6) 통계버튼 : 조회하고자 하는 통계항목들이 버튼형태로 추가됩니다. </h2>
