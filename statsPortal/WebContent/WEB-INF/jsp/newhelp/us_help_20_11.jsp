...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '02', '00', '', '서비스 소개-살고싶은 우리동네');
        });
    </script>   
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<h2>● 생활편의 시설 현황, 교육환경, 자연환경 등 33종의 주거지 조건에 해당하는 추천지역리스트 및 통계정보를 확인할수 있습니다.</h2>
					<h2>● 주요기능</h2>
					...
					<img src="/img/newhelp/img_house_0_01.png" alt="살고싶은 우리동네" /><!-- 190313 방민정 수정 -->
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
