...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '16', '00', '', '서비스 개요');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1>
					...
					<h2>○ 1995년부터 최근까지 5년 간격으로 인구, 주택비율 등 시군구별 통계를 지도로 제공하고, 동시에 3개의 지도를 표출하여 한눈에 통계변화를 확인해볼 수 있습니다.</h2>
...
<!-- 					<img src="/img/newhelp/Lo_010_01.png" style="width:700px;" alt="지방의 변화보기 화면구성"/> -->
					<img src="/img/newhelp/Lo_010_01_001.png" style="width:700px;" alt="지방의 변화보기 화면구성"/>
