...
<head>
	...
	<script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '10', '00', '', '서비스 개요');
        });
    </script>   
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1><br>
				    ...
				    <br><br>
				  <h1>화면 구성</h1>
					<img src="/img/newhelp/Ex_010_01.png"  border=0 alt="화면구성"/>
					<!-- mng_s 20210412 이진호 -->
					<h2>1) 지역단위 선택 : 시도, 시군구, 읍면동 등 활용하고자 하는 지역 단위를 선택합니다. (초기설정:시도)</h2>
					<h2>2) 입력방식 선택 및 데이터 조회방식 : 값 입력방식 및 입력한 값의 조회방식을 선택 할 수 있습니다. </h2>
					<h2>3) 등록방식선택 : 체험하고자 하는 값 및 데이터의 등록방식을 설정 할 수 있습니다.</h2>
					<h2>4) 보고서 제목 입력 : 보고서를 출력 할 때 보고서의 제목을 입력하여 지정할 수 있습니다.</h2>
					<h2>5) 통계단위 : 체험하고자 하는 값 및 데이터의 통계 단위를 입력하여 지정 할 수 있습니다.</h2>
					<h2>6) 통계값 입력 및 적용 : 체험하고자 하는 지역 단위에 대한 지역별 통계값을 입력하고 입력값을 적용 할 수 있습니다.  </h2>
					<h2>7) 지도창 : 선택하신 지역 단위에 통계값이 표현되는 지도창입니다. </h2>
					<h2>8) 데이터 보기 : 지역별 통계값의 데이터를 볼 수 있습니다.  </h2>
