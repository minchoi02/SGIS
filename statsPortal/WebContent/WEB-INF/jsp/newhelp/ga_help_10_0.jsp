	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1>
					<h2>○ 통계지리정보의 자료제공이나 OpenAPI 등을 통하여 전국의 연구기관, 학교 등 다양한 분야에서 활용이 증가하고 있어. 이용자가 직접 참여하고, 이용자가 우수 활용사례를 공유하고자 하는 서비스 입니다. </h2>
					<h2>○ 공간통계자료를 활용하여 논문이나 분석에 활용한 사례 및 OpenAPI를 연계하여 시스템을 개발한 사례에 대하여 이용자가 직접 등록하고, 승인절차에 따라 공개를 하도록 하고 있습니다.</h2>
					<br><br>
				  <h1>활용사례 등록방법</h1>
