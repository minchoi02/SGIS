...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '07', '00', '', '서비스 이용방법-추천지역 찾기');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
					...
					<img src="/img/newhelp/img_house_3_00.png" alt="추천지역찾기" style="width:90px;margin-top:-52px;margin-left:130px;"> 
					
					<h2 class="Type_3">1) 지역 선택 : 비교지역과 살고싶은지역을 설정합니다.</h2>

					<ul class="Cont_List">
						<li>비교지역과 살고싶은지역을 시도, 시군구까지 설정할 수 있습니다.</li>
						<li>비교지역은 지표의 기준, 비교의 대상이 되는 지역입니다.
							<ul>
								<li>현재 살고있는 지역을 입력하시면, 현 거주지에 대한 지표를 상, 중, 하로 보실 수 있습니다.</li>
								<li>비교지역을 전국으로 설정하시면, 전국 평균으로 지역을 검색하실 수 있습니다.</li>
							</ul>
						</li>
						<li>살고싶은지역은 찾아보고 싶은, 이사 하고자 하는 지역입니다.
							<ul>
								<li>이사 하고 싶은 지역을 살고싶은지역으로 설정 하시면, 설정된 지역 내에서 추천 지역을 찾습니다.</li>
								<li>살고싶은지역을 전국으로 설정하시면, 전국에 대한 모든 읍면동 중에서 추천 지역을 찾습니다.</li>
							</ul>
						</li>
					</ul>
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_3_01_1.png" style="margin-left: 0px;" alt="지역 선택">
					...
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_3_06_1.png" style="margin-left: 0px;" alt="라이프스타일 별 지표 설정">
						<figcaption>[라이프스타일 별 지표 설정]</figcaption>
					</figure>

					<h2 class="Type_3">3) 지표 설정 : 비교지역과 살고싶은지역을 설정합니다.</h2>
					<ul class="Cont_List">
					...
					<figure>
<!-- 190315 방민정 수정 --><img src="/img/newhelp/img_house_3_02_1.png" style="margin-left: 0px;" alt="지표 설정">
						...
						<li>추천된 지역의 정보를 지도와 우측의 데이터보드에서 보실 수 있습니다.
							<ul>
								<li>
									...
									<span style="font-size: 12px;">(※ 방사형 그래프의 각 지표를 클릭하면 하단에 지표별 종합현황이 그래프로 표기 됩니다.)</span>
								</li>
							</ul>
						</li>
					</ul>
