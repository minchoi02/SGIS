...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '03', '00', '', '서비스 개요');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1><br>
				    ...
				    <h2>&nbsp;&nbsp;&nbsp;- 증감타입 주제도 : 시점이 다른 두 데이터의 증감을 이용하여 지역별 증가 또는 감소 여부를 표출하고, 년도별로 데이터의 증감여부를 차트로 표출합니다.</h2>
				    <h2>&nbsp;&nbsp;&nbsp;- 시계열타입 주제도 : 시점에 따른 변화를 표출하기 위한 주제도 타입으로 각 시점별로 색상타입으로 조회할 수 있으며, 해당 지역의 시점별 정보 변화를 차트로 표출합니다.</h2>
				    <h2>&nbsp;&nbsp;&nbsp;- 분할타입 주제도 : 두 데이터를 직접 비교할 수 있는 주제도 타입입니다. 연관성 있거나 연관성이 높은 것으로 추정되는 데이터를 지역별로 비교할 수 있도록 표출합니다.</h2>
					<br><br>
				  <h1>화면 구성</h1>
					...
					<img src="/img/newhelp/Su_010_01_new_001.png"  alt="화면구성"/><br>
					<!-- mng_e 20200402 이진호 -->
					
					<h2>1) 지역설정 : 지도의 중심에 해당하는 지역이 설정됩니다. 따라서 지도 이동시 정보가 업데이트 됩니다.</h2>
					<h2>2) 주제도 목록 : 버튼 클릭 시 주제도 카테고리 및 주제도 목록이 나타납니다.</h2>
					<h2>3) 주제도 제목 : 표출되는 통계의 제목입니다.</h2>
					<h2>4) 주제도 설정 : 통계선택, 지역경계 선택, 지도 유형, 통계표출 등의 통계정보 표현을 설정합니다.</h2>
					<h2>5) 데이터 시각화 : 통계정보의 범례를 조정합니다.</h2>
					<h2>6) 출력 및 주제도 신규 요청, 튜토리얼 : 주제도 인쇄 및 주제도 신규 추가를 신청하는 기능과 통계주제도 사용법에 대한 튜토리얼을 실행하는 기능 입니다.</h2>
