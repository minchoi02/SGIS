...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '15', '00', '', '서비스 이용방법');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 이용방법</h1>
					<h2>○ 성씨분포 서비스는 각지역의 인구분포를 확인할 수 있으며 조회 후, 지역을 마우스로 선택하면 인구수와 비율을 볼 수 있습니다.</h2>
					<img src="/img/newhelp/Nm_010_02.png"  alt="성씨분포 화면구성"/>
					<br><br>
					<h2>○ 성씨 선택과 성씨순, 인구순 조회</h2>
					<h2>&nbsp;&nbsp;&nbsp;&nbsp; 가나다순/인구수 순 을 선택하고 성씨별로 조회할 수 있습니다.</h2>
					<img src="/img/newhelp/Nm_010_03.png"  alt="성씨 선택과 성씨순, 인구순 조회"/>
					<br><br>
					<h2>○ 데이터 조회</h2>
					<img src="/img/newhelp/Nm_010_04.png"  alt="데이터 조회"/>
