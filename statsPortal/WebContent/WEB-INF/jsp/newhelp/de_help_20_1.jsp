...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '18', '00', '', 'OpenAPI 이용방법-Data API');
        });
    </script> 
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>Data API</h1>
				  	<!-- mng_s 20180205_김건민-->
					<h2>○ 개발지원센터에서 Rest 형식의 서비스를 위한 웹 사이트를 구현하는데 사용할 수 있는 Data API에 대한 상세안내를 제공합니다.</h2>
					<h2>○ 개발지원센터에서 Data API을 선택하면 Date API 정보 페이지를 조회할 수 있습니다.</h2>
					<h2>○ 지도API의 인터페이스 정의서 링크를 제공하고 인증키 발급 신청에 대한 설명 및 사용예제를 제공합니다.</h2>
					
					<!-- mng_s 20220105 이진호,  개발지원센터 개편으로 인한 현행화-->
					<!-- <img src="/img/newhelp/De_020_05_renewal.png" style="width:700px;" alt="Data API"/>-->
					<img src="/img/newhelp/De_020_05_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="Data API"/>
					<!-- mng_e 20220105 이진호 -->
					...
					<img src="/img/newhelp/De_020_06_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="Data 정의서"/>		
					<!-- mng_e 20220105 이진호 -->
										
					<br><br><br>
					<h2>○ API 사용예제와 함께 샘플코드를 직접 실행할 수 있는 링크를 제공하는데, 소스실행 버튼을 누르면 JIT 페이지의 관련 API로 직접 연결되어 샘플소스를 실행해 볼 수 있습니다.</h2>
										
					<!-- mng_s 20220105 이진호,  개발지원센터 개편으로 인한 현행화-->
					<!--<img src="/img/newhelp/De_020_07_renewal.png" style="width:700px;" alt="Data API"/>-->		
					<img src="/img/newhelp/De_020_07_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="Data API"/>		
					<!-- mng_e 20220105 이진호 -->
					<br><br><br>
					<!-- mng_e 20180205_김건민-->
				</div>
