...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '12', '00', '', '서비스 개요');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>서비스 개요</h1>
					<h2>○ 월간통계 서비스는 소비자물가지수, 실업률 등 월간 주요 통계정보를 당월통계, 전월비 및 전년동월비 등 3가지로 구분하여 지도기반의 색상지도로 보여주는 서비스입니다.</h2>
				  ...
				  <h1>화면 구성</h1>
					...
					<img src="/img/newhelp/Mn_010_01_001.png" style="width:700px;" alt="월간통계 화면구성"/>
