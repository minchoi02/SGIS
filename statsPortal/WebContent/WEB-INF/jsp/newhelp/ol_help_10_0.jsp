...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '14', '00', '', '서비스 개요');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>고령화 현황보기 서비스</h1><br>
					<h2>○ 고령화 현황보기 서비스는 고령화가 점점 심화되는 상황에서 고령화와 관련된 다양한 통계를 제공하고, 이를 통해서 고령화 현황, 고령화추세, 복지시설 등을 파악할 수 있도록 하기 위한 서비스입니다.</h2>
					<h2>○ 주요 기능</h2>
				    ...
				    <br><br>
				  <h1>화면 구성</h1>
					<img src="/img/newhelp/Ol_010_01.png"  alt="고령화 현황 화면구성"/>
