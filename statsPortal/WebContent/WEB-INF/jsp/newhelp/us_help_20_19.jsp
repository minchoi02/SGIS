	...
	<div class="wrapper">
		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/us_help_20_0">서비스 소개</a>
							<ul class="sub">
								...
								<li><a href="/view/newhelp/us_help_20_19" class="on">ㆍ생활권역 통계지도</a></li><!-- 2020년 SGIS고도화 3차 추가-->
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>생활권역 통계지도</h1>
					<h2>● 사용자가 선택한 특정시설(지점)의 위치에 대하여 도로 정보를 활용한 생활권역을 시각적으로 볼 수 있습니다.</h2>
					<h2>● 해당 생활권역 내의 통계자료와 그 역역의 격자 분포를 볼 수 있는 서비스 입니다.</h2>
					<h2>● 미리 분류된 시설 유형 선택, 지명검색 또는 지도 검색 서비스를 제공합니다.</h2>
					<br><br>
					
					<h2>● 주요기능</h2>
					<h2>　　 - <span style="font-weight:bold">지점 선택</span>
					<br>　　: 검색 또는 지도에서 지점선택 기능과 시설유형으로 지점을 선택하는 기능 제공</h2>
					<h2>　　 - <span style="font-weight:bold">영역 생성</span>
					<br>　　: 도로 길이, 평균 소요시간 등의정보를 가지고 있는 도로네트워크를 활용하여 주행시간, 주행거리, 반경에 대한 영역을 제공</h2>
					<h2>　　 - <span style="font-weight:bold">통계자료 조회</span>
					<br>　　: 사용사자 지정한 영역에  속한 통계정보 제공
					<br><br>
					
					<h2>● 화면 구성</h2>
					<br>
					<a href="/view/catchmentArea/main" style="cursor:pointer;font-size:12px;height:25px;width:238px;line-height:25px;background:#1778cc;border-radius:3px;color:#fff;padding:5px 10px;">생활권역 통계지도 바로가기 </a><!-- 2020년 SGIS고도화 3차 수정-->

					<img src="/img/nm/nm_picture_renewal_10.png" style="margin-left: 0px;" alt="생활권역 통계지도 화면구성">
					<br/><br/>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
