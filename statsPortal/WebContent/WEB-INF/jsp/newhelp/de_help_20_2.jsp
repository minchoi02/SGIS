...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '18', '00', '', 'OpenAPI 이용방법-모바일 SDK');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  <h1>모바일 SDK</h1>
				  	...
				  	<!-- mng_s 20220105 이진호, 개발지원센터 개편으로 이미지 현행화 -->
					...
					<img src="/img/newhelp/De_020_08_01_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="SDK 주요기능"/>
					...
					<img src="/img/newhelp/De_020_09_01_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="사용예제 및 샘플"/>	
					<!-- <img src="/img/newhelp/De_020_09_01_renewal_1.png" style="width:700px;" alt="사용예제 및 샘플"/>-->	
					<img src="/img/newhelp/De_020_09_01_latest_1.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="사용예제 및 샘플"/>	
					<h2>○ iOS SDK 다운로드 , API 정의서 보기 링크를 제공하고 주요기능에 대한 설명 및 사용예제를 제공합니다.</h2>
					<!-- <h2>○ 개발자사이트의 Open API 메뉴 선택 후 My App 서브메뉴를 선택하면 해당 사용자의 인증키 목록을 조회할 수 있습니다.</h2>
					<h2>○ 인증키 목록에서 인증키 종류, 인증키 상태 설정 후 검색을 할 수 있고, 항목을 삭제하려면 항목 선택 후 삭제 버튼을 누르면 됩니다.</h2> -->
					<!-- <img src="/img/newhelp/De_020_08_02_renewal.png" style="width:700px;" alt="SDK 주요기능"/>-->					
					<img src="/img/newhelp/De_020_08_02_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="SDK 주요기능"/>					
					<h2>○ 사용예제에 대한 샘플코드를 제공하며 샘플코드 실행결과를  이미지를 통해 미리 확인해 볼 수 있습니다.</h2>
					<!-- <img src="/img/newhelp/De_020_09_02_renewal.png" style="width:700px;" alt="사용예제 및 샘플"/>-->
					<img src="/img/newhelp/De_020_09_02_latest.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="사용예제 및 샘플"/>
					<!-- <img src="/img/newhelp/De_020_09_02_renewal_1.png" style="width:700px;" alt="사용예제 및 샘플"/>-->
					<img src="/img/newhelp/De_020_09_02_latest_1.png" style="width:101.5%; height: auto; image-rendering: -webkit-optimize-contrast;" alt="사용예제 및 샘플"/>
					<!-- mng_e20210105 이진호 -->
					...
					<h2>○ 신청 버튼을 누르면 약관동의 절차를 거쳐서 인증키 신청 창이 표출되고, 신청 관련 정보를 입력하고 신청 버튼을 누르면 테스트용 인증키가 즉시 발급됩니다.</h2>
					<img src="/img/newhelp/De_020_10.jpg" style="width:560px; height:840px"alt="Data API/>		
					<br><br><br>
					<h2>○ 등록한 인증키 정보를 수정하려면 목록에서 해당 인증키 항목의 서비스명을 선택하고, 이후 표출되는 인증키정보 수정 창에서 내용을 수정하면 됩니다.</h2>
					<img src="/img/newhelp/De_020_11.jpg" style="width:580px; height:960px"alt="Data API/>		
					<br><br><br>
				  <h1>상용 인증키 발급</h1>
					<h2>○ 상용 인증키를 발급 받으려면 등록한 인증키 선택 후 인증키 정보 수정 창에서 상용전환 신청 버튼을 눌러서 신청하면 됩니다.</h2>
