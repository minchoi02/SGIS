...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '04', '00', '', '서비스 구분별 이용방법-KOSIS(지역통계)');
        });
    </script> 
	...
	<div class="wrapper">
		...
		<div class="container">
					...
					<ul>
						...
						<li><a href="/view/newhelp/in_help_50_0">서비스 구분별 이용방법</a>
							<ul class="sub">
								...
								<li><a href="/view/newhelp/in_help_50_5" class="on">ㆍe-지방지표</a></li>
			...
			<div class="contentsWrap">
				<div class="contents">
					<h1>e-지방지표 조회</h1>
					<h2>○ e-지방지표 통계를 조회하는 기능입니다.</h2>
					<h2>○ e-지방지표 단위 통계의 조회 메뉴리스트에서 단계별로 항목을 선택하고, 세부항목을 선택하면, 조회 세부조건 설정창이 나타난다. 항목, 분류, 주기 등 세부조건을 설정하고 해당 통계를 조회할 수 있습니다.</h2>
					<!-- mng_s 20170810 웹접근성 조치 -->

					<!-- mng_s 20200403 이진호 / 도움말 현행화 -->
					<!-- <img src="/img/newhelp/In_050_12_1.png" style="margin-left: 10px; width:675px;" alt="행정구역통계 검색조건"/> --><!-- 190315 방민정 수정 -->
					<img src="/img/newhelp/In_050_12_1_001.png" style="margin-left: 10px; width:675px;" alt="행정구역통계 검색조건"/>
					<!-- mng_e 20200403 이진호 -->
					
					<!-- mng_e 20170810 웹접근성 조치 -->
					<!-- <h2 style="margin-left: 220px;">[e-지방지표 검색조건]</h2><br> -->
					<h2 align="center">[e-지방지표 검색조건]</h2><br>
					...
					<!-- <h2>○ 생성된 통계버튼을 더블클릭하거나, 지도화면의 임의의 행정구역에 드래그앤드롭 하면 선택된 행정구역의 세부행정구역 단위로 해당 KOSIS통계정보가 생성되어 지도화면에 표출됩니다.</h2> -->
					
					<!-- mng_s 20200403 이진호 -->
					<!-- <img src="/img/newhelp/In_050_13_new.png" style="margin-left: 0px;" alt="사업체 통계 검색 결과"/> -->
					<img src="/img/newhelp/In_050_13_new_001.png" style="margin-left: 0px;" alt="사업체 통계 검색 결과"/>
					<!-- mng_e 20200403 이진호 -->
					
					<h2 style="/* margin-left: 250px; */text-align:center;">[e-지방지표 검색결과]</h2><br>
					<br><br>
				</div>
			</div><!--contentsWrap-->
		</div><!--container-->
