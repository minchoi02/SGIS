...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             srvLogWrite('A0', '12', '17', '00', '', '서비스 이용절차');
        });
    </script> 
			...
			<div class="contentsWrap">
				<div class="contents">
				  ...
				  <h1>자료 신청방법</h1> <!-- 2016.03.18 수정, 자료제공 신청방법->자료신청 방법  -->
					...
					<h2><a href="/contents/shortcut/shortcut_05_02.jsp"><img src="/img/newhelp/Dd_blue.png" style="margin-left: 0px; width:238px; height:25px" border=0 alt="자료제공 바로가기"></a></h2>
					<!-- mng_e 20200728 이진호 -->
