...
<%
	...
	if(loginYn.equals("N")) {
		...
		session.setAttribute("returnUrl", "/view/pss/requestData");out.print("<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>");
		...
		out.print("</head>");
		out.print("<body>");
		out.print("<script type='text/javascript'> alert('로그인 후 이용할 수 있습니다.'); location.href='/view/member/login_new?returnPage=http://sgis.kostat.go.kr/view/pss/requstDataList'; </script> ");
	...
	<head>
		...
		<script>
			...
			function census_view(id) {
				...
				fm.aT.value = "RET";
				fm.action="/view/pss/requstDataListDtl";
				fm.submit();
			}
			...
			function census_del(id) {
			    ...
			    if(c == 1) {
				 	$.ajax({
						type: "POST",
						url: "/view/pss/deleteRequestData",
						data: {"sgis_census_req_id": id},
