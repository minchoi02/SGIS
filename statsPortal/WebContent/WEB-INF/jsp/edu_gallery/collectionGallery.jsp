	...
	<div id="wrap">
		...
		<div class="containerBox">  
			<p class="mpGuide">
				...
				<a href="/view/edu_gallery/collectionGallery"><span class="path_el current">작성 갤러리</span></a>
			</p>
...
<!-- //TODO	즐겨찾기, 작성갤러리, 수집 갤러리 - 카운트 쿼리 추가 -->
			...
			<div class="mrgTabs">
<!-- //TODO	링크연결 -->
				<a href="/view/edu_gallery/bookMarkGallery">즐겨찾기</a>
				<a href="/view/edu_gallery/collectionGallery" class="on">작성 갤러리</a>
...
<!-- //TODO	임시저장, 수집 갤러리, 추천 수 - 카운트 쿼리 추가(추천수-전체갤러리 추천수?) -->
				...
				<a onclick="javascript:srvLogWrite('J0','02','02','02','',''); collectionGallery.deleteGallery();" id="deleteBtn" class="btnGtype" style="display:none;">삭제</a>
