...
<head>
	...
	<script src="/js/edu_gallery/bookMarkGallery.js"></script>
	<script>
		$(function(){
			srvLogWrite('J0','02','01','01','','');
		});
	</script>
	...
	<div id="wrap">
		...
		<div class="containerBox">  
			<p class="mpGuide">
				...
				<a href="/view/edu_gallery/resultGallery"><span class="path_el">통계갤러리&nbsp;>&nbsp;</span></a>
				<a href="/view/edu_gallery/bookMarkGallery"><span class="path_el current">즐겨찾기</span></a>
			</p>
...
<!-- //TODO	링크연결 -->
				<a href="/view/edu_gallery/bookMarkGallery" class="on">즐겨찾기</a>
				<a href="/view/edu_gallery/collectionGallery">작성 갤러리</a>
				<a href="/view/edu_gallery/myGallery">수집 갤러리</a>
			</div>
			<div class="btnbox ar"> 
				<div class="leftEtc">
<!-- //TODO	임시저장, 수집 갤러리, 추천 수 - 카운트 쿼리 추가(추천수-전체갤러리 추천수?) -->
				...
				<!-- 2017. 02. 28 개발팀 수정요청 -->
				<a onclick="javascript:srvLogWrite('J0','02','01','02','',''); $bookMarkGallery.addGallery();" id="deleteBtn" class="btnGtype" style="display:none;">등록</a>
	...
	<div id="dialogDiv" style="display:none;">
		<jsp:include page="/view/edu_gallery/insertGallaryDialog"></jsp:include>
	</div>
