...
<script src="${pageContext.request.contextPath}/sgis_edu/resource/js/communityMap/batch/communityBatchMap.js"></script>
<script src="${pageContext.request.contextPath}/sgis_edu/resource/js/communityMap/batch/communityBatch.js"></script>
...
<style>
	footer{margin-top:0px !important; padding-top:10px;}
</style>
	...
	<div id="wrap">
		...
		<div id="container">
			<c:set var="appendPath" scope="request">
				<a href="#"><span class="path_el current">함께하는지도 데이터 일괄 업로드</span></a>
			</c:set>
			...
			<div class="containerBox">
				...
				<div class="dataMenuBox">
					...
					<form name="fileForm" method="post" enctype="multipart/form-data">
						...
						<ul class="dmBtn">
							<li>
								<a href="${pageContext.request.contextPath}${sampleUrl}&cmmnty_map_id=${param.cmmnty_map_id}" class="spbox type02">엑셀양식다운로드</a>
							</li>
						</ul>
					</form>
				</div>
	...
	<div id="mapSetting" class="DetailInfo" style="display: none;">
		<div class="cm_newwin" style="margin-left:-375px; width: 1000px;height: 600px;left: 50%;top: 50%;margin: -300px 0 0 -500px">
			...
			<div class="cm_newwin_cont" style="padding:0;">
				...
				<div id="map" class="map_img" style="width:750px;height: 555px; position:absolute !important; left:246px !important;"></div>
			</div>
		</div>
