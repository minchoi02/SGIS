<%
/**************************************************************************************************************************
* Program Name	 : 함께하는지도 개설하기 step1 JSP	
* File Name		 : step1.jsp
* Comment		 : 
	...
	<table class="cm_make_info">
		...
		<tr>
			...
			<td style="padding-bottom: 20px;">
				<jsp:include page="/view/edu/${ss_school_level}/community/form/layerPopup/createAreaItem"/>
				...
				<span class="comment_area">초기설정지역<a id="init-map-intro-tooltip" href="javascript:void(0)" title="초기설정지역은 함께하는지도의 초기화면에서 지도가 확대되어 보이는 지역입니다" style="padding-left:5px;"><img src="${pageContext.request.contextPath}/img/community/cm_btn_question.png" alt="?" style="margin-top: -1px;"></a></span>
			...
			<c:set var="grantTooltip">
				<div class='grant-helper'>
			 		...
			 		<div>
			 			...
			 			<div class='content' style='border-bottom:1px solid #ddd;'><p style='font-weight: bold;font-size:13px !important;padding-bottom:5px;'>회원 일괄 등록 </p>개설자가 함께하는지도 회원들의 아이디와 비밀번호를 미리 저장하고, 회원들은 지정받은 아이디와 비밀번호로 의견을 등록할 수 있습니다. <span style='font-weight:bold;font-size: 12px !important;color:#4673a2;'> 로그인이 필요 없습니다.</span></div>
