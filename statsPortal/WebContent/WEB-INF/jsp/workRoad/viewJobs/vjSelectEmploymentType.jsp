<%
/**************************************************************************************************************************
* Program Name	: 일자리 맵 서비스 > 일자리 보기 > 고용형태 선택 (팝업창) 	
* File Name		: viewJobs > vjSelectEmploymentType.jsp
* Comment		: 
* History		:
*	2018-10-02	ywKim	신규
*
...
<script src="${pageContext.request.contextPath}/js/workRoad/viewJobs/vjSelectEmploymentType.js"></script>

<div id="vjSelectEmploymentType">
