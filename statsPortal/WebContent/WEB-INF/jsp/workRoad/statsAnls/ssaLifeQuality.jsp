<%
/**************************************************************************************************************************
* Program Name	: 일자리 맵 서비스 > 일자리 통계분석 > 삶의 질 > 주요지표
* File Name		: statsAnls > ssaLifeQuality.jsp
* Comment		: 
...
<script src="${pageContext.request.contextPath}/js/workRoad/statsAnls/ssaLifeQuality.js"></script>

<div class="popBox job-offer-status wrmDraggable" id="ssaLifeQuality">
	<a href="javascript:void(0)" class="sideQuick sq03 xw wrmToggleBtn">
		<span>삶의 질 > 주요지표</span>
	</a>
	<div class="topbar wrmHeader">
		<span></span>
		<!-- <span style="margin-left:5px">삶의 질 > 주요지표 ></span> -->
		<a href="javascript:void(0)" data-active="false">닫기</a>  
  	</div>
	<div class="sqListBox sq03" id="ssaLifeQualityContents">
		<!-- normalBox START -->
   		<div class="normalBox">		<%-- 2019.05.17[한광희] 일자리 통계분석 > 화면 사이즈 고정으로 인한 wrmScrollable 기능 삭제 처리 --%>
			<div class="indicator-area">
				...
				<div class="indicator">
					<!-- 삶의 질 지표 START -->
					<div class="data-left">
						<div class="jab-indicator-table" id="E3506" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3506');">
							<!-- 삶에 대한 만족도 -->
						</div>
						<div class="jab-indicator-table" id="E3505" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3505');">
							<!-- 소비생활만족도 -->
						</div>
						<div class="jab-indicator-table" id="E3503" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3503');">
							<!-- 일자리 만족도 -->
						</div>
						<div class="jab-indicator-table" id="E3504" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3504');">
							<!-- 소득 만족도 -->
						</div>
						<div class="jab-indicator-table" id="E3502" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3502');">
							<!-- 상대적 빈곤율 -->
						</div>
						<div class="jab-indicator-table" id="E3501" onclick="javascript:$ssaLifeQuality.ui.ChangeColor('E3501');">
							<!-- 지니계수 -->
						</div>
					</div>
					<!-- 삶의 질 지표 END -->
					...
					<div class="data-right">
						<div class="iaChartBoxMain" id="ssaLifeQualityChartMain"></div>
					</div>
					<!-- 삶의 질 차트 END -->
				</div>
				<!-- 지표,차트 영역 END -->
				<!-- 지표설명 및 지표 검색 조건 영역 START -->
				<!-- 2019.05.29[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 지표설명 영역 주석처리 START -->
				<!-- <div class="indicator bottom">
					<div class="indicator-tab" id="E3506_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">삶에 대한 만족도(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3506_condition_C10"  style="display:none">
						<table class="info-table">
							...
							<tbody>
								<tr>
									<th>제&nbsp;&nbsp;목 : </th>
									<td id="ssaTitle">삶에 대한 만족도 (201712)</td>
								</tr>
								<tr>
									<th>설&nbsp;&nbsp;명 : </th>
					...
					<!-- <div class="indicator-tab" id="E3505_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">소비생활만족도(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3505_condition_C10"  style="display:none">
						<table class="info-table">
							<caption>일자리 통계분석 기본정보</caption>
							<colgroup>
								<col width="80px;">
							...
							<tbody>
								<tr>
									<th>제&nbsp;&nbsp;목 : </th>
									<td id="ssaTitle">소비생활만족도 (201712)</td>
								</tr>
								<tr>
									<th>설&nbsp;&nbsp;명 : </th>
									<td id="ssaExp">만 15세이상 인구중 조사대상 주간에 취업도 실업도 아닌 상태에 있는 사람 - 이들은 주된 활동상태에 따라 구분</td>
					...
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 END --%>
					<!-- <div class="indicator-tab" id="E3503_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">일자리 만족도(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3503_condition_C10"  style="display:none">
						<table class="info-table">
							<caption>일자리 통계분석 기본정보</caption>
							<colgroup>
								<col width="80px;">
							...
							<tbody>
								<tr>
									<th>제&nbsp;&nbsp;목 : </th>
									<td id="ssaTitle">일자리 만족도 (201712)</td>
								</tr>
								<tr>
									<th>설&nbsp;&nbsp;명 : </th>
									<td id="ssaExp">만 15세이상 인구중 조사대상 주간에 취업도 실업도 아닌 상태에 있는 사람 - 이들은 주된 활동상태에 따라 구분</td>
					...
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 END --%>
					<!-- <div class="indicator-tab" id="E3504_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">소득 만족도(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3504_condition_C10"  style="display:none">
						<table class="info-table">
							<caption>일자리 통계분석 기본정보</caption>
							<colgroup>
								<col width="80px;">
							...
							<tbody>
								<tr>
									<th>제&nbsp;&nbsp;목 : </th>
									<td id="ssaTitle">소득 만족도 (201712)</td>
								</tr>
								<tr>
									<th>설&nbsp;&nbsp;명 : </th>
									<td id="ssaExp">만 15세이상 인구중 조사대상 주간에 취업도 실업도 아닌 상태에 있는 사람 - 이들은 주된 활동상태에 따라 구분</td>
					...
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 END --%>
					<!-- <div class="indicator-tab" id="E3502_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">상대적 빈곤율(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3502_condition_C10"  style="display:none">
						<table class="info-table">
							<caption>일자리 통계분석 기본정보</caption>
							<colgroup>
								<col width="80px;">
							...
							<tbody>
								<tr>
									<th>제&nbsp;&nbsp;목 : </th>
									<td id="ssaTitle">상대적 빈곤율 (201712)</td>
								</tr>
								<tr>
									<th>설&nbsp;&nbsp;명 : </th>
									<td id="ssaExp">만 15세이상 인구중 조사대상 주간에 취업도 실업도 아닌 상태에 있는 사람 - 이들은 주된 활동상태에 따라 구분</td>
					...
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 END --%>
					<!-- <div class="indicator-tab" id="E3501_condition_C9"  style="display:none">
						<h3 id="ssaStatNm">지니계수(Economiccally inactive population)(월)</h3>
					</div> -->
					<%-- 2019.05.17[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 주석처리 START --%>
					<%-- <div class="info-area" id="E3501_condition_C10"  style="display:none">
						<table class="info-table">
							<caption>일자리 통계분석 기본정보</caption>
							<colgroup>
								<col width="80px;">
					...
					<div class="indicator-stepBox" id="ssaLifeQualty_map_type" style="display:none">
						<p>표출방법</p>
						<ul>
							<li><input type="radio" id="ssaLQ_color_map" name="ssaLQ_condition_map_type" value="color" checked="checked"><label for="ssaLQ_color_map" class="on">색상지도</label> </li>
							<li><input type="radio" id="ssaLQ_bubble_map" name="ssaLQ_condition_map_type" value="bubble"><label for="ssaLQ_bubble_map" class="">버블지도</label> </li>
							<li><input type="radio" id="ssaLQ_heat_map" name="ssaLQ_condition_map_type" value="heat"><label for="ssaLQ_heat_map" class="">열지도</label> </li>
						</ul>
					</div>
				</div> -->
				<!-- 2019.05.29[한광희] 일자리 통계분석 > 용어 설명 팝업 호출로  인한 지표설명 영역 주석처리 END -->
				<!-- 지표설명 및 지표 검색 조건 영역 END -->
			</div>
		</div>
		<!-- normalBox END -->
		<div class="btnBottom">
			<a href="javascript:$ssaLifeQuality.ui.addSearchBtn();" class="btnStyle02" id="buttonMakeBtn" data-subj="조건결합설정 팁" title="현재 선택된 통계지표 목록에 해당하는 통계조건을 통계버튼으로 생성하여 통계값을 조회 할 수 있어요">통계보기</a>
		</div>
	</div>
</div>