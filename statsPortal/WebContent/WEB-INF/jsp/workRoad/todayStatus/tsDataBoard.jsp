...
<script src="${pageContext.request.contextPath}/js/workRoad/todayStatus/tsDataBoard.js"></script>

<style>
	#tsDataSideBox {/* 데이터보드를 지도컨트롤 버튼 위에 위치시키기 */
		z-index: 1001;
	}
	
   	#tsDataBoard .popBox {/* 팝업용도가 아닌 데이터보드에 끼워넣기하는 경우 처리될 사항 - 테두리제거, 사이즈 Full */
   	    left: 0px;
	    top: 0px;
	    margin-left: 0px;
	    width: 100%;
...
<a href="javascript:void(0)" class="workRoadDataBoard" id="tsDataBoardToggle">데이터보드</a>
<div class="dataSideBox" id="tsDataSideBox">
	<div class="bar">
...
<!-- 	<a href="javascript:void(0)"><img src="/images/workRoad/ico/ico_close02.png" alt="데이터보드 닫기" /></a> -->
	...
	<div class="dataSideContents">
		...
		<div class="workRoad" id="tsDataBoard">
			<div class="popBox today-data-popup-view wrmScrollable">
			 	<div class="cont-box">
			 		<article>
			 			<h3 id="tsStatPath">오늘의 구인 현황 </h3>
					 	...
					 	<div class="dscList">
							...
							<div class="compareBox">
								...
								<div class="job-offer-graph" id="wrapperChartScroll"><!-- 기존코드에서 스크롤 기능 제거 - 2018.11.05	ywKim	변경 -->
