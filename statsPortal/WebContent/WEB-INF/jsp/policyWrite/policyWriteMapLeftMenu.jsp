...
<!-- 리디자인적용:link 우선순위에 따라 css style이 적용되지 않는 이유 - 2019.01.22	ywKim	추가 -->
<style>
#depth1Menu .nav-list li a {height: 70px;}

#depth1Menu .nav-list li:nth-child(1) > a,
#depth1Menu .nav-list li:nth-child(2) > a,
#depth1Menu .nav-list li:nth-child(3) > a,
#depth1Menu .nav-list li:nth-child(4) > a,
#depth1Menu .nav-list li:nth-child(5) > a {padding: 35px 0 5px;}
#depth1Menu .nav-list li:nth-child(6) > a {padding: 40px 0 5px;vertical-align: bottom;}
#depth1Menu .nav-list li:nth-child(7) > a {padding: 45px 0 5px;vertical-align: bottom;}

#depth1Menu .nav-list li:nth-child(1) > a:before {top: 7px;}
#depth1Menu .nav-list li:nth-child(2) > a:before,
#depth1Menu .nav-list li:nth-child(3) > a:before {top: 2px;}
#depth1Menu .nav-list li:nth-child(4) > a:before, 
#depth1Menu .nav-list li:nth-child(6) > a:before,
#depth1Menu .nav-list li:nth-child(5) > a:before {top: 6px;}
#depth1Menu .nav-list li:nth-child(7) > a:before {top: 9px;}

.quickBox.join {width: 839px;left: -840px;z-index: 1500;}

#companyClassListDiv .normalBox,
#kosisDetailDiv .normalBox {width: 280px;height: calc( 100% - 90px );overflow: hidden;position: relative;border-bottom: 1px solid #ccc;}
</style>
...
<div class="quickBox step01" id="quickBox-01">
	...
	<div class="scrollBox" style="height: calc(100% - 11px);">
		<ul class="themul ul-area interactive-list">
			<li id="mainIndexBtn" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('mainIndex');"><a href="javascript:void(0);" data-subj="총조사주요지표" title="${paramInfo.tooltipList.A0001}">총조사 주요지표</a></li>
			<li onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('populationHouse');"><a data-subj="인구주택총조사" title="${paramInfo.tooltipList.A0102}">인구주택총조사</a></li>
			<li onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('3f');"><a data-subj="농림어업총조사" title="${paramInfo.tooltipList.A0201}">농림어업총조사</a></li>
			<li id="companyBtn" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('company');"><a data-subj="전국사업체조사" title="${paramInfo.tooltipList.A0301}">전국사업체조사</a></li>
			<li id="kosisData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('kosis');"><a data-subj="KOSIS(지역통계)" title="${paramInfo.tooltipList.A0401}">KOSIS(지역통계)</a></li>
			<li id="collaboData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('local');"><a data-subj="협업형 데이터" title="${paramInfo.tooltipList.A0601}">협업형 데이터</a></li>  
			<li id="userData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('userData');"><a data-subj="나의 데이터" title="${paramInfo.tooltipList.A0601}">나의 데이터</a></li>  
		</ul>		
	</div>
</div><!-- 대화형통계지도 메뉴 보기 end -->
<div class="nav-sidebar" id="depth1Menu">
	<ul class="thematic nav-list interactive-list">
		<li id="mainIndexBtn" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('mainIndex');"><a href="javascript:void(0);" data-subj="총조사주요지표" title="${paramInfo.tooltipList.A0001}"><span>총조사<br/>주요지표</span></a></li>
		<li onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('populationHouse');"><a data-subj="인구주택총조사" title="${paramInfo.tooltipList.A0102}"><span>인구주택<br/>총조사</span></a></li>
		<li onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('3f');"><a data-subj="농림어업총조사" title="${paramInfo.tooltipList.A0201}"><span>농림어업<br/>총조사</span></a></li>
		<li id="companyBtn" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('company');"><a data-subj="전국사업체조사" title="${paramInfo.tooltipList.A0301}"><span>전국<br/>사업체조사</span></a></li>
		<li id="kosisData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('kosis');"><a data-subj="KOSIS(지역통계)" title="${paramInfo.tooltipList.A0401}"><span>KOSIS<br/>(지역통계)</span></a></li>
		<li id="collaboData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('local');"><a data-subj="협업형 데이터" title="${paramInfo.tooltipList.A0601}"><span>협업형 데이터</span></a></li>  
		<li id="userData" onclick="javascript:$policyWriteMapLeftMenu.ui.setDetailStatsPanel('userData');"><a data-subj="나의 데이터" title="${paramInfo.tooltipList.A0601}"><span>나의 데이터</span></a></li>  
	</ul>
	<div class="list_btn">
		<img src="/images/common/img_list_btn.png" alt="목록" style="cusor:pointer" onclick="javascript:$policyWriteMapLeftMenu.ui.showStatsPanel();"/>
	</div>
</div>
<!-- 2Depth start -->
	...
	<div class="scrollBox">
		...
		<div class="totalResult tr02"><!-- 인구주택총조사 통계 -->
			<ol class="cateMenu type01" id="populationTabDiv">
				...
				<div class="stepBox"> 
					<!-- 2019-01-28 연령선택을 라디오버튼으로 구간선택 -->
					<p class="on">연령</p>
					<ul class="dbTypeCk radioStepBoxPopulationAge validationStepBox">
				        <li>
				        	<input type="radio" id="populationAgeSelect01" name="populationAgeSelect" value="1" checked="checked"/>
				            <label for="populationAgeSelect01" class="mr20 on">구간선택</label>
				            <input type="radio" id="populationAgeSelect02" name="populationAgeSelect" value="2" />
				            <label for="populationAgeSelect02" class="mr20">목록선택</label>
				        </li> 
				    </ul>
					<a style="display: none;" href="javascript:void(0)" class="roundTextBox on" id="populationAgeTab" data-pair-id="populationAgeTabFavorite"><!-- 2018.06.21	ywKim	변경: 자주사용하는 연령 체크박스와 한쌍으로 연결 [v180618] - 연령구간 구체화 -->
					<!-- <a href="javascript:void(0)" class="roundTextBox" id="populationAgeTab"> -->
				    	<input type="checkbox" title="연령(선택)" checked="checked"/>
						<span>연령(선택)</span>
				    </a>
				    <div class="joinDefault" style="width:260px; display:block;" id="populationAgeSelect01Div">
					...
					<!-- 2018.06.21	ywKim	추가: 자주사용하는 연령 선택 [v180618] - 연령구간 구체화 -->
				    <!-- 20190306 손원웅 수정
				    <a style="display: none;" href="javascript:void(0)" class="roundTextBox" id="populationAgeTabFavorite" data-pair-id="populationAgeTab">
						<input type="checkbox" title="연령(선택) [즐겨찾기]" />
						<span>연령(선택) [즐겨찾기]</span>
				    </a>
				    <div class="joinDefault" style="width:260px;" id="populationAgeSelect02Div">
				    	<div class="box_area_option02">
	                        <div class="mgb_12">
	                            <p class="" style="margin-left:35px;">
	                                <select title="자주사용하는 연령 범위" id="populationAgeFavorite" name="favoriteAge"></select>
	                            </p>
	                        </div>
                        </div>
				    </div> -->
				    <div class="stepBox mainIndex_stepBox" id="favoriteAge_stepBox_radio" style="display:none;">
					   	<ul class="dbTypeCk">
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio01" value="0-6-Y" checked="checked"/>
					            <label for="favoriteAge_radio01" class="on">0세 ~ 7세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio02" value="7-12-Y" />
					            <label for="favoriteAge_radio02">7세 이상 ~ 13세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio03" value="13-15-Y" />
					            <label for="favoriteAge_radio03">13세 이상 ~ 16세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio04" value="16-18-Y" />
					            <label for="favoriteAge_radio04">16세 이상 ~ 19세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <p>
					        ---------------------------------
					        ...
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio06" value="0-14-Y" />
					            <label for="favoriteAge_radio06">0세 ~ 15세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio07" value="15-64-Y" />
					            <label for="favoriteAge_radio07">15세 이상 ~ 65세 미만</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
					        <li>
					            <input type="radio" name="favoriteAge_radio" id="favoriteAge_radio08" value="65-150-Y" />
					            <label for="favoriteAge_radio08">65세 이상</label>
					            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
					        </li>
						</ul>
					</div>
				...
				<div class="stepBox"> 
				    ...
				    <div class="joinDefault">
				   	...
				   	<a href="javascript:void(0)" class="roundTextBox" id="houseConstYearTab">
				    ...
				    <a href="javascript:void(0)" class="roundTextBox" id="houseUsePeriodTab" style="display:none;">
				...
				<div class="stepBox join">
		            <div class="joinStepBox first" id="fusionPopulation">
						...
						<a href="javascript:void(0)" class="roundTextBox">
							<input type="checkbox" title="연령(선택)"/>
							<span>연령(선택)</span>
						</a>
						<!-- 연령 선택에 레이아웃 변경 - 2019.01.30	ywKim	변경 -->
						<div class="joinDefault" style="width:260px;">
							<ul class="dbTypeCk radioStepBoxPopulationAge validationStepBox">
						        <li>
						        	<input type="radio" id="populationAgeSelect01" name="populationAgeSelect" value="1" checked="checked"/>
				    		...
				    		<a style="display: none" href="javascript:void(0)" class="roundTextBox on" id="populationAgeTab_combine" data-pair-id="populationAgeTab_combine_favorite"><!-- 2018.06.21	ywKim	변경: 자주사용하는 연령 체크박스와 한쌍으로 연결 [v180618] - 연령구간 구체화 -->								    		
						    <!-- <a href="javascript:void(0)" class="roundTextBox" id="populationAgeTab_combine"> -->
						    	<input type="checkbox" title="연령(선택)" checked="checked"/>
								<span>연령(선택)</span>
						    </a>
						    <div class="joinDefault" style="width:260px; display:block;">
						    	<div class="box_area_option02">
						    		<!-- 9월서비스 권차욱 수정 -->
	                                <div class="mgb_12">
	                                    <p class="houseArea">
						    ...
						    <!-- 2018.06.21	ywKim	추가: 자주사용하는 연령 [v180618] - 연령구간 구체화 -->
						    <!-- <a style="display: none" href="javascript:void(0)" class="roundTextBox" id="populationAgeTab_combine_favorite" data-pair-id="populationAgeTab_combine">
						    	<input type="checkbox" title="연령(선택) [즐겨찾기]"/>
								<span>연령(선택) [즐겨찾기]</span>
						    </a>
						    <div class="joinDefault" style="width:260px;">
						    	<div class="box_area_option02">
	                                <div class="mgb_12">
	                                    <p class="" style="margin-left:35px;">
	                                        <select title="자주사용하는 연령 범위" id="populationAge_combine_favorite" name="favoriteAge"></select>
	                                    </p>
	                                </div>
	                            </div>
						    </div> -->
						    <div class="stepBox mainIndex_stepBox" id="favoriteAge_combine_stepBox_radio" style="display:none;">
							   	<ul class="dbTypeCk">
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio01" value="0-6-Y" checked="checked"/>
							            <label for="favoriteAge_combine_radio01" class="on">0세 ~ 7세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio02" value="7-12-Y" />
							            <label for="favoriteAge_combine_radio02">7세 이상 ~ 13세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio03" value="13-15-Y" />
							            <label for="favoriteAge_combine_radio03">13세 이상 ~ 16세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio04" value="16-18-Y" />
							            <label for="favoriteAge_combine_radio04">16세 이상 ~ 19세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <p>
							        ---------------------------------
							        ...
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio06" value="0-14-Y" />
							            <label for="favoriteAge_combine_radio06">0세 ~ 15세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio07" value="15-64-Y" />
							            <label for="favoriteAge_combine_radio07">15세 이상 ~ 65세 미만</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
							        <li>
							            <input type="radio" name="favoriteAge_combine_radio" id="favoriteAge_combine_radio08" value="65-150-Y" />
							            <label for="favoriteAge_combine_radio08">65세 이상</label>
							            <a href="javascript:void(0)" class="ar" data-subj="인구주택총조사"></a>
							        </li>
								</ul>
							</div>
		...
		<div class="totalResult tr03">
				...
				<div class="stepBox">  
					...
					<a href="javascript:void(0)" class="roundTextBox" id="3fAgeTab" data-pair-id="3fAgeTabFavorite"><!-- 2018.06.21	ywKim	변경: 자주사용하는 연령 체크박스와 한쌍으로 연결 [v180618] - 연령구간 구체화 -->										
				    ...
				    <!-- 2018.06.21	ywKim	추가: 자주사용하는 연령 [v180618] - 연령구간 구체화 -->
				    <a href="javascript:void(0)" class="roundTextBox" id="3fAgeTabFavorite" data-pair-id="3fAgeTab">
				    	<input type="checkbox" title="해당 가구원 연령 선택 [즐겨찾기]">
				    	<span>해당 가구원 연령(선택) [즐겨찾기]</span>
				    </a>
				    <div class="joinDefault" style="width:260px;">
				    	<div class="box_area_option02">
                               <div class="mgb_12">
                                   <p class="" style="margin-left:35px;">
                                       <select title="자주사용하는 연령 범위" id="3fAgeFavorite" name="favoriteAge"></select>
                                   </p>
                               </div>
                           </div>
				    </div>
