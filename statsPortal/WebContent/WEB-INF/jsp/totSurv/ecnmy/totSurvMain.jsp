...
<!-- SGIS 공통 JS -->
	...
	<script src="${pageContext.request.contextPath}/js/totSurv/ecnmy/map.js"></script>
...
<!-- 헤더 -->
<jsp:include page="/view/totSurv/ecnmy/totSurvHeader"></jsp:include>
...
<input type="hidden" id="mngMode" name="mngMode" value="${mngMode}" />
<!-- 사용자 동적영역 생성 -->
