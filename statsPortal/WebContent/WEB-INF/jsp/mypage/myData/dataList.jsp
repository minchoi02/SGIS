...
<body>
	<div id="wrap">
		...
		<div id="container" style="width:1300px;">
			...
			<div class="containerBox">
				<div class="mpSubTitle2">
					...
					<div style="display:inline-block;width:10%;">
						<button style="background: #0d66ac;line-height: 25px;width: 80px;color: white;border-radius: 10px;padding: 3px 3px 3px 3px;" onclick="javascript:$myDataList.openPopup()">이용가이드</button>
					</div>
					<div class="mpfileBox">
						<!-- <input type="file" id="mpfile" /> <label for="mpfile">내파일 업로드 하기</label> -->
						<span id="mpfile"
							onclick="javascript:srvLogWrite('A0', '11', '03', '02', '', '');$myDataList.myDataFileUpload();"><label
							for="mpfile">내파일 업로드 하기</label></span>
					</div>
					<p>업로드된 개인 데이터 목록입니다. 저장된 데이터는 SGIS+plus 서비스(대화형통계지도, 생활권역 통계지도)에서
						활용가능합니다.</p>
				</div>
				...
				<!-- popBox 시작 -->
				<div class="popBox" id="downLoadPop" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:999999;display:none;">
				<div class="topbar">
					<span>파일 선택</span> 
			...
			<div class="popBox" id="sizeAlert" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:999999;display:none;">
				<div class="topbar">
					<span>파일 용량 초과</span> 
			...
			<div class="popBox" id="deleteAlert" style="position:absolute;margin-top:150px;margin-left:-150px;z-index:999999;display:none;">
				<div class="topbar">
					<span>데이터 삭제</span> 
	...
	<!-- map Layer start -->
			<div class="popBox mapPreView dragbox" id="mapSetting" style="display:none;z-index: 214748364;">
				<div class="rela">	
					...
					<div class="pfr" > -->
						<div id="mapRgn_1" class="map_img" style="width:990px;height:680px;z-index:214748364"></div>
					<!-- </div> -->
					</div>
				</div>
			</div>
