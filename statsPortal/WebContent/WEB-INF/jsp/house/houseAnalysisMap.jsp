...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/house/poi_pop.css" />
...
<%-- 		<link rel='shortcut icon' href='${pageContext.request.contextPath}/img/ico/n_favicon.png'/> --%>
        ...
        <style>
        	.interactiveSelect, .interactiveIco {
			    margin-top: 3px;
			    margin-left: 195px;
			}
			.sideQuick.sq02{
			...
			.house-list li > a{height:80px;}
			.house-list li:nth-child(1) > a{padding:53px 0px 15px;}
			.house-list li:nth-child(2) > a{padding:53px 0px 15px;}
			.house-list li:nth-child(3) > a{padding:53px 0px 15px;}
			.house-list li:nth-child(1){height:80px;}
			.house-list li:nth-child(2){height:80px;}
			.house-list li:nth-child(3){height:80px;}
			...
			.dscList dt>a.on{background:#00bcd4 url(/img/ico/ico_up01.gif) no-repeat 505px center;border-radius:13px;}
			
			.IndexStatusBar2 li.M_on ul li.M_on a{text-decoration: underline;}
			...
			.rqListBox>li>ol>li>input{margin-top:5px}/*우리동네수정*/
			.rqListBox li>ol.other>li>a {text-indent: 24px;}/*우리동네수정*/
			.rqListBox li>ol:before{background: url(/img/ico/ico_arr02.png) !important;}/*우리동네수정*/
		</style>
		<script>
			$(function(){
// 						srvLogWrite("F0","01","01","00",$("#inter-recommend-sido-select option:selected").text(),$("#inter-recommend-sgg-select option:selected").text());
						//190219_s 주용민
						$("#toggle_div_1>img").click(function(){
							if($("#toggle_div_1").hasClass("on")){
								$("#toggle_div_1").removeClass("on");
								$("#toggle_div_1>img").attr("src","/img/house/house_toggle2.png");
								$("#detailChart6").css("display","none");
								$("#detailChart4-chart .Chart_info").css("display","none");
								$("#detailChart6_1").css("display","block");
							}else{
								$("#toggle_div_1").addClass("on");
								$("#toggle_div_1>img").attr("src","/img/house/house_toggle1.png");
								$("#detailChart6").css("display","block");
								$("#detailChart4-chart .Chart_info").css("display","block");
								$("#detailChart6_1").css("display","none");
							}
						});
						$("#toggle_div_2>img").click(function(){
							if($("#toggle_div_2").hasClass("on")){
								$("#toggle_div_2").removeClass("on");
								$("#toggle_div_2>img").attr("src","/img/house/house_toggle2.png");
								$("#detailChart5").css("display","none");
								$("#detailChart3-chart .Chart_info").css("display","none");
								$("#detailChart6_2").css("display","block");
							}else{
								$("#toggle_div_2").addClass("on");
								$("#toggle_div_2>img").attr("src","/img/house/house_toggle1.png");
								$("#detailChart5").css("display","block");
								$("#detailChart3-chart .Chart_info").css("display","block");
								$("#detailChart6_2").css("display","none");
							}
						});
						...
						//190219_e 주용민
						$(".nav-sidebar li").eq(0).find("a").addClass("on");
						//mng_s 20180412_김건민	
			...
			$.tooltipOpen = function() {
				var popup = window.open('${pageContext.request.contextPath}/view/newhelp/house_help_10_0', 'tooltip', '');
				var crono = window.setInterval(function() {
					$('button#tuto_start_btn:eq(1)').removeAttr('aria-describedby');
					$('button#tuto_start_btn:eq(1)').removeAttr('title');
			...
			function checkClosed() {
				$('button#tuto_start_btn:eq(1)').attr('title', '이용법');
			}
			...
			function pageSrvLog() {
   			...
   			function callTutorial(){
   				if(confirm("<살고싶은 우리동네> \n처음 사용자를 위한 튜토리얼이 준비되어 있습니다.\n진행하시겠습니까?")) 
   					window.open('/view/house/houseAnalysisMap?tutorial_mode', '_blank'); 
   			}
		</script>
</head>
<body onload="pageSrvLog();">
	<div id="wrap" >
		<header>
		...
		<div class="containerBox">
			<div class="rela">
					...
					<div class="sceneRela">
						<div class="toolBar" style="border-top: 1px solid #D8DADE;">
							...
							<div>
								...
								<button type="button" id="tuto_start_btn" style=" border-radius: 1000px;	background-color: #1dab8f; font-size: 12px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 26px; width: 95px; right: 350px; top: 0; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;" onclick="javascript:srvLogWrite('F0','05','01','00','',''); callTutorial();" title="사용법 따라하기">튜토리얼</button>
								<!-- mng_e 20180412_김건민 -->
							</div>
							<div class="tb_right" id="btnList_1">
								<ul>
									...
									<li><a onclick="javascript:srvLogWrite('F0','05','04','00','','');$galleryAdd.houseGalleryPopOpen();" class="tb_bookmark" style="cursor:pointer;" title="즐겨찾기로 저장하기" ><img src="/img/ico/ico_toolbars05.png" alt="즐겨찾기로 저장하기"/></a></li>
									<li><a onclick="javascript:convertImage();" class="" style="cursor: pointer;" title="이미지 다운로드" tabindex="91"><img src="${pageContext.request.contextPath}/img/ico/download.png" alt="이미지 저장하기" /></a></li><!--20년수정반영(이미지 저장 추가)-->
									...
									<li><a onclick="javascript:srvLogWrite('F0','05','05','00','','');$houseAnalysisMap.ui.reportDataSet();" class="tb_report" style="cursor:pointer;" title="보고서 보기"><img src="${pageContext.request.contextPath}/img/ico/ico_toolbars09.png" alt="보고서출력"/></a></li>
								</ul>
							</div>
						</div>
						<div class="interactiveBar">
							<p class="helperText" style="margin: 1px 0 0 355px;left: -55px;top: -8px;">
							...
							<a tabindex="-1" onclick="$.tooltipOpen();" style="background: none;"><button type="button" id="tuto_start_btn" style="left:115px;   border-radius: 6px;	background-color: #0174DF; font-size: 11px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 21px; width: 50px; top:4px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;" title="이용법">이용법</button></a>
							...
							<a style="cursor:pointer;background: none;" onclick="javascript:srvLogWrite('F0','05','02','00','','');$.helpIndicator();"><button type="button" id="tuto_start_btn" style="   border-radius: 6px;	background-color: #0174DF; font-size: 11px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 21px; width: 50px; top:4px; left: 174px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;" title="지표현황">지표현황</button></a> 
							...
							<!-- mng_s 20200814 이진호 / 웹툰보기를 '이용법 웹툰보기' 로 수정 -->
							<!-- <a style="cursor:pointer;background: none;" onclick="javascript:srvLogWrite('F0','05','03','00','','');openWebtoon();"><button type="button" id="tuto_start_btn" style="   border-radius: 6px;	background-color: #f8a043; font-size: 11px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 21px; width: 50px; top:4px; left: 232px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;"  title="웹툰보기">웹툰보기</button></a> -->
							<a style="cursor:pointer;background: none;" onclick="javascript:srvLogWrite('F0','05','03','00','','');openWebtoon();"><button type="button" id="tuto_start_btn" style="   border-radius: 6px;	background-color: #f8a043; font-size: 11px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 21px; width: 80px; top:4px; left: 232px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;"  title="웹툰보기">이용법 웹툰보기</button></a>
							<!-- mng_e 20200814 이진호 -->
		    	...
		    	<a href="javascript:void(0)" class="sideQuick sq02 sq01_01 on" id="search-recommend" data-title="통계메뉴" data-left="115px">
		    		<span>통계메뉴</span>
		    		<img src="${pageContext.request.contextPath}/SgisProject_Publisher/include/images/ico_totalmenu.gif" alt="" />
		    	</a>
...
<!-- 							즐겨찾기 하시겠습니까? -->
	...
	<div id="ideal-type-step" class="LayerCont">
		...
		<div class="PopupCont" style="width:550px; height:590px;">
			<h1>살고싶은 우리동네 웹툰</h1>
			<button id="btn_houseAnalysis_webtoon_laypopup" type="button" style="z-index:100;" class="Popup_close1" onclick="javascript:closeRotationTip('houseAnalysis_webtoon_laypopup', 1);">창닫기</button>
	...
	<div class="infoWrapper" style= "display: none;position:absolute; width:100%; height:100%; top:0; background:rgba(0,0,0,0.4); z-index:10000;">
		<div class="infoTable ui-widget-content" style="position: absolute;display: block;background: white;">
		</div>
	</div>	
	<div class="tutorialWrapper" style= "display: none" draggable="false">
		<!-- mng_s 20180412_김건민 -->	
		<button type="button" id="tuto_start_btn" style="   border-radius: 1000px;	background-color: #1dab8f; font-size: 12px; margin: 0 1px 0 1px; color: #ffffff; line-height: 19px; height: 26px; width: 95px; right: 302px; top:104px; margin-top: 3px; cursor: pointer;position: absolute; border: 0; outline: 0;" onclick="closeTutorial();" title="튜토리얼 종료">튜토리얼 종료</button>
		<!-- mng_e 20180412_김건민 -->			
		...
		<!-- 주거현황보기 시군구 리스트 -->
		<img id="left_01" src="/img/tutorial/house/left_01.png" alt="전국 리스트" draggable="false" style="display:none; position:absolute; top:237px; left:159px; cursor:pointer;">
		
		<!-- 추천지역찾기 시군구 리스트 -->
		<img id="left_02" src="/img/tutorial/house/left_02.png" alt="전국 리스트" draggable="false" style="display:none; position:absolute; top:269px; left:185px; cursor:pointer; z-index:10000;"> 
		...
		<!-- 주거현황보기 버튼 -->
		<img id="bt_01" src="/img/tutorial/house/bt_01.png" alt="주거현황보기" draggable="false" style="display:none; position:absolute; top:253px; left:-2px; cursor:pointer;  border: 3px outset red;">
		<img id="bt_02" src="/img/tutorial/house/bt_02.png" alt="전국" draggable="false" style="display:none; position:absolute; top:238px; left:153px; cursor:pointer;  border: 3px outset red;">
		<img id="bt_03" src="/img/tutorial/house/bt_03.png" alt="대전광역시" draggable="false" style="display:none; position:absolute; top:353px; left:159px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_04" src="/img/tutorial/house/bt_04.png" alt="교육" draggable="false" style="display:none; position:absolute; top:570px; left:90px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_05" src="/img/tutorial/house/bt_05.png" alt="학원수" draggable="false" style="display:none; position:absolute; top:603px; left:260px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_06" src="/img/tutorial/house/bt_06.png" alt="보기" draggable="false" style="display:none; position:absolute; top:915px; left:207px; cursor:pointer; border: 3px outset red;"><!-- 우리동네수정 -->
		...
		<!-- mng_s 20200424 이진호 , 튜토리얼 현행화 / 학구도 => 학교-->
		...
		<img id="bt_08" src="/img/tutorial/house/bt_08_01.png" alt="학교" draggable="false" style="display:none; position:absolute; top:170px; right:235px; cursor:pointer; border: 3px outset red; z-index:10003;">
		<!-- mng_e 20200424 이진호 -->
				
		<img id="bt_09" src="/img/tutorial/house/bt_09.png" alt="초등학교" draggable="false" style="display:none; position:absolute; top:248px; right:358px; cursor:pointer; border: 3px outset red; z-index:10001;">
		...
		<!-- 추천지역찾기 버튼 -->
		<img id="bt_11" src="/img/tutorial/house/bt_11.png" alt="추천지역찾기" draggable="false" style="display:none; position:absolute; top:130px; left:0px; cursor:pointer;  border: 3px outset red;">
		<img id="bt_12" src="/img/tutorial/house/bt_12.png" alt="전국" draggable="false" style="display:none; position:absolute; top:269px; left:185px; cursor:pointer;  border: 3px outset red; z-index:10000;">
		<img id="bt_13" src="/img/tutorial/house/bt_13.png" alt="대전광역시" draggable="false" style="display:none; position:absolute; top:382px; left:184px; cursor:pointer;  border: 3px outset red; z-index:10001;">
		<img id="bt_14" src="/img/tutorial/house/bt_14.png" alt="생활 편의 교통" draggable="false" style="display:none; position:absolute; top:552px; left:90px; cursor:pointer;  border: 3px outset red; z-index:10000;">
		<img id="bt_15" src="/img/tutorial/house/bt_15.png" alt="편의시설 수" draggable="false" style="display:none; position:absolute; top:400px; left:240px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_16" src="/img/tutorial/house/bt_16.png" alt="복지 문화" draggable="false" style="display:none; position:absolute; top:648px; left:87px; cursor:pointer;  border: 3px outset red; z-index:10000;">
		<img id="bt_17" src="/img/tutorial/house/bt_17.png" alt="병의원 및 약국" draggable="false" style="display:none; position:absolute; top:444px; left:243px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_18" src="/img/tutorial/house/bt_18.png" alt="추천지역찾기" draggable="false" style="display:none; position:absolute; top:915px; left:245px; cursor:pointer;  border: 3px outset red; z-index:10000;"><!-- 우리동네수정 -->
		...
		<img id="bt_26" src="/img/tutorial/house/bt_26.png" alt="라이프스타일 별 지표 설정" draggable="false" style="display:none; position:absolute; top:319px; left:366px; cursor:pointer; border: 3px outset red; z-index:10000;">
		<img id="bt_27" src="/img/tutorial/house/bt_27.png" alt="어린이를 키우는 맞벌이 부부" draggable="false" style="display:none; position:absolute; top:339px; left:280px; cursor:pointer; border: 3px outset red; z-index:10000;">
		
		<!-- 간편동네찾기 버튼 -->
		<img id="bt_28" src="/img/tutorial/house/bt_28.png" alt="간편동네찾기" draggable="false" style="display:none; position:absolute; top:330px; left:-3px; cursor:pointer;  border: 3px outset red; z-index:10000;">
		...
		<img id="map_10" src="/img/tutorial/house/map_10_01.png" alt="우측퀵버튼" altdraggable="false" style="display:none; position:absolute; top:172px; right:0px; cursor:pointer; z-index:10002;">
		<img id="map_11" src="/img/tutorial/house/map_11_01.png" alt="학구도 리스트" draggable="false" style="display:none; position:absolute; top:172px; right:0px; cursor:pointer; z-index:10000;">
