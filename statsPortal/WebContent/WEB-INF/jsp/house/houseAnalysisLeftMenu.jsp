...
<div class="quickBox step01" style="width:478px; height:calc(100%);left: 80px;">
<!-- <div class="quickBox step01" style="width:478px; height:calc(100% - 68px);left: 0px;"> -->
	<div class="nav-sidebar">
		<ul class="thematic nav-list house-list">
			<li id="search-recommend_le"><a  href="javascript:void(0);" style="background-position: -279px -13px;">추천지역찾기</a></li>
			<li id="look-abode"><a href="javascript:void(0)">주거현황보기</a></li>
			<li id="ideal-type"><a href="javascript:void(0)">간편동네찾기</a></li>
		</ul>
		<div class="menuAutoClose" style="left:3px">
...
<!-- 	</div> -->
	<div class="scrollBox">
		<div id="look-abode-box" class="menu-box" style="display:none;">
			<div class="HouseMap">
				<h2 class="houseMenuBoxStep">지역선택 <input id="look-select-location" type="checkbox" checked="checked" title="지역선택" /></h2>
				...
				<h2 class="houseMenuBoxStep">지표선택 <input id="look-select-type" type="checkbox" checked="checked" title="지표선택" /></h2>
		...
		<div id="search-recommend-box" class="menu-box">
			<div class="HouseMap">
				<h2 class="houseMenuBoxStep">
					지역선택
					<a href="javascript:void(0)" style="position: absolute;right: 10px;top: 7px;" data-subj="지역선택" title="○ 살고싶은지역과 비교지역을 시도, 시군구까지 설정할 수 있습니다.<br><br> ○ 살고싶은지역은, 이사 하고자 하는 지역입니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 이사 하고 싶은 지역을 '살고싶은지역'으로 설정 하시면, 설정된 지역 내에서 추천 지역을 찾습니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 살고싶은지역을 전국으로 설정하시면, 전국에 대한 모든 읍면동 중에서 추천 지역을 찾습니다.<br><br>○ 비교지역은 지표의 기준, 비교의 대상이 되는 지역입니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 현재 살고있는 지역을 입력하시면, 현 거주지에 대한 지표를 상, 중, 하로 보실 수 있습니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 비교지역을 전국으로 설정하시면, 전국 평균으로 지역을 검색 하실 수 있습니다.">
				...
				<dl class="SetArea">
					<dt>
						<label for="inter-recommend-sido-select" style="vertical-align:top;">살고싶은지역</label>
						<a href="javascript:void(0)" style="position: unset;right: 10px;top: 7px;" data-subj="살고싶은지역" title="○ 살고싶은지역은, 이사 하고자 하는 지역입니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 이사 하고 싶은 지역을 '살고싶은지역'으로 설정 하시면, 설정된 지역 내에서 추천 지역을 찾습니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 살고싶은지역을 전국으로 설정하시면, 전국에 대한 모든 읍면동 중에서 추천 지역을 찾습니다.">	
							<img src="${pageContext.request.contextPath}/img/ico/ico_tooltip01.png" alt="아이콘" style="width:15px;height:15px;"/>
						</a>					
					</dt>
					<dd>
						<select id="inter-recommend-sido-select" data-type="inter-recommend" title="살고싶은지역 시도 선택"></select>
						<select id="inter-recommend-sgg-select" title="살고싶은지역 시군구 선택"></select>
					</dd>
					<dt style="margin:0px 5px 5px 0px;text-align:right;width:98%;">
						<label style="vertical-align:top;"><input type="checkbox" name="stand_area_check" style="position: relative !important;right:2px;top:0px;"/>비교지역 설정</label>
						<a href="javascript:void(0)" style="position: unset;right: 10px;top: 7px;" data-subj="비교지역" title="○ 비교지역은 지표의 기준, 비교의 대상이 되는 지역입니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 현재 살고있는 지역을 입력하시면, 현 거주지에 대한 지표를 상, 중, 하로 보실 수 있습니다.<br>&nbsp;&nbsp;&nbsp;&nbsp;- 비교지역을 전국으로 설정하시면, 전국 평균으로 지역을 검색 하실 수 있습니다.">	
							<img src="${pageContext.request.contextPath}/img/ico/ico_tooltip01.png" alt="아이콘" style="width:15px;height:15px;"/>
						</a>
					</dt>
					<dd></dd>
					<dt style="display:none;"><label for="stand-recommend-sido-select">비교지역</label></dt>
					<dd style="margin-bottom:5px;display:none;">
						<select id="stand-recommend-sido-select" data-type="stand-recommend" title="비교지역 시도 선택"></select>
						<select id="stand-recommend-sgg-select" title="비교지역 시군구 선택"></select>
					</dd>
				</dl>
				<h2 style="z-index:100;" class="houseMenuBoxStep">
				지표설정
					<button id="LifeStyleBtn" class="Btn_lifestyle close" style="height:23px; top:3px;">라이프스타일 별 지표 설정</button>
				...
				<h2 class="houseMenuBoxStep">설정된지표<button class="Btn_delete_all" type="button" id="recommend-search-list-delete">전체삭제</button></h2>
	...
	<div class="btnBottom" id="toSee" style="display:none;">
		<a id="tuto06" href="javascript:void(0);" onclick="$houseAnalysisMap.search.abode.search();return false;" class="btnStyle01 submit" style="display: inline-block;padding:10px 30px;">보기</a>
	</div>
	<div class="btnBottom" id="recommendAreaFind">
		<a id="tuto18" href="javascript:void(0);" onclick="$houseAnalysisMap.search.recommend.search();return false;" class="btnStyle01 submit" style="display: inline-block;padding:10px 30px;">추천지역찾기</a>
	</div>
