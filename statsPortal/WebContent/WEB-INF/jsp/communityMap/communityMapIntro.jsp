...
<%-- 	<link rel="shortcut icon" href="${pageContext.request.contextPath}/img/ico/n_favicon.png"/> --%>
	...
	<script>
		...
		function callTutorial(){
			if(confirm("<지역현안 소통지도> \n처음 사용자를 위한 튜토리얼이 준비되어 있습니다.\n진행하시겠습니까?")) 
				window.open('/view/community/intro?tutorial_mode', '_blank'); 
		}
	</script>
</head>
							...
							<div class="SearchArea">
								<form id="community-search-form">
									<p class="SearchList">
										...
										<a class="inputSearchKeyboard" href="javascript:openKeyboard('community_search_word', 'listSearchBtn');" style="position:absolute; margin-left:-35px; margin-top:0px;">
											<img class="keyimg" src="/js/plugins/keyboard/img/key_off.png" style="display:inline-block; width:25px; height:15px; vertical-align: middle;" alt="키보드" />
										</a>
										<button id="listSearchBtn" type="submit">목록검색</button>
									</p>
								</form>
...
<!-- 			                              <option value="date_desc">등록일 역순</option> -->
							...
							<div class="CM_List">
								...
								<div class="paging pagenation" style="display:block !important;width:100%;position:relative;margin:0 auto;text-align:center;overflow:hidden;font-size:0;padding-top:0px;">
						...
						<div class="CM_Right">
							<c:choose>
								...
								<c:otherwise>
									<c:url var="formUrl" value="https://sgis.kostat.go.kr/view/community/form">
							...
							<div style="padding-bottom: 22px;">
								...
								<button type="button" id="tuto_start_btn" style="   border-radius: 12px;	background-color: #1dab8f; font-size: 12px; color: #ffffff; line-height: 19px; height: 24px; width: 200px; top:167px;  padding-right: 117px; cursor: pointer;position: absolute; border: 0; " onclick="javascript:callTutorial();" title="사용법 따라하기">튜토리얼</button>
								<!-- mng_e 20180412_김건민 -->
							</div> 
							<div class="ListHot">
					...
					<c:if test="${writeAble==true }">
						<div id="recommend-stats" class="popup_recommend" style="display:none;">
							<div class="popupCont">
								<h1>통계소통지도 목록</h1>
								<button class="btn_close" type="button" onclick="$('.popup_recommend').hide();"><img src="https://sgis.kostat.go.kr/img/community/btn_close_layer.png" alt="닫기"></button>
		...
		<div class="tutorialWrapper" style= "display: none" draggable="false">
			<div style="position:relative; margin:0 auto; padding-bottom:23px; max-width:960px; min-width: 970px; padding-top:20px;">
				...
				<img id="toPoint_2" src="/img/tutorial/toPoint_2.png" alt="포인터" draggable="false">
		 		...
		 		<!-- mng_s 20180411_김건민 -->
		 		<!-- mng_s 20210616 이진호, 웹 접근성 오류 수정 / style의 outline 제거  -->
				<!-- <button type="button" id="tuto_end_btn2" style="   border-radius: 12px;	background-color: #2F4D6A; font-size: 12px; color: #ffffff; line-height: 19px; height: 24px; width: 200px; left:769px; top:291px;  padding-right: 90px; cursor: pointer;position: absolute; border: 0; outline: 0;" onclick="closeTutorial();" title="튜토리얼 종료">튜토리얼 종료</button> -->
				<button type="button" id="tuto_end_btn2" style="   border-radius: 12px;	background-color: #2F4D6A; font-size: 12px; color: #ffffff; line-height: 19px; height: 24px; width: 200px; left:769px; top:291px;  padding-right: 90px; cursor: pointer;position: absolute; border: 0;" onclick="closeTutorial();" title="튜토리얼 종료">튜토리얼 종료</button>
		 		<!-- mng_e 20210616 이진호 -->
		 		<!-- mng_e 20180411_김건민 -->
			</div>
		</div>
