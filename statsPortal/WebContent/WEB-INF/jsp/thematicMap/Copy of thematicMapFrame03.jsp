...
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    				...
		    				<li id="region_boundary">		
		    					<span>지역경계</span>
		    					<a href="javascript:$thematicMapFrame03.Popup.show(); setTimeout(function() {$thematicMapFrame03.ui.mapList[0].changeRegionBound()}, 1000);" class="first" id="autoRegion">자동</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show(); setTimeout(function() {$thematicMapFrame03.ui.mapList[0].changeRegionBound()}, 1000);" id="sido" style="width:90px;">시도별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show(); setTimeout(function() {$thematicMapFrame03.ui.mapList[0].changeRegionBound()}, 1000);" id="sigungu" style="width:100px;">시군구별 전국지도</a>
		    					<a href="javascript:$thematicMapFrame03.Popup.show(); setTimeout(function() {$thematicMapFrame03.ui.mapList[0].changeRegionBound()}, 1000);" id="eupmyundong" class="last" style="width:100px;">읍면동별 전국지도</a>
...
<!-- 		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" data-subj="버블지도" title="버블지도버블지도버블지도" class="last" id="bubble">버블</a> -->
		    					...
		    					<a href="javascript:$thematicMapFrame03.ui.changeDataMode()" class="last" id="bubble">버블</a>
