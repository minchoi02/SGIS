...
<!-- 							<a href="javascript:$thematicMapFrame15.ui.mapList[0].mapNavigation.getLocation();" class="interactiveIco"><img src="/img/ico/ico_gps01.gif" alt="위치검색" /></a>  -->
							...
							<div class="tb_right"> 
								...
								<ul class="tbr01">
									<!--20년수정반영 시작 (1)~(4)-->
									<li><a onclick="javascript:$thematicMapFrame15.ui.doMaxSize();" id="fullScreen" style="cursor: pointer;" title="전체 화면 확대" ><img src="/img/ico/ico_toolbars01.png" alt="전체 화면 확대" /></a></li><!--(1)-->   
									<!-- <li><a onclick="javascript:$thematicMapFrame15.ui.doClearMap(1);" style="cursor:pointer;" title="초기화"><img src="/img/ico/ico_toolbars02.png" alt="초기화"></a></li> --><!--(2)-->
									<li><a onclick="javascript:$thematicMapFrame15.ui.doShare(1);" class="tb_share" style="cursor:pointer;" title="URL 공유하기" ><img src="/img/ico/ico_toolbars04.png" alt="URL 공유하기"/></a></li><!--(3)-->
									<li><a onclick="javascript:$thematicMapFrame15.ui.mapImageDown();" style="cursor:pointer;" title="지도 이미지 다운로드"><img src="/img/ico/ico_toolbars13.png" alt="지도 이미지 다운로드" /></a></li>
									...
									<li><a onclick="javascript:$thematicMapFrame15.ui.reportDataSet(1); javascript:srvLogWrite('B0','03','09','00',$('.helperText span').text(),'');" style="cursor:pointer;" title="보고서 보기"><img src="/img/ico/ico_toolbars09.png" alt="보고서 보기" /></a></li>
...
<!-- 				    	</div> -->
						...
						<div id="dataBoard" >
							...
							<div class="dataSideBox" style="width:400px;height:500px;">
								<div class="bar">
									<div style="position:relative;width:50px;float:left;left:240px;top:2px;"><a onclick="javascript:$thematicMapFrame15.ui.chartImageDown();" style="cursor:pointer;" title="데이터보드 이미지 다운로드"><img src="/img/ico/ico_toolbars13.png" alt="데이터보드 이미지 다운로드" /></a></div>
									<div id="dataSlider" class="dataSlider"></div>
...
<!-- 				    		<div id="general_cnt"  style="position:absolute; left:35%;transform:translateX(-50%); top:50%;transform:translateY(-50%);z-index:1002;height:340px;width:500px;display:none;"></div> -->
				    		<div id="general_cnt"  style="position:absolute; left:35%;transform:translateX(-50%); top:45%;transform:translateY(-50%);z-index:1002;height:533px;width:500px;display:none;"></div>
				    	</div>
		    		...
		    		<!-- mng_e 2019. 11. 21 j.h.Seok 이용자 중심 서비스 개편 - 상하위 10개 표출 -->
		    			...
		    			<ul>
		    				...
		    				<li id="change_stat_thema">
		    					<span>지표선택</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('left', true);" class="first" id="change_stat_thema_left">ON</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('middle', true);" id="change_stat_thema_middle">OFF</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('middle1', true);" id="change_stat_thema_middle1" style="display: none;">OFF</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('middle2', true);" id="change_stat_thema_middle2" style="display: none;">OFF</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('middle3', true);" id="change_stat_thema_middle3" style="display: none;">OFF</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].changeStatThemaId('right', true);" class="last" id="change_stat_thema_right">OFF</a>
		    				</li>
		    				...
		    				<li id="stat_sel">
		    					<span>통계선택</span>
<!-- 		    					<a href="javascript:$thematicMapFrame15.ui.changeLeftRightValue()" class="first" id="leftValue">증감틀</a> -->
<!-- 		    					<a href="javascript:$thematicMapFrame15.ui.changeLeftRightValue()" class="last" id="rightValue">CAGR</a> -->
		    					<input type="hidden" id="selectValue" value=""/>
		    				</li>
							<!-- 코로나추가 20200722 주용민	-->
		    				<li id="covid_type" style="display: none;">
		    					<span>세부선택</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].covid();" class="first" id="covid0" style="width:25px;">전체</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].covid();"  id="covid1" style="width:60px;">국민안심병원</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].covid();" id="covid2" style="width:70px;">승차검진진료소</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].covid();" id="covid3" class="last">선별진료소</a>
		    				</li>
							<!-- 코로나추가 20200722 주용민	-->
		    				...
		    				<li id="cancer_list" style="display: none;">
		    					<span>유형선택</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');" class="first" id="cancer0"  style="width:45px;" title="5대 암을 포함한 전체 암 통계">전체 암</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');"  id="cancer1" style="width:33px;">폐암</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');" id="cancer2" style="width:33px;">위암</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');" id="cancer3" style="width:33px;">간암</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');" id="cancer4" style="width:40px;">대장암</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('cancer_data','00');" id="cancer5" class="last" style="width:40px;">유방암</a>
		    				</li>
							<!--  암발생현황 추가 -->
		    				...
		    				<li id="infection_list" style="display: none;">
		    					<span>그룹선택</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('infection_data','00');" class="first" id="infection1" >제1군</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('infection_data','00');" id="cancer2" >제2군</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('infection_data','00');" id="cancer3" >제3군</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].getThemaMapData('infection_data','00');" id="cancer4" class="last">제4군</a>
		    				</li>
							<!--  감염병 발생현황 추가 -->
		    				...
		    				<li id="region_boundary">		
		    					<span>지역경계</span>
		    					<a onclick="javascript:srvLogWrite('B0','03','04','01',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame15.Popup.show();$thematicMapFrame15.ui.mapList[0].changeRegionBound()" class="first" id="autoRegion">자동</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','04','02',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame15.Popup.show();$thematicMapFrame15.ui.mapList[0].changeRegionBound()" id="sido" >시도</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','04','03',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame15.Popup.show();$thematicMapFrame15.ui.mapList[0].changeRegionBound()" id="sigungu" >시군구</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','04','04',$('.helperText span').text(),'');" href="javascript:$thematicMapFrame15.Popup.show();$thematicMapFrame15.ui.mapList[0].changeRegionBound()" id="eupmyundong" class="last" >읍면동</a>
		    				...
		    				<li id="top_bottom_li" style="display: none;">  <!-- style="display: none;" -->
		    					<span>선택보기</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].showTopBottomDataOnly('ON', false);" class="first" id="top_bottom_on">ON</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].showTopBottomDataOnly('OFF', false);" class="last" id="top_bottom_off">OFF</a>
		    				</li>
		    				
		    				<li id="top_bottom_type" style="display: none;">
		    					<span>&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;</span>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].setTopBottomType('top');" class="first" id="top_bottom_type_top">상위</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].setTopBottomType('both');" id="top_bottom_type_both">상/하위</a>
		    					<a href="javascript:$thematicMapFrame15.ui.mapList[0].setTopBottomType('bottom');" class="last" id="top_bottom_type_bottom">하위</a>
		    				</li>
		    				
		    				<li id="top_bottom_select" style="display: none;">
		    					<span>&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;</span>
		    					<select id="top_bottom_select_count" onchange="javascript:$thematicMapFrame15.ui.mapList[0].setTopBottomCount(this.value);">
		    				...
		    				<li id="map_type">
		    					<span>지도유형</span>
		    					<a onclick="javascript:srvLogWrite('B0','03','05','01',$('.helperText span').text(),'');$('.thematicTopText').show();" href="javascript:$thematicMapFrame15.ui.changeDataMode();" class="first" id="color">색상</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','05','02',$('.helperText span').text(),'');$('.thematicTopText').hide();" href="javascript:$thematicMapFrame15.ui.changeDataMode();" class="last" id="bubble">버블</a>
		    					<input type="hidden" id="dataMode" value="color"/>
		    					<input type="hidden" id="pieChartFlag" value="off"/>
		    				</li> 
		    				<li id="data_type">
		    					<span>통계표출</span>
		    					<a onclick="javascript:srvLogWrite('B0','03','06','00',$('.helperText span').text(),'ON');" href="javascript:$thematicMapFrame15.ui.changeDataMode2()" class="first">ON</a>
		    					<a onclick="javascript:srvLogWrite('B0','03','06','00',$('.helperText span').text(),'OFF');" href="javascript:$thematicMapFrame15.ui.changeDataMode2()" class="last" id="default_switch">OFF</a>
		    					<input type="hidden" id="dataMode2" value="dataOff"/>
		    				</li>
		    				<!-- 2016.07.11 시계열 추가  -->
		    				<li id="timeSeries_type" style="display: none;">
		    					<span>시계열조회</span>
		    					<a href="javascript:$thematicMapFrame15.Popup.show();javascript:$thematicMapFrame15.ui.timeSeriesPlay(true)" title="ON 클릭 시 로딩하는데 시간이 오래걸림" class="first" style="margin-left:-12px;">ON</a>
		    					<a href="javascript:$thematicMapFrame15.ui.timeSeriesPlay(false)" class="last on" id="timeSeries_off">OFF</a>
					...
					<div class="quickBox step01">
						...
						<div class="normalBox">
							...
							<ol class="stat-infor">
		                        ...
		                        <li><a onclick="javascript:$thematicMapFrame15.ui.reportDataSet(1);" style="cursor:pointer;">보고서 보기</a></li>
		                        <li><a href="${pageContext.request.contextPath}/view/newhelp/su_help_10_0" target="_top">도움말 보기</a></li>
		                        <li><a href="javascript:$thematicMapFrame15.ui.doMaxSize();" id="fullScreen">전체 화면 확대</a></li>  
							</ol>
...
<!-- 							<a href="javascript:void(0)"></a> -->
		...
		<!-- 공유팝업  -->
		    	<div id="sharedlg" class="galleryPopBox" style="display:none; z-index:20001;">
					<div class="topbar">
						...
						<a onclick="javascript:$thematicMapFrame15.ui.doCancel('sharedlg');">닫기</a>
					</div>
					<div class="popContents">
								...
								<div style="width:100%;margin:auto 0">
									<table style="margin:auto;width:270px;height:30px;margin-top:10px" summary="URL공유하기 SNS 목록">
										<tr style="height:30px;line-height:1px;">
											<td valign="middle">
												<a href="javascript:$thematicMapFrame15.ui.shareToKakaoStory();" style="margin-left:10px;"><img src="/img/im/kakao.png" alt="카카오스토리"></a>
											</td>
											<td valign="middle">
						...
						<div class="btnBox">
							<a onclick="javascript:$thematicMapFrame15.ui.doDone('sharedlg');" class="btnStyle01">URL 복사하기</a>
							<a onclick="javascript:$thematicMapFrame15.ui.doCancel('sharedlg');" class="btnStyle01">닫기</a>
						</div>
					</div>
				</div>
		<!--20년수정반영 끝 (공유팝업)-->
		...
		<div id="bookmarkdlg" class="popBox" style="display: none; z-index: 20001;">
			<div class="topbar">
				...
				<a onclick="javascript:$thematicMapFrame15.ui.doCancel('bookmarkdlg');">닫기</a>
			</div>
			<div class="popContents">
				<ul class="listFormPop">
					<li>
				...
				<div class="btnBox">
					<a onclick="javascript:$thematicMapFrame15.ui.doDone('bookmarkdlg');" class="btnStyle01">My Page 저장</a> 
					<a onclick="javascript:$thematicMapFrame15.ui.doCancel('bookmarkdlg');" class="btnStyle01">닫기</a>
				</div>
		 	</div>
	    </div>
		...
		<div id="myGalleryPop" style="display: none; z-index: 20000;" class="popBox">
			...
			<div class="popContents">
				...
				<div class="btnBox">
					...
					<a href="javascript:$thematicMapFrame15.ui.doBookMark(1, 'THEME');" class="btnGtype">즐겨찾기</a> 
