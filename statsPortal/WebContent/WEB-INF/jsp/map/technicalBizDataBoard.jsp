		...
		<div class="dataSideScroll">
				...
				<dl class="dscList">
					...
					<dd>
						...
						<div class="dbTabs inType" id="sidoFeatureDetailBtn">
							<!-- mng_s 20190402 김건민 -->
   							<a href="javascript:srvLogWrite('G2', '08', '04', '01', '업종별 특성 현황/수', '');$technicalBizDataBoard.ui.changeSidoFeatureChart(1);" class="on">수</a>
   							<a href="javascript:srvLogWrite('G2', '08', '04', '02', '업종별 특성 현황/증감', '');$technicalBizDataBoard.ui.changeSidoFeatureChart(2);" class="">증감</a>
   							<!-- mng_e 20190402 김건민 -->
						</div>
						<!-- 2017.08.24 개발팀 수정 완료-->
						...
						<div class="chartAreaRela sidoFeatureChartArea" id="sidoFeatureChartArea03" style="display:none;">
							<div class="compareBox">
								<div class="typeBox" style="margin-left:260px;">
									<a onclick="javascript:srvLogWrite('G2', '08', '04', '03', '업종별 입지계수 현황/차트', '');$technicalBizDataBoard.ui.changeShowChartTable('sidoFeatureChart03','1');" class="first on">차트</a>
									<a onclick="javascript:srvLogWrite('G2', '08', '04', '04', '업종별 입지계수 현황/표', '');$technicalBizDataBoard.ui.changeShowChartTable('sidoFeatureChart03','2');">표</a>
								</div>
					...
					<dd>
						...
						<div class="dbTabs type01" id="ChangeEconomyChart">
							<a href="javascript:srvLogWrite('G2', '08', '04', '05', '', '매출액');$technicalBizDataBoard.ui.changeSidoEconomyChart('sales', 0)" class="on">매출액</a>
							<a href="javascript:srvLogWrite('G2', '08', '04', '05', '', '인건비');$technicalBizDataBoard.ui.changeSidoEconomyChart('lbcst', 0)">인건비</a>
							<a href="javascript:srvLogWrite('G2', '08', '04', '05', '', '임차료');$technicalBizDataBoard.ui.changeSidoEconomyChart('rntchrg', 0)">임차료</a> 
							<a href="javascript:srvLogWrite('G2', '08', '04', '05', '', '영업이익');$technicalBizDataBoard.ui.changeSidoEconomyChart('business_profit', 0)">영업이익</a>
						</div>
						<!-- 2017.08.24 개발팀 수정 종료-->
						<!-- 2021-05-17 김건민 사업체 2019년으로 수정함. -->
						...
						<div class="chartAreaRela sidoEconomyChartArea" id="sidoEconomyChartArea00">
							...
							<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청,전국사업체조사(2019), 통계청,경제총조사(2015)</p> <!-- 2018.01.09 [개발팀]-->
						</div>
   				...
   				<dl class="dscList"> 
    				...
    				<dd>
    					...
    					<div class="dbTabs" id="sigunguDbTabs">
					    	<a href="javascript:srvLogWrite('G2', '09', '06', '03', '', '업종별 비율 현황');$technicalBizDataBoard.ui.changeSigunguFeatureChart(1);" class="on">업종별 비율 현황</a>
					    	<a href="javascript:srvLogWrite('G2', '09', '06', '03', '', '업종별 입지계수 현황');$technicalBizDataBoard.ui.changeSigunguFeatureChart(2);">업종별 입지계수 현황</a> 
					    </div>
					    <!-- 2017.09.11 개발팀 수정 종료 -->
					    <!-- 업종별 비율 현황 탭 -->
    							...
    							<div class="compareBox">
    								...
    								<div class="noneAreaBox">
	    								<div class="dbTabs dbTabs2">
	    									<!-- mng_s 2019042 김건민 -->
	    									<a href="javascript:srvLogWrite('G2', '09', '06', '10', '입지계수/전국 대비', '');$technicalBizDataBoard.ui.changeSigunguLctChart('country')" class="on">전국 대비</a>
	    									<a href="javascript:srvLogWrite('G2', '09', '06', '10', '입지계수/시도 대비', '');$technicalBizDataBoard.ui.changeSigunguLctChart('sido');">시도 대비</a>
	    									<!-- mng_e 2019042 김건민 -->
	    								</div>
			    					</div>
			    					<div class="typeBox" style="position:absolute;top:2px;left:260px">
										<a onclick="javascript:srvLogWrite('G2', '09', '06', '04', '', '차트');$technicalBizDataBoard.ui.changeShowChartTable('sigunguLctChart','1');" class="first on">차트</a>
										<a onclick="javascript:srvLogWrite('G2', '09', '06', '04', '', '표');$technicalBizDataBoard.ui.changeShowChartTable('sigunguLctChart','2');">표</a>
									</div>
    					...
    					<dt class="t01 mt15" id="techRank_corp_cnt" title="해당 업종의 사업체 수">
						...
						<dt class="t01 mt15" id="techRank_corp_per" title="상위지역 대비 해당 업종의 비율">
    					...
    					<dt class="t01 mt15" id="techRank_resid_ppltn_cnt" title="해당 업종의 수 대비 거주인구">
    					...
    					<dt class="t01 mt15" id="techRank_worker_cnt" title="해당 업종의 종사자 수">
    					...
    					<dt class="t01 mt15" id="techRank_avg_worker_cnt" title="해당 업종의 수 대비 종사자 수">
			...
			<div class="dataBoardDiv" id="technicalLqDiv">
				<div class="areaBox" id="technicalLqDivAreaBox" data-name="sido" data-admcd="00" data-classCd="11">adm_nm <span>dateYear</span></div>
					<button id="technicalLqPrevButton" class="MapBefore" onclick="javascript:srvLogWrite('G2', '11', '08', '01', '', '이전 레벨 가기');$technicalBizMap.ui.doPrevRegionInfo('lq');" style="display:none;"></button>
					<dl class="dscList" id="lqIncreaseTab" style="display:none;">
						...
						<dd>
							<div class="dbTabs" id="technicalYearDbTabs">
					    		<a id="technicalYearDbTab_11" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '첨단기술');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(11)" class="c01 on" data-name="11">첨단기술</a>
					    		<a id="technicalYearDbTab_12" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '고기술');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(12)" class="c02" data-name="12">고기술</a>
					    		<a id="technicalYearDbTab_13" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '중기술');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(13)" class="c03" data-name="13">중기술</a>
					    		<a id="technicalYearDbTab_14" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '저기술');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(14)" class="c04" data-name="14">저기술</a>
					    		<a id="technicalYearDbTab_21" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '창의 및 디지털');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(21)" class="c05" data-name="21">창의 및 디지털</a>
					    		<a id="technicalYearDbTab_22" href="javascript:srvLogWrite('G2', '11', '08', '02', '', 'ICT');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(22)" class="c06" data-name="22" style="color:#fff;">ICT</a>
					    		<a id="technicalYearDbTab_23" href="javascript:srvLogWrite('G2', '11', '08', '02', '', '전문서비스');$technicalBizDataBoard.ui.changeLqInfoYearDataBoardGrid(23)" class="c07" data-name="23" style="color:#fff;">전문서비스</a>  
					    	</div>
					...
					<dl class="dscList">
					    ...
					    <div class="dbTabs" id="technicalDbTabs">
					    	...
					    	<a id="technicalDbTab_22" href="javascript:$technicalBizDataBoard.ui.changeLqInfo(22)" class="c06" data-name="22" style="color:#fff;">ICT</a>
					    	<a id="technicalDbTab_23" href="javascript:$technicalBizDataBoard.ui.changeLqInfo(23)" class="c07" data-name="23" style="color:#fff;">전문서비스</a>  
					    </div>
					    <!-- 2017.12.01 개발팀 수정 기술업종 코드 변경 -->
				  		...
				  		<div class="chartAreaRela" id="lqInfoChartRela">
				  			<div class="compareBox">
				  				...
				  				<div class="noneAreaBox" id="lqInfoChartStandard"> <!-- 2018.01.15 [개발팀] -->
									<div class="dbTabs dbTabs2" id="lqInfoChartStandardButton">
						    			<a href="javascript:srvLogWrite('G2', '11', '08', '05', '', '전국 대비');void(0)" class="on">전국 대비</a>
						    			<a href="javascript:void(0)">경기도 대비</a> 
						    		</div>
								</div>
						
				  				<div class="typeBox" style="position:absolute;top:2px;left:260px" id="lqInfoTypeBox"> <!-- 2018.01.15 [개발팀] -->
										<a onclick="javascript:srvLogWrite('G2', '11', '08', '03', '', '업종별 지역 특성 정보 차트');$technicalBizDataBoard.ui.changeShowChartTable('lqInfoLctChart','1');" class="first on">차트</a>
										<a onclick="javascript:srvLogWrite('G2', '11', '08', '04', '', '업종별 지역 특성 정보 표');$technicalBizDataBoard.ui.changeShowChartTable('lqInfoLctChart','2');">표</a>
								</div>
			    		...
			    		<div class="ltListBox" style="margin-bottom:15px;"> <!-- 2018..01.02 [개발팀] -->
				   		...
				   		<div class="censusTabs" >
							<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(9 , this , 2);"  data-value="9">9차</a>
					    	<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(10, this , 2);"  data-value="10" class="on">10차</a>
						</div>
						<div class="sensus9 lqInfoYearCensusTabs">
					   		<ul class="ysettingList" id="lqInfoYearSettingList">
					   			<li id="lqInfoYear_2006"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2006')" data-year="2006">2006</a></li>
					   			<li id="lqInfoYear_2007"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2007')" data-year="2007">2007</a></li>
					   			<li id="lqInfoYear_2008"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2008')" data-year="2008">2008</a></li>
					   			<li id="lqInfoYear_2009"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2009')" data-year="2009">2009</a></li>
					   			<li id="lqInfoYear_2010"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2010')" data-year="2010">2010</a></li>
					   			<li id="lqInfoYear_2011"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2011')" data-year="2011">2011</a></li>
					   			<li id="lqInfoYear_2012"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2012')" data-year="2012">2012</a></li>
					   			<li id="lqInfoYear_2013"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2013')" data-year="2013">2013</a></li>
					   			<li id="lqInfoYear_2014"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2014')" data-year="2014">2014</a></li>
					   			<li id="lqInfoYear_2015"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2015')" data-year="2015">2015</a></li>
					   			<li id="lqInfoYear_2016"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2016')" data-year="2016" >2016</a></li>
					   		</ul>
					   	</div>
					   	<div class="sensus10 lqInfoYearCensusTabs"  style="display: none">
    						<ul  class="ysettingList" id="lqInfoYearSettingList2">
	    						<li id="lqInfoYear_9016"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('9016');void(0);" data-year="9016">2016</a></li>
		    					<li id="lqInfoYear_2017"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2017');void(0);" data-year="2017">2017</a></li>
		    					<li id="lqInfoYear_2018"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2018');void(0);" data-year="2018">2018</a></li>
		    					<li id="lqInfoYear_2019"><a href="javascript:$technicalBizDataBoard.ui.changeLqInfoYearDataBoard('2019');void(0);" data-year="2019" class="on">2019</a></li> <!-- 2021-05-17 김건민 사업체 2019년도 추가 -->
		    				</ul>
    					</div>
				...
				<dl class="dscList"> 
					...
					<dd>
						<div class="dbTabs type01" id="techbizSearchTabList" style="height : 35px;">
					    	<a href="javascript:srvLogWrite('G2', '12', '03', '01', '', '검색지역 리스트');$technicalBizDataBoard.ui.initSearchGridTechBizSggGridInfo()" class="on">검색지역 리스트</a>
					    	<a href="javascript:srvLogWrite('G2', '12', '03', '02', '', '사업체 입지계수');$technicalBizDataBoard.ui.initSearchGridTechBizCorpGraph()">사업체 <br>입지계수</a>
					    	<a href="javascript:srvLogWrite('G2', '12', '03', '03', '', '종사자 입지계수');$technicalBizDataBoard.ui.initSearchGridTechBizWorkerGraph()">종사자<br>입지계수</a>
					    	<a href="javascript:srvLogWrite('G2', '12', '03', '04', '', '창업지원시설');$technicalBizDataBoard.ui.initSearchGridSupplyInfo()">창업지원시설</a>
					    	<a href="javascript:srvLogWrite('G2', '12', '03', '05', '', '신업단지');$technicalBizDataBoard.ui.initSearchGridIndustry()">산업단지</a> 
						</div>
					    <div class="chartAreaRela full cellType">  
					    	<div class="carRight">
					    ...
					    <div class="dbTabs">
					    	...
					    	<a href="javascript:$technicalBizDataBoard.ui.searchTabBoxChange(5);" class="c06" style="color:#fff;">ICT</a>
					    	<a href="javascript:$technicalBizDataBoard.ui.searchTabBoxChange(6);" class="c07" style="color:#fff;">서</a>  
					    </div> 
			...
			<div class="dataBoardDiv" id="technicalSearchDetail">
				...
				<dl class="dscList">
    				...
    				<dd>
    					...
    					<div class="dbTabs mt20 dbTabs3"><!--2019-03-13 박길섭 -->
    					...
    					<div class="chartAreaRela searchDetailStatsInfoChart" id="searchDetailStatsInfo01Div">
    						...
    						<p class="etcRight05" style="margin-top:40px; margin-left:-10px;">출처 : 통계청,전국사업체조사(2019)</p> <!-- 2018.01.09 [개발팀]-->
    					</div>   
						<div class="chartAreaType02 t01 mt20 searchDetailStatsInfoChart" id="searchDetailStatsInfoChart02Div" style="height: auto;">
							...
							<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청,전국사업체조사(2019)</p> <!-- 2018.01.09 [개발팀]-->
						</div>
				...
				<div class="areaBox" id="densityAdmTitle">
   				...
   				<dl class="dscList"> 
    				...
    				<dd> 
    					...
    					<!-- 2019-04-21 djle 수정 시작 -->
    					<div class="censusTabs" >
							<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(9, this , 1);" >9차</a>
					    	<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(10, this , 1);"  class="on">10차</a>
						</div>
						<div class="sensus9">
	    					<ul id="densityBaseYearList" class="ysettingList">
	    						...
	    						<li><a id="densityBaseYear_2016" href="javascript:$technicalBizDataBoard.ui.changeDensityBaseYear('2016');void(0);" >2016</a></li>
	    					</ul>
	    					<ul id="newCorpBaseYearList" class="ysettingList" style="display:none;">
	    						...
	    						<li><a id="newCorpBaseYear_2015" href="javascript:$technicalBizDataBoard.ui.changeDensityNewCorp('2015');void(0);" >2015</a></li>
	    						<li><a id="newCorpBaseYear_2016" href="javascript:$technicalBizDataBoard.ui.changeDensityNewCorp('2016');void(0);" >2016</a></li>
	    					</ul>
							<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청,전국사업체조사(2006 ~ 2016)</p><!-- 2019-04-23 djlee 수정 -->
    					</div>
    					<div class="sensus10" style="display: none;">
    						<ul  class="ysettingList">
	    						<li><a id="densityBaseYear_9016"  href="javascript:$technicalBizDataBoard.ui.changeDensityBaseYear('9016');void(0);" >2016</a></li>
		    					<li><a id="densityBaseYear_2017" href="javascript:$technicalBizDataBoard.ui.changeDensityBaseYear('2017');void(0);"  >2017</a></li>
		    					<li><a id="densityBaseYear_2018" href="javascript:$technicalBizDataBoard.ui.changeDensityBaseYear('2018');void(0);"  >2018</a></li>
		    					<li><a id="densityBaseYear_2019" href="javascript:$technicalBizDataBoard.ui.changeDensityBaseYear('2019');void(0);" class="on">2019</a></li>
		    				</ul>
							<!-- 2019-04-21 djle 수정 끝 -->
    						<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청,전국사업체조사(2019)</p><!-- 2019-04-23 djlee 수정 -->
    					</div>
			...
			<div class="dataBoardDiv" id="supplyDiv">
				<div class="areaBox">전국 시도별 현황</div>
   				<div class="dscList"> 
    				<div>
    					<div class="dbTabs">
    						<a id="changeSupplyTabBtn01" href="javascript:srvLogWrite('G2', '13', '07', '01', '', '지역통계 현황');$technicalBizDataBoard.ui.changeSupplyTab('1')" class="on">지역통계 현황</a>
    						<a id="changeSupplyTabBtn02" href="javascript:srvLogWrite('G2', '13', '07', '02', '', '창업지원시설 현황');$technicalBizDataBoard.ui.changeSupplyTab('2')">창업지원시설 현황</a>  
    					</div>
    					...
    					<div class="chartAreaRela full startUpSupplyDiv" style="display: none;">      					
    						...
    						<!-- 20220225 김건민 (출처정보 수정함.) -->
							<p class="etcRight05" style="margin-left:-10px;">출처: 중소벤처기업부 벤처창업입지114</p>
    					</div>		
   				...
   				<dl class="dscList"> 
    				...
    				<dd>
    					...
    					<div class="chartAreaRela supplyAreaSynthesizeStatsInfoChart" id="supplyAreaSynthesizeStatsInfoChart01Div">
    						...
    						<p class="etcRight05" style="margin-top:40px; margin-left:-10px;">출처 : 통계청,전국사업체조사(2019)</p> <!-- 2018.01.09 [개발팀]--><!-- 2019-04-23 djlee 수정 -->
    					</div>   
						<div class="chartAreaType02 t01 mt20 supplyAreaSynthesizeStatsInfoChart" id="supplyAreaSynthesizeStatsInfoChart02Div" style="height: auto;">
							...
							<div class="typelabel" style="height: auto;"></div>
							<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청,전국사업체조사(2019)</p> <!-- 2018.01.09 [개발팀]--><!-- 2019-04-23 djlee 수정 -->
						</div>
						<div class="chartAreaRela supplyAreaSynthesizeStatsInfoChart" id="supplyAreaSynthesizeStatsInfoChart03Div">
							...
							<div class="censusTabs chart" >
								<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(9 , this , 3);" data-value="9">9차</a>
						    	<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(10, this , 3);" data-value="10" class="on" >10차</a>
							</div>
    						...
    						<div class="chartAreaRela">
    							<div class="compareBox">
    								...
    								<div class="noneAreaBox" id="supplyLqInfoChartStandard" style="display:none;">
										<div class="dbTabs dbTabs2" id="supplyLqInfoChartStandardButton">
							    			<a href="javascript:void(0)" class="on">전국 대비</a>
							    			<a href="javascript:void(0)">경기도 대비</a> 
							    		</div>
									</div>
    				...
    				<dd>
    					...
    					<p class="horizontalTitle mt20 startUpSupplyListsTitle">
  							...
  							<p class="etcRight05" id="techListOrigin" style="margin-left:-10px;">출처 : 중소기업청, 벤처창업입지 114</p>
  							<!-- 2017.09.28 개발팀 수정 종료 -->
			...
			<div class="dataBoardDiv" id="industryDiv">
				<div class="areaBox">전국 시도별 현황</div>
   				<dl class="dscList"> 
    				<dt class="mt15 botype">
    					<a href="javascript:void(0)" class="industySidoDataboardTitle" style="border-radius:10px;">기술업종 사업체 수 / 산업단지 수  현황</a>
    				</dt> 
    				<dd>
    					<div class="chartAreaRela">
    						<div class="carLeft">
    						...
    						<p class="etcRight05" style="margin-left:-10px;">출처 : 통계청, 전국사업체조사(2019)</p>
    						<p class="etcRight05" style="margin-left:-10px;">출처 : 국토교통부, 산업단지현황(2015)</p>
    						<p class="etcRight05" style="margin-left:-10px;">출처 : 한국산업단지공단, 한국산업단지총람(2015)</p>
    					</div>
	    			</dd>
    			</dl>
			</div>
	   				...
	   				<div class="industryDetailStep01">
	    				...
	    				<dd>
	    					...
	    					<div class="chartAreaRela industryAreaSynthesizeStatsInfoChart" id="industryAreaSynthesizeStatsInfoChart01Div">
	    						...
	    						<p class="etcRight05" style="margin-top:40px; margin-left:-10px;">출처 : 통계청, 전국사업체조사(2019)</p>
	    					</div>   
							...
							<div class="chartAreaRela industryAreaSynthesizeStatsInfoChart" id="industryAreaSynthesizeStatsInfoChart03Div">
								<!-- 2019-04-14 djlee 수정 시작 -->
								<div class="censusTabs chart" >
									<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(9 , this , 4);" data-value="9">9차</a>
							    	<a href="javascript:void(0)" onclick="javascript:$technicalBizDataBoard.event.sensusCheck(10, this , 4);" data-value="10" class="on" >10차</a>
								</div>
								<!-- 2019-04-14 djlee 수정 끝 -->
	    						<p class="etcText05 mt30"></p>
								...
								<div class="chartAreaRela">
									<div class="compareBox">
    									...
    									<div class="noneAreaBox" id="industryLqInfoChartStandard" style="display:none;">
											<div class="dbTabs dbTabs2" id="industryLqInfoChartStandardButton">
								    			<a href="javascript:void(0)" class="on">전국 대비</a>
								    			<a href="javascript:void(0)">경기도 대비</a> 
								    		</div>
										</div>
	    				...
	    				<dd>
	    					...
	    					<p class="horizontalTitle mt20 industryListsTitle">
								<span>해당 지역 전체 산업단지 개수 :</span> <strong>0</strong><span>개</span>
	  							...
	  							<p class="etcRight05" id="industryOrigin1" style="margin-left:-10px;">출처 : 국토교통부,산업단지현황(2015)</p>
	  							<p class="etcRight05" id="industryOrigin2" style="margin-left:-10px;">출처 : 한국산업단지공단,한국산업단지총람(2015)</p>
						...
						<dd>
							<div id="industryAreaSynthesizeStatsDetailInfoChart04Div" data-index="" data-page="">
								...
								<div class="chartAreaRela">
									<div class="compareBox">
										<div class="noneAreaBox">
	    									<div class="dbTabs dbTabs2" id="industryLctDetailStandard">
	    										<a href="javascript:$technicalBizDataBoard.ui.industryLctDetailChartStandardChange(0)" class="on">전국 대비</a>
	    										<a href="javascript:$technicalBizDataBoard.ui.industryLctDetailChartStandardChange(1)">시도 대비</a> 
											</div> 
										</div>	
					...
					<div class="industryDetailStep02" style="display:none;">
						...
						<dd>
	    					...
	    					<div class="chartAreaRela t01">
	    						...
	    						<p class="etcRight05" id="industryTimeseriesOrigin" style="margin-left:-10px;"></p>
	    					</div> 
	    				</dd>
	    				<!-- 산업단지 내 분포현황 -->
						<dt class="mt15">
