	            ...
	            <div id="content">
	                <div id="title-area">
						...
						<!-- 190313 방민정 수정 시작 -->
							...
							<li><a href="/contents/shortcut/shortcut_05.jsp"><em>자료제공 목록</em></a></li>
						<!-- 190313 방민정 수정 끝 -->
	                    </ul>
	                    ...
	                    <div class="header-infor">
	                        ...
	                        <table class="table-style type01">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    <td class="first">격자경계별 통계(사업체)</td>
	                                    <td>2019,2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003, 2002, 2001, 2000</td>
	                                    <td>txt</td>
	                                    <td>공개</td>
	                                    <td>전국</td>
