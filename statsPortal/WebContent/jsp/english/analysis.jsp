		...
		<div id="container">
			...
			<div id="contents">
				<ul class="location">
					...
					<li><a href=/jsp/english/analysis.jsp>Map Analysis</a></li>
				</ul>
				<div id="content_2">
					<!-- 게시판 전체 영역// -->
					<div id="article-wrap">
							...
							<div class="article-list">
								<div id="content">
									<div class="pl20 pr20">
										...
										<a href="https://sgis.kostat.go.kr/funny_month/month/sta_month_main.do"><img src="/jsp/english/img/btn_service.png" alt="서비스 바로가기" /></a><hr>
										...
										<a href="https://sgis.kostat.go.kr/publicsmodel/"><img src="/jsp/english/img/btn_service.png" alt="서비스 바로가기" /></a><hr>
										<h4 class="itit">Service Overview</h4>
										<p class="para mb25">
										...
										<h4 class="itit">Screen Layout</h4>
										<p><img src="/img/newhelp/Ol_010_01.png" alt="고령화 현황보기 안내" style="width:850px;"/></p>
										<p class="para mb25">
