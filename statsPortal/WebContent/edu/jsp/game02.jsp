...
// 		}
	...
	function initGame(){
		...
		quizList.push({ OX : "O", title : "통계갤러리", 		quiz : "여러 서비스에서 조회한 통계정보를 사용자가 갤러리로 등록할 수 있다" });
		quizList.push({ OX : "X", title : "통계갤러리", 		quiz : "다른 사용자가 등록한 갤러리는 조회만 가능하다" });
		...
		quizList.push({ OX : "O", title : "고령화 현황보기", 	quiz : "지역 간 고령화 비교, 추세분석의 고령화 관련 통계정보를 제공한다" });
		quizList.push({ OX : "X", title : "고령화 현황보기", 	quiz : "전국 단위로 복지시설 통계를 확인할 수 있다" });
