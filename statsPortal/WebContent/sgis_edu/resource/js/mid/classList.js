(function(W, D) {
	...
	$(document).ready(function() {
		srvLogWrite('T0','02','03','01','M','thema_id='+contents.themaId);
		...
		makeContentsList : function () {
			...
			$.ajax({
				...
				$.each(res.result.resultList, function(i, val){
					html += "<li><a href='/view/edu/mid/classDetail?contents_id="+val.contents_id+"'>";
			...
			$.ajax({
				...
				$.each(res.result.resultList, function(i, val){
					if( val.thema_id == contents.themaId ){
						html += "<li><a class='"+val.thema_id+" on' href='/view/edu/mid/classList?thema_id="+val.thema_id+"'>"+val.thema_nm+"</a></li>";
						$(".contTi").text(val.thema_nm);
					}else {
						html += "<li><a class='"+val.thema_id+"' href='/view/edu/mid/classList?thema_id="+val.thema_id+"'>"+val.thema_nm+"</a></li>";
					}
				});
				$("#menuList").html(html);
