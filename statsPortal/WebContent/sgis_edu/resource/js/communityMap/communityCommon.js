...
(function(W, D) {
	...
	$(document).ready(function(){
		if( getParameter("type") === "full" ){
			$("header").css("display","none").hide();
			$("#container").css({"height":"100%", "top":"0px"});
			
			if( getParameter("footer") === "none" ){
				$("footer").css("display", "none").hide();
			}
			
			if( getParameter("lm") === "none" ){
				$("header .util").css("display", "none").hide();
			}
		}
	});
	$communityMapCommon= {
