		...
		this.createLegend = function() {
			...
			infoLegend.update = function(props) {
				...
				this._div.innerHTML = '<div data-html2canvas-ignore=true class="legendRing legendBox max" id="legendBox_'+that.id+'" data-ing="max">'
						...
						+colorList
						+'</ul>'
						+'<div class="heatMin" id="heatMinLegend_'+that.id +'" style="display:none;"><img src="/images/ico/wheel.500.png" style="width:80px;height:80px;margin:14px 10px 10px 10px;"/></div>'
						...
						+'<img src="/images/ico/ico_dbPlay.png" style="float:left;margin:4px 10px 0 10px;width:10px;height:10px;"/><div style="height:20px;font-size:11px;">반지름 조절 (Radius)</div>'
						...
						+'</ul>'
						+'</div>'
						+'<img src="/images/ico/ico_dbPlay.png" width=10 height=10 style="float:left;margin:4px 10px 0 10px;width:10px;height:10px;"/><div style="height:20px;font-size:11px;">흐림도 조절 (Blur)</div>'
						+'<div style="height:50px;">'
