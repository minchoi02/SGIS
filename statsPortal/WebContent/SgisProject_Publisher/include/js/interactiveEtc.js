...
function quickEvent(){
	...
	body.on("click", ".statul > li", function(){ 
		var on = $(this).hasClass("on");
		if(!on){
	...
	body.on("click",".tb_sizing",function(){ 
		...
		if(!ck){
			...
			$(".tb_sizing").children().attr("src","/wordR_lnb/include/images/ico_toolbars12.png");
			...
			$(".tb_sizing").children().attr("src","/wordR_lnb/include/images/ico_toolbars01.png");
