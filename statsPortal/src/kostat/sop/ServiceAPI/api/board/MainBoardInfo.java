...
public class MainBoardInfo extends AbsQuery<List> {
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			if(gubun.equals("allAtOnce")){
				result = session.selectList("board.allAtOnce", mapParameter);
//			}else if(gubun.substring(0,5).equals("BOARD")){
...
//			}else if(gubun.equals("cmmnty")){
//				result = session.selectList("board.cmmnty", mapParameter);
//				// 2016.12.02 시큐어코딩 삭제
			}
