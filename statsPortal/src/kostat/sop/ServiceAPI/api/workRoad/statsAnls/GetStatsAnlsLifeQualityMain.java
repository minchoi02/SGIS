...
public class GetStatsAnlsLifeQualityMain extends AbsQuery<List> {
	private static final Log logger = LogFactory.getLog(GetStatsAnlsLifeQualityMain.class);
	...
	public List executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try {
			...
			result = session.selectList("wrStatsAnls.getStatsAnlsLifeQualityMain", mapParameter);
