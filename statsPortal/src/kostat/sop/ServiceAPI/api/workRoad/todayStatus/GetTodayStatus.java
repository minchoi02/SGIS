...
public class GetTodayStatus extends AbsQuery<Map> {
	...
	enum OptionParam {
		...
		sido_cd,
		sgg_cd,
		search_type		// 2019.06.17[한광희] 오늘의 구인현황 기간조회 기능 활성화에 따른 변수 추가
	}
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res,
		...
		try {
			...
			result.put("todayStatusList", workRoadTodayStatusService.getTodayStatus(mapParameter));
