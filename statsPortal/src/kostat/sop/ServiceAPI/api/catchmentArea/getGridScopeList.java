...
public class getGridScopeList extends AbsQuery< List > {
	
	private static final Log logger = LogFactory.getLog( getGridScopeList.class );
	...
	{
		return "catchmentArea.selectGridScopeList";
	}
