...
public class getSearchScopeList extends AbsQuery< List > {
	
	private static final Log logger = LogFactory.getLog( getSearchScopeList.class );
	...
	{
		return "catchmentArea.selectSerachareaScopeList";
	}
