...
public class getPointFacilitiesList extends AbsQuery< List > {
	
	private static final Log logger = LogFactory.getLog( getPointFacilitiesList.class );
	...
	{
		return "catchmentArea.selectPtFacList";
	}
