...
public class EduIssueContentsList extends AbsQuery<Map>{
	private static final Log logger = LogFactory.getLog(EduIssueContentsList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try{
			...
			int totalCount = eduService.selectEduIssueContentsListCount(mapParameter);
			...
			resultList = eduService.selectEduIssueContentsList(mapParameter);
