...
public class EduThemaList extends AbsQuery<Map>{
	private static final Log logger = LogFactory.getLog(EduThemaList.class);
	...
	public Map executeAPI(HttpServletRequest req, HttpServletResponse res, String trId) throws AbsException {
		...
		try{
			...
			resultList = eduService.selectEduThemaList(mapParameter);
			result.put("resultList", resultList);
			result.put("thema_id", httpSession.getAttribute("ss_school_grade"));
