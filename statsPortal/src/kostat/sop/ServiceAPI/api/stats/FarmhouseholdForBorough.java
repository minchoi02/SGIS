...
/**
* 농가 통계 API 농가에 대한 통계를 제공하기 위한 API
* 
* <pre>
* input : farmhouseholdForBorough.json/xml
* output : json/xml
...
public class FarmhouseholdForBorough extends AbsQuery< List >
{
	private static final Log logger = LogFactory.getLog( FarmhouseholdForBorough.class );
	...
	protected void optimizeParameterMap( Map mapParameter ) throws Exception
	{
		...
		String acre_sz_to = (String) mapParameter.get( "acre_sz_to" );
		String acre_sz_from = (String) mapParameter.get( "acre_sz_from" );
		String adm_length = "0";
...
//			mapParameter.put( "bnd_year", "2014" );
	...
	{
		return "stats.farmhouseholdForBorough";
	}
