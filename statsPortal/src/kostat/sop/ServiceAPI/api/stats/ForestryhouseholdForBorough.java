...
* 
* <pre>
* input : forestryhouseholdForBorough.json/xml
* output : json/xml
...
public class ForestryhouseholdForBorough extends AbsQuery< List >
{
	private static final Log logger = LogFactory.getLog( ForestryhouseholdForBorough.class );
...
//			mapParameter.put( "bnd_year", "2014" );
	...
	{
		return "stats.forestryhouseholdForBorough";
	}
