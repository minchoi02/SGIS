...
public class PolicyWriteServiceImpl extends EgovAbstractServiceImpl implements PolicyWriteService {
	...
	public String mydataList(HttpServletRequest request) throws SQLException {
		...
		if(session.getAttribute("member_id") == null)session.setAttribute("member_id", "");
		String usr_id = session.getAttribute("member_id").toString();
	...
	//=========================== 2017.09.06 [개발팀] START ========================//
		...
		public List getFavoriteAgeList(Map mapParameter) throws SQLException {
			return policyMapper.getFavoriteAgeList(mapParameter);
		}
}