...
public class BoardController {
	...
	@Interceptor("PageCallReg")
	@RequestMapping(value="/sopIntro01")
	public ModelAndView sopIntro01(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/sopIntro01");
	}
	
	@Interceptor("PageCallReg")
	@RequestMapping(value="/sopIntro02")
	public ModelAndView sopIntro02(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/sopIntro02");
	}
	 ...
	 * @param request
	 * @param response
	 * @return board/expAndNoticeStatsWord
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/expAndNoticeStatsWord")
	public ModelAndView expAndNoticeStatsWord(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/expAndNoticeStatsWord");
	}
	 ...
	 * @param request
	 * @param response
	 * @return board/expAndNoticeOfferTableList
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/expAndNoticeOfferTableList")
	public ModelAndView expAndNoticeOfferTableList(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/expAndNoticeOfferTableList");
	}
	 ...
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/qnaAndRequestFaq")
	public ModelAndView qnaAndRequestFaq(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/qnaAndRequestFaq");
	}
	 ...
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/qnaAndRequestQna")
	public ModelAndView qnaAndRequestQna(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/qnaAndRequestQna");
	}
	 ...
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/qnaAndRequestThema")
	public ModelAndView qnaAndRequestThema(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("board/qnaAndRequestThema");
	}
	...
	public ModelAndView faqView(HttpServletRequest request, HttpServletResponse response) {
		...
		//크로스 사이트 스크립트 관련하여 수정 20190801 leekh start
		String post_no = request.getParameter("post_no");
		String boardType = request.getParameter("boardType");
		
		post_no = Security.cleanXss(post_no);
		boardType = Security.cleanXss(boardType); 
		
		request.setAttribute("post_no", post_no);
		request.setAttribute("boardCd", boardType);
		//크로스 사이트 스크립트 관련하여 수정 20190801 leekh end
