...
//	}
	...
	/**
	 * 통계주제도 iframe 화면 13 (색상 통합 주제도)
	 * @param request
	 * @param response
	 * @return thematicMap/thematicMapMain
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/thematicMapFrame13")
	public ModelAndView thematicMapFrame13(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("thematicMap/thematicMapFrame13");
	}
	
	/**
	 * 통계주제도 iframe 화면 15 (시계열 통합 주제도)
	 * @param request
	 * @param response
	 * @return thematicMap/thematicMapMain
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/thematicMapFrame15")
	public ModelAndView thematicMapFrame15(HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("thematicMap/thematicMapFrame15");
	}
