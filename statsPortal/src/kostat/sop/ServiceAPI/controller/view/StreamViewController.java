...
public class StreamViewController {
	...
	@RequestMapping(value="/view/play/{video_name:.+}", method= RequestMethod.GET) 
	public String getContentMediaVideo(@PathVariable("video_name")String video_name, HttpServletRequest request, HttpServletResponse response) 
	...
	String exp = "";
		...
		*/
		...
		System.out.println("[StreamViewController.java] video_name ["+ video_name);
		File file = new File("/DATA/docs/statsPotal/play/"+ video_name);
		
		
		
		if( ! file.exists() ) throw new FileNotFoundException(); 
		RandomAccessFile randomFile = new RandomAccessFile(file, "r"); long rangeStart = 0; 
		...
		}finally{ randomFile.close(); } return null; }
