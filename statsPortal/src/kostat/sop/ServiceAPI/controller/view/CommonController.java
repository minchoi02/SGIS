...
public class CommonController {
	 ...
	 */
	@Interceptor("PageCallReg")
	@RequestMapping(value="/searchListEng")
	public ModelAndView searchListEng(HttpServletRequest request, HttpServletResponse response) {
		...
		return new ModelAndView("common/searchListEng");
	}
